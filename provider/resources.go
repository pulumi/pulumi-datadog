...
func Provider() tfbridge.ProviderInfo {
	...
	err := x.ComputeDefaults(&prov, x.TokensKnownModules("datadog_", datadogMod, []string{
		"gcp_",
		"aws_",
		"azure_",
		"pagerduty_",
		"slack_",
		"opsgenie_",
	}, x.MakeStandardToken(datadogPkg)).Unmappable("integration", "integration acts as a sub-module of the next term: "+
