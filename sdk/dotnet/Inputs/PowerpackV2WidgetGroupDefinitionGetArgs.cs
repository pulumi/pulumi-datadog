...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetGroupDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetGroupDefinitionTimeGetArgs>? Time { get; set; }
        ...
        [Input("widgets")]
        private InputList<Inputs.PowerpackV2WidgetGroupDefinitionWidgetGetArgs>? _widgets;

        /// <summary>
        /// The list of widgets in this group.
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetGroupDefinitionWidgetGetArgs> Widgets
        {
            get => _widgets ?? (_widgets = new InputList<Inputs.PowerpackV2WidgetGroupDefinitionWidgetGetArgs>());
            set => _widgets = value;
        }

        public PowerpackV2WidgetGroupDefinitionGetArgs()
        {
        }
        public static new PowerpackV2WidgetGroupDefinitionGetArgs Empty => new PowerpackV2WidgetGroupDefinitionGetArgs();
    }
}
