...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetQueryValueDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("customLinks")]
        private InputList<Inputs.PowerpackV2WidgetQueryValueDefinitionCustomLinkGetArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetQueryValueDefinitionCustomLinkGetArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.PowerpackV2WidgetQueryValueDefinitionCustomLinkGetArgs>());
        ...
        [Input("requests")]
        private InputList<Inputs.PowerpackV2WidgetQueryValueDefinitionRequestGetArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetQueryValueDefinitionRequestGetArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.PowerpackV2WidgetQueryValueDefinitionRequestGetArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetQueryValueDefinitionTimeGetArgs>? Time { get; set; }

        /// <summary>
        /// Set a timeseries on the widget background.
        /// </summary>
        [Input("timeseriesBackground")]
        public Input<Inputs.PowerpackV2WidgetQueryValueDefinitionTimeseriesBackgroundGetArgs>? TimeseriesBackground { get; set; }
        ...
        public PowerpackV2WidgetQueryValueDefinitionGetArgs()
        {
        }
        public static new PowerpackV2WidgetQueryValueDefinitionGetArgs Empty => new PowerpackV2WidgetQueryValueDefinitionGetArgs();
    }
}
