...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardWidgetDistributionDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("requests")]
        private InputList<Inputs.DashboardWidgetDistributionDefinitionRequestArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.DashboardWidgetDistributionDefinitionRequestArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.DashboardWidgetDistributionDefinitionRequestArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("xaxis")]
        public Input<Inputs.DashboardWidgetDistributionDefinitionXaxisArgs>? Xaxis { get; set; }

        /// <summary>
        /// A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
        /// </summary>
        [Input("yaxis")]
        public Input<Inputs.DashboardWidgetDistributionDefinitionYaxisArgs>? Yaxis { get; set; }
