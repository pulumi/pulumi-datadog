...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetQueryValueDefinitionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("customLinks")]
        private InputList<Inputs.DashboardV2WidgetQueryValueDefinitionCustomLinkArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetQueryValueDefinitionCustomLinkArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.DashboardV2WidgetQueryValueDefinitionCustomLinkArgs>());
        ...
        [Input("requests")]
        private InputList<Inputs.DashboardV2WidgetQueryValueDefinitionRequestArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetQueryValueDefinitionRequestArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.DashboardV2WidgetQueryValueDefinitionRequestArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetQueryValueDefinitionTimeArgs>? Time { get; set; }

        /// <summary>
        /// Set a timeseries on the widget background.
        /// </summary>
        [Input("timeseriesBackground")]
        public Input<Inputs.DashboardV2WidgetQueryValueDefinitionTimeseriesBackgroundArgs>? TimeseriesBackground { get; set; }
        ...
        public DashboardV2WidgetQueryValueDefinitionArgs()
        {
        }
        public static new DashboardV2WidgetQueryValueDefinitionArgs Empty => new DashboardV2WidgetQueryValueDefinitionArgs();
    }
}
