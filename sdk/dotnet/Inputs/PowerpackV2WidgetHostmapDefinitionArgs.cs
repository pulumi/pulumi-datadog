...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetHostmapDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("customLinks")]
        private InputList<Inputs.PowerpackV2WidgetHostmapDefinitionCustomLinkArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetHostmapDefinitionCustomLinkArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.PowerpackV2WidgetHostmapDefinitionCustomLinkArgs>());
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.PowerpackV2WidgetHostmapDefinitionRequestArgs>? Request { get; set; }
        ...
        /// </summary>
        [Input("style")]
        public Input<Inputs.PowerpackV2WidgetHostmapDefinitionStyleArgs>? Style { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetHostmapDefinitionTimeArgs>? Time { get; set; }
        ...
        public PowerpackV2WidgetHostmapDefinitionArgs()
        {
        }
        public static new PowerpackV2WidgetHostmapDefinitionArgs Empty => new PowerpackV2WidgetHostmapDefinitionArgs();
    }
}
