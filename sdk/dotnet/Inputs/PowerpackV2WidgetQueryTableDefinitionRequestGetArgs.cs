...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetQueryTableDefinitionRequestGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("apmStatsQuery")]
        public Input<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestApmStatsQueryGetArgs>? ApmStatsQuery { get; set; }
        ...
        private InputList<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatGetArgs>? _conditionalFormats;
        ...
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatGetArgs> ConditionalFormats
        {
            get => _conditionalFormats ?? (_conditionalFormats = new InputList<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatGetArgs>());
            set => _conditionalFormats = value;
        }

        [Input("formulas")]
        private InputList<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestFormulaGetArgs>? _formulas;

        /// <summary>
        /// A list of formulas to use in the widget.
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestFormulaGetArgs> Formulas
        {
            get => _formulas ?? (_formulas = new InputList<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestFormulaGetArgs>());
            set => _formulas = value;
        }
        ...
        /// </summary>
        [Input("processQuery")]
        public Input<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryGetArgs>? ProcessQuery { get; set; }
        ...
        [Input("queries")]
        private InputList<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestQueryGetArgs>? _queries;

        /// <summary>
        /// A list of queries to use in the widget.
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestQueryGetArgs> Queries
        {
            get => _queries ?? (_queries = new InputList<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestQueryGetArgs>());
            set => _queries = value;
        }
        ...
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestTextFormatGetArgs> TextFormats
        {
            get => _textFormats ?? (_textFormats = new InputList<Inputs.PowerpackV2WidgetQueryTableDefinitionRequestTextFormatGetArgs>());
            set => _textFormats = value;
        }

        public PowerpackV2WidgetQueryTableDefinitionRequestGetArgs()
        {
        }
        public static new PowerpackV2WidgetQueryTableDefinitionRequestGetArgs Empty => new PowerpackV2WidgetQueryTableDefinitionRequestGetArgs();
    }
}
