...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetFunnelDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.DashboardV2WidgetFunnelDefinitionRequestGetArgs>? Request { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetFunnelDefinitionTimeGetArgs>? Time { get; set; }
        ...
        public DashboardV2WidgetFunnelDefinitionGetArgs()
        {
        }
        public static new DashboardV2WidgetFunnelDefinitionGetArgs Empty => new DashboardV2WidgetFunnelDefinitionGetArgs();
    }
}
