...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetFunnelDefinitionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.PowerpackV2WidgetFunnelDefinitionRequestArgs>? Request { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetFunnelDefinitionTimeArgs>? Time { get; set; }
        ...
        public PowerpackV2WidgetFunnelDefinitionArgs()
        {
        }
        public static new PowerpackV2WidgetFunnelDefinitionArgs Empty => new PowerpackV2WidgetFunnelDefinitionArgs();
    }
}
