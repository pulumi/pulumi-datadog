...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetDistributionDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("markers")]
        private InputList<Inputs.PowerpackV2WidgetDistributionDefinitionMarkerGetArgs>? _markers;
        ...
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetDistributionDefinitionMarkerGetArgs> Markers
        {
            get => _markers ?? (_markers = new InputList<Inputs.PowerpackV2WidgetDistributionDefinitionMarkerGetArgs>());
            set => _markers = value;
        }

        [Input("requests")]
        private InputList<Inputs.PowerpackV2WidgetDistributionDefinitionRequestGetArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetDistributionDefinitionRequestGetArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.PowerpackV2WidgetDistributionDefinitionRequestGetArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetDistributionDefinitionTimeGetArgs>? Time { get; set; }
        ...
        /// </summary>
        [Input("xaxis")]
        public Input<Inputs.PowerpackV2WidgetDistributionDefinitionXaxisGetArgs>? Xaxis { get; set; }

        /// <summary>
        /// A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
        /// </summary>
        [Input("yaxis")]
        public Input<Inputs.PowerpackV2WidgetDistributionDefinitionYaxisGetArgs>? Yaxis { get; set; }

        public PowerpackV2WidgetDistributionDefinitionGetArgs()
        {
        }
        public static new PowerpackV2WidgetDistributionDefinitionGetArgs Empty => new PowerpackV2WidgetDistributionDefinitionGetArgs();
    }
}
