...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetDistributionDefinitionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("markers")]
        private InputList<Inputs.PowerpackV2WidgetDistributionDefinitionMarkerArgs>? _markers;
        ...
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetDistributionDefinitionMarkerArgs> Markers
        {
            get => _markers ?? (_markers = new InputList<Inputs.PowerpackV2WidgetDistributionDefinitionMarkerArgs>());
            set => _markers = value;
        }

        [Input("requests")]
        private InputList<Inputs.PowerpackV2WidgetDistributionDefinitionRequestArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetDistributionDefinitionRequestArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.PowerpackV2WidgetDistributionDefinitionRequestArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetDistributionDefinitionTimeArgs>? Time { get; set; }
        ...
        /// </summary>
        [Input("xaxis")]
        public Input<Inputs.PowerpackV2WidgetDistributionDefinitionXaxisArgs>? Xaxis { get; set; }

        /// <summary>
        /// A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
        /// </summary>
        [Input("yaxis")]
        public Input<Inputs.PowerpackV2WidgetDistributionDefinitionYaxisArgs>? Yaxis { get; set; }

        public PowerpackV2WidgetDistributionDefinitionArgs()
        {
        }
        public static new PowerpackV2WidgetDistributionDefinitionArgs Empty => new PowerpackV2WidgetDistributionDefinitionArgs();
    }
}
