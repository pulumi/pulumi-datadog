...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class OnCallTeamRoutingRulesRuleArgs : global::Pulumi.ResourceArgs
    {
        [Input("actions")]
        private InputList<Inputs.OnCallTeamRoutingRulesRuleActionArgs>? _actions;

        /// <summary>
        /// Specifies the list of actions to perform when the routing rule is matched.
        /// </summary>
        public InputList<Inputs.OnCallTeamRoutingRulesRuleActionArgs> Actions
        {
            get => _actions ?? (_actions = new InputList<Inputs.OnCallTeamRoutingRulesRuleActionArgs>());
            set => _actions = value;
        }
        ...
        public OnCallTeamRoutingRulesRuleArgs()
        {
        }
        public static new OnCallTeamRoutingRulesRuleArgs Empty => new OnCallTeamRoutingRulesRuleArgs();
    }
}
