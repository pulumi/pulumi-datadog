...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class ReferenceTableFileMetadataGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Cloud storage access configuration. Exactly one of aws*detail, gcp*detail, or azure*detail must be specified.
        /// </summary>
        [Input("accessDetails")]
        public Input<Inputs.ReferenceTableFileMetadataAccessDetailsGetArgs>? AccessDetails { get; set; }
        ...
        public ReferenceTableFileMetadataGetArgs()
        {
        }
        public static new ReferenceTableFileMetadataGetArgs Empty => new ReferenceTableFileMetadataGetArgs();
    }
}
