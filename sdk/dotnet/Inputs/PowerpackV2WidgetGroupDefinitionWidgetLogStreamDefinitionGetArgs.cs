...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("columns")]
        ...
        /// </summary>
        [Input("sort")]
        public Input<Inputs.PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionSortGetArgs>? Sort { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionTimeGetArgs>? Time { get; set; }
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionGetArgs()
        {
        }
        public static new PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionGetArgs Empty => new PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionGetArgs();
    }
}
