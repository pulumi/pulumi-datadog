...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class ObservabilityPipelineConfigDestinationClickhouseArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Authentication strategy for ClickHouse HTTP requests. Only `Basic` strategy is supported.
        /// </summary>
        [Input("auth")]
        public Input<Inputs.ObservabilityPipelineConfigDestinationClickhouseAuthArgs>? Auth { get; set; }

        /// <summary>
        /// Batching configuration for ClickHouse inserts.
        /// </summary>
        [Input("batch")]
        public Input<Inputs.ObservabilityPipelineConfigDestinationClickhouseBatchArgs>? Batch { get; set; }

        /// <summary>
        /// Batch encoding configuration. Required when `Format` is `ArrowStream`.
        /// </summary>
        [Input("batchEncoding")]
        public Input<Inputs.ObservabilityPipelineConfigDestinationClickhouseBatchEncodingArgs>? BatchEncoding { get; set; }

        /// <summary>
        /// Configuration for buffer settings on destination components. Exactly one of `Disk` or `Memory` must be specified.
        /// </summary>
        [Input("buffer")]
        public Input<Inputs.ObservabilityPipelineConfigDestinationClickhouseBufferArgs>? Buffer { get; set; }

        /// <summary>
        /// Compression for outbound HTTP requests. Use `algorithm = "gzip"` or `algorithm = "none"`.
        /// </summary>
        [Input("compression")]
        public Input<Inputs.ObservabilityPipelineConfigDestinationClickhouseCompressionArgs>? Compression { get; set; }
        ...
        /// </summary>
        [Input("tls")]
        public Input<Inputs.ObservabilityPipelineConfigDestinationClickhouseTlsArgs>? Tls { get; set; }

        public ObservabilityPipelineConfigDestinationClickhouseArgs()
        {
        }
        public static new ObservabilityPipelineConfigDestinationClickhouseArgs Empty => new ObservabilityPipelineConfigDestinationClickhouseArgs();
    }
}
