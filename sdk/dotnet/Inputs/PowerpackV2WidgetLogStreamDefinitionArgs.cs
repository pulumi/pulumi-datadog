...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetLogStreamDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("columns")]
        ...
        /// </summary>
        [Input("sort")]
        public Input<Inputs.PowerpackV2WidgetLogStreamDefinitionSortArgs>? Sort { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetLogStreamDefinitionTimeArgs>? Time { get; set; }
        ...
        public PowerpackV2WidgetLogStreamDefinitionArgs()
        {
        }
        public static new PowerpackV2WidgetLogStreamDefinitionArgs Empty => new PowerpackV2WidgetLogStreamDefinitionArgs();
    }
}
