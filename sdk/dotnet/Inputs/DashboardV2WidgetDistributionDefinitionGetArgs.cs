...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetDistributionDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("markers")]
        private InputList<Inputs.DashboardV2WidgetDistributionDefinitionMarkerGetArgs>? _markers;
        ...
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetDistributionDefinitionMarkerGetArgs> Markers
        {
            get => _markers ?? (_markers = new InputList<Inputs.DashboardV2WidgetDistributionDefinitionMarkerGetArgs>());
            set => _markers = value;
        }

        [Input("requests")]
        private InputList<Inputs.DashboardV2WidgetDistributionDefinitionRequestGetArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetDistributionDefinitionRequestGetArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.DashboardV2WidgetDistributionDefinitionRequestGetArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetDistributionDefinitionTimeGetArgs>? Time { get; set; }
        ...
        /// </summary>
        [Input("xaxis")]
        public Input<Inputs.DashboardV2WidgetDistributionDefinitionXaxisGetArgs>? Xaxis { get; set; }

        /// <summary>
        /// A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
        /// </summary>
        [Input("yaxis")]
        public Input<Inputs.DashboardV2WidgetDistributionDefinitionYaxisGetArgs>? Yaxis { get; set; }

        public DashboardV2WidgetDistributionDefinitionGetArgs()
        {
        }
        public static new DashboardV2WidgetDistributionDefinitionGetArgs Empty => new DashboardV2WidgetDistributionDefinitionGetArgs();
    }
}
