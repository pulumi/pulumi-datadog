...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetQueryValueDefinitionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("customLinks")]
        private InputList<Inputs.PowerpackV2WidgetQueryValueDefinitionCustomLinkArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetQueryValueDefinitionCustomLinkArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.PowerpackV2WidgetQueryValueDefinitionCustomLinkArgs>());
        ...
        [Input("requests")]
        private InputList<Inputs.PowerpackV2WidgetQueryValueDefinitionRequestArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetQueryValueDefinitionRequestArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.PowerpackV2WidgetQueryValueDefinitionRequestArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetQueryValueDefinitionTimeArgs>? Time { get; set; }

        /// <summary>
        /// Set a timeseries on the widget background.
        /// </summary>
        [Input("timeseriesBackground")]
        public Input<Inputs.PowerpackV2WidgetQueryValueDefinitionTimeseriesBackgroundArgs>? TimeseriesBackground { get; set; }
        ...
        public PowerpackV2WidgetQueryValueDefinitionArgs()
        {
        }
        public static new PowerpackV2WidgetQueryValueDefinitionArgs Empty => new PowerpackV2WidgetQueryValueDefinitionArgs();
    }
}
