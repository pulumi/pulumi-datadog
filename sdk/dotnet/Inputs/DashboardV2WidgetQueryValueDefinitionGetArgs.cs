...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetQueryValueDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("customLinks")]
        private InputList<Inputs.DashboardV2WidgetQueryValueDefinitionCustomLinkGetArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetQueryValueDefinitionCustomLinkGetArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.DashboardV2WidgetQueryValueDefinitionCustomLinkGetArgs>());
        ...
        [Input("requests")]
        private InputList<Inputs.DashboardV2WidgetQueryValueDefinitionRequestGetArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetQueryValueDefinitionRequestGetArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.DashboardV2WidgetQueryValueDefinitionRequestGetArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetQueryValueDefinitionTimeGetArgs>? Time { get; set; }

        /// <summary>
        /// Set a timeseries on the widget background.
        /// </summary>
        [Input("timeseriesBackground")]
        public Input<Inputs.DashboardV2WidgetQueryValueDefinitionTimeseriesBackgroundGetArgs>? TimeseriesBackground { get; set; }
        ...
        public DashboardV2WidgetQueryValueDefinitionGetArgs()
        {
        }
        public static new DashboardV2WidgetQueryValueDefinitionGetArgs Empty => new DashboardV2WidgetQueryValueDefinitionGetArgs();
    }
}
