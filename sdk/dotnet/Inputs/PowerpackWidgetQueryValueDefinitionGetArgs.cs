...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackWidgetQueryValueDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("customLinks")]
        private InputList<Inputs.PowerpackWidgetQueryValueDefinitionCustomLinkGetArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.PowerpackWidgetQueryValueDefinitionCustomLinkGetArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.PowerpackWidgetQueryValueDefinitionCustomLinkGetArgs>());
        ...
        [Input("requests")]
        private InputList<Inputs.PowerpackWidgetQueryValueDefinitionRequestGetArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.PowerpackWidgetQueryValueDefinitionRequestGetArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.PowerpackWidgetQueryValueDefinitionRequestGetArgs>());
            set => _requests = value;
        }
        ...
        public Input<Inputs.PowerpackWidgetQueryValueDefinitionTimeseriesBackgroundGetArgs>? TimeseriesBackground { get; set; }
        ...
        public PowerpackWidgetQueryValueDefinitionGetArgs()
        {
        }
        public static new PowerpackWidgetQueryValueDefinitionGetArgs Empty => new PowerpackWidgetQueryValueDefinitionGetArgs();
    }
}
