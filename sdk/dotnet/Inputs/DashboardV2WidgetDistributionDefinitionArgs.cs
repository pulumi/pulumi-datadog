...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetDistributionDefinitionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("markers")]
        private InputList<Inputs.DashboardV2WidgetDistributionDefinitionMarkerArgs>? _markers;
        ...
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetDistributionDefinitionMarkerArgs> Markers
        {
            get => _markers ?? (_markers = new InputList<Inputs.DashboardV2WidgetDistributionDefinitionMarkerArgs>());
            set => _markers = value;
        }

        [Input("requests")]
        private InputList<Inputs.DashboardV2WidgetDistributionDefinitionRequestArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetDistributionDefinitionRequestArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.DashboardV2WidgetDistributionDefinitionRequestArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetDistributionDefinitionTimeArgs>? Time { get; set; }
        ...
        /// </summary>
        [Input("xaxis")]
        public Input<Inputs.DashboardV2WidgetDistributionDefinitionXaxisArgs>? Xaxis { get; set; }

        /// <summary>
        /// A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
        /// </summary>
        [Input("yaxis")]
        public Input<Inputs.DashboardV2WidgetDistributionDefinitionYaxisArgs>? Yaxis { get; set; }

        public DashboardV2WidgetDistributionDefinitionArgs()
        {
        }
        public static new DashboardV2WidgetDistributionDefinitionArgs Empty => new DashboardV2WidgetDistributionDefinitionArgs();
    }
}
