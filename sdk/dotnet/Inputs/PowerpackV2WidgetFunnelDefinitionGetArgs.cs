...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetFunnelDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.PowerpackV2WidgetFunnelDefinitionRequestGetArgs>? Request { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetFunnelDefinitionTimeGetArgs>? Time { get; set; }
        ...
        public PowerpackV2WidgetFunnelDefinitionGetArgs()
        {
        }
        public static new PowerpackV2WidgetFunnelDefinitionGetArgs Empty => new PowerpackV2WidgetFunnelDefinitionGetArgs();
    }
}
