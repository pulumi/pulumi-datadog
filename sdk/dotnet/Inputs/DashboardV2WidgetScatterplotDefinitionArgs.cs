...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetScatterplotDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("colorByGroups")]
        ...
        [Input("customLinks")]
        private InputList<Inputs.DashboardV2WidgetScatterplotDefinitionCustomLinkArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetScatterplotDefinitionCustomLinkArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.DashboardV2WidgetScatterplotDefinitionCustomLinkArgs>());
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.DashboardV2WidgetScatterplotDefinitionRequestArgs>? Request { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetScatterplotDefinitionTimeArgs>? Time { get; set; }
        ...
        /// </summary>
        [Input("xaxis")]
        public Input<Inputs.DashboardV2WidgetScatterplotDefinitionXaxisArgs>? Xaxis { get; set; }

        /// <summary>
        /// A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
        /// </summary>
        [Input("yaxis")]
        public Input<Inputs.DashboardV2WidgetScatterplotDefinitionYaxisArgs>? Yaxis { get; set; }

        public DashboardV2WidgetScatterplotDefinitionArgs()
        {
        }
        public static new DashboardV2WidgetScatterplotDefinitionArgs Empty => new DashboardV2WidgetScatterplotDefinitionArgs();
    }
}
