...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetLogStreamDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("columns")]
        ...
        /// </summary>
        [Input("sort")]
        public Input<Inputs.DashboardV2WidgetLogStreamDefinitionSortArgs>? Sort { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetLogStreamDefinitionTimeArgs>? Time { get; set; }
        ...
        public DashboardV2WidgetLogStreamDefinitionArgs()
        {
        }
        public static new DashboardV2WidgetLogStreamDefinitionArgs Empty => new DashboardV2WidgetLogStreamDefinitionArgs();
    }
}
