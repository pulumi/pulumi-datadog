...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetHostmapDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("customLinks")]
        private InputList<Inputs.PowerpackV2WidgetHostmapDefinitionCustomLinkGetArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetHostmapDefinitionCustomLinkGetArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.PowerpackV2WidgetHostmapDefinitionCustomLinkGetArgs>());
        ...
        /// </summary>
        [Input("style")]
        public Input<Inputs.PowerpackV2WidgetHostmapDefinitionStyleGetArgs>? Style { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetHostmapDefinitionTimeGetArgs>? Time { get; set; }
        ...
        public PowerpackV2WidgetHostmapDefinitionGetArgs()
        {
        }
        public static new PowerpackV2WidgetHostmapDefinitionGetArgs Empty => new PowerpackV2WidgetHostmapDefinitionGetArgs();
    }
}
