...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetScatterplotDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("colorByGroups")]
        ...
        [Input("customLinks")]
        private InputList<Inputs.PowerpackV2WidgetScatterplotDefinitionCustomLinkArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetScatterplotDefinitionCustomLinkArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.PowerpackV2WidgetScatterplotDefinitionCustomLinkArgs>());
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.PowerpackV2WidgetScatterplotDefinitionRequestArgs>? Request { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetScatterplotDefinitionTimeArgs>? Time { get; set; }
        ...
        /// </summary>
        [Input("xaxis")]
        public Input<Inputs.PowerpackV2WidgetScatterplotDefinitionXaxisArgs>? Xaxis { get; set; }

        /// <summary>
        /// A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
        /// </summary>
        [Input("yaxis")]
        public Input<Inputs.PowerpackV2WidgetScatterplotDefinitionYaxisArgs>? Yaxis { get; set; }

        public PowerpackV2WidgetScatterplotDefinitionArgs()
        {
        }
        public static new PowerpackV2WidgetScatterplotDefinitionArgs Empty => new PowerpackV2WidgetScatterplotDefinitionArgs();
    }
}
