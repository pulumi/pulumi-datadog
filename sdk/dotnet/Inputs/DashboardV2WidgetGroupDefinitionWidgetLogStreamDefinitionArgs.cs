...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("columns")]
        ...
        /// </summary>
        [Input("sort")]
        public Input<Inputs.DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionSortArgs>? Sort { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionTimeArgs>? Time { get; set; }
        ...
        public DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs()
        {
        }
        public static new DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs Empty => new DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs();
    }
}
