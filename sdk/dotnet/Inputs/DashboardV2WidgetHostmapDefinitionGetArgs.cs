...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetHostmapDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("customLinks")]
        private InputList<Inputs.DashboardV2WidgetHostmapDefinitionCustomLinkGetArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetHostmapDefinitionCustomLinkGetArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.DashboardV2WidgetHostmapDefinitionCustomLinkGetArgs>());
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.DashboardV2WidgetHostmapDefinitionRequestGetArgs>? Request { get; set; }
        ...
        /// </summary>
        [Input("style")]
        public Input<Inputs.DashboardV2WidgetHostmapDefinitionStyleGetArgs>? Style { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetHostmapDefinitionTimeGetArgs>? Time { get; set; }
        ...
        public DashboardV2WidgetHostmapDefinitionGetArgs()
        {
        }
        public static new DashboardV2WidgetHostmapDefinitionGetArgs Empty => new DashboardV2WidgetHostmapDefinitionGetArgs();
    }
}
