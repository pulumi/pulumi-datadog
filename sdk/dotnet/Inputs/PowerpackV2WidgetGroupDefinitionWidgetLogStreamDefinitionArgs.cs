...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("columns")]
        ...
        /// </summary>
        [Input("sort")]
        public Input<Inputs.PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionSortArgs>? Sort { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionTimeArgs>? Time { get; set; }
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs()
        {
        }
        public static new PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs Empty => new PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs();
    }
}
