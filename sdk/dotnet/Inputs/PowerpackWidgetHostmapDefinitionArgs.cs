...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackWidgetHostmapDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("customLinks")]
        private InputList<Inputs.PowerpackWidgetHostmapDefinitionCustomLinkArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.PowerpackWidgetHostmapDefinitionCustomLinkArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.PowerpackWidgetHostmapDefinitionCustomLinkArgs>());
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.PowerpackWidgetHostmapDefinitionRequestArgs>? Request { get; set; }
        ...
        /// </summary>
        [Input("style")]
        public Input<Inputs.PowerpackWidgetHostmapDefinitionStyleArgs>? Style { get; set; }
        ...
        public PowerpackWidgetHostmapDefinitionArgs()
        {
        }
        public static new PowerpackWidgetHostmapDefinitionArgs Empty => new PowerpackWidgetHostmapDefinitionArgs();
    }
}
