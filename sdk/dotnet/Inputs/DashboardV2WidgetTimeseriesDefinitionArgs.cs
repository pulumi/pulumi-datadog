...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetTimeseriesDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("customLinks")]
        private InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionCustomLinkArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionCustomLinkArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionCustomLinkArgs>());
        ...
        [Input("events")]
        private InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionEventArgs>? _events;

        /// <summary>
        /// The definition of the event to overlay on the graph. Multiple `Event` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionEventArgs> Events
        {
            get => _events ?? (_events = new InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionEventArgs>());
            set => _events = value;
        }
        ...
        [Input("markers")]
        private InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionMarkerArgs>? _markers;
        ...
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionMarkerArgs> Markers
        {
            get => _markers ?? (_markers = new InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionMarkerArgs>());
            set => _markers = value;
        }

        [Input("requests")]
        private InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionRequestArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionRequestArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionRequestArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("rightYaxis")]
        public Input<Inputs.DashboardV2WidgetTimeseriesDefinitionRightYaxisArgs>? RightYaxis { get; set; }
        ...
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetTimeseriesDefinitionTimeArgs>? Time { get; set; }
        ...
        /// </summary>
        [Input("yaxis")]
        public Input<Inputs.DashboardV2WidgetTimeseriesDefinitionYaxisArgs>? Yaxis { get; set; }

        public DashboardV2WidgetTimeseriesDefinitionArgs()
        {
        }
        public static new DashboardV2WidgetTimeseriesDefinitionArgs Empty => new DashboardV2WidgetTimeseriesDefinitionArgs();
    }
}
