...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("customLinks")]
        private InputList<Inputs.PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLinkGetArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLinkGetArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLinkGetArgs>());
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestGetArgs>? Request { get; set; }
        ...
        /// </summary>
        [Input("style")]
        public Input<Inputs.PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionStyleGetArgs>? Style { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionTimeGetArgs>? Time { get; set; }
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionGetArgs()
        {
        }
        public static new PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionGetArgs Empty => new PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionGetArgs();
    }
}
