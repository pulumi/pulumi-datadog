...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetFunnelDefinitionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.DashboardV2WidgetFunnelDefinitionRequestArgs>? Request { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetFunnelDefinitionTimeArgs>? Time { get; set; }
        ...
        public DashboardV2WidgetFunnelDefinitionArgs()
        {
        }
        public static new DashboardV2WidgetFunnelDefinitionArgs Empty => new DashboardV2WidgetFunnelDefinitionArgs();
    }
}
