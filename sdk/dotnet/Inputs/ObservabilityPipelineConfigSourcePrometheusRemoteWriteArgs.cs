...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class ObservabilityPipelineConfigSourcePrometheusRemoteWriteArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("tls")]
        public Input<Inputs.ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs>? Tls { get; set; }
        ...
        [Input("validTokens")]
        private InputList<Inputs.ObservabilityPipelineConfigSourcePrometheusRemoteWriteValidTokenArgs>? _validTokens;
        ...
        /// </summary>
        public InputList<Inputs.ObservabilityPipelineConfigSourcePrometheusRemoteWriteValidTokenArgs> ValidTokens
        {
            get => _validTokens ?? (_validTokens = new InputList<Inputs.ObservabilityPipelineConfigSourcePrometheusRemoteWriteValidTokenArgs>());
            set => _validTokens = value;
        }

        public ObservabilityPipelineConfigSourcePrometheusRemoteWriteArgs()
        {
        }
        public static new ObservabilityPipelineConfigSourcePrometheusRemoteWriteArgs Empty => new ObservabilityPipelineConfigSourcePrometheusRemoteWriteArgs();
    }
}
