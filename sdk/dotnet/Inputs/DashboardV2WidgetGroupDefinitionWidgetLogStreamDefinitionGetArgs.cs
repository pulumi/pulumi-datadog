...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("columns")]
        ...
        /// </summary>
        [Input("sort")]
        public Input<Inputs.DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionSortGetArgs>? Sort { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionTimeGetArgs>? Time { get; set; }
        ...
        public DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionGetArgs()
        {
        }
        public static new DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionGetArgs Empty => new DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionGetArgs();
    }
}
