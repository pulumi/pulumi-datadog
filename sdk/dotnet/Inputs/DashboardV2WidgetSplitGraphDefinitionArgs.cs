...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetSplitGraphDefinitionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionArgs>? SourceWidgetDefinition { get; set; }

        /// <summary>
        /// Encapsulates all user choices about how to split a graph.
        /// </summary>
        [Input("splitConfig", required: true)]
        public Input<Inputs.DashboardV2WidgetSplitGraphDefinitionSplitConfigArgs> SplitConfig { get; set; } = null!;

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetSplitGraphDefinitionTimeArgs>? Time { get; set; }
        ...
        public DashboardV2WidgetSplitGraphDefinitionArgs()
        {
        }
        public static new DashboardV2WidgetSplitGraphDefinitionArgs Empty => new DashboardV2WidgetSplitGraphDefinitionArgs();
    }
}
