...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackWidgetSunburstDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("customLinks")]
        ...
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.PowerpackWidgetSunburstDefinitionCustomLinkArgs>());
        ...
        /// </summary>
        [Input("legendInline")]
        public Input<Inputs.PowerpackWidgetSunburstDefinitionLegendInlineArgs>? LegendInline { get; set; }
        ...
        {
            get => _requests ?? (_requests = new InputList<Inputs.PowerpackWidgetSunburstDefinitionRequestArgs>());
            set => _requests = value;
        }
        ...
        public PowerpackWidgetSunburstDefinitionArgs()
        {
        }
        public static new PowerpackWidgetSunburstDefinitionArgs Empty => new PowerpackWidgetSunburstDefinitionArgs();
    }
}
