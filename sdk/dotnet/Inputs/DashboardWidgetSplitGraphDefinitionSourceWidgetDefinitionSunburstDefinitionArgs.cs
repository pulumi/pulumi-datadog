...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("customLinks")]
        ...
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionCustomLinkArgs>());
        ...
        /// </summary>
        [Input("legendInline")]
        public Input<Inputs.DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionLegendInlineArgs>? LegendInline { get; set; }

        /// <summary>
        /// Used to configure the table legend. Cannot be used in conjunction with legend*inline.
        /// </summary>
        [Input("legendTable")]
        public Input<Inputs.DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionLegendTableArgs>? LegendTable { get; set; }
        ...
        {
            get => _requests ?? (_requests = new InputList<Inputs.DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionRequestArgs>());
            set => _requests = value;
        }
        ...
        public DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionArgs()
        {
        }
        public static new DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionArgs Empty => new DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionArgs();
    }
}
