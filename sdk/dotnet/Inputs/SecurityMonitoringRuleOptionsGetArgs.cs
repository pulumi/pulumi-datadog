...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class SecurityMonitoringRuleOptionsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Options for rules using the anomaly detection method.
        /// </summary>
        [Input("anomalyDetectionOptions")]
        public Input<Inputs.SecurityMonitoringRuleOptionsAnomalyDetectionOptionsGetArgs>? AnomalyDetectionOptions { get; set; }
        ...
        public Input<Inputs.SecurityMonitoringRuleOptionsSequenceDetectionOptionsGetArgs>? SequenceDetectionOptions { get; set; }

        /// <summary>
        /// Options for rules using the third-party detection method.
        /// </summary>
        [Input("thirdPartyRuleOptions")]
        public Input<Inputs.SecurityMonitoringRuleOptionsThirdPartyRuleOptionsGetArgs>? ThirdPartyRuleOptions { get; set; }

        public SecurityMonitoringRuleOptionsGetArgs()
        {
        }
        public static new SecurityMonitoringRuleOptionsGetArgs Empty => new SecurityMonitoringRuleOptionsGetArgs();
    }
}
