...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetTimeseriesDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("customLinks")]
        private InputList<Inputs.PowerpackV2WidgetTimeseriesDefinitionCustomLinkArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetTimeseriesDefinitionCustomLinkArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.PowerpackV2WidgetTimeseriesDefinitionCustomLinkArgs>());
        ...
        [Input("events")]
        private InputList<Inputs.PowerpackV2WidgetTimeseriesDefinitionEventArgs>? _events;

        /// <summary>
        /// The definition of the event to overlay on the graph. Multiple `Event` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetTimeseriesDefinitionEventArgs> Events
        {
            get => _events ?? (_events = new InputList<Inputs.PowerpackV2WidgetTimeseriesDefinitionEventArgs>());
            set => _events = value;
        }
        ...
        [Input("markers")]
        private InputList<Inputs.PowerpackV2WidgetTimeseriesDefinitionMarkerArgs>? _markers;
        ...
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetTimeseriesDefinitionMarkerArgs> Markers
        {
            get => _markers ?? (_markers = new InputList<Inputs.PowerpackV2WidgetTimeseriesDefinitionMarkerArgs>());
            set => _markers = value;
        }

        [Input("requests")]
        private InputList<Inputs.PowerpackV2WidgetTimeseriesDefinitionRequestArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetTimeseriesDefinitionRequestArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.PowerpackV2WidgetTimeseriesDefinitionRequestArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("rightYaxis")]
        public Input<Inputs.PowerpackV2WidgetTimeseriesDefinitionRightYaxisArgs>? RightYaxis { get; set; }
        ...
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetTimeseriesDefinitionTimeArgs>? Time { get; set; }
        ...
        /// </summary>
        [Input("yaxis")]
        public Input<Inputs.PowerpackV2WidgetTimeseriesDefinitionYaxisArgs>? Yaxis { get; set; }

        public PowerpackV2WidgetTimeseriesDefinitionArgs()
        {
        }
        public static new PowerpackV2WidgetTimeseriesDefinitionArgs Empty => new PowerpackV2WidgetTimeseriesDefinitionArgs();
    }
}
