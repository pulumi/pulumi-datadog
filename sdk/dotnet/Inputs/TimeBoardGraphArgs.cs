...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class TimeBoardGraphArgs : Pulumi.ResourceArgs
    {
        [Input("autoscale")]
        ...
        [Input("markers")]
        private InputList<Inputs.TimeBoardGraphMarkerArgs>? _markers;
        public InputList<Inputs.TimeBoardGraphMarkerArgs> Markers
        {
            get => _markers ?? (_markers = new InputList<Inputs.TimeBoardGraphMarkerArgs>());
            set => _markers = value;
        }
        ...
        private InputList<Inputs.TimeBoardGraphRequestArgs>? _requests;
        public InputList<Inputs.TimeBoardGraphRequestArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.TimeBoardGraphRequestArgs>());
            set => _requests = value;
        }
