...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetHostmapDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("customLinks")]
        private InputList<Inputs.DashboardV2WidgetHostmapDefinitionCustomLinkArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetHostmapDefinitionCustomLinkArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.DashboardV2WidgetHostmapDefinitionCustomLinkArgs>());
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.DashboardV2WidgetHostmapDefinitionRequestArgs>? Request { get; set; }
        ...
        /// </summary>
        [Input("style")]
        public Input<Inputs.DashboardV2WidgetHostmapDefinitionStyleArgs>? Style { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetHostmapDefinitionTimeArgs>? Time { get; set; }
        ...
        public DashboardV2WidgetHostmapDefinitionArgs()
        {
        }
        public static new DashboardV2WidgetHostmapDefinitionArgs Empty => new DashboardV2WidgetHostmapDefinitionArgs();
    }
}
