...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetTimeseriesDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("customLinks")]
        private InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionCustomLinkGetArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionCustomLinkGetArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionCustomLinkGetArgs>());
        ...
        [Input("events")]
        private InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionEventGetArgs>? _events;

        /// <summary>
        /// The definition of the event to overlay on the graph. Multiple `Event` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionEventGetArgs> Events
        {
            get => _events ?? (_events = new InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionEventGetArgs>());
            set => _events = value;
        }
        ...
        [Input("markers")]
        private InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionMarkerGetArgs>? _markers;
        ...
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionMarkerGetArgs> Markers
        {
            get => _markers ?? (_markers = new InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionMarkerGetArgs>());
            set => _markers = value;
        }

        [Input("requests")]
        private InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionRequestGetArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionRequestGetArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.DashboardV2WidgetTimeseriesDefinitionRequestGetArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("rightYaxis")]
        public Input<Inputs.DashboardV2WidgetTimeseriesDefinitionRightYaxisGetArgs>? RightYaxis { get; set; }
        ...
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetTimeseriesDefinitionTimeGetArgs>? Time { get; set; }
        ...
        /// </summary>
        [Input("yaxis")]
        public Input<Inputs.DashboardV2WidgetTimeseriesDefinitionYaxisGetArgs>? Yaxis { get; set; }

        public DashboardV2WidgetTimeseriesDefinitionGetArgs()
        {
        }
        public static new DashboardV2WidgetTimeseriesDefinitionGetArgs Empty => new DashboardV2WidgetTimeseriesDefinitionGetArgs();
    }
}
