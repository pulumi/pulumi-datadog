...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs : global::Pulumi.ResourceArgs
    {
        [Input("customLinks")]
        private InputList<Inputs.PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLinkArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLinkArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLinkArgs>());
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestArgs>? Request { get; set; }
        ...
        /// </summary>
        [Input("style")]
        public Input<Inputs.PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionStyleArgs>? Style { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionTimeArgs>? Time { get; set; }
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs()
        {
        }
        public static new PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs Empty => new PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs();
    }
}
