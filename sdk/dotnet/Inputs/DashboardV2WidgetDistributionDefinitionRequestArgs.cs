...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetDistributionDefinitionRequestArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("apmStatsQuery")]
        public Input<Inputs.DashboardV2WidgetDistributionDefinitionRequestApmStatsQueryArgs>? ApmStatsQuery { get; set; }

        [Input("formulas")]
        private InputList<Inputs.DashboardV2WidgetDistributionDefinitionRequestFormulaArgs>? _formulas;

        /// <summary>
        /// A list of formulas to use in the widget.
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetDistributionDefinitionRequestFormulaArgs> Formulas
        {
            get => _formulas ?? (_formulas = new InputList<Inputs.DashboardV2WidgetDistributionDefinitionRequestFormulaArgs>());
            set => _formulas = value;
        }
        ...
        /// </summary>
        [Input("processQuery")]
        public Input<Inputs.DashboardV2WidgetDistributionDefinitionRequestProcessQueryArgs>? ProcessQuery { get; set; }
        ...
        [Input("queries")]
        private InputList<Inputs.DashboardV2WidgetDistributionDefinitionRequestQueryArgs>? _queries;

        /// <summary>
        /// A list of queries to use in the widget.
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetDistributionDefinitionRequestQueryArgs> Queries
        {
        ...
        /// </summary>
        [Input("style")]
        public Input<Inputs.DashboardV2WidgetDistributionDefinitionRequestStyleArgs>? Style { get; set; }

        public DashboardV2WidgetDistributionDefinitionRequestArgs()
        {
        }
        public static new DashboardV2WidgetDistributionDefinitionRequestArgs Empty => new DashboardV2WidgetDistributionDefinitionRequestArgs();
    }
}
