...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class DashboardV2WidgetScatterplotDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("colorByGroups")]
        ...
        [Input("customLinks")]
        private InputList<Inputs.DashboardV2WidgetScatterplotDefinitionCustomLinkGetArgs>? _customLinks;

        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public InputList<Inputs.DashboardV2WidgetScatterplotDefinitionCustomLinkGetArgs> CustomLinks
        {
            get => _customLinks ?? (_customLinks = new InputList<Inputs.DashboardV2WidgetScatterplotDefinitionCustomLinkGetArgs>());
        ...
        /// </summary>
        [Input("request")]
        public Input<Inputs.DashboardV2WidgetScatterplotDefinitionRequestGetArgs>? Request { get; set; }

        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        [Input("time")]
        public Input<Inputs.DashboardV2WidgetScatterplotDefinitionTimeGetArgs>? Time { get; set; }
        ...
        /// </summary>
        [Input("xaxis")]
        public Input<Inputs.DashboardV2WidgetScatterplotDefinitionXaxisGetArgs>? Xaxis { get; set; }

        /// <summary>
        /// A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
        /// </summary>
        [Input("yaxis")]
        public Input<Inputs.DashboardV2WidgetScatterplotDefinitionYaxisGetArgs>? Yaxis { get; set; }

        public DashboardV2WidgetScatterplotDefinitionGetArgs()
        {
        }
        public static new DashboardV2WidgetScatterplotDefinitionGetArgs Empty => new DashboardV2WidgetScatterplotDefinitionGetArgs();
    }
}
