...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class PowerpackWidgetDistributionDefinitionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("requests")]
        private InputList<Inputs.PowerpackWidgetDistributionDefinitionRequestArgs>? _requests;
        ...
        /// </summary>
        public InputList<Inputs.PowerpackWidgetDistributionDefinitionRequestArgs> Requests
        {
            get => _requests ?? (_requests = new InputList<Inputs.PowerpackWidgetDistributionDefinitionRequestArgs>());
            set => _requests = value;
        }
        ...
        /// </summary>
        [Input("xaxis")]
        public Input<Inputs.PowerpackWidgetDistributionDefinitionXaxisArgs>? Xaxis { get; set; }

        /// <summary>
        /// A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
        /// </summary>
        [Input("yaxis")]
        public Input<Inputs.PowerpackWidgetDistributionDefinitionYaxisArgs>? Yaxis { get; set; }

        public PowerpackWidgetDistributionDefinitionArgs()
        {
        }
        public static new PowerpackWidgetDistributionDefinitionArgs Empty => new PowerpackWidgetDistributionDefinitionArgs();
    }
}
