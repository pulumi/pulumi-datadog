...
namespace Pulumi.Datadog.Inputs
{
    ...
    public sealed class ObservabilityPipelineConfigDestinationSplunkHecMetricsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Configuration for buffer settings on destination components. Exactly one of `Disk` or `Memory` must be specified.
        /// </summary>
        [Input("buffer")]
        public Input<Inputs.ObservabilityPipelineConfigDestinationSplunkHecMetricsBufferGetArgs>? Buffer { get; set; }
        ...
        /// </summary>
        [Input("tls")]
        public Input<Inputs.ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsGetArgs>? Tls { get; set; }
        ...
        public ObservabilityPipelineConfigDestinationSplunkHecMetricsGetArgs()
        {
        }
        public static new ObservabilityPipelineConfigDestinationSplunkHecMetricsGetArgs Empty => new ObservabilityPipelineConfigDestinationSplunkHecMetricsGetArgs();
    }
}
