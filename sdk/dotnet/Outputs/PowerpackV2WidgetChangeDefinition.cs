...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class PowerpackV2WidgetChangeDefinition
    {
        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public readonly ImmutableArray<Outputs.PowerpackV2WidgetChangeDefinitionCustomLink> CustomLinks;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.PowerpackV2WidgetChangeDefinitionRequest> Requests;
        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        public readonly Outputs.PowerpackV2WidgetChangeDefinitionTime? Time;
        /// <summary>
        ...
        private PowerpackV2WidgetChangeDefinition(
            ImmutableArray<Outputs.PowerpackV2WidgetChangeDefinitionCustomLink> customLinks,
            ...
            ImmutableArray<Outputs.PowerpackV2WidgetChangeDefinitionRequest> requests,

            Outputs.PowerpackV2WidgetChangeDefinitionTime? time,
