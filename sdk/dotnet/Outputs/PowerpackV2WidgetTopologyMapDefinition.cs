...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class PowerpackV2WidgetTopologyMapDefinition
    {
        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public readonly ImmutableArray<Outputs.PowerpackV2WidgetTopologyMapDefinitionCustomLink> CustomLinks;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.PowerpackV2WidgetTopologyMapDefinitionRequest> Requests;
        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        public readonly Outputs.PowerpackV2WidgetTopologyMapDefinitionTime? Time;
        /// <summary>
        ...
        private PowerpackV2WidgetTopologyMapDefinition(
            ImmutableArray<Outputs.PowerpackV2WidgetTopologyMapDefinitionCustomLink> customLinks,
            ...
            ImmutableArray<Outputs.PowerpackV2WidgetTopologyMapDefinitionRequest> requests,

            Outputs.PowerpackV2WidgetTopologyMapDefinitionTime? time,
