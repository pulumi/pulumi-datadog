...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class DashboardV2WidgetQueryTableDefinition
    {
        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public readonly ImmutableArray<Outputs.DashboardV2WidgetQueryTableDefinitionCustomLink> CustomLinks;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.DashboardV2WidgetQueryTableDefinitionRequest> Requests;
        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        public readonly Outputs.DashboardV2WidgetQueryTableDefinitionTime? Time;
        /// <summary>
        ...
        private DashboardV2WidgetQueryTableDefinition(
            ImmutableArray<Outputs.DashboardV2WidgetQueryTableDefinitionCustomLink> customLinks,
            ...
            ImmutableArray<Outputs.DashboardV2WidgetQueryTableDefinitionRequest> requests,

            Outputs.DashboardV2WidgetQueryTableDefinitionTime? time,
