...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class DashboardV2WidgetTopologyMapDefinition
    {
        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public readonly ImmutableArray<Outputs.DashboardV2WidgetTopologyMapDefinitionCustomLink> CustomLinks;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.DashboardV2WidgetTopologyMapDefinitionRequest> Requests;
        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        public readonly Outputs.DashboardV2WidgetTopologyMapDefinitionTime? Time;
        /// <summary>
        ...
        private DashboardV2WidgetTopologyMapDefinition(
            ImmutableArray<Outputs.DashboardV2WidgetTopologyMapDefinitionCustomLink> customLinks,
            ...
            ImmutableArray<Outputs.DashboardV2WidgetTopologyMapDefinitionRequest> requests,

            Outputs.DashboardV2WidgetTopologyMapDefinitionTime? time,
