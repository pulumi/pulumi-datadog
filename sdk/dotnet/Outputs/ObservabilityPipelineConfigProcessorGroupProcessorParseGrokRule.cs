...
namespace Pulumi.Datadog.Outputs
{
    ...
    public sealed class ObservabilityPipelineConfigProcessorGroupProcessorParseGrokRule
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.ObservabilityPipelineConfigProcessorGroupProcessorParseGrokRuleSupportRule> SupportRules;

        [OutputConstructor]
        private ObservabilityPipelineConfigProcessorGroupProcessorParseGrokRule(
            ImmutableArray<Outputs.ObservabilityPipelineConfigProcessorGroupProcessorParseGrokRuleMatchRule> matchRules,

            string source,

            ImmutableArray<Outputs.ObservabilityPipelineConfigProcessorGroupProcessorParseGrokRuleSupportRule> supportRules)
        {
