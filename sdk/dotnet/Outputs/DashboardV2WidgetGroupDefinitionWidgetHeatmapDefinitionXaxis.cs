...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class DashboardV2WidgetGroupDefinitionWidgetHeatmapDefinitionXaxis
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DashboardV2WidgetGroupDefinitionWidgetHeatmapDefinitionXaxis(int? numBuckets)
        {
