...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinition
    {
        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public readonly ImmutableArray<Outputs.PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionCustomLink> CustomLinks;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequest> Requests;
        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        public readonly Outputs.PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionTime? Time;
        /// <summary>
        ...
        private PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinition(
            ImmutableArray<Outputs.PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionCustomLink> customLinks,
            ...
            ImmutableArray<Outputs.PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequest> requests,

            Outputs.PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionTime? time,
