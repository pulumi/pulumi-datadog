...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionGeomapDefinitionView
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionGeomapDefinitionView(string focus)
        {
            Focus = focus;
        }
    }
