...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class PowerpackV2WidgetGroupDefinitionWidgetHeatmapDefinitionXaxis
    {
        /// <summary>
        ...
        [OutputConstructor]
        private PowerpackV2WidgetGroupDefinitionWidgetHeatmapDefinitionXaxis(int? numBuckets)
        {
