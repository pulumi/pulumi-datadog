...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class DashboardV2WidgetSunburstDefinition
    {
        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public readonly ImmutableArray<Outputs.DashboardV2WidgetSunburstDefinitionCustomLink> CustomLinks;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.DashboardV2WidgetSunburstDefinitionLegendInline? LegendInline;
        /// <summary>
        /// Used to configure the table legend. Cannot be used in conjunction with legend*inline.
        /// </summary>
        public readonly Outputs.DashboardV2WidgetSunburstDefinitionLegendTable? LegendTable;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.DashboardV2WidgetSunburstDefinitionRequest> Requests;
        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        public readonly Outputs.DashboardV2WidgetSunburstDefinitionTime? Time;
        /// <summary>
        ...
        private DashboardV2WidgetSunburstDefinition(
            ImmutableArray<Outputs.DashboardV2WidgetSunburstDefinitionCustomLink> customLinks,
            ...
            Outputs.DashboardV2WidgetSunburstDefinitionLegendInline? legendInline,

            Outputs.DashboardV2WidgetSunburstDefinitionLegendTable? legendTable,

            string? liveSpan,

            ImmutableArray<Outputs.DashboardV2WidgetSunburstDefinitionRequest> requests,

            Outputs.DashboardV2WidgetSunburstDefinitionTime? time,
