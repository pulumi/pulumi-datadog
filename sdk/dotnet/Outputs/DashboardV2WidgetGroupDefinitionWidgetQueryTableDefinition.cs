...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class DashboardV2WidgetGroupDefinitionWidgetQueryTableDefinition
    {
        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public readonly ImmutableArray<Outputs.DashboardV2WidgetGroupDefinitionWidgetQueryTableDefinitionCustomLink> CustomLinks;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.DashboardV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequest> Requests;
        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        public readonly Outputs.DashboardV2WidgetGroupDefinitionWidgetQueryTableDefinitionTime? Time;
        /// <summary>
        ...
        private DashboardV2WidgetGroupDefinitionWidgetQueryTableDefinition(
            ImmutableArray<Outputs.DashboardV2WidgetGroupDefinitionWidgetQueryTableDefinitionCustomLink> customLinks,
            ...
            ImmutableArray<Outputs.DashboardV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequest> requests,

            Outputs.DashboardV2WidgetGroupDefinitionWidgetQueryTableDefinitionTime? time,
