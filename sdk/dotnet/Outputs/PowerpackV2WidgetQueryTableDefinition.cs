...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class PowerpackV2WidgetQueryTableDefinition
    {
        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public readonly ImmutableArray<Outputs.PowerpackV2WidgetQueryTableDefinitionCustomLink> CustomLinks;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.PowerpackV2WidgetQueryTableDefinitionRequest> Requests;
        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        public readonly Outputs.PowerpackV2WidgetQueryTableDefinitionTime? Time;
        /// <summary>
        ...
        private PowerpackV2WidgetQueryTableDefinition(
            ImmutableArray<Outputs.PowerpackV2WidgetQueryTableDefinitionCustomLink> customLinks,
            ...
            ImmutableArray<Outputs.PowerpackV2WidgetQueryTableDefinitionRequest> requests,

            Outputs.PowerpackV2WidgetQueryTableDefinitionTime? time,
