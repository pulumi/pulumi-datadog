...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class DashboardV2WidgetGroupDefinitionWidgetGeomapDefinitionView
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DashboardV2WidgetGroupDefinitionWidgetGeomapDefinitionView(string focus)
        {
            Focus = focus;
        }
    }
