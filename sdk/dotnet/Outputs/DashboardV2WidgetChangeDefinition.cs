...
namespace Pulumi.Datadog.Outputs
{
    ...
    [OutputType]
    public sealed class DashboardV2WidgetChangeDefinition
    {
        /// <summary>
        /// A nested block describing a custom link. Multiple `CustomLink` blocks are allowed using the structure below.
        /// </summary>
        public readonly ImmutableArray<Outputs.DashboardV2WidgetChangeDefinitionCustomLink> CustomLinks;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.DashboardV2WidgetChangeDefinitionRequest> Requests;
        /// <summary>
        /// A nested block used to specify a time span for the widget. Use this or `LiveSpan`, not both.
        /// </summary>
        public readonly Outputs.DashboardV2WidgetChangeDefinitionTime? Time;
        /// <summary>
        ...
        private DashboardV2WidgetChangeDefinition(
            ImmutableArray<Outputs.DashboardV2WidgetChangeDefinitionCustomLink> customLinks,
            ...
            ImmutableArray<Outputs.DashboardV2WidgetChangeDefinitionRequest> requests,

            Outputs.DashboardV2WidgetChangeDefinitionTime? time,
