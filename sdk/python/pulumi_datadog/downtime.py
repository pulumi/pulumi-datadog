...
class DowntimeArgs:
    def __init__(__self__, *,
                 ...
                 monitor_tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 mute_first_recovery_notification: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: specify the group scope to which this downtime applies. For everything use '*'
        :param pulumi.Input[builtins.int] end: Optionally specify an end date when this downtime should expire. Accepts a Unix timestamp in UTC.
        :param pulumi.Input[builtins.str] end_date: String representing date and time to end the downtime in RFC3339 format.
        :param pulumi.Input[builtins.str] message: An optional message to provide when creating the downtime, can include notification handles
        :param pulumi.Input[builtins.int] monitor_id: When specified, this downtime will only apply to this monitor
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] monitor_tags: A list of monitor tags (up to 32) to base the scheduled downtime on. Only monitors that have all selected tags are silenced
        :param pulumi.Input[builtins.bool] mute_first_recovery_notification: When true the first recovery notification during the downtime will be muted Defaults to `false`.
        :param pulumi.Input['DowntimeRecurrenceArgs'] recurrence: Optional recurring schedule for this downtime
        :param pulumi.Input[builtins.int] start: Specify when this downtime should start. Accepts a Unix timestamp in UTC.
        :param pulumi.Input[builtins.str] start_date: String representing date and time to start the downtime in RFC3339 format.
        :param pulumi.Input[builtins.str] timezone: The timezone for the downtime. Follows IANA timezone database identifiers. Defaults to `"UTC"`.
        """
    ...
    def monitor_tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @monitor_tags.setter
    def monitor_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "monitor_tags", value)

    @property
    @pulumi.getter(name="muteFirstRecoveryNotification")
    def mute_first_recovery_notification(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def mute_first_recovery_notification(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DowntimeState:
    def __init__(__self__, *,
                 ...
                 active_child_id: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.bool] active: When true indicates this downtime is being actively applied
        :param pulumi.Input[builtins.int] active_child_id: The id corresponding to the downtime object definition of the active child for the original parent recurring downtime. This field will only exist on recurring downtimes.
        :param pulumi.Input[builtins.bool] disabled: When true indicates this downtime is not being applied
        :param pulumi.Input[builtins.int] end: Optionally specify an end date when this downtime should expire. Accepts a Unix timestamp in UTC.
        :param pulumi.Input[builtins.str] end_date: String representing date and time to end the downtime in RFC3339 format.
        :param pulumi.Input[builtins.str] message: An optional message to provide when creating the downtime, can include notification handles
        :param pulumi.Input[builtins.int] monitor_id: When specified, this downtime will only apply to this monitor
    ...
    def active_child_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def active_child_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Downtime(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            start: Optional[pulumi.Input[builtins.int]] = None,
            start_date: Optional[pulumi.Input[builtins.str]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None) -> 'Downtime':
        """
    ...
    @property
    @pulumi.getter(name="activeChildId")
    def active_child_id(self) -> pulumi.Output[builtins.int]:
        """
        The id corresponding to the downtime object definition of the active child for the original parent recurring downtime. This field will only exist on recurring downtimes.
        """
        return pulumi.get(self, "active_child_id")
    ...
    @property
    @pulumi.getter
    def end(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Optionally specify an end date when this downtime should expire. Accepts a Unix timestamp in UTC.
        """
        return pulumi.get(self, "end")
    ...
    @property
    @pulumi.getter(name="monitorId")
    def monitor_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        When specified, this downtime will only apply to this monitor
        """
        return pulumi.get(self, "monitor_id")
    ...
    @property
    @pulumi.getter(name="monitorTags")
    def monitor_tags(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of monitor tags (up to 32) to base the scheduled downtime on. Only monitors that have all selected tags are silenced
        """
        return pulumi.get(self, "monitor_tags")
    ...
    @property
    @pulumi.getter(name="muteFirstRecoveryNotification")
    def mute_first_recovery_notification(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When true the first recovery notification during the downtime will be muted Defaults to `false`.
        """
        return pulumi.get(self, "mute_first_recovery_notification")
    ...
    @property
    @pulumi.getter
    def start(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specify when this downtime should start. Accepts a Unix timestamp in UTC.
        """
        return pulumi.get(self, "start")
