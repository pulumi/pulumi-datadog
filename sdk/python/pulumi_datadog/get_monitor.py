...
class GetMonitorResult:
    ...
    def enable_samples(self) -> builtins.bool:
        """
    ...
    def evaluation_delay(self) -> builtins.int:
        """
    ...
    def monitor_tags_filters(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def new_group_delay(self) -> builtins.int:
        """
    ...
    def new_host_delay(self) -> builtins.int:
        """
    ...
    def no_data_timeframe(self) -> builtins.int:
        """
    ...
    def notify_bies(self) -> Sequence[builtins.str]:
        """
    ...
    def renotify_interval(self) -> builtins.int:
        """
    ...
    def renotify_occurrences(self) -> builtins.int:
        """
    ...
    def renotify_statuses(self) -> Sequence[builtins.str]:
        """
    ...
    def restricted_roles(self) -> Sequence[builtins.str]:
    ...
    def tags_filters(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def timeout_h(self) -> builtins.int:
        """
...
def get_monitor(monitor_tags_filters: Optional[Sequence[builtins.str]] = None,
                name_filter: Optional[builtins.str] = None,
                tags_filters: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] monitor_tags_filters: A list of monitor tags to limit the search. This filters on the tags set on the monitor itself.
    :param builtins.str name_filter: A monitor name to limit the search.
    :param Sequence[builtins.str] tags_filters: A list of tags to limit the search. This filters on the monitor scope.
    """
    __args__ = dict()
...
def get_monitor_output(monitor_tags_filters: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                       name_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       tags_filters: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
