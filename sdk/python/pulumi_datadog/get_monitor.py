...
class GetMonitorResult:
    ...
    def enable_logs_sample(self) -> _builtins.bool:
        """
    ...
    def enable_samples(self) -> _builtins.bool:
        """
    ...
    def escalation_message(self) -> _builtins.str:
        """
    ...
    def evaluation_delay(self) -> _builtins.int:
        """
    ...
    def group_retention_duration(self) -> _builtins.str:
        """
    ...
    def groupby_simple_monitor(self) -> _builtins.bool:
        """
    ...
    def monitor_tags_filters(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def new_group_delay(self) -> _builtins.int:
        """
    ...
    def new_host_delay(self) -> _builtins.int:
        """
    ...
    def notification_preset_name(self) -> _builtins.str:
        """
    ...
    def notify_audit(self) -> _builtins.bool:
        """
    ...
    def notify_bies(self) -> Sequence[_builtins.str]:
        """
    ...
    def on_missing_data(self) -> _builtins.str:
        """
    ...
    def renotify_interval(self) -> _builtins.int:
        """
    ...
    def renotify_occurrences(self) -> _builtins.int:
        """
    ...
    def renotify_statuses(self) -> Sequence[_builtins.str]:
        """
    ...
    def require_full_window(self) -> _builtins.bool:
        """
    ...
    def restricted_roles(self) -> Sequence[_builtins.str]:
    ...
    def timeout_h(self) -> _builtins.int:
        """
...
def get_monitor(monitor_tags_filters: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] monitor_tags_filters: A list of monitor tags to limit the search. This filters on the tags set on the monitor itself.
    :param _builtins.str name_filter: A monitor name to limit the search.
    :param Sequence[_builtins.str] tags_filters: A list of tags to limit the search. This filters on the monitor scope.
    """
    __args__ = dict()
