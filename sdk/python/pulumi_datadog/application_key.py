...
class ApplicationKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name for Application Key.
...
class _ApplicationKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key: The value of the Application Key.
        :param pulumi.Input[builtins.str] name: Name for Application Key.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: Authorization scopes for the Application Key. Application Keys configured with no scopes have full access.
        """
        if key is not None:
...
class ApplicationKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ApplicationKey':
        """
