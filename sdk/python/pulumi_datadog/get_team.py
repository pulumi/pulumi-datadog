...
class GetTeamResult:
    ...
    def link_count(self) -> _builtins.int:
        """
...
def get_team(filter_keyword: Optional[_builtins.str] = None,
...
def get_team_output(filter_keyword: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
