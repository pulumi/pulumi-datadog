...
def get_roles(filter: Optional[builtins.str] = None,
    ...
    :param builtins.str filter: Filter all roles by the given string.
    """
    __args__ = dict()
...
def get_roles_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
