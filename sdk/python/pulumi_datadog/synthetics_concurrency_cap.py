...
class SyntheticsConcurrencyCapArgs:
    def __init__(__self__, *,
                 on_demand_concurrency_cap: pulumi.Input[builtins.int]):
        """
        The set of arguments for constructing a SyntheticsConcurrencyCap resource.
        :param pulumi.Input[builtins.int] on_demand_concurrency_cap: Value of the on-demand concurrency cap, customizing the number of Synthetic tests run in parallel. Value must be at least 1.
        """
        pulumi.set(__self__, "on_demand_concurrency_cap", on_demand_concurrency_cap)

    @property
    @pulumi.getter(name="onDemandConcurrencyCap")
    def on_demand_concurrency_cap(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def on_demand_concurrency_cap(self, value: pulumi.Input[builtins.int]):
...
class _SyntheticsConcurrencyCapState:
    def __init__(__self__, *,
                 on_demand_concurrency_cap: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter(name="onDemandConcurrencyCap")
    def on_demand_concurrency_cap(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Value of the on-demand concurrency cap, customizing the number of Synthetic tests run in parallel. Value must be at least 1.
        """
        return pulumi.get(self, "on_demand_concurrency_cap")
    ...
    @on_demand_concurrency_cap.setter
    def on_demand_concurrency_cap(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "on_demand_concurrency_cap", value)
...
class SyntheticsConcurrencyCap(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            on_demand_concurrency_cap: Optional[pulumi.Input[builtins.int]] = None) -> 'SyntheticsConcurrencyCap':
        """
    ...
    @property
    @pulumi.getter(name="onDemandConcurrencyCap")
    def on_demand_concurrency_cap(self) -> pulumi.Output[builtins.int]:
        """
        Value of the on-demand concurrency cap, customizing the number of Synthetic tests run in parallel. Value must be at least 1.
        """
        return pulumi.get(self, "on_demand_concurrency_cap")
