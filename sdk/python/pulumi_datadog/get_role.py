...
def get_role(filter: Optional[builtins.str] = None,
    ...
    :param builtins.str filter: A string on which to filter the roles.
    """
    __args__ = dict()
...
def get_role_output(filter: Optional[pulumi.Input[builtins.str]] = None,
