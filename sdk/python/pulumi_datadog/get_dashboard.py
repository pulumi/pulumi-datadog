...
def get_dashboard(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The dashboard name to search for. Must only match one dashboard.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_dashboard_output(name: Optional[pulumi.Input[builtins.str]] = None,
