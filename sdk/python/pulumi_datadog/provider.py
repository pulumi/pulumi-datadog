...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 http_client_retry_backoff_base: Optional[pulumi.Input[builtins.int]] = None,
                 http_client_retry_backoff_multiplier: Optional[pulumi.Input[builtins.int]] = None,
                 http_client_retry_enabled: Optional[pulumi.Input[builtins.str]] = None,
                 http_client_retry_max_retries: Optional[pulumi.Input[builtins.int]] = None,
                 http_client_retry_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 validate: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[builtins.str] api_key: (Required unless validate is false) Datadog API key. This can also be set via the DD_API_KEY environment variable.
        :param pulumi.Input[builtins.str] api_url: The API URL. This can also be set via the DD_HOST environment variable, and defaults to `https://api.datadoghq.com`.
        ...
        :param pulumi.Input[builtins.int] http_client_retry_max_retries: The HTTP request maximum retry number. Defaults to 3.
        :param pulumi.Input[builtins.int] http_client_retry_timeout: The HTTP request retry timeout period. Defaults to 60 seconds.
        :param pulumi.Input[builtins.str] validate: Enables validation of the provided API key during provider initialization. Valid values are [`true`, `false`]. Default
    ...
    def http_client_retry_backoff_base(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def http_client_retry_backoff_base(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "http_client_retry_backoff_base", value)

    @property
    @pulumi.getter(name="httpClientRetryBackoffMultiplier")
    def http_client_retry_backoff_multiplier(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def http_client_retry_backoff_multiplier(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "http_client_retry_backoff_multiplier", value)

    @property
    @pulumi.getter(name="httpClientRetryEnabled")
    def http_client_retry_enabled(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def http_client_retry_enabled(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "http_client_retry_enabled", value)

    @property
    @pulumi.getter(name="httpClientRetryMaxRetries")
    def http_client_retry_max_retries(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def http_client_retry_max_retries(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "http_client_retry_max_retries", value)

    @property
    @pulumi.getter(name="httpClientRetryTimeout")
    def http_client_retry_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def http_client_retry_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Provider(pulumi.ProviderResource):
    ...
    @property
    @pulumi.getter(name="httpClientRetryEnabled")
    def http_client_retry_enabled(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Enables request retries on HTTP status codes 429 and 5xx. Valid values are [`true`, `false`]. Defaults to `true`.
        """
        return pulumi.get(self, "http_client_retry_enabled")
