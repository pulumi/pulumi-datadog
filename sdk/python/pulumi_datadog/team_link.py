...
class TeamLinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] label: The link's label.
        :param pulumi.Input[builtins.str] team_id: ID of the team the link is associated with.
        :param pulumi.Input[builtins.str] url: The URL for the link.
        :param pulumi.Input[builtins.int] position: The link's position, used to sort links for the team.
        """
...
class TeamLink(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            position: Optional[pulumi.Input[builtins.int]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'TeamLink':
        """
