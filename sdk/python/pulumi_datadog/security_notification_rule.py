...
class SecurityNotificationRuleArgs:
    def __init__(__self__, *,
                 ...
                 time_aggregation: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a SecurityNotificationRule resource.
        :param pulumi.Input[builtins.str] name: The name of the rule (must be unique).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] targets: The list of handle targets for the notifications. A target must be prefixed with an @. It can be an email address (@bob@email.com), or any installed integration. For example, a Slack recipient (@slack-ops), or a Teams recipient (@teams-ops).
        :param pulumi.Input[builtins.bool] enabled: Indicates whether the rule is enabled. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.int] time_aggregation: Specifies the time period, in seconds, used to aggregate the notification. Defaults to `0`.
        """
    ...
    def time_aggregation(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def time_aggregation(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _SecurityNotificationRuleState:
    def __init__(__self__, *,
                 ...
                 created_by_handle: Optional[pulumi.Input[builtins.str]] = None,
                 created_by_name: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 modified_at: Optional[pulumi.Input[builtins.int]] = None,
                 modified_by_handle: Optional[pulumi.Input[builtins.str]] = None,
                 modified_by_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] created_at: Indicates when this rule was created.
        :param pulumi.Input[builtins.str] created_by_handle: The handle of the rule creator.
        :param pulumi.Input[builtins.str] created_by_name: The name of the rule creator.
        :param pulumi.Input[builtins.bool] enabled: Indicates whether the rule is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.int] modified_at: Indicates when this rule was last modified.
        :param pulumi.Input[builtins.str] modified_by_handle: The handle of the rule last modifier.
        :param pulumi.Input[builtins.str] modified_by_name: The name of the rule last modifier.
        :param pulumi.Input[builtins.str] name: The name of the rule (must be unique).
        :param pulumi.Input['SecurityNotificationRuleSelectorsArgs'] selectors: Defines selectors to filter security issues that generate notifications.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] targets: The list of handle targets for the notifications. A target must be prefixed with an @. It can be an email address (@bob@email.com), or any installed integration. For example, a Slack recipient (@slack-ops), or a Teams recipient (@teams-ops).
        :param pulumi.Input[builtins.int] time_aggregation: Specifies the time period, in seconds, used to aggregate the notification. Defaults to `0`.
        :param pulumi.Input[builtins.int] version: The rule version (incremented at each update).
        """
    ...
    def created_by_handle(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def created_by_handle(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def modified_at(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @modified_at.setter
    def modified_at(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "modified_at", value)

    @property
    @pulumi.getter(name="modifiedByHandle")
    def modified_by_handle(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def modified_by_handle(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "modified_by_handle", value)

    @property
    @pulumi.getter(name="modifiedByName")
    def modified_by_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def modified_by_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SecurityNotificationRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            targets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            time_aggregation: Optional[pulumi.Input[builtins.int]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'SecurityNotificationRule':
        """
    ...
    @property
    @pulumi.getter(name="createdByHandle")
    def created_by_handle(self) -> pulumi.Output[builtins.str]:
        """
        The handle of the rule creator.
        """
        return pulumi.get(self, "created_by_handle")
    ...
    @property
    @pulumi.getter(name="createdByName")
    def created_by_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the rule creator.
        """
        return pulumi.get(self, "created_by_name")
    ...
    @property
    @pulumi.getter(name="modifiedAt")
    def modified_at(self) -> pulumi.Output[builtins.int]:
        """
        Indicates when this rule was last modified.
        """
        return pulumi.get(self, "modified_at")
    ...
    @property
    @pulumi.getter(name="modifiedByHandle")
    def modified_by_handle(self) -> pulumi.Output[builtins.str]:
        """
        The handle of the rule last modifier.
        """
        return pulumi.get(self, "modified_by_handle")
    ...
    @property
    @pulumi.getter(name="modifiedByName")
    def modified_by_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the rule last modifier.
        """
        return pulumi.get(self, "modified_by_name")
    ...
    @property
    @pulumi.getter(name="timeAggregation")
    def time_aggregation(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the time period, in seconds, used to aggregate the notification. Defaults to `0`.
        """
        return pulumi.get(self, "time_aggregation")
