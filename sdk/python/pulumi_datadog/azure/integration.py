...
class IntegrationArgs:
    def __init__(__self__, *,
                 ...
                 app_service_plan_filters: Optional[pulumi.Input[builtins.str]] = None,
                 automute: Optional[pulumi.Input[builtins.bool]] = None,
                 container_app_filters: Optional[pulumi.Input[builtins.str]] = None,
                 cspm_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 custom_metrics_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 host_filters: Optional[pulumi.Input[builtins.str]] = None,
                 metrics_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 metrics_enabled_default: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 usage_metrics_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Integration resource.
        :param pulumi.Input[builtins.str] client_id: Your Azure web application ID.
        :param pulumi.Input[builtins.str] client_secret: (Required for Initial Creation) Your Azure web application secret key.
        :param pulumi.Input[builtins.str] tenant_name: Your Azure Active Directory ID.
        :param pulumi.Input[builtins.str] app_service_plan_filters: This comma-separated list of tags (in the form `key:value,key:value`) defines a filter that Datadog uses when collecting metrics from Azure App Service Plans. Only App Service Plans that match one of the defined tags are imported into Datadog. The rest, including the apps and functions running on them, are ignored. This also filters the metrics for any App or Function running on the App Service Plan(s). Defaults to `""`.
        :param pulumi.Input[builtins.bool] automute: Silence monitors for expected Azure VM shutdowns. Defaults to `false`.
        :param pulumi.Input[builtins.str] container_app_filters: This comma-separated list of tags (in the form `key:value,key:value`) defines a filter that Datadog uses when collecting metrics from Azure Container Apps. Only Container Apps that match one of the defined tags are imported into Datadog. Defaults to `""`.
        :param pulumi.Input[builtins.bool] cspm_enabled: When enabled, Datadog’s Cloud Security Management product scans resource configurations monitored by this app registration.
               Note: This requires `resource_collection_enabled` to be set to true. Defaults to `false`.
        :param pulumi.Input[builtins.bool] custom_metrics_enabled: Enable custom metrics for your organization. Defaults to `false`.
        :param pulumi.Input[builtins.str] host_filters: String of host tag(s) (in the form `key:value,key:value`) defines a filter that Datadog will use when collecting metrics from Azure. Limit the Azure instances that are pulled into Datadog by using tags. Only hosts that match one of the defined tags are imported into Datadog. e.x. `env:production,deploymentgroup:red` Defaults to `""`.
        :param pulumi.Input[builtins.bool] metrics_enabled: Enable Azure metrics for your organization. Defaults to `true`.
        :param pulumi.Input[builtins.bool] metrics_enabled_default: Enable Azure metrics for your organization for resource providers where no resource provider config is specified. Defaults to `true`.
        :param pulumi.Input[builtins.bool] resource_collection_enabled: When enabled, Datadog collects metadata and configuration info from cloud resources (such as compute instances, databases, and load balancers) monitored by this app registration.
        ...
        :param pulumi.Input[builtins.bool] usage_metrics_enabled: Enable azure.usage metrics for your organization. Defaults to `true`.
        """
    ...
    def app_service_plan_filters(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def app_service_plan_filters(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def container_app_filters(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def container_app_filters(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "container_app_filters", value)

    @property
    @pulumi.getter(name="cspmEnabled")
    def cspm_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @cspm_enabled.setter
    def cspm_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "cspm_enabled", value)

    @property
    @pulumi.getter(name="customMetricsEnabled")
    def custom_metrics_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def custom_metrics_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "custom_metrics_enabled", value)

    @property
    @pulumi.getter(name="hostFilters")
    def host_filters(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @host_filters.setter
    def host_filters(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def metrics_enabled_default(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def metrics_enabled_default(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def usage_metrics_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def usage_metrics_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Integration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_provider_configs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['IntegrationResourceProviderConfigArgs', 'IntegrationResourceProviderConfigArgsDict']]]]] = None,
            tenant_name: Optional[pulumi.Input[builtins.str]] = None,
            usage_metrics_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'Integration':
        """
    ...
    @property
    @pulumi.getter(name="appServicePlanFilters")
    def app_service_plan_filters(self) -> pulumi.Output[builtins.str]:
        """
        This comma-separated list of tags (in the form `key:value,key:value`) defines a filter that Datadog uses when collecting metrics from Azure App Service Plans. Only App Service Plans that match one of the defined tags are imported into Datadog. The rest, including the apps and functions running on them, are ignored. This also filters the metrics for any App or Function running on the App Service Plan(s). Defaults to `""`.
        """
        return pulumi.get(self, "app_service_plan_filters")
    ...
    @property
    @pulumi.getter(name="containerAppFilters")
    def container_app_filters(self) -> pulumi.Output[builtins.str]:
        """
        This comma-separated list of tags (in the form `key:value,key:value`) defines a filter that Datadog uses when collecting metrics from Azure Container Apps. Only Container Apps that match one of the defined tags are imported into Datadog. Defaults to `""`.
        """
        return pulumi.get(self, "container_app_filters")
    ...
    @property
    @pulumi.getter(name="cspmEnabled")
    def cspm_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        When enabled, Datadog’s Cloud Security Management product scans resource configurations monitored by this app registration.
        Note: This requires `resource_collection_enabled` to be set to true. Defaults to `false`.
        """
    ...
    @property
    @pulumi.getter(name="customMetricsEnabled")
    def custom_metrics_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Enable custom metrics for your organization. Defaults to `false`.
        """
        return pulumi.get(self, "custom_metrics_enabled")
    ...
    @property
    @pulumi.getter(name="hostFilters")
    def host_filters(self) -> pulumi.Output[builtins.str]:
        """
        String of host tag(s) (in the form `key:value,key:value`) defines a filter that Datadog will use when collecting metrics from Azure. Limit the Azure instances that are pulled into Datadog by using tags. Only hosts that match one of the defined tags are imported into Datadog. e.x. `env:production,deploymentgroup:red` Defaults to `""`.
        """
        return pulumi.get(self, "host_filters")
    ...
    @property
    @pulumi.getter(name="metricsEnabled")
    def metrics_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Enable Azure metrics for your organization. Defaults to `true`.
        """
        return pulumi.get(self, "metrics_enabled")
    ...
    @property
    @pulumi.getter(name="metricsEnabledDefault")
    def metrics_enabled_default(self) -> pulumi.Output[builtins.bool]:
        """
        Enable Azure metrics for your organization for resource providers where no resource provider config is specified. Defaults to `true`.
        """
        return pulumi.get(self, "metrics_enabled_default")
    ...
    @property
    @pulumi.getter(name="usageMetricsEnabled")
    def usage_metrics_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Enable azure.usage metrics for your organization. Defaults to `true`.
        """
        return pulumi.get(self, "usage_metrics_enabled")
