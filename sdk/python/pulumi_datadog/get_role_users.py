...
def get_role_users(exact_match: Optional[builtins.bool] = None,
    ...
    :param builtins.bool exact_match: When true, `filter_keyword` string is exact matched against the user's `name`.
    :param builtins.str filter: Search query, can be user name.
    :param builtins.str role_id: The role's identifier.
    """
    __args__ = dict()
...
def get_role_users_output(exact_match: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
