...
class IntegrationArgs:
    def __init__(__self__, *,
                 ...
                 cspm_resource_collection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] client_email: Your email found in your JSON service account key.
        :param pulumi.Input[builtins.str] client_id: Your ID found in your JSON service account key.
        :param pulumi.Input[builtins.str] private_key: Your private key name found in your JSON service account key.
        :param pulumi.Input[builtins.str] private_key_id: Your private key ID found in your JSON service account key.
        :param pulumi.Input[builtins.str] project_id: Your Google Cloud project ID found in your JSON service account key.
        :param pulumi.Input[builtins.bool] automute: Silence monitors for expected GCE instance shutdowns. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.bool] cspm_resource_collection_enabled: Whether Datadog collects cloud security posture management resources from your GCP project. If enabled, requires `resource_collection_enabled` to also be enabled. Defaults to `false`.
        :param pulumi.Input[builtins.str] host_filters: Limit the GCE instances that are pulled into Datadog by using tags. Only hosts that match one of the defined tags are imported into Datadog. Defaults to `""`.
    ...
    def cspm_resource_collection_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def cspm_resource_collection_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Integration(pulumi.CustomResource):
    ...
    pulumi_type = "datadog:gcp/integration:Integration"
    ...
    def get(resource_name: str,
            ...
            private_key_id: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            resource_collection_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'Integration':
        """
    ...
    @property
    @pulumi.getter(name="cspmResourceCollectionEnabled")
    def cspm_resource_collection_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether Datadog collects cloud security posture management resources from your GCP project. If enabled, requires `resource_collection_enabled` to also be enabled. Defaults to `false`.
        """
        return pulumi.get(self, "cspm_resource_collection_enabled")
