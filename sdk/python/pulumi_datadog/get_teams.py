...
class GetTeamsResult:
    ...
    def filter_me(self) -> Optional[builtins.bool]:
        """
...
def get_teams(filter_keyword: Optional[builtins.str] = None,
              filter_me: Optional[builtins.bool] = None,
    ...
    :param builtins.str filter_keyword: Search query. Can be team name, team handle, or email of team member.
    :param builtins.bool filter_me: When true, only returns teams the current user belongs to.
...
def get_teams_output(filter_keyword: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     filter_me: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
