...
class UserArgs:
    def __init__(__self__, *,
                 ...
                 send_user_invitation: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a User resource.
        :param pulumi.Input[builtins.str] email: Email address for user.
        :param pulumi.Input[builtins.bool] disabled: Whether the user is disabled. Defaults to `false`.
        :param pulumi.Input[builtins.str] name: User's name. Should be set only for password authentication, as it is overridden by Google or SAML authentication.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: A list of role IDs to assign to the user.
        :param pulumi.Input[builtins.bool] send_user_invitation: Whether an invitation email should be sent when the user is created. Defaults to `true`.
        """
    ...
    def send_user_invitation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def send_user_invitation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _UserState:
    def __init__(__self__, *,
                 ...
                 roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 send_user_invitation: Optional[pulumi.Input[builtins.bool]] = None,
                 user_invitation_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: A list of role IDs to assign to the user.
        :param pulumi.Input[builtins.bool] send_user_invitation: Whether an invitation email should be sent when the user is created. Defaults to `true`.
        :param pulumi.Input[builtins.str] user_invitation_id: The ID of the user invitation that was sent when creating the user.
        :param pulumi.Input[builtins.bool] verified: Returns `true` if the user is verified.
        """
        if disabled is not None:
            pulumi.set(__self__, "disabled", disabled)
    ...
    def user_invitation_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def user_invitation_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class User(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="sendUserInvitation")
    def send_user_invitation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether an invitation email should be sent when the user is created. Defaults to `true`.
        """
        return pulumi.get(self, "send_user_invitation")
    ...
    @property
    @pulumi.getter(name="userInvitationId")
    def user_invitation_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the user invitation that was sent when creating the user.
        """
        return pulumi.get(self, "user_invitation_id")
