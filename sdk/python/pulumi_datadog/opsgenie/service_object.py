...
class ServiceObjectArgs:
    ...
    def opsgenie_api_key(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "opsgenie_api_key")

    @opsgenie_api_key.setter
    def opsgenie_api_key(self, value: pulumi.Input[_builtins.str]):
...
class ServiceObject(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="customUrl")
    def custom_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The custom url for a custom region.
        """
        return pulumi.get(self, "custom_url")
    ...
    @_builtins.property
    @pulumi.getter(name="opsgenieApiKey")
    def opsgenie_api_key(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "opsgenie_api_key")
