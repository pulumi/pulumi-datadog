...
class TeamMembershipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] team_id: ID of the team the team membership is associated with.
        :param pulumi.Input[builtins.str] user_id: The ID of the user.
        :param pulumi.Input[builtins.str] role: The user's role within the team. Valid values are `admin`.
        """
