...
class GetPermissionsResult:
    ...
    def include_restricted(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def permissions(self) -> Mapping[str, builtins.str]:
        """
...
def get_permissions(include_restricted: Optional[builtins.bool] = None,
    ...
    :param builtins.bool include_restricted: Whether to include restricted permissions. Restricted permissions are granted by default to all users of a Datadog org, and cannot be manually granted or revoked. Defaults to `false`.
    """
    __args__ = dict()
...
def get_permissions_output(include_restricted: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
