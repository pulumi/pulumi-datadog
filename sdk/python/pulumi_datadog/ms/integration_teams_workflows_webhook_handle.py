...
__all__ = ['IntegrationTeamsWorkflowsWebhookHandleArgs', 'IntegrationTeamsWorkflowsWebhookHandle']

@pulumi.input_type
class IntegrationTeamsWorkflowsWebhookHandleArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 url: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a IntegrationTeamsWorkflowsWebhookHandle resource.
        :param pulumi.Input[builtins.str] name: Your Microsoft Workflows webhook handle name.
        :param pulumi.Input[builtins.str] url: Your Microsoft Workflows webhook URL.
        """
...
class IntegrationTeamsWorkflowsWebhookHandle(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IntegrationTeamsWorkflowsWebhookHandleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IntegrationTeamsWorkflowsWebhookHandleArgs.__new__(IntegrationTeamsWorkflowsWebhookHandleArgs)
        ...
        super(IntegrationTeamsWorkflowsWebhookHandle, __self__).__init__(
            'datadog:ms/integrationTeamsWorkflowsWebhookHandle:IntegrationTeamsWorkflowsWebhookHandle',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'IntegrationTeamsWorkflowsWebhookHandle':
        """
        ...
        __props__ = _IntegrationTeamsWorkflowsWebhookHandleState.__new__(_IntegrationTeamsWorkflowsWebhookHandleState)

        __props__.__dict__["name"] = name
        __props__.__dict__["url"] = url
        return IntegrationTeamsWorkflowsWebhookHandle(resource_name, opts=opts, __props__=__props__)
