...
class GetHostsResult:
    ...
    def include_muted_hosts_data(self) -> Optional[builtins.bool]:
        """
    ...
    def total_matching(self) -> builtins.int:
        """
    ...
    def total_returned(self) -> builtins.int:
        """
...
def get_hosts(filter: Optional[builtins.str] = None,
              from_: Optional[builtins.int] = None,
              include_muted_hosts_data: Optional[builtins.bool] = None,
    ...
    :param builtins.str filter: String to filter search results.
    :param builtins.int from_: Number of seconds since UNIX epoch from which you want to search your hosts.
    :param builtins.bool include_muted_hosts_data: Include information on the muted status of hosts and when the mute expires.
    :param builtins.str sort_dir: Direction of sort.
    :param builtins.str sort_field: Sort hosts by this field.
    """
    __args__ = dict()
...
def get_hosts_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     from_: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                     include_muted_hosts_data: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
