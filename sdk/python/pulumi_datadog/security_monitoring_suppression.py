...
class SecurityMonitoringSuppressionArgs:
    def __init__(__self__, *,
                 ...
                 rule_query: pulumi.Input[builtins.str],
                 data_exclusion_query: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 expiration_date: Optional[pulumi.Input[builtins.str]] = None,
                 start_date: Optional[pulumi.Input[builtins.str]] = None,
                 suppression_query: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SecurityMonitoringSuppression resource.
        :param pulumi.Input[builtins.bool] enabled: Whether the suppression rule is enabled.
        :param pulumi.Input[builtins.str] name: The name of the suppression rule.
        :param pulumi.Input[builtins.str] rule_query: The rule query of the suppression rule, with the same syntax as the search bar for detection rules.
        :param pulumi.Input[builtins.str] data_exclusion_query: An exclusion query on the input data of the security rules, which could be logs, Agent events, or other types of data based on the security rule. Events matching this query are ignored by any detection rules referenced in the suppression rule.
        :param pulumi.Input[builtins.str] description: A description for the suppression rule.
        :param pulumi.Input[builtins.str] expiration_date: A RFC3339 timestamp giving an expiration date for the suppression rule. After this date, it won't suppress signals anymore.
        :param pulumi.Input[builtins.str] start_date: A RFC3339 timestamp giving a start date for the suppression rule. Before this date, it doesn't suppress signals.
        :param pulumi.Input[builtins.str] suppression_query: The suppression query of the suppression rule. If a signal matches this query, it is suppressed and is not triggered. It uses the same syntax as the queries to search signals in the Signals Explorer.
        """
    ...
    def rule_query(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @rule_query.setter
    def rule_query(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "rule_query", value)

    @property
    @pulumi.getter(name="dataExclusionQuery")
    def data_exclusion_query(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_exclusion_query(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def suppression_query(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def suppression_query(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SecurityMonitoringSuppressionState:
    def __init__(__self__, *,
                 ...
                 rule_query: Optional[pulumi.Input[builtins.str]] = None,
                 start_date: Optional[pulumi.Input[builtins.str]] = None,
                 suppression_query: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="ruleQuery")
    def rule_query(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The rule query of the suppression rule, with the same syntax as the search bar for detection rules.
        """
        return pulumi.get(self, "rule_query")
    ...
    @rule_query.setter
    def rule_query(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rule_query", value)
...
class SecurityMonitoringSuppression(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rule_query: Optional[pulumi.Input[builtins.str]] = None,
            start_date: Optional[pulumi.Input[builtins.str]] = None,
            suppression_query: Optional[pulumi.Input[builtins.str]] = None) -> 'SecurityMonitoringSuppression':
        """
    ...
    @property
    @pulumi.getter(name="dataExclusionQuery")
    def data_exclusion_query(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An exclusion query on the input data of the security rules, which could be logs, Agent events, or other types of data based on the security rule. Events matching this query are ignored by any detection rules referenced in the suppression rule.
        """
        return pulumi.get(self, "data_exclusion_query")
    ...
    @property
    @pulumi.getter(name="ruleQuery")
    def rule_query(self) -> pulumi.Output[builtins.str]:
        """
        The rule query of the suppression rule, with the same syntax as the search bar for detection rules.
        """
        return pulumi.get(self, "rule_query")
    ...
    @property
    @pulumi.getter(name="suppressionQuery")
    def suppression_query(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The suppression query of the suppression rule. If a signal matches this query, it is suppressed and is not triggered. It uses the same syntax as the queries to search signals in the Signals Explorer.
        """
        return pulumi.get(self, "suppression_query")
