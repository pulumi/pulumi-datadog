...
class GetSecurityMonitoringRulesResult:
    ...
    def default_only_filter(self) -> Optional[builtins.bool]:
        """
    ...
    def user_only_filter(self) -> Optional[builtins.bool]:
        """
...
def get_security_monitoring_rules(default_only_filter: Optional[builtins.bool] = None,
                                  name_filter: Optional[builtins.str] = None,
                                  tags_filters: Optional[Sequence[builtins.str]] = None,
                                  user_only_filter: Optional[builtins.bool] = None,
    ...
    :param builtins.bool default_only_filter: Limit the search to default rules
    :param builtins.str name_filter: A rule name to limit the search
    :param Sequence[builtins.str] tags_filters: A list of tags to limit the search
    :param builtins.bool user_only_filter: Limit the search to user rules
    """
    __args__ = dict()
...
def get_security_monitoring_rules_output(default_only_filter: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                         ...
                                         user_only_filter: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
