...
class SloCorrectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] category: Category the SLO correction belongs to. Valid values are `Scheduled Maintenance`, `Outside Business Hours`, `Deployment`, `Other`.
        :param pulumi.Input[builtins.str] slo_id: ID of the SLO that this correction will be applied to.
        :param pulumi.Input[builtins.int] start: Starting time of the correction in epoch seconds.
        :param pulumi.Input[builtins.str] description: Description of the correction being made.
        :param pulumi.Input[builtins.int] duration: Length of time in seconds for a specified `rrule` recurring SLO correction (required if specifying `rrule`)
        :param pulumi.Input[builtins.int] end: Ending time of the correction in epoch seconds. Required for one time corrections, but optional if `rrule` is specified
        :param pulumi.Input[builtins.str] rrule: Recurrence rules as defined in the iCalendar RFC 5545. Supported rules for SLO corrections are `FREQ`, `INTERVAL`, `COUNT` and `UNTIL`.
        :param pulumi.Input[builtins.str] timezone: The timezone to display in the UI for the correction times (defaults to "UTC")
        """
...
class SloCorrection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            slo_id: Optional[pulumi.Input[builtins.str]] = None,
            start: Optional[pulumi.Input[builtins.int]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None) -> 'SloCorrection':
        """
    ...
    @property
    @pulumi.getter
    def rrule(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Recurrence rules as defined in the iCalendar RFC 5545. Supported rules for SLO corrections are `FREQ`, `INTERVAL`, `COUNT` and `UNTIL`.
        """
        return pulumi.get(self, "rrule")
    ...
    @property
    @pulumi.getter
    def start(self) -> pulumi.Output[builtins.int]:
        """
        Starting time of the correction in epoch seconds.
        """
        return pulumi.get(self, "start")
