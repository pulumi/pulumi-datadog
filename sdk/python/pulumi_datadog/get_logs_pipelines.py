...
class GetLogsPipelinesResult:
    ...
    def is_read_only(self) -> Optional[builtins.str]:
        """
...
def get_logs_pipelines(is_read_only: Optional[builtins.str] = None,
    ...
    :param builtins.str is_read_only: Filter parameter for retrieved pipelines
    """
    __args__ = dict()
...
def get_logs_pipelines_output(is_read_only: Optional[pulumi.Input[Optional[builtins.str]]] = None,
