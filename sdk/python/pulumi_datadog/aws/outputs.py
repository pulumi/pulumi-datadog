...
class IntegrationAccountAuthConfigAwsAuthConfigRole(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str external_id: AWS IAM external ID for associated role. If omitted, one is generated.
        :param builtins.str role_name: AWS IAM role name.
        """
...
class IntegrationAccountAwsRegions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 include_onlies: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool include_all: Include all regions. Defaults to `true`.
        :param Sequence[builtins.str] include_onlies: Include only these regions.
        """
    ...
    def include_onlies(self) -> Optional[Sequence[builtins.str]]:
        """
...
class IntegrationAccountLogsConfigLambdaForwarder(dict):
    def __init__(__self__, *,
                 lambdas: Optional[Sequence[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def lambdas(self) -> Optional[Sequence[builtins.str]]:
        """
...
class IntegrationAccountMetricsConfig(dict):
    ...
    def __init__(__self__, *,
                 automute_enabled: Optional[builtins.bool] = None,
                 collect_cloudwatch_alarms: Optional[builtins.bool] = None,
                 collect_custom_metrics: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.bool automute_enabled: Enable EC2 automute for AWS metrics Defaults to `true`.
        :param builtins.bool collect_cloudwatch_alarms: Enable CloudWatch alarms collection Defaults to `false`.
        :param builtins.bool collect_custom_metrics: Enable custom metrics collection Defaults to `false`.
        :param builtins.bool enabled: Enable AWS metrics collection Defaults to `true`.
    ...
    def automute_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def collect_cloudwatch_alarms(self) -> Optional[builtins.bool]:
        """
    ...
    def collect_custom_metrics(self) -> Optional[builtins.bool]:
        """
...
class IntegrationAccountMetricsConfigNamespaceFilters(dict):
    ...
    def __init__(__self__, *,
                 exclude_onlies: Optional[Sequence[builtins.str]] = None,
                 include_onlies: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] exclude_onlies: Exclude only these namespaces from metrics collection. Use `aws_get_integration_available_namespaces` data source to get allowed values. Defaults to `["AWS/SQS", "AWS/ElasticMapReduce"]`. `AWS/SQS` and `AWS/ElasticMapReduce` are excluded by default to reduce your AWS CloudWatch costs from `GetMetricData` API calls.
        :param Sequence[builtins.str] include_onlies: Include only these namespaces for metrics collection. Use `aws_get_integration_available_namespaces` data source to get allowed values.
        """
    ...
    def exclude_onlies(self) -> Optional[Sequence[builtins.str]]:
        """
...
class IntegrationAccountMetricsConfigTagFilter(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str namespace: The AWS service for which the tag filters defined in `tags` will be applied.
        :param Sequence[builtins.str] tags: The AWS resource tags to filter on for the service specified by `namespace`. Defaults to `[]`.
        """
...
class IntegrationAccountResourcesConfig(dict):
    ...
    def __init__(__self__, *,
                 cloud_security_posture_management_collection: Optional[builtins.bool] = None,
                 extended_collection: Optional[builtins.bool] = None):
        """
        :param builtins.bool cloud_security_posture_management_collection: Enable Cloud Security Management to scan AWS resources for vulnerabilities, misconfigurations, identity risks, and compliance violations. Requires `extended_collection` to be set to `true`. Defaults to `false`.
        :param builtins.bool extended_collection: Whether Datadog collects additional attributes and configuration information about the resources in your AWS account. Required for `cloud_security_posture_management_collection`. Defaults to `true`.
        """
    ...
    def cloud_security_posture_management_collection(self) -> Optional[builtins.bool]:
        """
    ...
    def extended_collection(self) -> Optional[builtins.bool]:
        """
...
class IntegrationAccountTracesConfigXrayServices(dict):
    ...
    def __init__(__self__, *,
                 ...
                 include_onlies: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool include_all: Include all services.
        :param Sequence[builtins.str] include_onlies: Include only these services. Defaults to `[]`.
        """
        if include_all is not None:
            pulumi.set(__self__, "include_all", include_all)
        if include_onlies is not None:
...
class GetIntegrationLogsServicesAwsLogsServiceResult(dict):
    def __init__(__self__, *,
                 ...
                 label: builtins.str):
        """
        :param builtins.str id: The id of the AWS log service.
        :param builtins.str label: The name of the AWS log service.
        """
