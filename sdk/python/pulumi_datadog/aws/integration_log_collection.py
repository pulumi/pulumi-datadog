...
class IntegrationLogCollectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] services: A list of services to collect logs from. See the  for more details on which services are supported.
        """
    ...
    def services(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
        A list of services to collect logs from. See the  for more details on which services are supported.
        """
