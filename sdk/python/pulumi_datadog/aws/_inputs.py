...
class IntegrationAccountAuthConfigAwsAuthConfigRoleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] external_id: AWS IAM external ID for associated role. If omitted, one is generated.
        :param pulumi.Input[builtins.str] role_name: AWS IAM role name.
        """
...
if not MYPY:
    class IntegrationAccountAwsRegionsArgsDict(TypedDict):
        include_all: NotRequired[pulumi.Input[builtins.bool]]
        """
        Include all regions. Defaults to `true`.
        """
        include_onlies: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class IntegrationAccountAwsRegionsArgs:
    def __init__(__self__, *,
                 include_all: Optional[pulumi.Input[builtins.bool]] = None,
                 include_onlies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] include_all: Include all regions. Defaults to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_onlies: Include only these regions.
        """
    ...
    def include_all(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Include all regions. Defaults to `true`.
        """
    ...
    @include_all.setter
    def include_all(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "include_all", value)

    @property
    @pulumi.getter(name="includeOnlies")
    def include_onlies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Include only these regions.
        """
    ...
    def include_onlies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class IntegrationAccountLogsConfigLambdaForwarderArgsDict(TypedDict):
        lambdas: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class IntegrationAccountLogsConfigLambdaForwarderArgs:
    def __init__(__self__, *,
                 lambdas: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter
    def lambdas(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of Datadog Lambda Log Forwarder ARNs in your AWS account. Defaults to `[]`.
        """
    ...
    @lambdas.setter
    def lambdas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class IntegrationAccountMetricsConfigArgsDict(TypedDict):
        automute_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enable EC2 automute for AWS metrics Defaults to `true`.
        """
        collect_cloudwatch_alarms: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enable CloudWatch alarms collection Defaults to `false`.
        """
        collect_custom_metrics: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class IntegrationAccountMetricsConfigArgs:
    def __init__(__self__, *,
                 automute_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 collect_cloudwatch_alarms: Optional[pulumi.Input[builtins.bool]] = None,
                 collect_custom_metrics: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] automute_enabled: Enable EC2 automute for AWS metrics Defaults to `true`.
        :param pulumi.Input[builtins.bool] collect_cloudwatch_alarms: Enable CloudWatch alarms collection Defaults to `false`.
        :param pulumi.Input[builtins.bool] collect_custom_metrics: Enable custom metrics collection Defaults to `false`.
        :param pulumi.Input[builtins.bool] enabled: Enable AWS metrics collection Defaults to `true`.
    ...
    def automute_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable EC2 automute for AWS metrics Defaults to `true`.
        """
    ...
    def automute_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "automute_enabled", value)

    @property
    @pulumi.getter(name="collectCloudwatchAlarms")
    def collect_cloudwatch_alarms(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable CloudWatch alarms collection Defaults to `false`.
        """
    ...
    def collect_cloudwatch_alarms(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "collect_cloudwatch_alarms", value)

    @property
    @pulumi.getter(name="collectCustomMetrics")
    def collect_custom_metrics(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable custom metrics collection Defaults to `false`.
        """
    ...
    def collect_custom_metrics(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class IntegrationAccountMetricsConfigNamespaceFiltersArgsDict(TypedDict):
        exclude_onlies: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class IntegrationAccountMetricsConfigNamespaceFiltersArgs:
    def __init__(__self__, *,
                 exclude_onlies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 include_onlies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_onlies: Exclude only these namespaces from metrics collection. Use `aws_get_integration_available_namespaces` data source to get allowed values. Defaults to `["AWS/SQS", "AWS/ElasticMapReduce"]`. `AWS/SQS` and `AWS/ElasticMapReduce` are excluded by default to reduce your AWS CloudWatch costs from `GetMetricData` API calls.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_onlies: Include only these namespaces for metrics collection. Use `aws_get_integration_available_namespaces` data source to get allowed values.
        """
    ...
    def exclude_onlies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Exclude only these namespaces from metrics collection. Use `aws_get_integration_available_namespaces` data source to get allowed values. Defaults to `["AWS/SQS", "AWS/ElasticMapReduce"]`. `AWS/SQS` and `AWS/ElasticMapReduce` are excluded by default to reduce your AWS CloudWatch costs from `GetMetricData` API calls.
        """
    ...
    def exclude_onlies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class IntegrationAccountMetricsConfigTagFilterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] namespace: The AWS service for which the tag filters defined in `tags` will be applied.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The AWS resource tags to filter on for the service specified by `namespace`. Defaults to `[]`.
        """
...
if not MYPY:
    class IntegrationAccountResourcesConfigArgsDict(TypedDict):
        cloud_security_posture_management_collection: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        extended_collection: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class IntegrationAccountResourcesConfigArgs:
    def __init__(__self__, *,
                 cloud_security_posture_management_collection: Optional[pulumi.Input[builtins.bool]] = None,
                 extended_collection: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] cloud_security_posture_management_collection: Enable Cloud Security Management to scan AWS resources for vulnerabilities, misconfigurations, identity risks, and compliance violations. Requires `extended_collection` to be set to `true`. Defaults to `false`.
        :param pulumi.Input[builtins.bool] extended_collection: Whether Datadog collects additional attributes and configuration information about the resources in your AWS account. Required for `cloud_security_posture_management_collection`. Defaults to `true`.
        """
    ...
    def cloud_security_posture_management_collection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable Cloud Security Management to scan AWS resources for vulnerabilities, misconfigurations, identity risks, and compliance violations. Requires `extended_collection` to be set to `true`. Defaults to `false`.
        """
    ...
    def cloud_security_posture_management_collection(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "cloud_security_posture_management_collection", value)

    @property
    @pulumi.getter(name="extendedCollection")
    def extended_collection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether Datadog collects additional attributes and configuration information about the resources in your AWS account. Required for `cloud_security_posture_management_collection`. Defaults to `true`.
        """
    ...
    def extended_collection(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class IntegrationAccountTracesConfigXrayServicesArgs:
    def __init__(__self__, *,
                 ...
                 include_onlies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] include_all: Include all services.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_onlies: Include only these services. Defaults to `[]`.
        """
        if include_all is not None:
            pulumi.set(__self__, "include_all", include_all)
        if include_onlies is not None:
