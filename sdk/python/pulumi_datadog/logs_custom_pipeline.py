...
class LogsCustomPipeline(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Import is supported using the following syntax# For the previously created custom pipelines, you can include them in Terraform with the import operation. Currently, Terraform requires you to explicitly create resources that match the existing pipelines to import them.
