...
def get_application_key(exact_match: Optional[builtins.bool] = None,
    ...
    :param builtins.str id: Id for Application Key.
    :param builtins.str name: Name for Application Key.
    """
    __args__ = dict()
...
def get_application_key_output(exact_match: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
