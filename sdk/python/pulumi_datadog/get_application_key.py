...
def get_application_key(exact_match: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool exact_match: Whether to use exact match when searching by name.
    :param _builtins.str id: Id for Application Key.
    :param _builtins.str name: Name for Application Key.
    """
    __args__ = dict()
...
def get_application_key_output(exact_match: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
