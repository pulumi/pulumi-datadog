...
class CloudWorkloadSecurityAgentRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the Agent rule. Defaults to `""`.
        :param pulumi.Input[builtins.bool] enabled: Whether the Agent rule is enabled. Defaults to `true`.
        """
...
class CloudWorkloadSecurityAgentRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            expression: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'CloudWorkloadSecurityAgentRule':
        """
