...
class DashboardArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] reflow_type: The reflow type of a multi-size layout dashboard. Set this only when layout type is ‘ordered’. If set to ‘fixed’, the dashboard expect all widgets to have a layout, and if it’s set to ‘auto’, widgets should not have layouts.
