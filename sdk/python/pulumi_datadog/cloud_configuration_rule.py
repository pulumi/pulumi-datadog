...
class CloudConfigurationRuleArgs:
    def __init__(__self__, *,
                 ...
                 related_resource_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a CloudConfigurationRule resource.
        :param pulumi.Input[builtins.bool] enabled: Whether the cloud configuration rule is enabled.
        :param pulumi.Input[builtins.str] message: The message associated to the rule that will be shown in findings and signals.
        :param pulumi.Input[builtins.str] name: The name of the cloud configuration rule.
        :param pulumi.Input[builtins.str] policy: Policy written in Rego format.
        :param pulumi.Input[builtins.str] resource_type: Main resource type to be checked by the rule.
        :param pulumi.Input[builtins.str] severity: Severity of the rule and associated signals. Valid values are `info`, `low`, `medium`, `high`, `critical`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] group_bies: Defaults to empty list. This function will be deprecated soon. Use the notification rules function instead. Fields to group by when generating signals, e.g. @resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notifications: This function will be deprecated soon. Use the notification rules function instead. Notification targets for signals. Defaults to empty list.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] related_resource_types: Related resource types to be checked by the rule. Defaults to empty list.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Tags of the rule, propagated to findings and signals. Defaults to empty list.
        """
    ...
    def related_resource_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def related_resource_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class CloudConfigurationRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_type: Optional[pulumi.Input[builtins.str]] = None,
            severity: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'CloudConfigurationRule':
        """
    ...
    @property
    @pulumi.getter(name="relatedResourceTypes")
    def related_resource_types(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Related resource types to be checked by the rule. Defaults to empty list.
        """
        return pulumi.get(self, "related_resource_types")
