...
class ServiceLevelObjectiveArgs:
    def __init__(__self__, *,
                 ...
                 monitor_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 ...
                 target_threshold: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] type: The type of the service level objective. The mapping from these types to the types found in the Datadog Web UI can be found in the Datadog API [documentation page](https://docs.datadoghq.com/api/v1/service-level-objectives/#create-a-slo-object). Valid values are `metric`, `monitor`, `time_slice`.
        :param pulumi.Input[builtins.str] description: A description of this service level objective.
        :param pulumi.Input[builtins.bool] force_delete: A boolean indicating whether this monitor can be deleted even if it's referenced by other resources (for example, dashboards).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] groups: A static set of groups to filter monitor-based SLOs
        ...
        :param pulumi.Input[builtins.float] warning_threshold: The objective's warning value in `(0,100)`. This must be greater than the target value and match the corresponding thresholds of the primary time frame.
        """
    ...
    def monitor_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
    ...
    @monitor_ids.setter
    def monitor_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
    ...
    def target_threshold(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def target_threshold(self, value: Optional[pulumi.Input[builtins.float]]):
...
class ServiceLevelObjective(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            validate: Optional[pulumi.Input[builtins.bool]] = None,
            warning_threshold: Optional[pulumi.Input[builtins.float]] = None) -> 'ServiceLevelObjective':
        """
    ...
    @property
    @pulumi.getter(name="monitorIds")
    def monitor_ids(self) -> pulumi.Output[Optional[Sequence[builtins.int]]]:
        """
        A static set of monitor IDs to use as part of the SLO
        """
        return pulumi.get(self, "monitor_ids")
    ...
    @property
    @pulumi.getter(name="targetThreshold")
    def target_threshold(self) -> pulumi.Output[builtins.float]:
        """
        The objective's target in `(0,100)`. This must match the corresponding thresholds of the primary time frame.
        """
        return pulumi.get(self, "target_threshold")
    ...
    @property
    @pulumi.getter(name="warningThreshold")
    def warning_threshold(self) -> pulumi.Output[builtins.float]:
        """
        The objective's warning value in `(0,100)`. This must be greater than the target value and match the corresponding thresholds of the primary time frame.
        """
        return pulumi.get(self, "warning_threshold")
