...
def get_users(filter: Optional[_builtins.str] = None,
    ...
    :param _builtins.str filter_status: Filter on status attribute. Comma-separated list with possible values of Active, Pending, and Disabled.
    """
    __args__ = dict()
