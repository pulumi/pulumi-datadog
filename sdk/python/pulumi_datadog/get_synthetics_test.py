...
def get_synthetics_test(test_id: Optional[builtins.str] = None,
    ...
    :param builtins.str test_id: The synthetic test id or URL to search for
    """
    __args__ = dict()
...
def get_synthetics_test_output(test_id: Optional[pulumi.Input[builtins.str]] = None,
