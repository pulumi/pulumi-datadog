...
class OpenapiApiArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] spec: The textual content of the OpenAPI specification. Use `file()` in order to reference another file in the repository (see exmaple).
        """
...
class OpenapiApi(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            spec: Optional[pulumi.Input[builtins.str]] = None) -> 'OpenapiApi':
        """
