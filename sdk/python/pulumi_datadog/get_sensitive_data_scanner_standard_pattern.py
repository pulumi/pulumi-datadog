...
class GetSensitiveDataScannerStandardPatternResult:
    ...
    def included_keywords(self) -> Sequence[builtins.str]:
        """
...
def get_sensitive_data_scanner_standard_pattern(filter: Optional[builtins.str] = None,
    ...
    :param builtins.str filter: Filter all the Datadog standard patterns by name.
    """
    __args__ = dict()
...
def get_sensitive_data_scanner_standard_pattern_output(filter: Optional[pulumi.Input[builtins.str]] = None,
