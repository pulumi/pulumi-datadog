...
class LogsArchiveArgs:
    def __init__(__self__, *,
                 ...
                 rehydration_max_scan_size_in_gb: Optional[pulumi.Input[builtins.int]] = None,
                 rehydration_tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] name: Your archive name.
        :param pulumi.Input[builtins.str] query: The archive query/filter. Logs matching this query are included in the archive.
        ...
        :param pulumi.Input[builtins.bool] include_tags: To store the tags in the archive, set the value `true`. If it is set to `false`, the tags will be dropped when the logs are sent to the archive. Defaults to `false`.
        :param pulumi.Input[builtins.int] rehydration_max_scan_size_in_gb: To limit the rehydration scan size for the archive, set a value in GB.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rehydration_tags: An array of tags to add to rehydrated logs from an archive.
    ...
    def rehydration_max_scan_size_in_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def rehydration_max_scan_size_in_gb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "rehydration_max_scan_size_in_gb", value)

    @property
    @pulumi.getter(name="rehydrationTags")
    def rehydration_tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def rehydration_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class LogsArchive(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="rehydrationMaxScanSizeInGb")
    def rehydration_max_scan_size_in_gb(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        To limit the rehydration scan size for the archive, set a value in GB.
        """
        return pulumi.get(self, "rehydration_max_scan_size_in_gb")
    ...
    @property
    @pulumi.getter(name="rehydrationTags")
    def rehydration_tags(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of tags to add to rehydrated logs from an archive.
        """
        return pulumi.get(self, "rehydration_tags")
