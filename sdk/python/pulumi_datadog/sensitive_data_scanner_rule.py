...
class SensitiveDataScannerRuleArgs:
    def __init__(__self__, *,
                 ...
                 standard_pattern_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] group_id: Id of the scanning group the rule belongs to.
        :param pulumi.Input[builtins.str] description: Description of the rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_namespaces: Attributes excluded from the scan. If namespaces is provided, it has to be a sub-path of the namespaces array.
        ...
        :param pulumi.Input[builtins.bool] is_enabled: Whether or not the rule is enabled.
        :param pulumi.Input[builtins.str] name: Name of the rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] namespaces: Attributes included in the scan. If namespaces is empty or missing, all attributes except excluded_namespaces are scanned. If both are missing the whole event is scanned.
        :param pulumi.Input[builtins.str] pattern: Not included if there is a relationship to a standard pattern.
        :param pulumi.Input[builtins.int] priority: Priority level of the rule (optional). Used to order sensitive data discovered in the sds summary page. It must be between 1 and 5 (1 being the most important).
        :param pulumi.Input[builtins.str] standard_pattern_id: Id of the standard pattern the rule refers to. If provided, then pattern must not be provided.
    ...
    def standard_pattern_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def standard_pattern_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SensitiveDataScannerRule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="standardPatternId")
    def standard_pattern_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Id of the standard pattern the rule refers to. If provided, then pattern must not be provided.
        """
        return pulumi.get(self, "standard_pattern_id")
