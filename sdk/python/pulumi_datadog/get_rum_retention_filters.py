...
def get_rum_retention_filters(application_id: Optional[str] = None,
    ...
    :param str application_id: RUM application ID.
    """
    __args__ = dict()
...
def get_rum_retention_filters_output(application_id: Optional[pulumi.Input[str]] = None,
