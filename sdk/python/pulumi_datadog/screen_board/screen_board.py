...
class ScreenBoard(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, __name__, __opts__=None, height=None, read_only=None, shared=None, template_variables=None, title=None, widgets=None, width=None):
        ...
        super(ScreenBoard, __self__).__init__(
            'datadog:screenBoard:ScreenBoard',
            __name__,
            __props__,
            __opts__)
