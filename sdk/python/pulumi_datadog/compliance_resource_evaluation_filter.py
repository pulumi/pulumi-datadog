...
class ComplianceResourceEvaluationFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cloud_provider: The cloud provider of the filter's targeted resource. Only `aws`, `gcp`, or `azure` are considered valid cloud
               providers.
        :param pulumi.Input[builtins.str] resource_id: The ID of the of the filter's targeted resource. Different cloud providers target different resource IDs: - `aws`:
               account ID - `gcp`: project ID - `azure`: subscription ID
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: List of tags to filter misconfiguration detections. Each entry should follow the format: "key":"value".
        """
...
class ComplianceResourceEvaluationFilter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cloud_provider: Optional[pulumi.Input[builtins.str]] = None,
            resource_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ComplianceResourceEvaluationFilter':
        """
