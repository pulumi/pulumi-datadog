...
class OnCallTeamRoutingRules(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['OnCallTeamRoutingRulesRuleArgs', 'OnCallTeamRoutingRulesRuleArgsDict', 'outputs.OnCallTeamRoutingRulesRule']]]]] = None,
                 team_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['OnCallTeamRoutingRulesRuleArgs', 'OnCallTeamRoutingRulesRuleArgsDict', 'outputs.OnCallTeamRoutingRulesRule']]]] rules: List of team routing rules.
        :param pulumi.Input[_builtins.str] team_id: ID of the team to associate the routing rules with.
        """
        ...
    @overload
