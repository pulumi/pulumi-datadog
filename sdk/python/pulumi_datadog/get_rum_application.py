...
def get_rum_application(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: ID of the RUM application. Cannot be used with name and type filters.
    :param _builtins.str name_filter: The name used to search for a RUM application.
    :param _builtins.str type_filter: The type used to search for a RUM application.
    """
    __args__ = dict()
    __args__['id'] = id
