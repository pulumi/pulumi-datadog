...
def get_rum_application(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: ID of the RUM application. Cannot be used with name and type filters.
    :param builtins.str name_filter: The name used to search for a RUM application.
    :param builtins.str type_filter: The type used to search for a RUM application.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_rum_application_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
