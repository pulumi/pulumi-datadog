...
class ServiceAccountApplicationKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the application key.
        :param pulumi.Input[builtins.str] service_account_id: ID of the service account that owns this key.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: Authorization scopes for the Application Key. Application Keys configured with no scopes have full access.
        """
...
class _ServiceAccountApplicationKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: Creation date of the application key.
        :param pulumi.Input[builtins.str] key: The value of the service account application key. This value cannot be imported.
        :param pulumi.Input[builtins.str] last4: The last four characters of the application key.
        :param pulumi.Input[builtins.str] name: Name of the application key.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: Authorization scopes for the Application Key. Application Keys configured with no scopes have full access.
        :param pulumi.Input[builtins.str] service_account_id: ID of the service account that owns this key.
        """
...
class ServiceAccountApplicationKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            service_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceAccountApplicationKey':
        """
