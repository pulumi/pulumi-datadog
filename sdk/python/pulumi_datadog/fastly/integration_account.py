...
class IntegrationAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_key: The API key for the Fastly account.
        :param pulumi.Input[builtins.str] name: The name of the Fastly account.
        """
...
class IntegrationAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            api_key: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'IntegrationAccount':
        """
