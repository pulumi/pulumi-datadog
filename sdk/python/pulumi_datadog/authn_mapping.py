...
class AuthnMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key: Identity provider key.
        :param pulumi.Input[builtins.str] value: Identity provider value.
        :param pulumi.Input[builtins.str] role: The ID of a role to attach to all users with the corresponding key and value. Cannot be used in conjunction with `team`.
        :param pulumi.Input[builtins.str] team: The ID of a team to add all users with the corresponding key and value to. Cannot be used in conjunction with `role`.
        """
...
@pulumi.type_token("datadog:index/authnMapping:AuthnMapping")
class AuthnMapping(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role: Optional[pulumi.Input[builtins.str]] = None,
            team: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthnMapping':
        """
