...
class MetricMetadataArgs:
    def __init__(__self__, *,
                 ...
                 per_unit: Optional[pulumi.Input[builtins.str]] = None,
                 short_name: Optional[pulumi.Input[builtins.str]] = None,
                 statsd_interval: Optional[pulumi.Input[builtins.int]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 unit: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MetricMetadata resource.
        :param pulumi.Input[builtins.str] metric: The name of the metric.
        :param pulumi.Input[builtins.str] description: A description of the metric.
        :param pulumi.Input[builtins.str] per_unit: Per unit of the metric such as `second` in `bytes per second`.
        :param pulumi.Input[builtins.str] short_name: A short name of the metric.
        :param pulumi.Input[builtins.int] statsd_interval: If applicable, statsd flush interval in seconds for the metric.
        :param pulumi.Input[builtins.str] type: Metric type such as `count`, `gauge`, or `rate`. Updating a metric of type `distribution` is not supported. If you would like to see the `distribution` type returned, contact [Datadog support](https://docs.datadoghq.com/help/).
        :param pulumi.Input[builtins.str] unit: Primary unit of the metric such as `byte` or `operation`.
        """
    ...
    def per_unit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @per_unit.setter
    def per_unit(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def statsd_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def statsd_interval(self, value: Optional[pulumi.Input[builtins.int]]):
...
class MetricMetadata(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            statsd_interval: Optional[pulumi.Input[builtins.int]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            unit: Optional[pulumi.Input[builtins.str]] = None) -> 'MetricMetadata':
        """
    ...
    @property
    @pulumi.getter(name="perUnit")
    def per_unit(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Per unit of the metric such as `second` in `bytes per second`.
        """
        return pulumi.get(self, "per_unit")
    ...
    @property
    @pulumi.getter(name="statsdInterval")
    def statsd_interval(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        If applicable, statsd flush interval in seconds for the metric.
        """
        return pulumi.get(self, "statsd_interval")
