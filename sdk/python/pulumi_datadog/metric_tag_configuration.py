...
class MetricTagConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 exclude_tags_mode: Optional[pulumi.Input[builtins.bool]] = None,
                 include_percentiles: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a MetricTagConfiguration resource.
        :param pulumi.Input[builtins.str] metric_name: The metric name for this resource.
        :param pulumi.Input[builtins.str] metric_type: The metric's type. This field can't be updated after creation. Valid values are `gauge`, `count`, `rate`, `distribution`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of tag keys that will be queryable for your metric.
        ...
        :param pulumi.Input[builtins.bool] exclude_tags_mode: Toggle to include/exclude tags as queryable for your metric. Can only be applied to metrics that have one or more tags configured. Defaults to `false`.
        :param pulumi.Input[builtins.bool] include_percentiles: Toggle to include/exclude percentiles for a distribution metric. Defaults to false. Can only be applied to metrics that have a `metric_type` of distribution.
        """
    ...
    def exclude_tags_mode(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def exclude_tags_mode(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "exclude_tags_mode", value)

    @property
    @pulumi.getter(name="includePercentiles")
    def include_percentiles(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def include_percentiles(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class MetricTagConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            metric_name: Optional[pulumi.Input[builtins.str]] = None,
            metric_type: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'MetricTagConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="excludeTagsMode")
    def exclude_tags_mode(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Toggle to include/exclude tags as queryable for your metric. Can only be applied to metrics that have one or more tags configured. Defaults to `false`.
        """
        return pulumi.get(self, "exclude_tags_mode")
    ...
    @property
    @pulumi.getter(name="includePercentiles")
    def include_percentiles(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Toggle to include/exclude percentiles for a distribution metric. Defaults to false. Can only be applied to metrics that have a `metric_type` of distribution.
        """
        return pulumi.get(self, "include_percentiles")
