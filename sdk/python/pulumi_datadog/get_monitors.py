...
def get_monitors(monitor_tags_filters: Optional[Sequence[builtins.str]] = None,
...
def get_monitors_output(monitor_tags_filters: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
