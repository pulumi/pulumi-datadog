...
def get_powerpack(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the Powerpack to search for.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_powerpack_output(name: Optional[pulumi.Input[builtins.str]] = None,
