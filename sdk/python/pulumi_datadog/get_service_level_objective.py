...
class GetServiceLevelObjectiveResult:
    ...
    def target_threshold(self) -> builtins.float:
        """
    ...
    def warning_threshold(self) -> builtins.float:
        """
...
def get_service_level_objective(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: A SLO ID to limit the search.
...
def get_service_level_objective_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
