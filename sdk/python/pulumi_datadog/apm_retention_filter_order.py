...
class ApmRetentionFilterOrderArgs:
    def __init__(__self__, *,
                 filter_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        The set of arguments for constructing a ApmRetentionFilterOrder resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] filter_ids: The filter IDs list. The order of filters IDs in this attribute defines the overall APM retention filters order.
        """
        pulumi.set(__self__, "filter_ids", filter_ids)

    @property
    @pulumi.getter(name="filterIds")
    def filter_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @filter_ids.setter
    def filter_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class ApmRetentionFilterOrder(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            filter_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ApmRetentionFilterOrder':
        """
    ...
    @property
    @pulumi.getter(name="filterIds")
    def filter_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The filter IDs list. The order of filters IDs in this attribute defines the overall APM retention filters order.
        """
        return pulumi.get(self, "filter_ids")
