...
class LogsPipelineOrderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: The name attribute in the resource LogsPipelineOrder needs to be unique. It's recommended to use the same value as the resource name. No related field is available in .
    ...
    def name(self) -> pulumi.Input[str]:
        """
        The name attribute in the resource LogsPipelineOrder needs to be unique. It's recommended to use the same value as the resource name. No related field is available in .
        """
...
class LogsPipelineOrder(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Import is supported using the following syntax# There must be at most one datadog_logs_pipeline_order resource. Pipeline order creation is not supported from logs config API. You can import the datadog_logs_pipeline_order or create a pipeline order (which is actually doing the update operation).
