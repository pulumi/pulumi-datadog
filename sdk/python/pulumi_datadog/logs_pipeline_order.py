...
class LogsPipelineOrderArgs:
    def __init__(__self__, *,
                 ...
                 pipelines: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        The set of arguments for constructing a LogsPipelineOrder resource.
        :param pulumi.Input[builtins.str] name: The name attribute in the resource `LogsPipelineOrder` needs to be unique. It's recommended to use the same value as the resource name. No related field is available in [Logs Pipeline API](https://docs.datadoghq.com/api/v1/logs-pipelines/#get-pipeline-order).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] pipelines: The pipeline IDs list. The order of pipeline IDs in this attribute defines the overall pipeline order for logs.
        """
    ...
    @property
    @pulumi.getter
    def pipelines(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @pipelines.setter
    def pipelines(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _LogsPipelineOrderState:
    def __init__(__self__, *,
                 ...
                 pipelines: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
    ...
    @property
    @pulumi.getter
    def pipelines(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The pipeline IDs list. The order of pipeline IDs in this attribute defines the overall pipeline order for logs.
        """
        return pulumi.get(self, "pipelines")
    ...
    @pipelines.setter
    def pipelines(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "pipelines", value)
...
class LogsPipelineOrder(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            pipelines: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'LogsPipelineOrder':
        """
    ...
    @property
    @pulumi.getter
    def pipelines(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The pipeline IDs list. The order of pipeline IDs in this attribute defines the overall pipeline order for logs.
        """
        return pulumi.get(self, "pipelines")
