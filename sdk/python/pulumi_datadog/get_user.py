...
class GetUserResult:
    ...
    def service_account(self) -> builtins.bool:
        """
...
def get_user(exact_match: Optional[builtins.bool] = None,
    ...
    :param builtins.bool exact_match: When true, `filter` string is exact matched against the user's `email`, followed by `name` attribute. Defaults to `false`.
...
def get_user_output(exact_match: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
