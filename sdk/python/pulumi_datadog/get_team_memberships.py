...
class GetTeamMembershipsResult:
    ...
    def filter_keyword(self) -> Optional[builtins.str]:
        """
...
def get_team_memberships(exact_match: Optional[builtins.bool] = None,
                         filter_keyword: Optional[builtins.str] = None,
    ...
    :param builtins.bool exact_match: When true, `filter_keyword` string is exact matched against the user's `email`, followed by `name`.
    :param builtins.str filter_keyword: Search query, can be user email or name.
    :param builtins.str team_id: The team's identifier.
    """
    __args__ = dict()
...
def get_team_memberships_output(exact_match: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                filter_keyword: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('datadog:index/getTeamMemberships:getTeamMemberships', __args__, opts=opts, typ=GetTeamMembershipsResult)
    return __ret__.apply(lambda __response__: GetTeamMembershipsResult(
        exact_match=pulumi.get(__response__, 'exact_match'),
        filter_keyword=pulumi.get(__response__, 'filter_keyword'),
        id=pulumi.get(__response__, 'id'),
        team_id=pulumi.get(__response__, 'team_id'),
        team_memberships=pulumi.get(__response__, 'team_memberships')))
