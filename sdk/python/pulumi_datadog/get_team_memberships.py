...
def get_team_memberships(exact_match: Optional[_builtins.bool] = None,
                         filter_keyword: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool exact_match: When true, `filter_keyword` string is exact matched against the user's `email`, followed by `name`.
    :param _builtins.str filter_keyword: Search query, can be user email or name.
    :param _builtins.str team_id: The team's identifier.
    """
    __args__ = dict()
