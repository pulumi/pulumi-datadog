...
class MonitorArgs:
    def __init__(__self__, *,
                 ...
                 enable_logs_sample: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_samples: Optional[pulumi.Input[builtins.bool]] = None,
                 escalation_message: Optional[pulumi.Input[builtins.str]] = None,
                 evaluation_delay: Optional[pulumi.Input[builtins.int]] = None,
                 force_delete: Optional[pulumi.Input[builtins.bool]] = None,
                 group_retention_duration: Optional[pulumi.Input[builtins.str]] = None,
                 groupby_simple_monitor: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 new_group_delay: Optional[pulumi.Input[builtins.int]] = None,
                 new_host_delay: Optional[pulumi.Input[builtins.int]] = None,
                 no_data_timeframe: Optional[pulumi.Input[builtins.int]] = None,
                 notification_preset_name: Optional[pulumi.Input[builtins.str]] = None,
                 notify_audit: Optional[pulumi.Input[builtins.bool]] = None,
                 notify_bies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 notify_no_data: Optional[pulumi.Input[builtins.bool]] = None,
                 on_missing_data: Optional[pulumi.Input[builtins.str]] = None,
                 priority: Optional[pulumi.Input[builtins.str]] = None,
                 renotify_interval: Optional[pulumi.Input[builtins.int]] = None,
                 renotify_occurrences: Optional[pulumi.Input[builtins.int]] = None,
                 renotify_statuses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 require_full_window: Optional[pulumi.Input[builtins.bool]] = None,
                 restricted_roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 scheduling_options: Optional[pulumi.Input[Sequence[pulumi.Input['MonitorSchedulingOptionArgs']]]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 timeout_h: Optional[pulumi.Input[builtins.int]] = None,
                 validate: Optional[pulumi.Input[builtins.bool]] = None,
                 variables: Optional[pulumi.Input['MonitorVariablesArgs']] = None):
        """
        The set of arguments for constructing a Monitor resource.
        :param pulumi.Input[builtins.str] message: A message to include with notifications for this monitor.
        :param pulumi.Input[builtins.str] name: Name of Datadog monitor.
        :param pulumi.Input[builtins.str] type: The type of the monitor. The mapping from these types to the types found in the Datadog Web UI can be found in the
        ...
        :param pulumi.Input[builtins.bool] enable_logs_sample: A boolean indicating whether or not to include a list of log values which triggered the alert. This is only used by log
               monitors. Defaults to `false`.
        :param pulumi.Input[builtins.bool] enable_samples: Whether or not a list of samples which triggered the alert is included. This is only used by CI Test and Pipeline
               monitors.
        :param pulumi.Input[builtins.str] escalation_message: A message to include with a re-notification. Supports the `@username` notification allowed elsewhere.
        :param pulumi.Input[builtins.int] evaluation_delay: (Only applies to metric alert) Time (in seconds) to delay evaluation, as a non-negative integer. For example, if the
        ...
        :param pulumi.Input[builtins.bool] force_delete: A boolean indicating whether this monitor can be deleted even if it’s referenced by other resources (e.g. SLO,
               composite monitor).
        :param pulumi.Input[builtins.str] group_retention_duration: The time span after which groups with missing data are dropped from the monitor state. The minimum value is one hour,
        ...
        :param pulumi.Input[builtins.bool] groupby_simple_monitor: Whether or not to trigger one alert if any source breaches a threshold. This is only used by log monitors. Defaults to
               `false`.
        :param pulumi.Input[builtins.bool] include_tags: A boolean indicating whether notifications from this monitor automatically insert its triggering tags into the title.
        :param pulumi.Input[builtins.bool] locked: A boolean indicating whether changes to this monitor should be restricted to the creator or admins. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.int] new_group_delay: The time (in seconds) to skip evaluations for new groups. `new_group_delay` overrides `new_host_delay` if it is set to a
               nonzero value.
        :param pulumi.Input[builtins.int] new_host_delay: **Deprecated**. See `new_group_delay`. Time (in seconds) to allow a host to boot and applications to fully start before
        ...
        :param pulumi.Input[builtins.int] no_data_timeframe: The number of minutes before a monitor will notify when data stops reporting. We recommend at least 2x the monitor
               timeframe for metric alerts or 2 minutes for service checks.
        :param pulumi.Input[builtins.str] notification_preset_name: Toggles the display of additional content sent in the monitor notification.
        :param pulumi.Input[builtins.bool] notify_audit: A boolean indicating whether tagged users will be notified on changes to this monitor. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notify_bies: Controls what granularity a monitor alerts on. Only available for monitors with groupings. For instance, a monitor
        ...
        :param pulumi.Input[builtins.bool] notify_no_data: A boolean indicating whether this monitor will notify when data stops reporting.
        :param pulumi.Input[builtins.str] on_missing_data: Controls how groups or monitors are treated if an evaluation does not return any data points. The default option results
               ...
               `resolve`, and `default`.
        :param pulumi.Input[builtins.str] priority: Integer from 1 (high) to 5 (low) indicating alert severity.
        :param pulumi.Input[builtins.int] renotify_interval: The number of minutes after the last notification before a monitor will re-notify on the current status. It will only
               re-notify if it's not resolved.
        :param pulumi.Input[builtins.int] renotify_occurrences: The number of re-notification messages that should be sent on the current status.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] renotify_statuses: The types of statuses for which re-notification messages should be sent.
        ...
        :param pulumi.Input[builtins.int] timeout_h: The number of hours of the monitor not reporting data before it automatically resolves from a triggered state. The
    ...
    def enable_logs_sample(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_logs_sample(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_logs_sample", value)

    @property
    @pulumi.getter(name="enableSamples")
    def enable_samples(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_samples(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_samples", value)

    @property
    @pulumi.getter(name="escalationMessage")
    def escalation_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def escalation_message(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def group_retention_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def group_retention_duration(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "group_retention_duration", value)

    @property
    @pulumi.getter(name="groupbySimpleMonitor")
    def groupby_simple_monitor(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def groupby_simple_monitor(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def new_group_delay(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def new_group_delay(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def new_host_delay(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def new_host_delay(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "new_host_delay", value)

    @property
    @pulumi.getter(name="noDataTimeframe")
    def no_data_timeframe(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def no_data_timeframe(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "no_data_timeframe", value)

    @property
    @pulumi.getter(name="notificationPresetName")
    def notification_preset_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def notification_preset_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "notification_preset_name", value)

    @property
    @pulumi.getter(name="notifyAudit")
    def notify_audit(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @notify_audit.setter
    def notify_audit(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "notify_audit", value)

    @property
    @pulumi.getter(name="notifyBies")
    def notify_bies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @notify_bies.setter
    def notify_bies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "notify_bies", value)

    @property
    @pulumi.getter(name="notifyNoData")
    def notify_no_data(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def notify_no_data(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "notify_no_data", value)

    @property
    @pulumi.getter(name="onMissingData")
    def on_missing_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def on_missing_data(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def renotify_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def renotify_interval(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "renotify_interval", value)

    @property
    @pulumi.getter(name="renotifyOccurrences")
    def renotify_occurrences(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def renotify_occurrences(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "renotify_occurrences", value)

    @property
    @pulumi.getter(name="renotifyStatuses")
    def renotify_statuses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def renotify_statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "renotify_statuses", value)

    @property
    @pulumi.getter(name="requireFullWindow")
    def require_full_window(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def require_full_window(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def restricted_roles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def timeout_h(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @timeout_h.setter
    def timeout_h(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Monitor(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableLogsSample")
    def enable_logs_sample(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean indicating whether or not to include a list of log values which triggered the alert. This is only used by log
        monitors. Defaults to `false`.
        """
    ...
    @property
    @pulumi.getter(name="enableSamples")
    def enable_samples(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether or not a list of samples which triggered the alert is included. This is only used by CI Test and Pipeline
        monitors.
        """
    ...
    @property
    @pulumi.getter(name="escalationMessage")
    def escalation_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A message to include with a re-notification. Supports the `@username` notification allowed elsewhere.
        """
        return pulumi.get(self, "escalation_message")
    ...
    @property
    @pulumi.getter(name="evaluationDelay")
    def evaluation_delay(self) -> pulumi.Output[builtins.int]:
        """
        (Only applies to metric alert) Time (in seconds) to delay evaluation, as a non-negative integer. For example, if the
        value is set to `300` (5min), the `timeframe` is set to `last_5m` and the time is 7:00, the monitor will evaluate data
        from 6:50 to 6:55. This is useful for AWS CloudWatch and other backfilled metrics to ensure the monitor will always have
    ...
    @property
    @pulumi.getter(name="groupRetentionDuration")
    def group_retention_duration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time span after which groups with missing data are dropped from the monitor state. The minimum value is one hour,
        and the maximum value is 72 hours. Example values are: 60m, 1h, and 2d. This option is only available for APM Trace
        Analytics, Audit Trail, CI, Error Tracking, Event, Logs, and RUM monitors.
    ...
    @property
    @pulumi.getter(name="groupbySimpleMonitor")
    def groupby_simple_monitor(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether or not to trigger one alert if any source breaches a threshold. This is only used by log monitors. Defaults to
        `false`.
        """
    ...
    @property
    @pulumi.getter(name="includeTags")
    def include_tags(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean indicating whether notifications from this monitor automatically insert its triggering tags into the title.
        """
        return pulumi.get(self, "include_tags")
    ...
    @property
    @pulumi.getter(name="newGroupDelay")
    def new_group_delay(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The time (in seconds) to skip evaluations for new groups. `new_group_delay` overrides `new_host_delay` if it is set to a
        nonzero value.
        """
    ...
    @pulumi.getter(name="newHostDelay")
    @_utilities.deprecated("""Use `new_group_delay` except when setting `new_host_delay` to zero.""")
    def new_host_delay(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        **Deprecated**. See `new_group_delay`. Time (in seconds) to allow a host to boot and applications to fully start before
        starting the evaluation of monitor results. Should be a non-negative integer. This value is ignored for simple monitors
        and monitors not grouped by host. The only case when this should be used is to override the default and set
    ...
    @property
    @pulumi.getter(name="noDataTimeframe")
    def no_data_timeframe(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of minutes before a monitor will notify when data stops reporting. We recommend at least 2x the monitor
        timeframe for metric alerts or 2 minutes for service checks.
        """
    ...
    @property
    @pulumi.getter(name="notificationPresetName")
    def notification_preset_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Toggles the display of additional content sent in the monitor notification.
        """
        return pulumi.get(self, "notification_preset_name")
    ...
    @property
    @pulumi.getter(name="notifyAudit")
    def notify_audit(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean indicating whether tagged users will be notified on changes to this monitor. Defaults to `false`.
        """
        return pulumi.get(self, "notify_audit")
    ...
    @property
    @pulumi.getter(name="notifyBies")
    def notify_bies(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Controls what granularity a monitor alerts on. Only available for monitors with groupings. For instance, a monitor
        grouped by `cluster`, `namespace`, and `pod` can be configured to only notify on each new `cluster` violating the alert
        conditions by setting `notify_by` to `['cluster']`. Tags mentioned in `notify_by` must be a subset of the grouping tags
    ...
    @property
    @pulumi.getter(name="notifyNoData")
    def notify_no_data(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean indicating whether this monitor will notify when data stops reporting.
        """
        return pulumi.get(self, "notify_no_data")
    ...
    @property
    @pulumi.getter(name="onMissingData")
    def on_missing_data(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Controls how groups or monitors are treated if an evaluation does not return any data points. The default option results
        in different behavior depending on the monitor query type. For monitors using `Count` queries, an empty monitor
        evaluation is treated as 0 and is compared to the threshold conditions. For monitors using any query type other than
    ...
    @property
    @pulumi.getter(name="renotifyInterval")
    def renotify_interval(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of minutes after the last notification before a monitor will re-notify on the current status. It will only
        re-notify if it's not resolved.
        """
    ...
    @property
    @pulumi.getter(name="renotifyOccurrences")
    def renotify_occurrences(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of re-notification messages that should be sent on the current status.
        """
        return pulumi.get(self, "renotify_occurrences")
    ...
    @property
    @pulumi.getter(name="renotifyStatuses")
    def renotify_statuses(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The types of statuses for which re-notification messages should be sent.
        """
        return pulumi.get(self, "renotify_statuses")
    ...
    @property
    @pulumi.getter(name="requireFullWindow")
    def require_full_window(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean indicating whether this monitor needs a full window of data before it's evaluated. Datadog strongly recommends
        you set this to `false` for sparse metrics, otherwise some evaluations may be skipped. If there's a custom_schedule set,
        `require_full_window` must be false and will be ignored.
    ...
    @property
    @pulumi.getter(name="timeoutH")
    def timeout_h(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of hours of the monitor not reporting data before it automatically resolves from a triggered state. The
        minimum allowed value is 0 hours. The maximum allowed value is 24 hours.
        """
