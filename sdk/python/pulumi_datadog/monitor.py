...
class MonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] notify_bies: Controls what granularity a monitor alerts on. Only available for monitors with groupings. For instance, a monitor grouped by `cluster`, `namespace`, and `pod` can be configured to only notify on each new `cluster` violating the alert conditions by setting `notify_by` to `['cluster']`. Tags mentioned in `notify_by` must be a proper subset of the grouping tags in the query. For example, a query grouped by `cluster` and `namespace` cannot notify on `region` because `region` is not part of the grouping tags; furthermore, the same query cannot set `notify_by` to `['cluster', 'namespace']` because that is not a proper subset. Setting `notify_by` to `[*]` configures the monitor to notify as a simple-alert.
...
class Monitor(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="escalationMessage")
    def escalation_message(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A message to include with a re-notification. Supports the `@username` notification allowed elsewhere.
        """
        return pulumi.get(self, "escalation_message")
    ...
    @_builtins.property
    @pulumi.getter(name="notificationPresetName")
    def notification_preset_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Toggles the display of additional content sent in the monitor notification.
        """
        return pulumi.get(self, "notification_preset_name")
    ...
    @_builtins.property
    @pulumi.getter(name="notifyAudit")
    def notify_audit(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        A boolean indicating whether tagged users will be notified on changes to this monitor. Defaults to `false`.
        """
        return pulumi.get(self, "notify_audit")
    ...
    @_builtins.property
    @pulumi.getter(name="notifyNoData")
    def notify_no_data(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        A boolean indicating whether this monitor will notify when data stops reporting.
        """
        return pulumi.get(self, "notify_no_data")
    ...
    @_builtins.property
    @pulumi.getter(name="renotifyOccurrences")
    def renotify_occurrences(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of re-notification messages that should be sent on the current status.
        """
        return pulumi.get(self, "renotify_occurrences")
    ...
    @_builtins.property
    @pulumi.getter(name="renotifyStatuses")
    def renotify_statuses(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The types of statuses for which re-notification messages should be sent.
        """
        return pulumi.get(self, "renotify_statuses")
