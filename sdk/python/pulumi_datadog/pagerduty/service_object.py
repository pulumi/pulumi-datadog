...
class ServiceObjectArgs:
    def __init__(__self__, *,
                 service_key: pulumi.Input[builtins.str],
                 service_name: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ServiceObject resource.
        :param pulumi.Input[builtins.str] service_name: Your Service name in PagerDuty.
        """
    ...
    def service_key(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "service_key")

    @service_key.setter
    def service_key(self, value: pulumi.Input[builtins.str]):
...
class ServiceObject(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            service_key: Optional[pulumi.Input[builtins.str]] = None,
            service_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceObject':
        """
