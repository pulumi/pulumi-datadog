...
class RumApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the RUM application.
        :param pulumi.Input[builtins.str] type: Type of the RUM application. Supported values are `browser`, `ios`, `android`, `react-native`, `flutter`. Defaults to `"browser"`.
        """
...
class _RumApplicationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_token: The client token.
        :param pulumi.Input[builtins.str] name: Name of the RUM application.
        :param pulumi.Input[builtins.str] type: Type of the RUM application. Supported values are `browser`, `ios`, `android`, `react-native`, `flutter`. Defaults to `"browser"`.
        """
...
class RumApplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            client_token: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'RumApplication':
        """
