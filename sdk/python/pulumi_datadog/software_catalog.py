...
class SoftwareCatalogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] entity: The catalog entity definition. Entity must be a valid entity YAML/JSON structure.
        """
...
class SoftwareCatalog(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            entity: Optional[pulumi.Input[builtins.str]] = None) -> 'SoftwareCatalog':
        """
