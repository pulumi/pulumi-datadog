...
def get_dashboard_list(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: A dashboard list name to limit the search.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_dashboard_list_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('datadog:index/getDashboardList:getDashboardList', __args__, opts=opts, typ=GetDashboardListResult)
    return __ret__.apply(lambda __response__: GetDashboardListResult(
