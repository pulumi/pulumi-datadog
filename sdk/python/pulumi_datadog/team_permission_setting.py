...
class TeamPermissionSettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: The identifier for the action. Valid values are `manage_membership`, `edit`.
        :param pulumi.Input[builtins.str] team_id: ID of the team the team permission setting is associated with.
        :param pulumi.Input[builtins.str] value: The action value. Valid values are dependent on the action. `manage_membership` action allows `admins`, `members`, `organization`, `user_access_manage` values. `edit` action allows `admins`, `members`, `teams_manage` values.
        """
...
class TeamPermissionSetting(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            action: Optional[pulumi.Input[builtins.str]] = None,
            team_id: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'TeamPermissionSetting':
        """
