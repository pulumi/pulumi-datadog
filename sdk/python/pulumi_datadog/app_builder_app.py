...
class AppBuilderAppArgs:
    def __init__(__self__, *,
                 app_json: pulumi.Input[str],
                 action_query_names_to_connection_ids: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 published: Optional[pulumi.Input[bool]] = None,
                 root_instance_name: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a AppBuilderApp resource.
        :param pulumi.Input[str] app_json: The JSON representation of the App. String length must be at least 1.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] action_query_names_to_connection_ids: If specified, this will override the Action Connection IDs for the specified Action Query Names in the App JSON. Otherwise, a map of the App's Action Query Names to Action Connection IDs will be returned in output.
        :param pulumi.Input[str] description: If specified, this will override the human-readable description of the App in the App JSON. String length must be at least 1.
        :param pulumi.Input[str] name: If specified, this will override the name of the App in the App JSON. String length must be at least 1.
        :param pulumi.Input[bool] published: Set the app to published or unpublished. Published apps are available to other users. To ensure the app is accessible to the correct users, you also need to set a [Restriction Policy](https://docs.datadoghq.com/api/latest/restriction-policies/) on the app if a policy does not yet exist. Defaults to `false`.
        :param pulumi.Input[str] root_instance_name: The name of the root component of the app. This must be a grid component that contains all other components. If specified, this will override the root instance name of the App in the App JSON. String length must be at least 1.
        """
    ...
    def app_json(self) -> pulumi.Input[str]:
        """
    ...
    @app_json.setter
    def app_json(self, value: pulumi.Input[str]):
        pulumi.set(self, "app_json", value)

    @property
    @pulumi.getter(name="actionQueryNamesToConnectionIds")
    def action_query_names_to_connection_ids(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]:
        """
    ...
    def action_query_names_to_connection_ids(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]):
    ...
    def root_instance_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def root_instance_name(self, value: Optional[pulumi.Input[str]]):
...
class _AppBuilderAppState:
    def __init__(__self__, *,
                 action_query_names_to_connection_ids: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 app_json: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 published: Optional[pulumi.Input[bool]] = None,
                 root_instance_name: Optional[pulumi.Input[str]] = None):
    ...
    @property
    @pulumi.getter(name="appJson")
    def app_json(self) -> Optional[pulumi.Input[str]]:
        """
        The JSON representation of the App. String length must be at least 1.
        """
        return pulumi.get(self, "app_json")
    ...
    @app_json.setter
    def app_json(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "app_json", value)
...
class AppBuilderApp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            published: Optional[pulumi.Input[bool]] = None,
            root_instance_name: Optional[pulumi.Input[str]] = None) -> 'AppBuilderApp':
        """
    ...
    @property
    @pulumi.getter(name="actionQueryNamesToConnectionIds")
    def action_query_names_to_connection_ids(self) -> pulumi.Output[Mapping[str, str]]:
        """
        If specified, this will override the Action Connection IDs for the specified Action Query Names in the App JSON. Otherwise, a map of the App's Action Query Names to Action Connection IDs will be returned in output.
        """
        return pulumi.get(self, "action_query_names_to_connection_ids")
    ...
    @property
    @pulumi.getter(name="appJson")
    def app_json(self) -> pulumi.Output[str]:
        """
        The JSON representation of the App. String length must be at least 1.
        """
        return pulumi.get(self, "app_json")
    ...
    @property
    @pulumi.getter(name="rootInstanceName")
    def root_instance_name(self) -> pulumi.Output[str]:
        """
        The name of the root component of the app. This must be a grid component that contains all other components. If specified, this will override the root instance name of the App in the App JSON. String length must be at least 1.
        """
        return pulumi.get(self, "root_instance_name")
