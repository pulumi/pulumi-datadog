...
export class TimeBoard extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TimeBoardState): TimeBoard {
        return new TimeBoard(name, <any>state, { id });
    }
    ...
    constructor(name: string, argsOrState?: TimeBoardArgs | TimeBoardState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            const state: TimeBoardState = argsOrState as TimeBoardState | undefined;
        ...
        super("datadog:timeBoard:TimeBoard", name, inputs, opts);
    }
}
