...
export class MetricMetadata extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MetricMetadataState): MetricMetadata {
        return new MetricMetadata(name, <any>state, { id });
    }
    ...
    constructor(name: string, argsOrState?: MetricMetadataArgs | MetricMetadataState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            const state: MetricMetadataState = argsOrState as MetricMetadataState | undefined;
        ...
        super("datadog:metricMetadata:MetricMetadata", name, inputs, opts);
    }
}
