...
export class User extends pulumi.CustomResource {
    ...
    /**
     * Role description for user. Can be st (standard user), adm (admin user) or ro (read-only user). Default is st. accessRole is ignored for new users created with this resource. New users have to use the roles attribute.  This parameter is replaced by roles and will be removed from the next Major version.
     *
