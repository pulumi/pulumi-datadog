...
export class LogsArchive extends pulumi.CustomResource {
    ...
    /**
     * Definition of an azure archive.  Define azureArchive list with one element instead.
     *
    ...
    /**
     * Definition of a GCS archive.  Define gcsArchive list with one element instead.
     *
    ...
    /**
     * Definition of an s3 archive.  Define s3Archive list with one element instead.
     *
