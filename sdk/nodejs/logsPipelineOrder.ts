...
export class LogsPipelineOrder extends pulumi.CustomResource {
    ...
    /**
     * The name attribute in the resource datadog.LogsPipelineOrder needs to be unique. It's recommended to use the same value as the resource name. No related field is available in .
     */
