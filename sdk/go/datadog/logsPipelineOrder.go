...
//
// There must be at most one LogsPipelineOrder resource. Pipeline order creation is not supported from logs config API. You can import the LogsPipelineOrder or create a pipeline order (which is actually doing the update operation).
//
// ```sh
