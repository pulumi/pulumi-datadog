...
func NewMetricMetadata(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("datadog:metricMetadata:MetricMetadata", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetMetricMetadata(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("datadog:metricMetadata:MetricMetadata", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &MetricMetadata{s: s}, nil
