...
type LookupMonitorResult struct {
	...
	SchedulingOptions []GetMonitorSchedulingOption `pulumi:"schedulingOptions"`
...
func LookupMonitorOutput(ctx *pulumi.Context, args LookupMonitorOutputArgs, opts ...pulumi.InvokeOption) LookupMonitorResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMonitorResultOutput, error) {
			...
			return ctx.InvokeOutput("datadog:index/getMonitor:getMonitor", args, LookupMonitorResultOutput{}, options).(LookupMonitorResultOutput), nil
...
// Whether or not a list of samples which triggered the alert is included. This is only used by CI Test and Pipeline monitors.
func (o LookupMonitorResultOutput) EnableSamples() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupMonitorResult) bool { return v.EnableSamples }).(pulumi.BoolOutput)
}
...
// Configuration options for scheduling.
func (o LookupMonitorResultOutput) SchedulingOptions() GetMonitorSchedulingOptionArrayOutput {
	return o.ApplyT(func(v LookupMonitorResult) []GetMonitorSchedulingOption { return v.SchedulingOptions }).(GetMonitorSchedulingOptionArrayOutput)
}
