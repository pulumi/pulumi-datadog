...
type Integration struct {
	...
	ContainerAppFilters pulumi.StringPtrOutput `pulumi:"containerAppFilters"`
...
// This comma-separated list of tags (in the form `key:value,key:value`) defines a filter that Datadog uses when collecting metrics from Azure Container Apps. Only Container Apps that match one of the defined tags are imported into Datadog.
func (o IntegrationOutput) ContainerAppFilters() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Integration) pulumi.StringPtrOutput { return v.ContainerAppFilters }).(pulumi.StringPtrOutput)
}
