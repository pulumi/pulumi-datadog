...
import com.pulumi.datadog.outputs.DashboardV2WidgetManageStatusDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetManageStatusDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetManageStatusDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetManageStatusDefinition() {}
    /**
     * @return Whether to colorize text or background. Valid values are `background`, `text`.
     * 
     */
     ...
     * 
     */
    public Optional<DashboardV2WidgetManageStatusDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetManageStatusDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetManageStatusDefinition defaults) {
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetManageStatusDefinition", "query");
            }
            this.query = query;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetManageStatusDefinitionTime time) {
        ...
        public DashboardV2WidgetManageStatusDefinition build() {
            final var _resultValue = new DashboardV2WidgetManageStatusDefinition();
