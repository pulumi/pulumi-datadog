...
public final class PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs Empty = new PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs() {}

    private PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs(PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
