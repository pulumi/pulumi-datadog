...
import com.pulumi.datadog.inputs.PowerpackV2WidgetTimeseriesDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetTimeseriesDefinitionEventArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetTimeseriesDefinitionMarkerArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetTimeseriesDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetTimeseriesDefinitionRightYaxisArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetTimeseriesDefinitionTimeArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetTimeseriesDefinitionYaxisArgs;
...
public final class PowerpackV2WidgetTimeseriesDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTimeseriesDefinitionArgs Empty = new PowerpackV2WidgetTimeseriesDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetTimeseriesDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetTimeseriesDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="events")
    private @Nullable Output<List<PowerpackV2WidgetTimeseriesDefinitionEventArgs>> events;

    /**
     * @return The definition of the event to overlay on the graph. Multiple `event` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetTimeseriesDefinitionEventArgs>>> events() {
     ...
     */
    @Import(name="markers")
    private @Nullable Output<List<PowerpackV2WidgetTimeseriesDefinitionMarkerArgs>> markers;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetTimeseriesDefinitionMarkerArgs>>> markers() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetTimeseriesDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetTimeseriesDefinitionRequestArgs>>> requests() {
    ...
    private @Nullable Output<PowerpackV2WidgetTimeseriesDefinitionRightYaxisArgs> rightYaxis;
     ...
     * 
     */
    public Optional<Output<PowerpackV2WidgetTimeseriesDefinitionRightYaxisArgs>> rightYaxis() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetTimeseriesDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetTimeseriesDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="yaxis")
    private @Nullable Output<PowerpackV2WidgetTimeseriesDefinitionYaxisArgs> yaxis;

    /**
     * @return A nested block describing the Y-Axis Controls. The structure of this block is described below.
     * 
     */
    public Optional<Output<PowerpackV2WidgetTimeseriesDefinitionYaxisArgs>> yaxis() {
        return Optional.ofNullable(this.yaxis);
    }

    private PowerpackV2WidgetTimeseriesDefinitionArgs() {}

    private PowerpackV2WidgetTimeseriesDefinitionArgs(PowerpackV2WidgetTimeseriesDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTimeseriesDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTimeseriesDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetTimeseriesDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetTimeseriesDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetTimeseriesDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetTimeseriesDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetTimeseriesDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder events(@Nullable Output<List<PowerpackV2WidgetTimeseriesDefinitionEventArgs>> events) {
            $.events = events;
            return this;
        }
         ...
         * 
         */
        public Builder events(List<PowerpackV2WidgetTimeseriesDefinitionEventArgs> events) {
         ...
         * 
         */
        public Builder events(PowerpackV2WidgetTimeseriesDefinitionEventArgs... events) {
         ...
         * 
         */
        public Builder markers(@Nullable Output<List<PowerpackV2WidgetTimeseriesDefinitionMarkerArgs>> markers) {
            $.markers = markers;
            return this;
        }
         ...
         * 
         */
        public Builder markers(List<PowerpackV2WidgetTimeseriesDefinitionMarkerArgs> markers) {
         ...
         * 
         */
        public Builder markers(PowerpackV2WidgetTimeseriesDefinitionMarkerArgs... markers) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetTimeseriesDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetTimeseriesDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetTimeseriesDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder rightYaxis(@Nullable Output<PowerpackV2WidgetTimeseriesDefinitionRightYaxisArgs> rightYaxis) {
         ...
         * 
         */
        public Builder rightYaxis(PowerpackV2WidgetTimeseriesDefinitionRightYaxisArgs rightYaxis) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetTimeseriesDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetTimeseriesDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder yaxis(@Nullable Output<PowerpackV2WidgetTimeseriesDefinitionYaxisArgs> yaxis) {
            $.yaxis = yaxis;
            return this;
        }
         ...
         * 
         */
        public Builder yaxis(PowerpackV2WidgetTimeseriesDefinitionYaxisArgs yaxis) {
            return yaxis(Output.of(yaxis));
        }

        public PowerpackV2WidgetTimeseriesDefinitionArgs build() {
            return $;
        }
    }
