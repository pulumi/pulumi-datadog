...
public final class PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs Empty = new PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs();
    ...
    private PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs() {}

    private PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs(PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetChangeDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
