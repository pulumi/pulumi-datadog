...
import com.pulumi.datadog.inputs.DashboardV2WidgetLogStreamDefinitionSortArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetLogStreamDefinitionTimeArgs;
...
public final class DashboardV2WidgetLogStreamDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetLogStreamDefinitionArgs Empty = new DashboardV2WidgetLogStreamDefinitionArgs();
     ...
     */
    @Import(name="sort")
    private @Nullable Output<DashboardV2WidgetLogStreamDefinitionSortArgs> sort;

    /**
     * @return The facet and order to sort the data, for example: `{&#34;column&#34;: &#34;time&#34;, &#34;order&#34;: &#34;desc&#34;}`.
     * 
     */
    public Optional<Output<DashboardV2WidgetLogStreamDefinitionSortArgs>> sort() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetLogStreamDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetLogStreamDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetLogStreamDefinitionArgs() {}

    private DashboardV2WidgetLogStreamDefinitionArgs(DashboardV2WidgetLogStreamDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetLogStreamDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetLogStreamDefinitionArgs();
        }

        public Builder(DashboardV2WidgetLogStreamDefinitionArgs defaults) {
            $ = new DashboardV2WidgetLogStreamDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sort(@Nullable Output<DashboardV2WidgetLogStreamDefinitionSortArgs> sort) {
            $.sort = sort;
            return this;
        }
         ...
         * 
         */
        public Builder sort(DashboardV2WidgetLogStreamDefinitionSortArgs sort) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetLogStreamDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetLogStreamDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetLogStreamDefinitionArgs build() {
            return $;
        }
    }
