...
public final class DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs Empty = new DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs();
    ...
    private DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs() {}

    private DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs(DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGeomapDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
