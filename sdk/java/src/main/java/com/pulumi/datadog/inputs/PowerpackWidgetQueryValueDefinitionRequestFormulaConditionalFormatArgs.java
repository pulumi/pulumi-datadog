...
public final class PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs(PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
