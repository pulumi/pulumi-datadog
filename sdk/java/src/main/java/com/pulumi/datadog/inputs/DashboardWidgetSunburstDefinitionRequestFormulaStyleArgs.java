...
public final class DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs() {}

    private DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs(DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
