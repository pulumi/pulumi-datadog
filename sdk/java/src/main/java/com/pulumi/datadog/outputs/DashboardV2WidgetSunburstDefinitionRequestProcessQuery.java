...
@CustomType
public final class DashboardV2WidgetSunburstDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardV2WidgetSunburstDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetSunburstDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetSunburstDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetSunburstDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetSunburstDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetSunburstDefinitionRequestProcessQuery();
