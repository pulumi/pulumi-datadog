...
public final class SloCorrectionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SloCorrectionArgs() {}

    private SloCorrectionArgs(SloCorrectionArgs $) {
    ...
    public static Builder builder(SloCorrectionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SloCorrectionArgs();
        }

        public Builder(SloCorrectionArgs defaults) {
            $ = new SloCorrectionArgs(Objects.requireNonNull(defaults));
        }
