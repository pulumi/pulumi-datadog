...
@CustomType
public final class DashboardWidgetSunburstDefinitionRequestAuditQueryMultiCompute {
    /**
    ...
    private DashboardWidgetSunburstDefinitionRequestAuditQueryMultiCompute() {}
    /**
     * @return The aggregation method.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetSunburstDefinitionRequestAuditQueryMultiCompute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer interval;
        public Builder() {}
        public Builder(DashboardWidgetSunburstDefinitionRequestAuditQueryMultiCompute defaults) {
        ...
        public Builder aggregation(String aggregation) {
            if (aggregation == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestAuditQueryMultiCompute", "aggregation");
            }
