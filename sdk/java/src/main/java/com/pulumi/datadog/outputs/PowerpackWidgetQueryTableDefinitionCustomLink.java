...
@CustomType
public final class PowerpackWidgetQueryTableDefinitionCustomLink {
    /**
    ...
    private PowerpackWidgetQueryTableDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetQueryTableDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(PowerpackWidgetQueryTableDefinitionCustomLink defaults) {
        ...
        public PowerpackWidgetQueryTableDefinitionCustomLink build() {
            final var _resultValue = new PowerpackWidgetQueryTableDefinitionCustomLink();
