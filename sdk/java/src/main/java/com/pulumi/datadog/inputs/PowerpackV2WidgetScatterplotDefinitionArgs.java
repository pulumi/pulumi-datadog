...
import com.pulumi.datadog.inputs.PowerpackV2WidgetScatterplotDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetScatterplotDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetScatterplotDefinitionTimeArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetScatterplotDefinitionXaxisArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetScatterplotDefinitionYaxisArgs;
...
public final class PowerpackV2WidgetScatterplotDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionArgs Empty = new PowerpackV2WidgetScatterplotDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetScatterplotDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetScatterplotDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="request")
    private @Nullable Output<PowerpackV2WidgetScatterplotDefinitionRequestArgs> request;
     ...
     * 
     */
    public Optional<Output<PowerpackV2WidgetScatterplotDefinitionRequestArgs>> request() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetScatterplotDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetScatterplotDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="xaxis")
    private @Nullable Output<PowerpackV2WidgetScatterplotDefinitionXaxisArgs> xaxis;

    /**
     * @return A nested block describing the X-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<PowerpackV2WidgetScatterplotDefinitionXaxisArgs>> xaxis() {
     ...
     */
    @Import(name="yaxis")
    private @Nullable Output<PowerpackV2WidgetScatterplotDefinitionYaxisArgs> yaxis;

    /**
     * @return A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<PowerpackV2WidgetScatterplotDefinitionYaxisArgs>> yaxis() {
        return Optional.ofNullable(this.yaxis);
    }

    private PowerpackV2WidgetScatterplotDefinitionArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionArgs(PowerpackV2WidgetScatterplotDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetScatterplotDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetScatterplotDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetScatterplotDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder request(@Nullable Output<PowerpackV2WidgetScatterplotDefinitionRequestArgs> request) {
            $.request = request;
            return this;
        }
         ...
         * 
         */
        public Builder request(PowerpackV2WidgetScatterplotDefinitionRequestArgs request) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetScatterplotDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetScatterplotDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder xaxis(@Nullable Output<PowerpackV2WidgetScatterplotDefinitionXaxisArgs> xaxis) {
            $.xaxis = xaxis;
            return this;
        }
         ...
         * 
         */
        public Builder xaxis(PowerpackV2WidgetScatterplotDefinitionXaxisArgs xaxis) {
         ...
         * 
         */
        public Builder yaxis(@Nullable Output<PowerpackV2WidgetScatterplotDefinitionYaxisArgs> yaxis) {
            $.yaxis = yaxis;
            return this;
        }
         ...
         * 
         */
        public Builder yaxis(PowerpackV2WidgetScatterplotDefinitionYaxisArgs yaxis) {
            return yaxis(Output.of(yaxis));
        }

        public PowerpackV2WidgetScatterplotDefinitionArgs build() {
            return $;
        }
    }
