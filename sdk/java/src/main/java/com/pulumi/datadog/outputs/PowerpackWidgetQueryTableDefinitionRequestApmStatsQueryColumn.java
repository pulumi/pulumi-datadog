...
public final class PowerpackWidgetQueryTableDefinitionRequestApmStatsQueryColumn {
    ...
    public static Builder builder(PowerpackWidgetQueryTableDefinitionRequestApmStatsQueryColumn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String order;
        public Builder() {}
        public Builder(PowerpackWidgetQueryTableDefinitionRequestApmStatsQueryColumn defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestApmStatsQueryColumn", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public PowerpackWidgetQueryTableDefinitionRequestApmStatsQueryColumn build() {
            final var _resultValue = new PowerpackWidgetQueryTableDefinitionRequestApmStatsQueryColumn();
