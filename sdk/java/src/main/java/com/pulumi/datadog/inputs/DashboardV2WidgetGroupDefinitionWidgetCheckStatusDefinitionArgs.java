...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs $) {
        this.check = $.check;
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs build() {
            if ($.check == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs", "check");
            }
            if ($.grouping == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetCheckStatusDefinitionArgs", "grouping");
            }
            return $;
        }
    }
