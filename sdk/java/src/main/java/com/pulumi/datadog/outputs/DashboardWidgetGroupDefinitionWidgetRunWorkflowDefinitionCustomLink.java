...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLink {
    private @Nullable Boolean isHidden;
    private @Nullable String label;
    private @Nullable String link;
    private @Nullable String overrideLabel;

    private DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLink() {}
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLink defaults) {
