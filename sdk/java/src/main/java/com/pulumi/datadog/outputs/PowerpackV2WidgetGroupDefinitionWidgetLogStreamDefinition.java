...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionSort;
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionSort sort;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinition() {}
    /**
     * @return Stringified list of columns to use, for example: `[&#34;column1&#34;,&#34;column2&#34;,&#34;column3&#34;]`.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionSort> sort() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder sort(@Nullable PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionSort sort) {

            this.sort = sort;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinitionTime time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetLogStreamDefinition();
