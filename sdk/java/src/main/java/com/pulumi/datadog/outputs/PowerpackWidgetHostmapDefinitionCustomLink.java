...
@CustomType
public final class PowerpackWidgetHostmapDefinitionCustomLink {
    /**
    ...
    private PowerpackWidgetHostmapDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetHostmapDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(PowerpackWidgetHostmapDefinitionCustomLink defaults) {
        ...
        public PowerpackWidgetHostmapDefinitionCustomLink build() {
            final var _resultValue = new PowerpackWidgetHostmapDefinitionCustomLink();
