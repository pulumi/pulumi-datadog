...
public final class DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs Empty = new DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs();
    ...
    private DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs() {}

    private DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs(DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
