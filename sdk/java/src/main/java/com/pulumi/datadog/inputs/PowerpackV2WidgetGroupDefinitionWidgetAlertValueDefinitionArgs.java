...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs build() {
            if ($.alertId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs", "alertId");
            }
            return $;
        }
    }
