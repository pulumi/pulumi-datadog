...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetTopologyMapDefinitionArgs build() {
            return $;
        }
    }
