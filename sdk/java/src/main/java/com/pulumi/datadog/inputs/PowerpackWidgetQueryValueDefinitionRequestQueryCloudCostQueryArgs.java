...
public final class PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs Empty = new PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs();
    ...
    private PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs() {}

    private PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs(PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs();
        }

        public Builder(PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs defaults) {
            $ = new PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs", "dataSource");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQueryArgs", "query");
            }
            return $;
        }
    }
