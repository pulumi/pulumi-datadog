...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendInlineArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendTableArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendInlineArgs> legendInline;

    /**
     * @return Used to configure the inline legend. Cannot be used in conjunction with legend*table.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendInlineArgs>> legendInline() {
    ...
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendTableArgs> legendTable;

    /**
     * @return Used to configure the table legend. Cannot be used in conjunction with legend*inline.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendTableArgs>> legendTable() {
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder legendInline(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendInlineArgs> legendInline) {
         ...
         * 
         */
        public Builder legendInline(DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendInlineArgs legendInline) {
         ...
         * 
         */
        public Builder legendTable(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendTableArgs> legendTable) {
         ...
         * 
         */
        public Builder legendTable(DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendTableArgs legendTable) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs build() {
            return $;
        }
    }
