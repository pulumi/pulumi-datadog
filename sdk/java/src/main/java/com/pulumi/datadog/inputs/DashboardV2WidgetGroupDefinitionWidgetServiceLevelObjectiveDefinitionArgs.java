...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs build() {
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs", "sloId");
            }
            if ($.timeWindows == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs", "timeWindows");
            }
            if ($.viewMode == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs", "viewMode");
            }
            if ($.viewType == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs", "viewType");
            }
            return $;
        }
    }
