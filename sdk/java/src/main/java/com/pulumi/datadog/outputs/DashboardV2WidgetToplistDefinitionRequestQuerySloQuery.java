...
@CustomType
public final class DashboardV2WidgetToplistDefinitionRequestQuerySloQuery {
    /**
    ...
    private DashboardV2WidgetToplistDefinitionRequestQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetToplistDefinitionRequestQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(DashboardV2WidgetToplistDefinitionRequestQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public DashboardV2WidgetToplistDefinitionRequestQuerySloQuery build() {
            final var _resultValue = new DashboardV2WidgetToplistDefinitionRequestQuerySloQuery();
