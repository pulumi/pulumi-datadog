...
public final class DashboardV2WidgetBarChartDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetBarChartDefinitionRequestProcessQueryArgs Empty = new DashboardV2WidgetBarChartDefinitionRequestProcessQueryArgs();
    ...
    private DashboardV2WidgetBarChartDefinitionRequestProcessQueryArgs() {}

    private DashboardV2WidgetBarChartDefinitionRequestProcessQueryArgs(DashboardV2WidgetBarChartDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetBarChartDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetBarChartDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardV2WidgetBarChartDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardV2WidgetBarChartDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetBarChartDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetBarChartDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
