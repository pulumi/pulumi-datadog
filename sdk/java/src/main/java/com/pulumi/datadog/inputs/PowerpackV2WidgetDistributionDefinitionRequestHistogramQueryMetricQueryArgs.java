...
public final class PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs Empty = new PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs() {}

    private PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs(PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
