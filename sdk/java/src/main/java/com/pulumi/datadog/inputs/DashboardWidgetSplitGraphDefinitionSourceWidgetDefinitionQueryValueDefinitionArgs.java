...
import com.pulumi.datadog.inputs.DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeseriesBackgroundArgs;
...
public final class DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs Empty = new DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `custom_link` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionRequestArgs>>> requests() {
    ...
    private @Nullable Output<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeseriesBackgroundArgs> timeseriesBackground;

    /**
     * @return Set a timeseries on the widget background.
     * 
     */
    public Optional<Output<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeseriesBackgroundArgs>> timeseriesBackground() {
    ...
    private DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs() {}

    private DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs(DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs $) {
    ...
    public static Builder builder(DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs();
        }

        public Builder(DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs defaults) {
            $ = new DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder timeseriesBackground(@Nullable Output<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeseriesBackgroundArgs> timeseriesBackground) {
         ...
         * 
         */
        public Builder timeseriesBackground(DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeseriesBackgroundArgs timeseriesBackground) {
        ...
        public DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs build() {
            return $;
        }
    }
