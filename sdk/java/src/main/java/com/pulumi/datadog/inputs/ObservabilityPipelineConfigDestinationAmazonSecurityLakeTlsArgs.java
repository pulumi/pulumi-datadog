...
public final class ObservabilityPipelineConfigDestinationAmazonSecurityLakeTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationAmazonSecurityLakeTlsArgs Empty = new ObservabilityPipelineConfigDestinationAmazonSecurityLakeTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationAmazonSecurityLakeTlsArgs() {}

    private ObservabilityPipelineConfigDestinationAmazonSecurityLakeTlsArgs(ObservabilityPipelineConfigDestinationAmazonSecurityLakeTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationAmazonSecurityLakeTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationAmazonSecurityLakeTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationAmazonSecurityLakeTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationAmazonSecurityLakeTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationAmazonSecurityLakeTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationAmazonSecurityLakeTlsArgs", "crtFile");
            }
            return $;
        }
    }
