...
public final class DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyleArgs Empty = new DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyleArgs();
    ...
    private DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyleArgs() {}

    private DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyleArgs(DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyleArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyleArgs();
        }

        public Builder(DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyleArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyleArgs build() {
            return $;
        }
    }
