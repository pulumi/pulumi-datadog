...
import com.pulumi.datadog.inputs.PowerpackV2WidgetBarChartDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetBarChartDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetBarChartDefinitionStyleArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetBarChartDefinitionTimeArgs;
...
public final class PowerpackV2WidgetBarChartDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetBarChartDefinitionArgs Empty = new PowerpackV2WidgetBarChartDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetBarChartDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetBarChartDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="request")
    private @Nullable Output<PowerpackV2WidgetBarChartDefinitionRequestArgs> request;

    /**
     * @return A nested block describing the request to use when displaying the widget.
     * 
     */
    public Optional<Output<PowerpackV2WidgetBarChartDefinitionRequestArgs>> request() {
     ...
     */
    @Import(name="style")
    private @Nullable Output<PowerpackV2WidgetBarChartDefinitionStyleArgs> style;

    /**
     * @return Style customization for the bar chart widget.
     * 
     */
    public Optional<Output<PowerpackV2WidgetBarChartDefinitionStyleArgs>> style() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetBarChartDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetBarChartDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetBarChartDefinitionArgs() {}

    private PowerpackV2WidgetBarChartDefinitionArgs(PowerpackV2WidgetBarChartDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetBarChartDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetBarChartDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetBarChartDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetBarChartDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetBarChartDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetBarChartDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetBarChartDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder request(@Nullable Output<PowerpackV2WidgetBarChartDefinitionRequestArgs> request) {
            $.request = request;
            return this;
        }
         ...
         * 
         */
        public Builder request(PowerpackV2WidgetBarChartDefinitionRequestArgs request) {
         ...
         * 
         */
        public Builder style(@Nullable Output<PowerpackV2WidgetBarChartDefinitionStyleArgs> style) {
            $.style = style;
            return this;
        }
         ...
         * 
         */
        public Builder style(PowerpackV2WidgetBarChartDefinitionStyleArgs style) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetBarChartDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetBarChartDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetBarChartDefinitionArgs build() {
            return $;
        }
    }
