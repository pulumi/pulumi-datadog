...
import com.pulumi.datadog.outputs.PowerpackV2WidgetFreeTextDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetFreeTextDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetFreeTextDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetFreeTextDefinition() {}
    /**
     * @return The background color of the text widget.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetFreeTextDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetFreeTextDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetFreeTextDefinition defaults) {
        ...
        public Builder text(String text) {
            if (text == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetFreeTextDefinition", "text");
            }
            this.text = text;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetFreeTextDefinitionTime time) {
        ...
        public PowerpackV2WidgetFreeTextDefinition build() {
            final var _resultValue = new PowerpackV2WidgetFreeTextDefinition();
