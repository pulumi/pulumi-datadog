...
public final class PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs Empty = new PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs(PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
