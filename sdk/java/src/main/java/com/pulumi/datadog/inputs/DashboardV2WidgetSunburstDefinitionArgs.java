...
import com.pulumi.datadog.inputs.DashboardV2WidgetSunburstDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetSunburstDefinitionLegendInlineArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetSunburstDefinitionLegendTableArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetSunburstDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetSunburstDefinitionTimeArgs;
...
public final class DashboardV2WidgetSunburstDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetSunburstDefinitionArgs Empty = new DashboardV2WidgetSunburstDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetSunburstDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetSunburstDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<DashboardV2WidgetSunburstDefinitionLegendInlineArgs> legendInline;

    /**
     * @return Used to configure the inline legend. Cannot be used in conjunction with legend*table.
     * 
     */
    public Optional<Output<DashboardV2WidgetSunburstDefinitionLegendInlineArgs>> legendInline() {
    ...
    private @Nullable Output<DashboardV2WidgetSunburstDefinitionLegendTableArgs> legendTable;

    /**
     * @return Used to configure the table legend. Cannot be used in conjunction with legend*inline.
     * 
     */
    public Optional<Output<DashboardV2WidgetSunburstDefinitionLegendTableArgs>> legendTable() {
    ...
    private @Nullable Output<List<DashboardV2WidgetSunburstDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetSunburstDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetSunburstDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetSunburstDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetSunburstDefinitionArgs() {}

    private DashboardV2WidgetSunburstDefinitionArgs(DashboardV2WidgetSunburstDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetSunburstDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetSunburstDefinitionArgs();
        }

        public Builder(DashboardV2WidgetSunburstDefinitionArgs defaults) {
            $ = new DashboardV2WidgetSunburstDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetSunburstDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetSunburstDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetSunburstDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder legendInline(@Nullable Output<DashboardV2WidgetSunburstDefinitionLegendInlineArgs> legendInline) {
         ...
         * 
         */
        public Builder legendInline(DashboardV2WidgetSunburstDefinitionLegendInlineArgs legendInline) {
         ...
         * 
         */
        public Builder legendTable(@Nullable Output<DashboardV2WidgetSunburstDefinitionLegendTableArgs> legendTable) {
         ...
         * 
         */
        public Builder legendTable(DashboardV2WidgetSunburstDefinitionLegendTableArgs legendTable) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetSunburstDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetSunburstDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetSunburstDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetSunburstDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetSunburstDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetSunburstDefinitionArgs build() {
            return $;
        }
    }
