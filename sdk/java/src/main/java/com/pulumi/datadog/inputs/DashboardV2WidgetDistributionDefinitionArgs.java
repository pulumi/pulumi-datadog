...
import com.pulumi.datadog.inputs.DashboardV2WidgetDistributionDefinitionMarkerArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetDistributionDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetDistributionDefinitionTimeArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetDistributionDefinitionXaxisArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetDistributionDefinitionYaxisArgs;
...
public final class DashboardV2WidgetDistributionDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetDistributionDefinitionArgs Empty = new DashboardV2WidgetDistributionDefinitionArgs();
     ...
     */
    @Import(name="markers")
    private @Nullable Output<List<DashboardV2WidgetDistributionDefinitionMarkerArgs>> markers;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetDistributionDefinitionMarkerArgs>>> markers() {
    ...
    private @Nullable Output<List<DashboardV2WidgetDistributionDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetDistributionDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetDistributionDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetDistributionDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="xaxis")
    private @Nullable Output<DashboardV2WidgetDistributionDefinitionXaxisArgs> xaxis;

    /**
     * @return A nested block describing the X-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<DashboardV2WidgetDistributionDefinitionXaxisArgs>> xaxis() {
     ...
     */
    @Import(name="yaxis")
    private @Nullable Output<DashboardV2WidgetDistributionDefinitionYaxisArgs> yaxis;

    /**
     * @return A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<DashboardV2WidgetDistributionDefinitionYaxisArgs>> yaxis() {
        return Optional.ofNullable(this.yaxis);
    }

    private DashboardV2WidgetDistributionDefinitionArgs() {}

    private DashboardV2WidgetDistributionDefinitionArgs(DashboardV2WidgetDistributionDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetDistributionDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetDistributionDefinitionArgs();
        }

        public Builder(DashboardV2WidgetDistributionDefinitionArgs defaults) {
            $ = new DashboardV2WidgetDistributionDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder markers(@Nullable Output<List<DashboardV2WidgetDistributionDefinitionMarkerArgs>> markers) {
            $.markers = markers;
            return this;
        }
         ...
         * 
         */
        public Builder markers(List<DashboardV2WidgetDistributionDefinitionMarkerArgs> markers) {
         ...
         * 
         */
        public Builder markers(DashboardV2WidgetDistributionDefinitionMarkerArgs... markers) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetDistributionDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetDistributionDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetDistributionDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetDistributionDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetDistributionDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder xaxis(@Nullable Output<DashboardV2WidgetDistributionDefinitionXaxisArgs> xaxis) {
            $.xaxis = xaxis;
            return this;
        }
         ...
         * 
         */
        public Builder xaxis(DashboardV2WidgetDistributionDefinitionXaxisArgs xaxis) {
         ...
         * 
         */
        public Builder yaxis(@Nullable Output<DashboardV2WidgetDistributionDefinitionYaxisArgs> yaxis) {
            $.yaxis = yaxis;
            return this;
        }
         ...
         * 
         */
        public Builder yaxis(DashboardV2WidgetDistributionDefinitionYaxisArgs yaxis) {
            return yaxis(Output.of(yaxis));
        }

        public DashboardV2WidgetDistributionDefinitionArgs build() {
            return $;
        }
    }
