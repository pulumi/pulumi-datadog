...
@CustomType
public final class DashboardV2WidgetQueryValueDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardV2WidgetQueryValueDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetQueryValueDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetQueryValueDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetQueryValueDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetQueryValueDefinitionRequestProcessQuery();
