...
@CustomType
public final class DashboardV2WidgetWidgetLayout {
    /**
    ...
    private DashboardV2WidgetWidgetLayout() {}
    /**
     * @return The height of the widget.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetWidgetLayout defaults) {
    ...
    public static final class Builder {
        ...
        private Integer y;
        public Builder() {}
        public Builder(DashboardV2WidgetWidgetLayout defaults) {
        ...
        public Builder height(Integer height) {
            if (height == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWidgetLayout", "height");
            }
            this.height = height;
            return this;
        }
        ...
        public Builder width(Integer width) {
            if (width == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWidgetLayout", "width");
            }
            this.width = width;
            return this;
        }
        ...
        public Builder x(Integer x) {
            if (x == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWidgetLayout", "x");
            }
            this.x = x;
            return this;
        }
        ...
        public Builder y(Integer y) {
            if (y == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWidgetLayout", "y");
            }
            this.y = y;
            return this;
        }
        public DashboardV2WidgetWidgetLayout build() {
            final var _resultValue = new DashboardV2WidgetWidgetLayout();
