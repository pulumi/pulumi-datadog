...
public final class ObservabilityPipelineConfigSourcesHttpClientTls {
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesHttpClientTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesHttpClientTls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesHttpClientTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesHttpClientTls();
