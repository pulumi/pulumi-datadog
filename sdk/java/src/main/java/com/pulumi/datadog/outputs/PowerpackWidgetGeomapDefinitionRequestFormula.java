...
@CustomType
public final class PowerpackWidgetGeomapDefinitionRequestFormula {
    /**
    ...
    private PowerpackWidgetGeomapDefinitionRequestFormula() {}
    /**
     * @return An expression alias.
     * 
     */
     ...
     * 
     */
    public List<PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormat> conditionalFormats() {
     ...
     * 
     */
    public Optional<PowerpackWidgetGeomapDefinitionRequestFormulaLimit> limit() {
     ...
     * 
     */
    public Optional<PowerpackWidgetGeomapDefinitionRequestFormulaStyle> style() {
    ...
    public static Builder builder(PowerpackWidgetGeomapDefinitionRequestFormula defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder conditionalFormats(@Nullable List<PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormat> conditionalFormats) {

            this.conditionalFormats = conditionalFormats;
            return this;
        }
        public Builder conditionalFormats(PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormat... conditionalFormats) {
            return conditionalFormats(List.of(conditionalFormats));
        }
        @CustomType.Setter
        public Builder formulaExpression(String formulaExpression) {
            if (formulaExpression == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestFormula", "formulaExpression");
            }
            this.formulaExpression = formulaExpression;
            return this;
        }
        @CustomType.Setter
        public Builder limit(@Nullable PowerpackWidgetGeomapDefinitionRequestFormulaLimit limit) {
        ...
        public PowerpackWidgetGeomapDefinitionRequestFormula build() {
            final var _resultValue = new PowerpackWidgetGeomapDefinitionRequestFormula();
