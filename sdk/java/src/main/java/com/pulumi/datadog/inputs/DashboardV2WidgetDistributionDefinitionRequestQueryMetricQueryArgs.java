...
public final class DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs Empty = new DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs() {}

    private DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs(DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
