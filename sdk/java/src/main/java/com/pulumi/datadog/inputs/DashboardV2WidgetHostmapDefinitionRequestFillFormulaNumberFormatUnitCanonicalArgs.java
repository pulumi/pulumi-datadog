...
public final class DashboardV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs Empty = new DashboardV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs();
    ...
    private DashboardV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs() {}

    private DashboardV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs(DashboardV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(DashboardV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new DashboardV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
