...
public final class DashboardWidgetHeatmapDefinitionYaxisArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetHeatmapDefinitionYaxisArgs Empty = new DashboardWidgetHeatmapDefinitionYaxisArgs();
    ...
    private DashboardWidgetHeatmapDefinitionYaxisArgs() {}

    private DashboardWidgetHeatmapDefinitionYaxisArgs(DashboardWidgetHeatmapDefinitionYaxisArgs $) {
    ...
    public static Builder builder(DashboardWidgetHeatmapDefinitionYaxisArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetHeatmapDefinitionYaxisArgs defaults) {
            $ = new DashboardWidgetHeatmapDefinitionYaxisArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetHeatmapDefinitionYaxisArgs build() {
            return $;
        }
    }
