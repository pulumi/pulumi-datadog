...
@CustomType
public final class PowerpackWidgetHostmapDefinitionRequestSizeProcessQuery {
    /**
    ...
    private PowerpackWidgetHostmapDefinitionRequestSizeProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetHostmapDefinitionRequestSizeProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackWidgetHostmapDefinitionRequestSizeProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetHostmapDefinitionRequestSizeProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackWidgetHostmapDefinitionRequestSizeProcessQuery build() {
            final var _resultValue = new PowerpackWidgetHostmapDefinitionRequestSizeProcessQuery();
