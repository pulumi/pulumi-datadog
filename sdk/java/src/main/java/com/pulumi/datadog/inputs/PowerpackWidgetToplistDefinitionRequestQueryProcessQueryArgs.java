...
public final class PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs Empty = new PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs();
    ...
    private PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs() {}

    private PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs(PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
