...
@CustomType
public final class ObservabilityPipelineConfigSourceSocketTls {
    /**
    ...
    private ObservabilityPipelineConfigSourceSocketTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceSocketTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceSocketTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceSocketTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceSocketTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceSocketTls();
