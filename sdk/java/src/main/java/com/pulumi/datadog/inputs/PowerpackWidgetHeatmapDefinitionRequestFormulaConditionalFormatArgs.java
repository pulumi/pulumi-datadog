...
public final class PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs(PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
