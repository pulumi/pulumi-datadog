...
@CustomType
public final class PowerpackV2WidgetTimeseriesDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackV2WidgetTimeseriesDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetTimeseriesDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetTimeseriesDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetTimeseriesDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetTimeseriesDefinitionRequestProcessQuery();
