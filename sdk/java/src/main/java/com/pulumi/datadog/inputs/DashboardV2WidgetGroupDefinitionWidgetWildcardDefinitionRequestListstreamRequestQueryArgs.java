...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs>> groupBies;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs>>> groupBies() {
     ...
     */
    @Import(name="sort")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs> sort;

    /**
     * @return The facet and order to sort the data, for example: `{&#34;column&#34;: &#34;time&#34;, &#34;order&#34;: &#34;desc&#34;}`.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs>> sort() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryArgs(DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder groupBies(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs>> groupBies) {
            $.groupBies = groupBies;
            return this;
        }
         ...
         * 
         */
        public Builder groupBies(List<DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs> groupBies) {
         ...
         * 
         */
        public Builder groupBies(DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs... groupBies) {
         ...
         * 
         */
        public Builder sort(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs> sort) {
            $.sort = sort;
            return this;
        }
         ...
         * 
         */
        public Builder sort(DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs sort) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryArgs", "dataSource");
            }
            return $;
        }
    }
