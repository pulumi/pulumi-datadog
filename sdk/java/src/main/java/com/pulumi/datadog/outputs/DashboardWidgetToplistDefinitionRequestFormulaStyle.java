...
public final class DashboardWidgetToplistDefinitionRequestFormulaStyle {
    ...
    public static Builder builder(DashboardWidgetToplistDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(DashboardWidgetToplistDefinitionRequestFormulaStyle defaults) {
        ...
        public DashboardWidgetToplistDefinitionRequestFormulaStyle build() {
            final var _resultValue = new DashboardWidgetToplistDefinitionRequestFormulaStyle();
