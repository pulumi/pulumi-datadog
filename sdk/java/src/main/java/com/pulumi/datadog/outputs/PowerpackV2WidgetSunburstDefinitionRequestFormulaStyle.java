...
@CustomType
public final class PowerpackV2WidgetSunburstDefinitionRequestFormulaStyle {
    /**
    ...
    private PowerpackV2WidgetSunburstDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetSunburstDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackV2WidgetSunburstDefinitionRequestFormulaStyle defaults) {
        ...
        public PowerpackV2WidgetSunburstDefinitionRequestFormulaStyle build() {
            final var _resultValue = new PowerpackV2WidgetSunburstDefinitionRequestFormulaStyle();
