...
@CustomType
public final class DashboardWidgetHostmapDefinitionRequestFillProcessQuery {
    /**
    ...
    private DashboardWidgetHostmapDefinitionRequestFillProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetHostmapDefinitionRequestFillProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetHostmapDefinitionRequestFillProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetHostmapDefinitionRequestFillProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardWidgetHostmapDefinitionRequestFillProcessQuery build() {
            final var _resultValue = new DashboardWidgetHostmapDefinitionRequestFillProcessQuery();
