...
@CustomType
public final class ObservabilityPipelineConfigSourceAmazonS3Tls {
    /**
    ...
    private ObservabilityPipelineConfigSourceAmazonS3Tls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceAmazonS3Tls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceAmazonS3Tls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceAmazonS3Tls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceAmazonS3Tls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceAmazonS3Tls();
