...
@CustomType
public final class ObservabilityPipelineConfigDestinationSplunkHecMetricsTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationSplunkHecMetricsTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationSplunkHecMetricsTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyPassKey;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationSplunkHecMetricsTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationSplunkHecMetricsTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigDestinationSplunkHecMetricsTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationSplunkHecMetricsTls();
