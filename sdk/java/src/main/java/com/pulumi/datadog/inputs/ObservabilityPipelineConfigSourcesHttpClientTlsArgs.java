...
public final class ObservabilityPipelineConfigSourcesHttpClientTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcesHttpClientTlsArgs Empty = new ObservabilityPipelineConfigSourcesHttpClientTlsArgs();
    ...
    private ObservabilityPipelineConfigSourcesHttpClientTlsArgs() {}

    private ObservabilityPipelineConfigSourcesHttpClientTlsArgs(ObservabilityPipelineConfigSourcesHttpClientTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesHttpClientTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcesHttpClientTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcesHttpClientTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcesHttpClientTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcesHttpClientTlsArgs build() {
            return $;
        }
    }
