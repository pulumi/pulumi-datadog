...
import com.pulumi.datadog.inputs.DashboardV2WidgetManageStatusDefinitionTimeArgs;
...
public final class DashboardV2WidgetManageStatusDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetManageStatusDefinitionArgs Empty = new DashboardV2WidgetManageStatusDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetManageStatusDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetManageStatusDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetManageStatusDefinitionArgs() {}

    private DashboardV2WidgetManageStatusDefinitionArgs(DashboardV2WidgetManageStatusDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetManageStatusDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetManageStatusDefinitionArgs();
        }

        public Builder(DashboardV2WidgetManageStatusDefinitionArgs defaults) {
            $ = new DashboardV2WidgetManageStatusDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetManageStatusDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetManageStatusDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetManageStatusDefinitionArgs build() {
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetManageStatusDefinitionArgs", "query");
            }
            return $;
        }
    }
