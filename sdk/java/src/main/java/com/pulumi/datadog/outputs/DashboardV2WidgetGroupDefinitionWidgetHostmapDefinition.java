...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionStyle;
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetHostmapDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequest request;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionStyle style;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionTime time;
    /**
     ...
     * 
     */
    public List<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequest> request() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionStyle> style() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder request(@Nullable DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequest request) {
        ...
        @CustomType.Setter
        public Builder style(@Nullable DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionStyle style) {

            this.style = style;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionTime time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetHostmapDefinition build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetHostmapDefinition();
