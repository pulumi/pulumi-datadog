...
public final class PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs Empty = new PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs();
    ...
    private PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs() {}

    private PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs(PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
