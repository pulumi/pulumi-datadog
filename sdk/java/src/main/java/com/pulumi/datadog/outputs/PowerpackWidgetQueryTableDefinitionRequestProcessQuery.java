...
@CustomType
public final class PowerpackWidgetQueryTableDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackWidgetQueryTableDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetQueryTableDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackWidgetQueryTableDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackWidgetQueryTableDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackWidgetQueryTableDefinitionRequestProcessQuery();
