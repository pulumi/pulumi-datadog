...
import com.pulumi.datadog.inputs.DashboardV2WidgetGeomapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGeomapDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGeomapDefinitionStyleArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGeomapDefinitionTimeArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGeomapDefinitionViewArgs;
...
public final class DashboardV2WidgetGeomapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGeomapDefinitionArgs Empty = new DashboardV2WidgetGeomapDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetGeomapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGeomapDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<DashboardV2WidgetGeomapDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGeomapDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="style")
    private @Nullable Output<DashboardV2WidgetGeomapDefinitionStyleArgs> style;

    /**
     * @return The style of the widget graph. One nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<DashboardV2WidgetGeomapDefinitionStyleArgs>> style() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGeomapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGeomapDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="view")
    private @Nullable Output<DashboardV2WidgetGeomapDefinitionViewArgs> view;

    /**
     * @return The view of the world that the map should render.
     * 
     */
    public Optional<Output<DashboardV2WidgetGeomapDefinitionViewArgs>> view() {
        return Optional.ofNullable(this.view);
    }

    private DashboardV2WidgetGeomapDefinitionArgs() {}

    private DashboardV2WidgetGeomapDefinitionArgs(DashboardV2WidgetGeomapDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGeomapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGeomapDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGeomapDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGeomapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetGeomapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetGeomapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetGeomapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetGeomapDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetGeomapDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetGeomapDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder style(@Nullable Output<DashboardV2WidgetGeomapDefinitionStyleArgs> style) {
            $.style = style;
            return this;
        }
         ...
         * 
         */
        public Builder style(DashboardV2WidgetGeomapDefinitionStyleArgs style) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGeomapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGeomapDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder view(@Nullable Output<DashboardV2WidgetGeomapDefinitionViewArgs> view) {
            $.view = view;
            return this;
        }
         ...
         * 
         */
        public Builder view(DashboardV2WidgetGeomapDefinitionViewArgs view) {
            return view(Output.of(view));
        }

        public DashboardV2WidgetGeomapDefinitionArgs build() {
            return $;
        }
    }
