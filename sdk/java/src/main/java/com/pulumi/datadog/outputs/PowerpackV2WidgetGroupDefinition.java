...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionTime;
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidget;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionTime time;
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetGroupDefinitionWidget> widgets;

    private PowerpackV2WidgetGroupDefinition() {}
    /**
     * @return The background color of the group title, options: `vividBlue`, `vividPurple`, `vividPink`, `vividOrange`, `vividYellow`, `vividGreen`, `blue`, `purple`, `pink`, `orange`, `yellow`, `green`, `gray` or `white`
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionTime> time() {
     ...
     * 
     */
    public List<PowerpackV2WidgetGroupDefinitionWidget> widgets() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<PowerpackV2WidgetGroupDefinitionWidget> widgets;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinition defaults) {
        ...
        public Builder layoutType(String layoutType) {
            if (layoutType == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinition", "layoutType");
            }
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionTime time) {
        ...
        @CustomType.Setter
        public Builder widgets(@Nullable List<PowerpackV2WidgetGroupDefinitionWidget> widgets) {

            this.widgets = widgets;
            return this;
        }
        public Builder widgets(PowerpackV2WidgetGroupDefinitionWidget... widgets) {
            return widgets(List.of(widgets));
        }
        public PowerpackV2WidgetGroupDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinition();
