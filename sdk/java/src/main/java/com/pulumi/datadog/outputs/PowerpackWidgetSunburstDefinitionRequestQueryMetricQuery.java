...
@CustomType
public final class PowerpackWidgetSunburstDefinitionRequestQueryMetricQuery {
    /**
    ...
    private PowerpackWidgetSunburstDefinitionRequestQueryMetricQuery() {}
    /**
     * @return The aggregation methods available for metrics queries. Valid values are `avg`, `min`, `max`, `sum`, `last`, `area`, `l2norm`, `percentile`.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetSunburstDefinitionRequestQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(PowerpackWidgetSunburstDefinitionRequestQueryMetricQuery defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
        public PowerpackWidgetSunburstDefinitionRequestQueryMetricQuery build() {
            final var _resultValue = new PowerpackWidgetSunburstDefinitionRequestQueryMetricQuery();
