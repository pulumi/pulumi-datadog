...
public final class LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs extends com.pulumi.resources.ResourceArgs {

    public static final LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs Empty = new LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs();
    ...
    private LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs() {}

    private LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs(LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs $) {
        this.name = $.name;
    ...
    public static Builder builder(LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs();
        }

        public Builder(LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs defaults) {
            $ = new LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs", "name");
            }
            if ($.sources == null) {
                throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs", "sources");
            }
            if ($.target == null) {
                throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapperArgs", "target");
            }
            return $;
        }
    }
