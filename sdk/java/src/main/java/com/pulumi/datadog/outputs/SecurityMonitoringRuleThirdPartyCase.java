...
public final class SecurityMonitoringRuleThirdPartyCase {
    ...
    public static Builder builder(SecurityMonitoringRuleThirdPartyCase defaults) {
    ...
    public static final class Builder {
        ...
        private String status;
        public Builder() {}
        public Builder(SecurityMonitoringRuleThirdPartyCase defaults) {
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("SecurityMonitoringRuleThirdPartyCase", "status");
            }
            this.status = status;
            return this;
        }
        public SecurityMonitoringRuleThirdPartyCase build() {
            final var _resultValue = new SecurityMonitoringRuleThirdPartyCase();
