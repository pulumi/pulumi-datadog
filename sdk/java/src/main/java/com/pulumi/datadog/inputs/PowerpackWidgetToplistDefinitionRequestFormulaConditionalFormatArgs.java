...
public final class PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs(PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
