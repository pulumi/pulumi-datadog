...
public final class DashboardWidgetHeatmapDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetHeatmapDefinitionRequestProcessQueryArgs Empty = new DashboardWidgetHeatmapDefinitionRequestProcessQueryArgs();
    ...
    private DashboardWidgetHeatmapDefinitionRequestProcessQueryArgs() {}

    private DashboardWidgetHeatmapDefinitionRequestProcessQueryArgs(DashboardWidgetHeatmapDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetHeatmapDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetHeatmapDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardWidgetHeatmapDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardWidgetHeatmapDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetHeatmapDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
