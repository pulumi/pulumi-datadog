...
public final class DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs Empty = new DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs();
    ...
    private DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs() {}

    private DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs(DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
