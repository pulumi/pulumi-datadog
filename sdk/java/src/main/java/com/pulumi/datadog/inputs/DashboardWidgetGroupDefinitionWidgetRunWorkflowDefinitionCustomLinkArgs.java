...
public final class DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs Empty = new DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs();
    ...
    private DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs() {}

    private DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs(DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs();
        }

        public Builder(DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs build() {
            return $;
        }
    }
