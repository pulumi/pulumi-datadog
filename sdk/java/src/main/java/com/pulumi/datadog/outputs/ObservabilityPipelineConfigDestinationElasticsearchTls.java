...
@CustomType
public final class ObservabilityPipelineConfigDestinationElasticsearchTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationElasticsearchTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationElasticsearchTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyPassKey;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationElasticsearchTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationElasticsearchTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigDestinationElasticsearchTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationElasticsearchTls();
