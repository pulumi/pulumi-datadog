...
public final class DashboardWidgetQueryValueDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetQueryValueDefinitionRequestProcessQueryArgs Empty = new DashboardWidgetQueryValueDefinitionRequestProcessQueryArgs();
    ...
    private DashboardWidgetQueryValueDefinitionRequestProcessQueryArgs() {}

    private DashboardWidgetQueryValueDefinitionRequestProcessQueryArgs(DashboardWidgetQueryValueDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetQueryValueDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetQueryValueDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardWidgetQueryValueDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardWidgetQueryValueDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetQueryValueDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
