...
public final class PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs Empty = new PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs();
    ...
    private PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs() {}

    private PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs(PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
