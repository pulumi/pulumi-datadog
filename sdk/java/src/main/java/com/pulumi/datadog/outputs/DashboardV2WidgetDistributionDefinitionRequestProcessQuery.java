...
@CustomType
public final class DashboardV2WidgetDistributionDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardV2WidgetDistributionDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetDistributionDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetDistributionDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetDistributionDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetDistributionDefinitionRequestProcessQuery();
