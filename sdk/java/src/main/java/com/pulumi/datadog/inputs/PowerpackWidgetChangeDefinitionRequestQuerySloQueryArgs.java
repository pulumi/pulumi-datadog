...
public final class PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs Empty = new PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs(PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
