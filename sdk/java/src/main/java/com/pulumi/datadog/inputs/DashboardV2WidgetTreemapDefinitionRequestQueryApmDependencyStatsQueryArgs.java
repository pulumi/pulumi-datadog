...
public final class DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs Empty = new DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs();
    ...
    private DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs() {}

    private DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs(DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs();
        }

        public Builder(DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
            $ = new DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
