...
import com.pulumi.datadog.outputs.DashboardV2WidgetProductAnalyticsFunnelDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetProductAnalyticsFunnelDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetProductAnalyticsFunnelDefinition {
    /**
     ...
     * 
     */
    private List<DashboardV2WidgetProductAnalyticsFunnelDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetProductAnalyticsFunnelDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetProductAnalyticsFunnelDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<DashboardV2WidgetProductAnalyticsFunnelDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetProductAnalyticsFunnelDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetProductAnalyticsFunnelDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetProductAnalyticsFunnelDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder requests(List<DashboardV2WidgetProductAnalyticsFunnelDefinitionRequest> requests) {
            if (requests == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetProductAnalyticsFunnelDefinition", "requests");
            }
            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetProductAnalyticsFunnelDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetProductAnalyticsFunnelDefinitionTime time) {
        ...
        public DashboardV2WidgetProductAnalyticsFunnelDefinition build() {
            final var _resultValue = new DashboardV2WidgetProductAnalyticsFunnelDefinition();
