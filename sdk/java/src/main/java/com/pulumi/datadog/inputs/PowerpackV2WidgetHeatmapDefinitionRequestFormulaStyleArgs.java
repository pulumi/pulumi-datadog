...
public final class PowerpackV2WidgetHeatmapDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHeatmapDefinitionRequestFormulaStyleArgs Empty = new PowerpackV2WidgetHeatmapDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackV2WidgetHeatmapDefinitionRequestFormulaStyleArgs() {}

    private PowerpackV2WidgetHeatmapDefinitionRequestFormulaStyleArgs(PowerpackV2WidgetHeatmapDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHeatmapDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHeatmapDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetHeatmapDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetHeatmapDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHeatmapDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
