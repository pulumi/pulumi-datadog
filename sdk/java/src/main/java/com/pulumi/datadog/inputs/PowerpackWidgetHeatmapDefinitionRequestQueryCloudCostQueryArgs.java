...
public final class PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs Empty = new PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs();
    ...
    private PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs() {}

    private PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs(PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs();
        }

        public Builder(PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs defaults) {
            $ = new PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs", "dataSource");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetHeatmapDefinitionRequestQueryCloudCostQueryArgs", "query");
            }
            return $;
        }
    }
