 ...
 *             .compute(com.pulumi.datadog.inputs.RumMetricComputeArgs.builder()
 *                 .aggregationType("distribution")
 *                 .includePercentiles(true)
 *                 .path("}{@literal @}{@code duration")
 *                 .build())
 *             .eventType("session")
 *             .filter(com.pulumi.datadog.inputs.RumMetricFilterArgs.builder()
 ...
 *                 .build())
 *             .uniqueness(com.pulumi.datadog.inputs.RumMetricUniquenessArgs.builder()
 *                 .when("match")
 *                 .build())
 *             .build());
 * 
