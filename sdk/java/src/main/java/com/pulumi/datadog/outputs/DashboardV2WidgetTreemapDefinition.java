...
import com.pulumi.datadog.outputs.DashboardV2WidgetTreemapDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardV2WidgetTreemapDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetTreemapDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetTreemapDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardV2WidgetTreemapDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetTreemapDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetTreemapDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetTreemapDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<DashboardV2WidgetTreemapDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<DashboardV2WidgetTreemapDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetTreemapDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetTreemapDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetTreemapDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardV2WidgetTreemapDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardV2WidgetTreemapDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<DashboardV2WidgetTreemapDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetTreemapDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetTreemapDefinitionTime time) {
        ...
        public DashboardV2WidgetTreemapDefinition build() {
            final var _resultValue = new DashboardV2WidgetTreemapDefinition();
