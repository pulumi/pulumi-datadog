...
@CustomType
public final class ObservabilityPipelineConfigSourceGooglePubsubTls {
    /**
    ...
    private ObservabilityPipelineConfigSourceGooglePubsubTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceGooglePubsubTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceGooglePubsubTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceGooglePubsubTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceGooglePubsubTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceGooglePubsubTls();
