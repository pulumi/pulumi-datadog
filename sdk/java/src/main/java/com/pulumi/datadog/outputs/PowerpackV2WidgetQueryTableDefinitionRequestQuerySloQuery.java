...
@CustomType
public final class PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQuery {
    /**
    ...
    private PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQuery build() {
            final var _resultValue = new PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQuery();
