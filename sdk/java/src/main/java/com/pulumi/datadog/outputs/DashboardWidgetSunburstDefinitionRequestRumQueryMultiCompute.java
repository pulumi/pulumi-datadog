...
@CustomType
public final class DashboardWidgetSunburstDefinitionRequestRumQueryMultiCompute {
    /**
    ...
    private DashboardWidgetSunburstDefinitionRequestRumQueryMultiCompute() {}
    /**
     * @return The aggregation method.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetSunburstDefinitionRequestRumQueryMultiCompute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer interval;
        public Builder() {}
        public Builder(DashboardWidgetSunburstDefinitionRequestRumQueryMultiCompute defaults) {
        ...
        public Builder aggregation(String aggregation) {
            if (aggregation == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestRumQueryMultiCompute", "aggregation");
            }
