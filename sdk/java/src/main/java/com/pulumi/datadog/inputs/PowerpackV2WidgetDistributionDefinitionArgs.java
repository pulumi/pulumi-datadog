...
import com.pulumi.datadog.inputs.PowerpackV2WidgetDistributionDefinitionMarkerArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetDistributionDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetDistributionDefinitionTimeArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetDistributionDefinitionXaxisArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetDistributionDefinitionYaxisArgs;
...
public final class PowerpackV2WidgetDistributionDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetDistributionDefinitionArgs Empty = new PowerpackV2WidgetDistributionDefinitionArgs();
     ...
     */
    @Import(name="markers")
    private @Nullable Output<List<PowerpackV2WidgetDistributionDefinitionMarkerArgs>> markers;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetDistributionDefinitionMarkerArgs>>> markers() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetDistributionDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetDistributionDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetDistributionDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetDistributionDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="xaxis")
    private @Nullable Output<PowerpackV2WidgetDistributionDefinitionXaxisArgs> xaxis;

    /**
     * @return A nested block describing the X-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<PowerpackV2WidgetDistributionDefinitionXaxisArgs>> xaxis() {
     ...
     */
    @Import(name="yaxis")
    private @Nullable Output<PowerpackV2WidgetDistributionDefinitionYaxisArgs> yaxis;

    /**
     * @return A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<PowerpackV2WidgetDistributionDefinitionYaxisArgs>> yaxis() {
        return Optional.ofNullable(this.yaxis);
    }

    private PowerpackV2WidgetDistributionDefinitionArgs() {}

    private PowerpackV2WidgetDistributionDefinitionArgs(PowerpackV2WidgetDistributionDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetDistributionDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetDistributionDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetDistributionDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetDistributionDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder markers(@Nullable Output<List<PowerpackV2WidgetDistributionDefinitionMarkerArgs>> markers) {
            $.markers = markers;
            return this;
        }
         ...
         * 
         */
        public Builder markers(List<PowerpackV2WidgetDistributionDefinitionMarkerArgs> markers) {
         ...
         * 
         */
        public Builder markers(PowerpackV2WidgetDistributionDefinitionMarkerArgs... markers) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetDistributionDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetDistributionDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetDistributionDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetDistributionDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetDistributionDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder xaxis(@Nullable Output<PowerpackV2WidgetDistributionDefinitionXaxisArgs> xaxis) {
            $.xaxis = xaxis;
            return this;
        }
         ...
         * 
         */
        public Builder xaxis(PowerpackV2WidgetDistributionDefinitionXaxisArgs xaxis) {
         ...
         * 
         */
        public Builder yaxis(@Nullable Output<PowerpackV2WidgetDistributionDefinitionYaxisArgs> yaxis) {
            $.yaxis = yaxis;
            return this;
        }
         ...
         * 
         */
        public Builder yaxis(PowerpackV2WidgetDistributionDefinitionYaxisArgs yaxis) {
            return yaxis(Output.of(yaxis));
        }

        public PowerpackV2WidgetDistributionDefinitionArgs build() {
            return $;
        }
    }
