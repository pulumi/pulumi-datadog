...
import com.pulumi.datadog.inputs.PowerpackWidgetLogStreamDefinitionSortArgs;
...
public final class PowerpackWidgetLogStreamDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetLogStreamDefinitionArgs Empty = new PowerpackWidgetLogStreamDefinitionArgs();
     ...
     */
    @Import(name="sort")
    private @Nullable Output<PowerpackWidgetLogStreamDefinitionSortArgs> sort;

    /**
     * @return The facet and order to sort the data, for example: `{&#34;column&#34;: &#34;time&#34;, &#34;order&#34;: &#34;desc&#34;}`.
     * 
     */
    public Optional<Output<PowerpackWidgetLogStreamDefinitionSortArgs>> sort() {
    ...
    private PowerpackWidgetLogStreamDefinitionArgs() {}
    ...
    public static Builder builder(PowerpackWidgetLogStreamDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetLogStreamDefinitionArgs();
        }

        public Builder(PowerpackWidgetLogStreamDefinitionArgs defaults) {
            $ = new PowerpackWidgetLogStreamDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sort(@Nullable Output<PowerpackWidgetLogStreamDefinitionSortArgs> sort) {
            $.sort = sort;
            return this;
        }
         ...
         * 
         */
        public Builder sort(PowerpackWidgetLogStreamDefinitionSortArgs sort) {
        ...
        public PowerpackWidgetLogStreamDefinitionArgs build() {
            return $;
        }
    }
