...
public final class ObservabilityPipelineConfigSourceAmazonS3TlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceAmazonS3TlsArgs Empty = new ObservabilityPipelineConfigSourceAmazonS3TlsArgs();
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceAmazonS3TlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceAmazonS3TlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceAmazonS3TlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceAmazonS3TlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceAmazonS3TlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceAmazonS3TlsArgs", "crtFile");
            }
            return $;
        }
    }
