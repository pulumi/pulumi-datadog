...
import com.pulumi.datadog.inputs.PowerpackV2WidgetListStreamDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetListStreamDefinitionTimeArgs;
...
public final class PowerpackV2WidgetListStreamDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetListStreamDefinitionArgs Empty = new PowerpackV2WidgetListStreamDefinitionArgs();
    ...
    private Output<List<PowerpackV2WidgetListStreamDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Output<List<PowerpackV2WidgetListStreamDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetListStreamDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetListStreamDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetListStreamDefinitionArgs() {}

    private PowerpackV2WidgetListStreamDefinitionArgs(PowerpackV2WidgetListStreamDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetListStreamDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetListStreamDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetListStreamDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetListStreamDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<PowerpackV2WidgetListStreamDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetListStreamDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetListStreamDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetListStreamDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetListStreamDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetListStreamDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetListStreamDefinitionArgs", "requests");
            }
            return $;
        }
    }
