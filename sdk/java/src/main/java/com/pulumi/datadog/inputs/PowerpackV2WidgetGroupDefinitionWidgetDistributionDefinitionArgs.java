...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionMarkerArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionTimeArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionXaxisArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionYaxisArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs();
     ...
     */
    @Import(name="markers")
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionMarkerArgs>> markers;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionMarkerArgs>>> markers() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="xaxis")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionXaxisArgs> xaxis;

    /**
     * @return A nested block describing the X-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionXaxisArgs>> xaxis() {
     ...
     */
    @Import(name="yaxis")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionYaxisArgs> yaxis;

    /**
     * @return A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionYaxisArgs>> yaxis() {
        return Optional.ofNullable(this.yaxis);
    }

    private PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param markers A nested block describing the marker to use when displaying the widget. The structure of this block is described below. Multiple `marker` blocks are allowed within a given `distributionDefinition` block.
         * 
         * @return builder
         * 
         */
        public Builder markers(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionMarkerArgs>> markers) {
            $.markers = markers;
            return this;
        }
         ...
         * 
         */
        public Builder markers(List<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionMarkerArgs> markers) {
         ...
         * 
         */
        public Builder markers(PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionMarkerArgs... markers) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder xaxis(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionXaxisArgs> xaxis) {
            $.xaxis = xaxis;
            return this;
        }
         ...
         * 
         */
        public Builder xaxis(PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionXaxisArgs xaxis) {
         ...
         * 
         */
        public Builder yaxis(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionYaxisArgs> yaxis) {
            $.yaxis = yaxis;
            return this;
        }
         ...
         * 
         */
        public Builder yaxis(PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionYaxisArgs yaxis) {
            return yaxis(Output.of(yaxis));
        }

        public PowerpackV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs build() {
            return $;
        }
    }
