...
public final class PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs Empty = new PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs();
    ...
    private PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs() {}

    private PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs(PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs();
        }

        public Builder(PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs defaults) {
            $ = new PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
