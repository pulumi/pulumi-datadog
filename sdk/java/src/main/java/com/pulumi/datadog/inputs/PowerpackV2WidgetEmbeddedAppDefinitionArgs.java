...
import com.pulumi.datadog.inputs.PowerpackV2WidgetEmbeddedAppDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetEmbeddedAppDefinitionInputArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetEmbeddedAppDefinitionTimeArgs;
...
public final class PowerpackV2WidgetEmbeddedAppDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetEmbeddedAppDefinitionArgs Empty = new PowerpackV2WidgetEmbeddedAppDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetEmbeddedAppDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetEmbeddedAppDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="inputs")
    private @Nullable Output<List<PowerpackV2WidgetEmbeddedAppDefinitionInputArgs>> inputs;

    /**
     * @return A nested block describing an input passed to the embedded app. Multiple `input` blocks are allowed.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetEmbeddedAppDefinitionInputArgs>>> inputs() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetEmbeddedAppDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetEmbeddedAppDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetEmbeddedAppDefinitionArgs() {}

    private PowerpackV2WidgetEmbeddedAppDefinitionArgs(PowerpackV2WidgetEmbeddedAppDefinitionArgs $) {
        this.appId = $.appId;
    ...
    public static Builder builder(PowerpackV2WidgetEmbeddedAppDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetEmbeddedAppDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetEmbeddedAppDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetEmbeddedAppDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetEmbeddedAppDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetEmbeddedAppDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetEmbeddedAppDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder inputs(@Nullable Output<List<PowerpackV2WidgetEmbeddedAppDefinitionInputArgs>> inputs) {
            $.inputs = inputs;
            return this;
        }
         ...
         * 
         */
        public Builder inputs(List<PowerpackV2WidgetEmbeddedAppDefinitionInputArgs> inputs) {
         ...
         * 
         */
        public Builder inputs(PowerpackV2WidgetEmbeddedAppDefinitionInputArgs... inputs) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetEmbeddedAppDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetEmbeddedAppDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetEmbeddedAppDefinitionArgs build() {
            return $;
        }
    }
