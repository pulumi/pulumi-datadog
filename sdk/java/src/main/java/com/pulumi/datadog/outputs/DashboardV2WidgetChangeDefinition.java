...
import com.pulumi.datadog.outputs.DashboardV2WidgetChangeDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardV2WidgetChangeDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetChangeDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetChangeDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardV2WidgetChangeDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetChangeDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetChangeDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetChangeDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<DashboardV2WidgetChangeDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<DashboardV2WidgetChangeDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetChangeDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetChangeDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetChangeDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardV2WidgetChangeDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardV2WidgetChangeDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<DashboardV2WidgetChangeDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetChangeDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetChangeDefinitionTime time) {
        ...
        public DashboardV2WidgetChangeDefinition build() {
            final var _resultValue = new DashboardV2WidgetChangeDefinition();
