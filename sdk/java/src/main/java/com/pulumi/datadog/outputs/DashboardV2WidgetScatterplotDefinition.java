...
import com.pulumi.datadog.outputs.DashboardV2WidgetScatterplotDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardV2WidgetScatterplotDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetScatterplotDefinitionTime;
import com.pulumi.datadog.outputs.DashboardV2WidgetScatterplotDefinitionXaxis;
import com.pulumi.datadog.outputs.DashboardV2WidgetScatterplotDefinitionYaxis;
...
@CustomType
public final class DashboardV2WidgetScatterplotDefinition {
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetScatterplotDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetScatterplotDefinitionRequest request;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetScatterplotDefinitionTime time;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetScatterplotDefinitionXaxis xaxis;
    /**
     * @return A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    private @Nullable DashboardV2WidgetScatterplotDefinitionYaxis yaxis;

    private DashboardV2WidgetScatterplotDefinition() {}
    /**
     * @return List of groups used for colors.
     * 
     */
     ...
     * 
     */
    public List<DashboardV2WidgetScatterplotDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetScatterplotDefinitionRequest> request() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetScatterplotDefinitionTime> time() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetScatterplotDefinitionXaxis> xaxis() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetScatterplotDefinitionYaxis> yaxis() {
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable DashboardV2WidgetScatterplotDefinitionYaxis yaxis;
        public Builder() {}
        public Builder(DashboardV2WidgetScatterplotDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardV2WidgetScatterplotDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardV2WidgetScatterplotDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder request(@Nullable DashboardV2WidgetScatterplotDefinitionRequest request) {

            this.request = request;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetScatterplotDefinitionTime time) {
        ...
        @CustomType.Setter
        public Builder xaxis(@Nullable DashboardV2WidgetScatterplotDefinitionXaxis xaxis) {

            this.xaxis = xaxis;
            return this;
        }
        @CustomType.Setter
        public Builder yaxis(@Nullable DashboardV2WidgetScatterplotDefinitionYaxis yaxis) {

            this.yaxis = yaxis;
            return this;
        }
        public DashboardV2WidgetScatterplotDefinition build() {
            final var _resultValue = new DashboardV2WidgetScatterplotDefinition();
