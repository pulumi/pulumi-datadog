...
import com.pulumi.datadog.inputs.PowerpackV2WidgetSloListDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetSloListDefinitionTimeArgs;
...
public final class PowerpackV2WidgetSloListDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetSloListDefinitionArgs Empty = new PowerpackV2WidgetSloListDefinitionArgs();
    ...
    private Output<List<PowerpackV2WidgetSloListDefinitionRequestArgs>> requests;

    /**
     * @return A nested block describing the request to use when displaying the widget. Exactly one `request` block is allowed.
     * 
     */
    public Output<List<PowerpackV2WidgetSloListDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetSloListDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetSloListDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetSloListDefinitionArgs() {}

    private PowerpackV2WidgetSloListDefinitionArgs(PowerpackV2WidgetSloListDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetSloListDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetSloListDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetSloListDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetSloListDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<PowerpackV2WidgetSloListDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetSloListDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetSloListDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetSloListDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetSloListDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetSloListDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSloListDefinitionArgs", "requests");
            }
            return $;
        }
    }
