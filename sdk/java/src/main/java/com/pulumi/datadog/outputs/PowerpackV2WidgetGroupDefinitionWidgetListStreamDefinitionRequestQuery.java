...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupBy;
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySort;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery {
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupBy> groupBies;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySort sort;
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery() {}
    /**
     * @return Specifies the field for logs pattern clustering. Can only be used with `logsPatternStream`.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupBy> groupBies() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySort> sort() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storage;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery", "dataSource");
            }
        ...
        @CustomType.Setter
        public Builder groupBies(@Nullable List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupBy> groupBies) {

            this.groupBies = groupBies;
            return this;
        }
        public Builder groupBies(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupBy... groupBies) {
        ...
        @CustomType.Setter
        public Builder sort(@Nullable PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySort sort) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery();
