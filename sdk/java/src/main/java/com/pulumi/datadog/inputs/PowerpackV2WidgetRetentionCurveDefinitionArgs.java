...
import com.pulumi.datadog.inputs.PowerpackV2WidgetRetentionCurveDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetRetentionCurveDefinitionTimeArgs;
...
public final class PowerpackV2WidgetRetentionCurveDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetRetentionCurveDefinitionArgs Empty = new PowerpackV2WidgetRetentionCurveDefinitionArgs();
    ...
    private Output<List<PowerpackV2WidgetRetentionCurveDefinitionRequestArgs>> requests;

    /**
     * @return Retention curve requests.
     * 
     */
    public Output<List<PowerpackV2WidgetRetentionCurveDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetRetentionCurveDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetRetentionCurveDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetRetentionCurveDefinitionArgs() {}

    private PowerpackV2WidgetRetentionCurveDefinitionArgs(PowerpackV2WidgetRetentionCurveDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetRetentionCurveDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetRetentionCurveDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetRetentionCurveDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetRetentionCurveDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<PowerpackV2WidgetRetentionCurveDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetRetentionCurveDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetRetentionCurveDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetRetentionCurveDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetRetentionCurveDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetRetentionCurveDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetRetentionCurveDefinitionArgs", "requests");
            }
            return $;
        }
    }
