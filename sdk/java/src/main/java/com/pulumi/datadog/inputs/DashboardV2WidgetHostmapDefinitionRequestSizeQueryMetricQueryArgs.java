...
public final class DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs Empty = new DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs() {}

    private DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs(DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
