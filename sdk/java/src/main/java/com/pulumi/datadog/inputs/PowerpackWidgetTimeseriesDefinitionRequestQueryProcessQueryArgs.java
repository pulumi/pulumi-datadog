...
public final class PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs Empty = new PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs();
    ...
    private PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs() {}

    private PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs(PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
