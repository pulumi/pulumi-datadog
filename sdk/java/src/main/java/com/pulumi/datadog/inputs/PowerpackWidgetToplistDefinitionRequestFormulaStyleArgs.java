...
public final class PowerpackWidgetToplistDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PowerpackWidgetToplistDefinitionRequestFormulaStyleArgs() {}

    private PowerpackWidgetToplistDefinitionRequestFormulaStyleArgs(PowerpackWidgetToplistDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackWidgetToplistDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetToplistDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackWidgetToplistDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackWidgetToplistDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetToplistDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
