...
public final class DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs Empty = new DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs();
    ...
    private DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs() {}

    private DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs(DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
