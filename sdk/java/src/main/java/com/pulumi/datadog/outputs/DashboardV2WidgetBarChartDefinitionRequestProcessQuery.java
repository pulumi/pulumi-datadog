...
@CustomType
public final class DashboardV2WidgetBarChartDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardV2WidgetBarChartDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetBarChartDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetBarChartDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetBarChartDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetBarChartDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetBarChartDefinitionRequestProcessQuery();
