...
@CustomType
public final class ObservabilityPipelineConfigDestinationAmazonS3GenericAuth {
    /**
    ...
    private ObservabilityPipelineConfigDestinationAmazonS3GenericAuth() {}
    /**
     * @return The Amazon Resource Name (ARN) of the role to assume.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationAmazonS3GenericAuth defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionName;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationAmazonS3GenericAuth defaults) {
        ...
        public ObservabilityPipelineConfigDestinationAmazonS3GenericAuth build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationAmazonS3GenericAuth();
