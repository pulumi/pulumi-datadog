...
public final class DashboardWidgetToplistDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetToplistDefinitionRequestFormulaStyleArgs Empty = new DashboardWidgetToplistDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardWidgetToplistDefinitionRequestFormulaStyleArgs() {}

    private DashboardWidgetToplistDefinitionRequestFormulaStyleArgs(DashboardWidgetToplistDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardWidgetToplistDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetToplistDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardWidgetToplistDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardWidgetToplistDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetToplistDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
