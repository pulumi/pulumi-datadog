...
import com.pulumi.datadog.outputs.DashboardV2WidgetServicemapDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardV2WidgetServicemapDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetServicemapDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardV2WidgetServicemapDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetServicemapDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetServicemapDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<DashboardV2WidgetServicemapDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetServicemapDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetServicemapDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetServicemapDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardV2WidgetServicemapDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardV2WidgetServicemapDefinitionCustomLink... customLinks) {
        ...
        public Builder filters(List<String> filters) {
            if (filters == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetServicemapDefinition", "filters");
            }
        ...
        public Builder service(String service) {
            if (service == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetServicemapDefinition", "service");
            }
            this.service = service;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetServicemapDefinitionTime time) {
        ...
        public DashboardV2WidgetServicemapDefinition build() {
            final var _resultValue = new DashboardV2WidgetServicemapDefinition();
