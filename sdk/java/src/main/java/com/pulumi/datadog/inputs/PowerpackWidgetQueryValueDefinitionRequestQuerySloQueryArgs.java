...
public final class PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs Empty = new PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs(PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
