...
@CustomType
public final class DashboardV2WidgetToplistDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardV2WidgetToplistDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetToplistDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetToplistDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetToplistDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetToplistDefinitionRequestProcessQuery();
