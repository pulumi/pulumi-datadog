...
public final class PowerpackWidgetHostmapDefinitionRequestSizeProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetHostmapDefinitionRequestSizeProcessQueryArgs Empty = new PowerpackWidgetHostmapDefinitionRequestSizeProcessQueryArgs();
    ...
    private PowerpackWidgetHostmapDefinitionRequestSizeProcessQueryArgs() {}

    private PowerpackWidgetHostmapDefinitionRequestSizeProcessQueryArgs(PowerpackWidgetHostmapDefinitionRequestSizeProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetHostmapDefinitionRequestSizeProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetHostmapDefinitionRequestSizeProcessQueryArgs();
        }

        public Builder(PowerpackWidgetHostmapDefinitionRequestSizeProcessQueryArgs defaults) {
            $ = new PowerpackWidgetHostmapDefinitionRequestSizeProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetHostmapDefinitionRequestSizeProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetHostmapDefinitionRequestSizeProcessQueryArgs", "metric");
            }
            return $;
        }
    }
