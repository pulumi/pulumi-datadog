...
public class CsmThreatsAgentRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public CsmThreatsAgentRule(String name) {
     ...
     */
    public CsmThreatsAgentRule(String name, CsmThreatsAgentRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("datadog:index/csmThreatsAgentRule:CsmThreatsAgentRule", name, args == null ? CsmThreatsAgentRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private CsmThreatsAgentRule(String name, Output<String> id, @Nullable CsmThreatsAgentRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("datadog:index/csmThreatsAgentRule:CsmThreatsAgentRule", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static CsmThreatsAgentRule get(String name, Output<String> id, @Nullable CsmThreatsAgentRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
