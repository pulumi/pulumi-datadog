...
public final class PowerpackV2WidgetTimeseriesDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTimeseriesDefinitionRequestProcessQueryArgs Empty = new PowerpackV2WidgetTimeseriesDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackV2WidgetTimeseriesDefinitionRequestProcessQueryArgs() {}

    private PowerpackV2WidgetTimeseriesDefinitionRequestProcessQueryArgs(PowerpackV2WidgetTimeseriesDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTimeseriesDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetTimeseriesDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetTimeseriesDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
