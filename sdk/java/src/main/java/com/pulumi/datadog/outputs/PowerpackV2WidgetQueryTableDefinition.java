...
import com.pulumi.datadog.outputs.PowerpackV2WidgetQueryTableDefinitionCustomLink;
import com.pulumi.datadog.outputs.PowerpackV2WidgetQueryTableDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetQueryTableDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetQueryTableDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<PowerpackV2WidgetQueryTableDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetQueryTableDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetQueryTableDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetQueryTableDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<PowerpackV2WidgetQueryTableDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<PowerpackV2WidgetQueryTableDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetQueryTableDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetQueryTableDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetQueryTableDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<PowerpackV2WidgetQueryTableDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(PowerpackV2WidgetQueryTableDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<PowerpackV2WidgetQueryTableDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetQueryTableDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetQueryTableDefinitionTime time) {
        ...
        public PowerpackV2WidgetQueryTableDefinition build() {
            final var _resultValue = new PowerpackV2WidgetQueryTableDefinition();
