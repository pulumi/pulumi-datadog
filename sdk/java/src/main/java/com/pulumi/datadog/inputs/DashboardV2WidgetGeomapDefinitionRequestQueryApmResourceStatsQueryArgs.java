...
public final class DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs Empty = new DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs();
    ...
    private DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs() {}

    private DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs(DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs();
        }

        public Builder(DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs defaults) {
            $ = new DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs", "name");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs", "stat");
            }
            return $;
        }
    }
