...
public final class PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs(PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
