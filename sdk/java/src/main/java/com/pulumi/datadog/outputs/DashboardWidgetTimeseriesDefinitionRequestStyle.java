...
@CustomType
public final class DashboardWidgetTimeseriesDefinitionRequestStyle {
    /**
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestStyle defaults) {
