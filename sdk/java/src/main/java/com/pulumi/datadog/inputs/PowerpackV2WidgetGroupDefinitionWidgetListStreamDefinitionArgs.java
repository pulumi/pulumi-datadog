...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs();
    ...
    private Output<List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Output<List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs", "requests");
            }
            return $;
        }
    }
