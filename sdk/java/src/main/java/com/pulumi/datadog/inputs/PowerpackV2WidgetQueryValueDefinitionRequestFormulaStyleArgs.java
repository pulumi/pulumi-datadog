...
public final class PowerpackV2WidgetQueryValueDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryValueDefinitionRequestFormulaStyleArgs Empty = new PowerpackV2WidgetQueryValueDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackV2WidgetQueryValueDefinitionRequestFormulaStyleArgs() {}

    private PowerpackV2WidgetQueryValueDefinitionRequestFormulaStyleArgs(PowerpackV2WidgetQueryValueDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryValueDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryValueDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetQueryValueDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetQueryValueDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryValueDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
