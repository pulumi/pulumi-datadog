...
public final class PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs Empty = new PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs();
    ...
    private PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs() {}

    private PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs(PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs();
        }

        public Builder(PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs defaults) {
            $ = new PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
