...
public final class DashboardWidgetAlertGraphDefinition {
    ...
    public static final class Builder {
        ...
        public Builder alertId(String alertId) {
            if (alertId == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetAlertGraphDefinition", "alertId");
            }
        ...
        public Builder vizType(String vizType) {
            if (vizType == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetAlertGraphDefinition", "vizType");
            }
            this.vizType = vizType;
            return this;
        }
        public DashboardWidgetAlertGraphDefinition build() {
            final var _resultValue = new DashboardWidgetAlertGraphDefinition();
