...
@CustomType
public final class DashboardWidgetTimeseriesDefinitionRequestFormulaStyle {
    private @Nullable String palette;
    private @Nullable Integer paletteIndex;

    private DashboardWidgetTimeseriesDefinitionRequestFormulaStyle() {}
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(DashboardWidgetTimeseriesDefinitionRequestFormulaStyle defaults) {
