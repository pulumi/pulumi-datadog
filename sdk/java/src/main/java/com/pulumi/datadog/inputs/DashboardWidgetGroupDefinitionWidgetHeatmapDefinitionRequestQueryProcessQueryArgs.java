...
public final class DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs Empty = new DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs();
    ...
    private DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs() {}

    private DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs(DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
