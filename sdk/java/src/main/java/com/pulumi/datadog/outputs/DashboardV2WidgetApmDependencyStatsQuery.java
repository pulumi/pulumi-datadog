...
@CustomType
public final class DashboardV2WidgetApmDependencyStatsQuery {
    /**
    ...
    private DashboardV2WidgetApmDependencyStatsQuery() {}
    /**
     * @return The source organization UUID for cross organization queries. Feature in Private Beta.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetApmDependencyStatsQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String stat;
        public Builder() {}
        public Builder(DashboardV2WidgetApmDependencyStatsQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQuery", "dataSource");
            }
        ...
        public Builder env(String env) {
            if (env == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQuery", "env");
            }
            this.env = env;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder operationName(String operationName) {
            if (operationName == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQuery", "operationName");
            }
        ...
        public Builder resourceName(String resourceName) {
            if (resourceName == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQuery", "resourceName");
            }
        ...
        public Builder service(String service) {
            if (service == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQuery", "service");
            }
        ...
        public Builder stat(String stat) {
            if (stat == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQuery", "stat");
            }
            this.stat = stat;
            return this;
        }
        public DashboardV2WidgetApmDependencyStatsQuery build() {
            final var _resultValue = new DashboardV2WidgetApmDependencyStatsQuery();
