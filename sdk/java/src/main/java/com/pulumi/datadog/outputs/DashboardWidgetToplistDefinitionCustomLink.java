...
@CustomType
public final class DashboardWidgetToplistDefinitionCustomLink {
    /**
    ...
    private DashboardWidgetToplistDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetToplistDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(DashboardWidgetToplistDefinitionCustomLink defaults) {
        ...
        public DashboardWidgetToplistDefinitionCustomLink build() {
            final var _resultValue = new DashboardWidgetToplistDefinitionCustomLink();
