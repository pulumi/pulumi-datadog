...
public final class DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestFillSecurityQuery {
    ...
    public static final class Builder {
        ...
        public Builder index(String index) {
            if (index == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestFillSecurityQuery", "index");
            }
            this.index = index;
            return this;
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestFillSecurityQuery build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestFillSecurityQuery();
