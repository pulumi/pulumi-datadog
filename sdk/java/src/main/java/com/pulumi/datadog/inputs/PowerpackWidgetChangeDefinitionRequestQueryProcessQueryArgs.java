...
public final class PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs Empty = new PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs();
    ...
    private PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs() {}

    private PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs(PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
