...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestQueryProcessQuery {
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestQueryProcessQuery() {}
    /**
     * @return The aggregation methods available for metrics queries. Valid values are `avg`, `min`, `max`, `sum`, `last`, `area`, `l2norm`, `percentile`.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestQueryProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String textFilter;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestQueryProcessQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestQueryProcessQuery", "dataSource");
            }
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestQueryProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestQueryProcessQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestQueryProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestQueryProcessQuery();
