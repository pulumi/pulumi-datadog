...
public final class PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs Empty = new PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs() {}

    private PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs(PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
