...
public final class PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs Empty = new PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs();
    ...
    private PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs() {}

    private PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs(PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs();
        }

        public Builder(PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
            $ = new PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
