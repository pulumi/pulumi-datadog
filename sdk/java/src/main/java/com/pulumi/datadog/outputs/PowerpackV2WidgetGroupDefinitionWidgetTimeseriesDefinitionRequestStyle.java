...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyle {
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyle() {}
    /**
     * @return Whether to display value labels on the timeseries.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String palette;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyle defaults) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyle build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestStyle();
