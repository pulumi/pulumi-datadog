...
public final class DashboardV2WidgetChangeDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetChangeDefinitionRequestFormulaStyleArgs Empty = new DashboardV2WidgetChangeDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardV2WidgetChangeDefinitionRequestFormulaStyleArgs() {}

    private DashboardV2WidgetChangeDefinitionRequestFormulaStyleArgs(DashboardV2WidgetChangeDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetChangeDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetChangeDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetChangeDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetChangeDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetChangeDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
