...
import com.pulumi.datadog.inputs.PowerpackV2WidgetLogStreamDefinitionSortArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetLogStreamDefinitionTimeArgs;
...
public final class PowerpackV2WidgetLogStreamDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetLogStreamDefinitionArgs Empty = new PowerpackV2WidgetLogStreamDefinitionArgs();
     ...
     */
    @Import(name="sort")
    private @Nullable Output<PowerpackV2WidgetLogStreamDefinitionSortArgs> sort;

    /**
     * @return The facet and order to sort the data, for example: `{&#34;column&#34;: &#34;time&#34;, &#34;order&#34;: &#34;desc&#34;}`.
     * 
     */
    public Optional<Output<PowerpackV2WidgetLogStreamDefinitionSortArgs>> sort() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetLogStreamDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetLogStreamDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetLogStreamDefinitionArgs() {}

    private PowerpackV2WidgetLogStreamDefinitionArgs(PowerpackV2WidgetLogStreamDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetLogStreamDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetLogStreamDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetLogStreamDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetLogStreamDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sort(@Nullable Output<PowerpackV2WidgetLogStreamDefinitionSortArgs> sort) {
            $.sort = sort;
            return this;
        }
         ...
         * 
         */
        public Builder sort(PowerpackV2WidgetLogStreamDefinitionSortArgs sort) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetLogStreamDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetLogStreamDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetLogStreamDefinitionArgs build() {
            return $;
        }
    }
