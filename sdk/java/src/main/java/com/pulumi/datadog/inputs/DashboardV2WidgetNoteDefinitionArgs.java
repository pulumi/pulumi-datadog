...
import com.pulumi.datadog.inputs.DashboardV2WidgetNoteDefinitionTimeArgs;
...
public final class DashboardV2WidgetNoteDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetNoteDefinitionArgs Empty = new DashboardV2WidgetNoteDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetNoteDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetNoteDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetNoteDefinitionArgs() {}

    private DashboardV2WidgetNoteDefinitionArgs(DashboardV2WidgetNoteDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetNoteDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetNoteDefinitionArgs();
        }

        public Builder(DashboardV2WidgetNoteDefinitionArgs defaults) {
            $ = new DashboardV2WidgetNoteDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetNoteDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetNoteDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetNoteDefinitionArgs build() {
            if ($.content == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetNoteDefinitionArgs", "content");
            }
            return $;
        }
    }
