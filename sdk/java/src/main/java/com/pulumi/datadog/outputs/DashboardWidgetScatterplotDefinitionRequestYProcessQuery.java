...
@CustomType
public final class DashboardWidgetScatterplotDefinitionRequestYProcessQuery {
    /**
    ...
    public static Builder builder(DashboardWidgetScatterplotDefinitionRequestYProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetScatterplotDefinitionRequestYProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetScatterplotDefinitionRequestYProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
