...
@CustomType
public final class PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyle {
    /**
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyle defaults) {
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyle build() {
            final var _resultValue = new PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyle();
