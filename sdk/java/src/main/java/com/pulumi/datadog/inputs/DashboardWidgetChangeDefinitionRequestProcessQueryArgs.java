...
public final class DashboardWidgetChangeDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetChangeDefinitionRequestProcessQueryArgs Empty = new DashboardWidgetChangeDefinitionRequestProcessQueryArgs();
    ...
    private DashboardWidgetChangeDefinitionRequestProcessQueryArgs() {}

    private DashboardWidgetChangeDefinitionRequestProcessQueryArgs(DashboardWidgetChangeDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetChangeDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetChangeDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardWidgetChangeDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardWidgetChangeDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetChangeDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetChangeDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
