...
@CustomType
public final class PowerpackWidgetAlertGraphDefinition {
    /**
    ...
    private PowerpackWidgetAlertGraphDefinition() {}
    /**
     * @return The ID of the monitor used by the widget.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetAlertGraphDefinition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder vizType(String vizType) {
            if (vizType == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetAlertGraphDefinition", "vizType");
            }
