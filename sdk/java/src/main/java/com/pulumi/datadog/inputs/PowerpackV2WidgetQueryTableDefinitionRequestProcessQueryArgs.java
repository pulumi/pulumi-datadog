...
public final class PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryArgs Empty = new PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryArgs() {}

    private PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryArgs(PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
