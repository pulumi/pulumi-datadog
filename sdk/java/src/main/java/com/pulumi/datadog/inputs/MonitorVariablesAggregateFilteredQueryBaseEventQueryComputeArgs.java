...
public final class MonitorVariablesAggregateFilteredQueryBaseEventQueryComputeArgs extends com.pulumi.resources.ResourceArgs {

    public static final MonitorVariablesAggregateFilteredQueryBaseEventQueryComputeArgs Empty = new MonitorVariablesAggregateFilteredQueryBaseEventQueryComputeArgs();
    ...
    private MonitorVariablesAggregateFilteredQueryBaseEventQueryComputeArgs() {}

    private MonitorVariablesAggregateFilteredQueryBaseEventQueryComputeArgs(MonitorVariablesAggregateFilteredQueryBaseEventQueryComputeArgs $) {
    ...
    public static Builder builder(MonitorVariablesAggregateFilteredQueryBaseEventQueryComputeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MonitorVariablesAggregateFilteredQueryBaseEventQueryComputeArgs();
        }

        public Builder(MonitorVariablesAggregateFilteredQueryBaseEventQueryComputeArgs defaults) {
            $ = new MonitorVariablesAggregateFilteredQueryBaseEventQueryComputeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MonitorVariablesAggregateFilteredQueryBaseEventQueryComputeArgs build() {
            if ($.aggregation == null) {
                throw new MissingRequiredPropertyException("MonitorVariablesAggregateFilteredQueryBaseEventQueryComputeArgs", "aggregation");
            }
            return $;
        }
    }
