...
import com.pulumi.datadog.outputs.PowerpackV2WidgetCohortDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetCohortDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetCohortDefinition {
    /**
     ...
     * 
     */
    private List<PowerpackV2WidgetCohortDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetCohortDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetCohortDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetCohortDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetCohortDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetCohortDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetCohortDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder requests(List<PowerpackV2WidgetCohortDefinitionRequest> requests) {
            if (requests == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetCohortDefinition", "requests");
            }
            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetCohortDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetCohortDefinitionTime time) {
        ...
        public PowerpackV2WidgetCohortDefinition build() {
            final var _resultValue = new PowerpackV2WidgetCohortDefinition();
