...
import com.pulumi.datadog.outputs.PowerpackV2WidgetQueryValueDefinitionCustomLink;
import com.pulumi.datadog.outputs.PowerpackV2WidgetQueryValueDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetQueryValueDefinitionTime;
import com.pulumi.datadog.outputs.PowerpackV2WidgetQueryValueDefinitionTimeseriesBackground;
...
@CustomType
public final class PowerpackV2WidgetQueryValueDefinition {
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetQueryValueDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetQueryValueDefinitionRequest> requests;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetQueryValueDefinitionTime time;
    /**
     * @return Set a timeseries on the widget background.
     * 
     */
    private @Nullable PowerpackV2WidgetQueryValueDefinitionTimeseriesBackground timeseriesBackground;
    /**
    ...
    private PowerpackV2WidgetQueryValueDefinition() {}
    /**
     * @return A Boolean indicating whether to automatically scale the tile.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetQueryValueDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<PowerpackV2WidgetQueryValueDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetQueryValueDefinitionTime> time() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetQueryValueDefinitionTimeseriesBackground> timeseriesBackground() {
    ...
    public static Builder builder(PowerpackV2WidgetQueryValueDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetQueryValueDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<PowerpackV2WidgetQueryValueDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(PowerpackV2WidgetQueryValueDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<PowerpackV2WidgetQueryValueDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetQueryValueDefinitionRequest... requests) {
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetQueryValueDefinitionTime time) {

            this.time = time;
            return this;
        }
        @CustomType.Setter
        public Builder timeseriesBackground(@Nullable PowerpackV2WidgetQueryValueDefinitionTimeseriesBackground timeseriesBackground) {
        ...
        public PowerpackV2WidgetQueryValueDefinition build() {
            final var _resultValue = new PowerpackV2WidgetQueryValueDefinition();
