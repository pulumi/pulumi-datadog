...
@CustomType
public final class DashboardV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery {
    /**
    ...
    private DashboardV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery();
