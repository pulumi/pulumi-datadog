...
@CustomType
public final class DashboardWidgetTimeseriesDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardWidgetTimeseriesDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetTimeseriesDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
