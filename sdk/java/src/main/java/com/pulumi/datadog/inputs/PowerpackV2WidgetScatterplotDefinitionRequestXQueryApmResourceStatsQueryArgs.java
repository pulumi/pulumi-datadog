...
public final class PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs(PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs", "name");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmResourceStatsQueryArgs", "stat");
            }
            return $;
        }
    }
