...
public final class DashboardV2WidgetBarChartDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetBarChartDefinitionRequestFormulaStyleArgs Empty = new DashboardV2WidgetBarChartDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardV2WidgetBarChartDefinitionRequestFormulaStyleArgs() {}

    private DashboardV2WidgetBarChartDefinitionRequestFormulaStyleArgs(DashboardV2WidgetBarChartDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetBarChartDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetBarChartDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetBarChartDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetBarChartDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetBarChartDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
