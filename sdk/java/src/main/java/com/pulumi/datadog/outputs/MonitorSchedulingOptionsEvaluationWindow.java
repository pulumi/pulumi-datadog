...
@CustomType
public final class MonitorSchedulingOptionsEvaluationWindow {
    /**
    ...
    public static Builder builder(MonitorSchedulingOptionsEvaluationWindow defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timezone;
        public Builder() {}
        public Builder(MonitorSchedulingOptionsEvaluationWindow defaults) {
        ...
        public MonitorSchedulingOptionsEvaluationWindow build() {
            final var _resultValue = new MonitorSchedulingOptionsEvaluationWindow();
