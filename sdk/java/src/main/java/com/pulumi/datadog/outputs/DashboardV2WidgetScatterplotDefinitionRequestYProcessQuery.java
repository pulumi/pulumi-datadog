...
@CustomType
public final class DashboardV2WidgetScatterplotDefinitionRequestYProcessQuery {
    /**
    ...
    private DashboardV2WidgetScatterplotDefinitionRequestYProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinitionRequestYProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetScatterplotDefinitionRequestYProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestYProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetScatterplotDefinitionRequestYProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetScatterplotDefinitionRequestYProcessQuery();
