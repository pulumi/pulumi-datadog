...
@CustomType
public final class PowerpackWidgetHeatmapDefinitionRequestFormulaStyle {
    /**
    ...
    private PowerpackWidgetHeatmapDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetHeatmapDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackWidgetHeatmapDefinitionRequestFormulaStyle defaults) {
        ...
        public PowerpackWidgetHeatmapDefinitionRequestFormulaStyle build() {
            final var _resultValue = new PowerpackWidgetHeatmapDefinitionRequestFormulaStyle();
