...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryGroupBy;
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuerySort;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuery {
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryGroupBy> groupBies;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuerySort sort;
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuery() {}
    /**
     * @return Specifies the field for logs pattern clustering. Can only be used with `logsPatternStream`.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryGroupBy> groupBies() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuerySort> sort() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storage;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuery", "dataSource");
            }
        ...
        @CustomType.Setter
        public Builder groupBies(@Nullable List<PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryGroupBy> groupBies) {

            this.groupBies = groupBies;
            return this;
        }
        public Builder groupBies(PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQueryGroupBy... groupBies) {
        ...
        @CustomType.Setter
        public Builder sort(@Nullable PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuerySort sort) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuery build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetWildcardDefinitionRequestListstreamRequestQuery();
