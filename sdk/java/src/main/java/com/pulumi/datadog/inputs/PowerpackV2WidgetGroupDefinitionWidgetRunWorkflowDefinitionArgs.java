...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionInputArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="inputs")
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionInputArgs>> inputs;

    /**
     * @return Array of workflow inputs to map to dashboard template variables.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionInputArgs>>> inputs() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder inputs(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionInputArgs>> inputs) {
            $.inputs = inputs;
            return this;
        }
         ...
         * 
         */
        public Builder inputs(List<PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionInputArgs> inputs) {
         ...
         * 
         */
        public Builder inputs(PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionInputArgs... inputs) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs build() {
            if ($.workflowId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs", "workflowId");
            }
            return $;
        }
    }
