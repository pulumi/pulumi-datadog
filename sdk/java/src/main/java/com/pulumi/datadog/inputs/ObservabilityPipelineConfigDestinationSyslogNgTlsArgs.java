...
public final class ObservabilityPipelineConfigDestinationSyslogNgTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationSyslogNgTlsArgs Empty = new ObservabilityPipelineConfigDestinationSyslogNgTlsArgs();
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationSyslogNgTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationSyslogNgTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationSyslogNgTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationSyslogNgTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationSyslogNgTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationSyslogNgTlsArgs", "crtFile");
            }
            return $;
        }
    }
