...
public final class LogsCustomPipelineProcessorPipelineProcessorGrokParser {
    ...
    public static final class Builder {
        ...
        public Builder grok(LogsCustomPipelineProcessorPipelineProcessorGrokParserGrok grok) {
            if (grok == null) {
              throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorGrokParser", "grok");
            }
            this.grok = grok;
            return this;
        }
        ...
        public Builder source(String source) {
            if (source == null) {
              throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorGrokParser", "source");
            }
            this.source = source;
            return this;
        }
