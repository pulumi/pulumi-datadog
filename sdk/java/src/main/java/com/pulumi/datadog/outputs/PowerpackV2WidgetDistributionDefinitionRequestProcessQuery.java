...
@CustomType
public final class PowerpackV2WidgetDistributionDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackV2WidgetDistributionDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetDistributionDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetDistributionDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetDistributionDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetDistributionDefinitionRequestProcessQuery();
