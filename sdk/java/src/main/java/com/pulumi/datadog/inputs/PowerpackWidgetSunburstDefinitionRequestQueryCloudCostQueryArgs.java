...
public final class PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs Empty = new PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs();
    ...
    private PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs() {}

    private PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs(PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs();
        }

        public Builder(PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs defaults) {
            $ = new PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs", "dataSource");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestQueryCloudCostQueryArgs", "query");
            }
            return $;
        }
    }
