...
import com.pulumi.datadog.outputs.DashboardV2WidgetTopologyMapDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardV2WidgetTopologyMapDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetTopologyMapDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetTopologyMapDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardV2WidgetTopologyMapDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetTopologyMapDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetTopologyMapDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetTopologyMapDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<DashboardV2WidgetTopologyMapDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<DashboardV2WidgetTopologyMapDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetTopologyMapDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetTopologyMapDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetTopologyMapDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardV2WidgetTopologyMapDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardV2WidgetTopologyMapDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<DashboardV2WidgetTopologyMapDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetTopologyMapDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetTopologyMapDefinitionTime time) {
        ...
        public DashboardV2WidgetTopologyMapDefinition build() {
            final var _resultValue = new DashboardV2WidgetTopologyMapDefinition();
