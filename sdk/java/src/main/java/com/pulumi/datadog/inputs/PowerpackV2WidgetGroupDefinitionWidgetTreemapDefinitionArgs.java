...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestArgs>> requests;

    /**
     * @return Nested block describing the request to use when displaying the widget.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs build() {
            return $;
        }
    }
