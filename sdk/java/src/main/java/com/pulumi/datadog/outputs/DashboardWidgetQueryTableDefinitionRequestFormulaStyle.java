...
@CustomType
public final class DashboardWidgetQueryTableDefinitionRequestFormulaStyle {
    /**
    ...
    private DashboardWidgetQueryTableDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette to apply. Valid values are `blue`, `custom_bg`, `custom_image`, `custom_text`, `gray_on_white`, `grey`, `green`, `orange`, `red`, `red_on_white`, `white_on_gray`, `white_on_green`, `green_on_white`, `white_on_red`, `white_on_yellow`, `yellow_on_white`, `black_on_light_yellow`, `black_on_light_green`, `black_on_light_red`.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetQueryTableDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(DashboardWidgetQueryTableDefinitionRequestFormulaStyle defaults) {
        ...
        public DashboardWidgetQueryTableDefinitionRequestFormulaStyle build() {
            final var _resultValue = new DashboardWidgetQueryTableDefinitionRequestFormulaStyle();
