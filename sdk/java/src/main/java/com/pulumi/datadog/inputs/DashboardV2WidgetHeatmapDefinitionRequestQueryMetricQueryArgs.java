...
public final class DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs Empty = new DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs() {}

    private DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs(DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHeatmapDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
