...
public final class MonitorVariablesAggregateFilteredQueryFilterEventQueryComputeArgs extends com.pulumi.resources.ResourceArgs {

    public static final MonitorVariablesAggregateFilteredQueryFilterEventQueryComputeArgs Empty = new MonitorVariablesAggregateFilteredQueryFilterEventQueryComputeArgs();
    ...
    private MonitorVariablesAggregateFilteredQueryFilterEventQueryComputeArgs() {}

    private MonitorVariablesAggregateFilteredQueryFilterEventQueryComputeArgs(MonitorVariablesAggregateFilteredQueryFilterEventQueryComputeArgs $) {
    ...
    public static Builder builder(MonitorVariablesAggregateFilteredQueryFilterEventQueryComputeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MonitorVariablesAggregateFilteredQueryFilterEventQueryComputeArgs();
        }

        public Builder(MonitorVariablesAggregateFilteredQueryFilterEventQueryComputeArgs defaults) {
            $ = new MonitorVariablesAggregateFilteredQueryFilterEventQueryComputeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MonitorVariablesAggregateFilteredQueryFilterEventQueryComputeArgs build() {
            if ($.aggregation == null) {
                throw new MissingRequiredPropertyException("MonitorVariablesAggregateFilteredQueryFilterEventQueryComputeArgs", "aggregation");
            }
            return $;
        }
    }
