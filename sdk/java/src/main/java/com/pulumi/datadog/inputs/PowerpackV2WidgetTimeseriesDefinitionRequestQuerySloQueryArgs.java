...
public final class PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs Empty = new PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs(PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
