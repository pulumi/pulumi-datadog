...
public final class PowerpackWidgetQueryTableDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryTableDefinitionRequestFormulaStyleArgs Empty = new PowerpackWidgetQueryTableDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackWidgetQueryTableDefinitionRequestFormulaStyleArgs() {}

    private PowerpackWidgetQueryTableDefinitionRequestFormulaStyleArgs(PowerpackWidgetQueryTableDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryTableDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryTableDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackWidgetQueryTableDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackWidgetQueryTableDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetQueryTableDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
