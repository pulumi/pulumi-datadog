...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQuery {
    /**
     * @return `compute_query` or `multi_compute` is required. The map keys are listed below.
     * 
     */
    private @Nullable DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQueryComputeQuery computeQuery;
    /**
     * @return Multiple `group_by` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQueryGroupBy> groupBies;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQueryMultiCompute> multiComputes;
    /**
     ...
     * 
     */
    public Optional<DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQueryComputeQuery> computeQuery() {
     ...
     * 
     */
    public List<DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQueryGroupBy> groupBies() {
     ...
     * 
     */
    public List<DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQueryMultiCompute> multiComputes() {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchQuery;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQuery defaults) {
        ...
        public Builder groupBies(DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQueryGroupBy... groupBies) {
        ...
        public Builder multiComputes(DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQueryMultiCompute... multiComputes) {
        ...
        public DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQuery build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestSecurityQuery();
