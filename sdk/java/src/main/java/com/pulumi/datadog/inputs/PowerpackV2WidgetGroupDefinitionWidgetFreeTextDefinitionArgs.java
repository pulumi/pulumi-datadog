...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs build() {
            if ($.text == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs", "text");
            }
            return $;
        }
    }
