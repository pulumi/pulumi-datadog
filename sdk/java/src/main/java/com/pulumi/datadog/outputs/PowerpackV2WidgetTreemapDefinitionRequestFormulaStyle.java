...
@CustomType
public final class PowerpackV2WidgetTreemapDefinitionRequestFormulaStyle {
    /**
    ...
    private PowerpackV2WidgetTreemapDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetTreemapDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackV2WidgetTreemapDefinitionRequestFormulaStyle defaults) {
        ...
        public PowerpackV2WidgetTreemapDefinitionRequestFormulaStyle build() {
            final var _resultValue = new PowerpackV2WidgetTreemapDefinitionRequestFormulaStyle();
