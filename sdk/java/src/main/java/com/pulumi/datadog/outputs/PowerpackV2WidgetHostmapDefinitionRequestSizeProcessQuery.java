...
@CustomType
public final class PowerpackV2WidgetHostmapDefinitionRequestSizeProcessQuery {
    /**
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestSizeProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestSizeProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetHostmapDefinitionRequestSizeProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestSizeProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestSizeProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetHostmapDefinitionRequestSizeProcessQuery();
