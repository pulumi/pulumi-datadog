...
@CustomType
public final class PowerpackWidgetTreemapDefinitionRequestFormulaStyle {
    /**
    ...
    private PowerpackWidgetTreemapDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetTreemapDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackWidgetTreemapDefinitionRequestFormulaStyle defaults) {
        ...
        public PowerpackWidgetTreemapDefinitionRequestFormulaStyle build() {
            final var _resultValue = new PowerpackWidgetTreemapDefinitionRequestFormulaStyle();
