...
public final class DatasetProductFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * The product type of the dataset. Supported types: `apm`, `rum`, `metrics` (Custom Metrics), `logs`, `sdRepoinfo`, `errorTracking`, `cloudCost`, and `mlObs`.
     * 
     */
    ...
    /**
     * @return The product type of the dataset. Supported types: `apm`, `rum`, `metrics` (Custom Metrics), `logs`, `sdRepoinfo`, `errorTracking`, `cloudCost`, and `mlObs`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param product The product type of the dataset. Supported types: `apm`, `rum`, `metrics` (Custom Metrics), `logs`, `sdRepoinfo`, `errorTracking`, `cloudCost`, and `mlObs`.
         * 
         * @return builder
         * 
         */
