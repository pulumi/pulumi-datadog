...
public final class DashboardWidgetDistributionDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetDistributionDefinitionRequestProcessQueryArgs Empty = new DashboardWidgetDistributionDefinitionRequestProcessQueryArgs();
    ...
    private DashboardWidgetDistributionDefinitionRequestProcessQueryArgs() {}

    private DashboardWidgetDistributionDefinitionRequestProcessQueryArgs(DashboardWidgetDistributionDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetDistributionDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetDistributionDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardWidgetDistributionDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardWidgetDistributionDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetDistributionDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetDistributionDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
