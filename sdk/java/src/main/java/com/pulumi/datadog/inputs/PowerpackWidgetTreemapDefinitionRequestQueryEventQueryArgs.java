...
import com.pulumi.datadog.inputs.PowerpackWidgetTreemapDefinitionRequestQueryEventQueryGroupByFieldsArgs;
...
public final class PowerpackWidgetTreemapDefinitionRequestQueryEventQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<PowerpackWidgetTreemapDefinitionRequestQueryEventQueryGroupByFieldsArgs> groupByFields;

    /**
     * @return Alternative group-by configuration that groups by multiple event facet fields. Use this or `groupBy`, not both.
     * 
     */
    public Optional<Output<PowerpackWidgetTreemapDefinitionRequestQueryEventQueryGroupByFieldsArgs>> groupByFields() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder groupByFields(@Nullable Output<PowerpackWidgetTreemapDefinitionRequestQueryEventQueryGroupByFieldsArgs> groupByFields) {
         ...
         * 
         */
        public Builder groupByFields(PowerpackWidgetTreemapDefinitionRequestQueryEventQueryGroupByFieldsArgs groupByFields) {
