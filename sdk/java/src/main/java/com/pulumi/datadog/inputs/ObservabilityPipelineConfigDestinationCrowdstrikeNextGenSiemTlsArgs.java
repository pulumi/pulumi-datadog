...
public final class ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTlsArgs Empty = new ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTlsArgs() {}

    private ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTlsArgs(ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTlsArgs", "crtFile");
            }
            return $;
        }
    }
