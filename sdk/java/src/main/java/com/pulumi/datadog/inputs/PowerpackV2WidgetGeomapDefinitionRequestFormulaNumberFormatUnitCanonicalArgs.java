...
public final class PowerpackV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs Empty = new PowerpackV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
    ...
    private PowerpackV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs() {}

    private PowerpackV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(PowerpackV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(PowerpackV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new PowerpackV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
