...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLink {
    /**
    ...
    private DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLink defaults) {
        ...
        public DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLink build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLink();
