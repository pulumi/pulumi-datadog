...
import com.pulumi.datadog.outputs.DashboardV2WidgetListStreamDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetListStreamDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetListStreamDefinition {
    /**
     ...
     * 
     */
    private List<DashboardV2WidgetListStreamDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetListStreamDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetListStreamDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<DashboardV2WidgetListStreamDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetListStreamDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetListStreamDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetListStreamDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder requests(List<DashboardV2WidgetListStreamDefinitionRequest> requests) {
            if (requests == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetListStreamDefinition", "requests");
            }
            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetListStreamDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetListStreamDefinitionTime time) {
        ...
        public DashboardV2WidgetListStreamDefinition build() {
            final var _resultValue = new DashboardV2WidgetListStreamDefinition();
