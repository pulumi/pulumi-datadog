...
public final class DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs Empty = new DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs();
    ...
    private DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs() {}

    private DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs(DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs();
        }

        public Builder(DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs defaults) {
            $ = new DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
