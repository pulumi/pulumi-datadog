...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionStyleArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="style")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionStyleArgs> style;

    /**
     * @return The style of the widget
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionStyleArgs>> style() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder style(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionStyleArgs> style) {
            $.style = style;
            return this;
        }
         ...
         * 
         */
        public Builder style(PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionStyleArgs style) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionArgs build() {
            return $;
        }
    }
