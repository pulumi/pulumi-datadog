...
@CustomType
public final class DashboardV2WidgetHeatmapDefinitionRequestFormulaStyle {
    /**
    ...
    private DashboardV2WidgetHeatmapDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHeatmapDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(DashboardV2WidgetHeatmapDefinitionRequestFormulaStyle defaults) {
        ...
        public DashboardV2WidgetHeatmapDefinitionRequestFormulaStyle build() {
            final var _resultValue = new DashboardV2WidgetHeatmapDefinitionRequestFormulaStyle();
