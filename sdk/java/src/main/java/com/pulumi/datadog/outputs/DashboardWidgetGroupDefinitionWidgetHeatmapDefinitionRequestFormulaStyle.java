...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestFormulaStyle {
    /**
    ...
    private DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestFormulaStyle defaults) {
        ...
        public DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestFormulaStyle build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestFormulaStyle();
