...
public final class DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs Empty = new DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs() {}

    private DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs(DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
