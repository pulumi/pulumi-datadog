...
@CustomType
public final class DashboardV2WidgetTimeseriesDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardV2WidgetTimeseriesDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetTimeseriesDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetTimeseriesDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetTimeseriesDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetTimeseriesDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetTimeseriesDefinitionRequestProcessQuery();
