...
public final class DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs Empty = new DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs();
    ...
    private DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs() {}

    private DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs(DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs();
        }

        public Builder(DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs defaults) {
            $ = new DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
