...
public final class PowerpackWidgetTimeseriesDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetTimeseriesDefinitionRequestProcessQueryArgs Empty = new PowerpackWidgetTimeseriesDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackWidgetTimeseriesDefinitionRequestProcessQueryArgs() {}

    private PowerpackWidgetTimeseriesDefinitionRequestProcessQueryArgs(PowerpackWidgetTimeseriesDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetTimeseriesDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetTimeseriesDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackWidgetTimeseriesDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackWidgetTimeseriesDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetTimeseriesDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
