...
import com.pulumi.datadog.outputs.DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequest;
...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetQueryTableDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `custom_link` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequest> requests;
    /**
     ...
     * 
     */
    public List<DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequest> requests() {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetQueryTableDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetQueryTableDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequest... requests) {
        ...
        public DashboardWidgetGroupDefinitionWidgetQueryTableDefinition build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetQueryTableDefinition();
