...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private String viewType;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition defaults) {
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTime time) {
        ...
        public Builder timeWindows(List<String> timeWindows) {
            if (timeWindows == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition", "timeWindows");
            }
        ...
        public Builder viewMode(String viewMode) {
            if (viewMode == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition", "viewMode");
            }
        ...
        public Builder viewType(String viewType) {
            if (viewType == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition", "viewType");
            }
            this.viewType = viewType;
            return this;
        }
        public DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition();
