...
@CustomType
public final class PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery {
    /**
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery build() {
            final var _resultValue = new PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery();
