...
@CustomType
public final class DashboardWidgetScatterplotDefinitionXaxis {
    /**
    ...
    public static Builder builder(DashboardWidgetScatterplotDefinitionXaxis defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String scale;
        public Builder() {}
        public Builder(DashboardWidgetScatterplotDefinitionXaxis defaults) {
        ...
        public DashboardWidgetScatterplotDefinitionXaxis build() {
            final var _resultValue = new DashboardWidgetScatterplotDefinitionXaxis();
