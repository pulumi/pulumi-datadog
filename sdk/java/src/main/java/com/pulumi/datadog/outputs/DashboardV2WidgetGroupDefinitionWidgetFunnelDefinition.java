...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetFunnelDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionRequest request;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionTime time;
    /**
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionRequest> request() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetFunnelDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetFunnelDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder request(@Nullable DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionRequest request) {

            this.request = request;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionTime time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetFunnelDefinition build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetFunnelDefinition();
