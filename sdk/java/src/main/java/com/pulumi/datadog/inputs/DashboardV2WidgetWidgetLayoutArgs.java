...
public final class DashboardV2WidgetWidgetLayoutArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetWidgetLayoutArgs Empty = new DashboardV2WidgetWidgetLayoutArgs();
    ...
    private DashboardV2WidgetWidgetLayoutArgs() {}

    private DashboardV2WidgetWidgetLayoutArgs(DashboardV2WidgetWidgetLayoutArgs $) {
        this.height = $.height;
    ...
    public static Builder builder(DashboardV2WidgetWidgetLayoutArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetWidgetLayoutArgs();
        }

        public Builder(DashboardV2WidgetWidgetLayoutArgs defaults) {
            $ = new DashboardV2WidgetWidgetLayoutArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetWidgetLayoutArgs build() {
            if ($.height == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWidgetLayoutArgs", "height");
            }
            if ($.width == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWidgetLayoutArgs", "width");
            }
            if ($.x == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWidgetLayoutArgs", "x");
            }
            if ($.y == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWidgetLayoutArgs", "y");
            }
            return $;
        }
    }
