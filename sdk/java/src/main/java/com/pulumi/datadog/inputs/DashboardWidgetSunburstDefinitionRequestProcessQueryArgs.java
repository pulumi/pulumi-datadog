...
public final class DashboardWidgetSunburstDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetSunburstDefinitionRequestProcessQueryArgs Empty = new DashboardWidgetSunburstDefinitionRequestProcessQueryArgs();
    ...
    private DashboardWidgetSunburstDefinitionRequestProcessQueryArgs() {}

    private DashboardWidgetSunburstDefinitionRequestProcessQueryArgs(DashboardWidgetSunburstDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetSunburstDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetSunburstDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardWidgetSunburstDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardWidgetSunburstDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetSunburstDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
