...
@CustomType
public final class DashboardV2WidgetHostmapDefinitionRequestSizeQuerySloQuery {
    /**
    ...
    private DashboardV2WidgetHostmapDefinitionRequestSizeQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestSizeQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(DashboardV2WidgetHostmapDefinitionRequestSizeQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestSizeQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestSizeQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestSizeQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestSizeQuerySloQuery build() {
            final var _resultValue = new DashboardV2WidgetHostmapDefinitionRequestSizeQuerySloQuery();
