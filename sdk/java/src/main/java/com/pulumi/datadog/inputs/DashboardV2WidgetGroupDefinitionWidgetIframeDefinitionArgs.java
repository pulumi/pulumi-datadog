...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionArgs", "url");
            }
            return $;
        }
    }
