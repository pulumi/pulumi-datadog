...
public final class PowerpackWidgetQueryValueDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryValueDefinitionRequestProcessQueryArgs Empty = new PowerpackWidgetQueryValueDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackWidgetQueryValueDefinitionRequestProcessQueryArgs() {}

    private PowerpackWidgetQueryValueDefinitionRequestProcessQueryArgs(PowerpackWidgetQueryValueDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryValueDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryValueDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackWidgetQueryValueDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackWidgetQueryValueDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetQueryValueDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
