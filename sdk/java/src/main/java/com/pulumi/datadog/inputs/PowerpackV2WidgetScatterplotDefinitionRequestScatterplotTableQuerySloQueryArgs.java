...
public final class PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs(PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
