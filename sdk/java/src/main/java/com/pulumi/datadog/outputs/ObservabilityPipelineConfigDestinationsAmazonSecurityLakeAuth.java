...
@CustomType
public final class ObservabilityPipelineConfigDestinationsAmazonSecurityLakeAuth {
    /**
    ...
    private ObservabilityPipelineConfigDestinationsAmazonSecurityLakeAuth() {}
    /**
     * @return The Amazon Resource Name (ARN) of the role to assume.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationsAmazonSecurityLakeAuth defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionName;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationsAmazonSecurityLakeAuth defaults) {
        ...
        public ObservabilityPipelineConfigDestinationsAmazonSecurityLakeAuth build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationsAmazonSecurityLakeAuth();
