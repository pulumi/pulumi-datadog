...
public final class DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs Empty = new DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs();
    ...
    private DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs() {}

    private DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs(DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs();
        }

        public Builder(DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs defaults) {
            $ = new DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs", "name");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryApmResourceStatsQueryArgs", "stat");
            }
            return $;
        }
    }
