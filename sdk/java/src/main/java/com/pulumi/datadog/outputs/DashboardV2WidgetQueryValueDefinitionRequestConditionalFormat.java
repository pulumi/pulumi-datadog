...
@CustomType
public final class DashboardV2WidgetQueryValueDefinitionRequestConditionalFormat {
    /**
    ...
    private DashboardV2WidgetQueryValueDefinitionRequestConditionalFormat() {}
    /**
     * @return The comparator to use. Valid values are `=`, `&gt;`, `&gt;=`, `&lt;`, `&lt;=`.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetQueryValueDefinitionRequestConditionalFormat defaults) {
    ...
    public static final class Builder {
        ...
        private Double value;
        public Builder() {}
        public Builder(DashboardV2WidgetQueryValueDefinitionRequestConditionalFormat defaults) {
        ...
        public Builder comparator(String comparator) {
            if (comparator == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestConditionalFormat", "comparator");
            }
        ...
        public Builder palette(String palette) {
            if (palette == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestConditionalFormat", "palette");
            }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestConditionalFormat", "value");
            }
            this.value = value;
            return this;
        }
        public DashboardV2WidgetQueryValueDefinitionRequestConditionalFormat build() {
            final var _resultValue = new DashboardV2WidgetQueryValueDefinitionRequestConditionalFormat();
