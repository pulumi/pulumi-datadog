...
public final class PowerpackWidgetToplistDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetToplistDefinitionRequestProcessQueryArgs Empty = new PowerpackWidgetToplistDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackWidgetToplistDefinitionRequestProcessQueryArgs() {}

    private PowerpackWidgetToplistDefinitionRequestProcessQueryArgs(PowerpackWidgetToplistDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetToplistDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetToplistDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackWidgetToplistDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackWidgetToplistDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetToplistDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
