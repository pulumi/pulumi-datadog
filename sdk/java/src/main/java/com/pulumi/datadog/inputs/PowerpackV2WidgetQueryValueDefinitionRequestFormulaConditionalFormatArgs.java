...
public final class PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs(PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
