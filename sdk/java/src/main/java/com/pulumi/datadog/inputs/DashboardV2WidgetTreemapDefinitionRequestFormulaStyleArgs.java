...
public final class DashboardV2WidgetTreemapDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetTreemapDefinitionRequestFormulaStyleArgs Empty = new DashboardV2WidgetTreemapDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardV2WidgetTreemapDefinitionRequestFormulaStyleArgs() {}

    private DashboardV2WidgetTreemapDefinitionRequestFormulaStyleArgs(DashboardV2WidgetTreemapDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetTreemapDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetTreemapDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetTreemapDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetTreemapDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetTreemapDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
