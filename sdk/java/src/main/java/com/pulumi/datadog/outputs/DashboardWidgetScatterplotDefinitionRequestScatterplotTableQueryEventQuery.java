...
import com.pulumi.datadog.outputs.DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryEventQueryGroupByFields;
...
public final class DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryEventQuery {
     ...
     * 
     */
    private @Nullable DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryEventQueryGroupByFields groupByFields;
    /**
     ...
     * 
     */
    public Optional<DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryEventQueryGroupByFields> groupByFields() {
    ...
    public static final class Builder {
        ...
        public Builder computes(List<DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryEventQueryCompute> computes) {
            if (computes == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryEventQuery", "computes");
            }
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryEventQuery", "dataSource");
            }
        ...
        @CustomType.Setter
        public Builder groupByFields(@Nullable DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryEventQueryGroupByFields groupByFields) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryEventQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryEventQuery build() {
            final var _resultValue = new DashboardWidgetScatterplotDefinitionRequestScatterplotTableQueryEventQuery();
