...
@CustomType
public final class PowerpackWidgetSunburstDefinitionLegendInline {
    /**
    ...
    public static Builder builder(PowerpackWidgetSunburstDefinitionLegendInline defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(PowerpackWidgetSunburstDefinitionLegendInline defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionLegendInline", "type");
            }
            this.type = type;
            return this;
        }
        public PowerpackWidgetSunburstDefinitionLegendInline build() {
            final var _resultValue = new PowerpackWidgetSunburstDefinitionLegendInline();
