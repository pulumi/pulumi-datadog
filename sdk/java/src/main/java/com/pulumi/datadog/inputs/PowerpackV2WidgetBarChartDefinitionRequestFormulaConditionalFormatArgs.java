...
public final class PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs(PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
