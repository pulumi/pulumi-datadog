...
@CustomType
public final class ObservabilityPipelineConfigSourceHttpServerTls {
    /**
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceHttpServerTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceHttpServerTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceHttpServerTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceHttpServerTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceHttpServerTls();
