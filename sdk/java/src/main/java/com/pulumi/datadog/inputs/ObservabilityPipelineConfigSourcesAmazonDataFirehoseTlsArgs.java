...
public final class ObservabilityPipelineConfigSourcesAmazonDataFirehoseTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcesAmazonDataFirehoseTlsArgs Empty = new ObservabilityPipelineConfigSourcesAmazonDataFirehoseTlsArgs();
    ...
    private ObservabilityPipelineConfigSourcesAmazonDataFirehoseTlsArgs() {}

    private ObservabilityPipelineConfigSourcesAmazonDataFirehoseTlsArgs(ObservabilityPipelineConfigSourcesAmazonDataFirehoseTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesAmazonDataFirehoseTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcesAmazonDataFirehoseTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcesAmazonDataFirehoseTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcesAmazonDataFirehoseTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcesAmazonDataFirehoseTlsArgs build() {
            return $;
        }
    }
