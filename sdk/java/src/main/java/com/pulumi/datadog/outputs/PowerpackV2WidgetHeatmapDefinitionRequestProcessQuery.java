...
@CustomType
public final class PowerpackV2WidgetHeatmapDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackV2WidgetHeatmapDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetHeatmapDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetHeatmapDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetHeatmapDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetHeatmapDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetHeatmapDefinitionRequestProcessQuery();
