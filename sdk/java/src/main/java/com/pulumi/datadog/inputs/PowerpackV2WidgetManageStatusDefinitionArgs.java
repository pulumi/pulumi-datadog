...
import com.pulumi.datadog.inputs.PowerpackV2WidgetManageStatusDefinitionTimeArgs;
...
public final class PowerpackV2WidgetManageStatusDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetManageStatusDefinitionArgs Empty = new PowerpackV2WidgetManageStatusDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetManageStatusDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetManageStatusDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetManageStatusDefinitionArgs() {}

    private PowerpackV2WidgetManageStatusDefinitionArgs(PowerpackV2WidgetManageStatusDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetManageStatusDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetManageStatusDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetManageStatusDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetManageStatusDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetManageStatusDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetManageStatusDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetManageStatusDefinitionArgs build() {
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetManageStatusDefinitionArgs", "query");
            }
            return $;
        }
    }
