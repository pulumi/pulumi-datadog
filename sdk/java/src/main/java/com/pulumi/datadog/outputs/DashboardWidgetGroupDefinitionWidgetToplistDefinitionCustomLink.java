...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetToplistDefinitionCustomLink {
    /**
    ...
    private DashboardWidgetGroupDefinitionWidgetToplistDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetToplistDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetToplistDefinitionCustomLink defaults) {
        ...
        public DashboardWidgetGroupDefinitionWidgetToplistDefinitionCustomLink build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetToplistDefinitionCustomLink();
