...
public final class DashboardV2WidgetChangeDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetChangeDefinitionRequestProcessQueryArgs Empty = new DashboardV2WidgetChangeDefinitionRequestProcessQueryArgs();
    ...
    private DashboardV2WidgetChangeDefinitionRequestProcessQueryArgs() {}

    private DashboardV2WidgetChangeDefinitionRequestProcessQueryArgs(DashboardV2WidgetChangeDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetChangeDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetChangeDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardV2WidgetChangeDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardV2WidgetChangeDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetChangeDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetChangeDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
