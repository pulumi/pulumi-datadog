...
public final class PowerpackV2WidgetChangeDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetChangeDefinitionRequestFormulaStyleArgs Empty = new PowerpackV2WidgetChangeDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackV2WidgetChangeDefinitionRequestFormulaStyleArgs() {}

    private PowerpackV2WidgetChangeDefinitionRequestFormulaStyleArgs(PowerpackV2WidgetChangeDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetChangeDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetChangeDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetChangeDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetChangeDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetChangeDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
