...
@CustomType
public final class PowerpackV2WidgetChangeDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackV2WidgetChangeDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetChangeDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetChangeDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetChangeDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetChangeDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetChangeDefinitionRequestProcessQuery();
