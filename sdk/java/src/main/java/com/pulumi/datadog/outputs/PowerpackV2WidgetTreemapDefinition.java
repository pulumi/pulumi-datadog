...
import com.pulumi.datadog.outputs.PowerpackV2WidgetTreemapDefinitionCustomLink;
import com.pulumi.datadog.outputs.PowerpackV2WidgetTreemapDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetTreemapDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetTreemapDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<PowerpackV2WidgetTreemapDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetTreemapDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetTreemapDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetTreemapDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<PowerpackV2WidgetTreemapDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<PowerpackV2WidgetTreemapDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetTreemapDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetTreemapDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetTreemapDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<PowerpackV2WidgetTreemapDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(PowerpackV2WidgetTreemapDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<PowerpackV2WidgetTreemapDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetTreemapDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetTreemapDefinitionTime time) {
        ...
        public PowerpackV2WidgetTreemapDefinition build() {
            final var _resultValue = new PowerpackV2WidgetTreemapDefinition();
