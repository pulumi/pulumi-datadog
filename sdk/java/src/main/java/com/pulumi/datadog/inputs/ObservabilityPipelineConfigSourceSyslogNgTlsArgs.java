...
public final class ObservabilityPipelineConfigSourceSyslogNgTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceSyslogNgTlsArgs Empty = new ObservabilityPipelineConfigSourceSyslogNgTlsArgs();
    ...
    private ObservabilityPipelineConfigSourceSyslogNgTlsArgs() {}

    private ObservabilityPipelineConfigSourceSyslogNgTlsArgs(ObservabilityPipelineConfigSourceSyslogNgTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceSyslogNgTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceSyslogNgTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceSyslogNgTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceSyslogNgTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceSyslogNgTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceSyslogNgTlsArgs", "crtFile");
            }
            return $;
        }
    }
