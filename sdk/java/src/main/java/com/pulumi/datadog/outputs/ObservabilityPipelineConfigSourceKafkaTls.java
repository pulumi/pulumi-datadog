...
@CustomType
public final class ObservabilityPipelineConfigSourceKafkaTls {
    /**
    ...
    private ObservabilityPipelineConfigSourceKafkaTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceKafkaTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceKafkaTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceKafkaTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceKafkaTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceKafkaTls();
