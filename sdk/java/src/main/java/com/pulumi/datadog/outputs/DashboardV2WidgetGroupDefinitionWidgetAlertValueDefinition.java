...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionTime time;
    /**
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unit;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinition defaults) {
        ...
        public Builder alertId(String alertId) {
            if (alertId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinition", "alertId");
            }
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionTime time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinition build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinition();
