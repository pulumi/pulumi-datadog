...
import com.pulumi.datadog.outputs.PowerpackV2WidgetTopologyMapDefinitionCustomLink;
import com.pulumi.datadog.outputs.PowerpackV2WidgetTopologyMapDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetTopologyMapDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetTopologyMapDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<PowerpackV2WidgetTopologyMapDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetTopologyMapDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetTopologyMapDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetTopologyMapDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<PowerpackV2WidgetTopologyMapDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<PowerpackV2WidgetTopologyMapDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetTopologyMapDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetTopologyMapDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetTopologyMapDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<PowerpackV2WidgetTopologyMapDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(PowerpackV2WidgetTopologyMapDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<PowerpackV2WidgetTopologyMapDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetTopologyMapDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetTopologyMapDefinitionTime time) {
        ...
        public PowerpackV2WidgetTopologyMapDefinition build() {
            final var _resultValue = new PowerpackV2WidgetTopologyMapDefinition();
