...
@CustomType
public final class DashboardWidgetQueryTableDefinitionRequestQueryMetricQuery {
    /**
    ...
    public static Builder builder(DashboardWidgetQueryTableDefinitionRequestQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
