...
@CustomType
public final class PowerpackWidgetGeomapDefinitionRequestFormulaStyle {
    /**
    ...
    private PowerpackWidgetGeomapDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetGeomapDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackWidgetGeomapDefinitionRequestFormulaStyle defaults) {
        ...
        public PowerpackWidgetGeomapDefinitionRequestFormulaStyle build() {
            final var _resultValue = new PowerpackWidgetGeomapDefinitionRequestFormulaStyle();
