...
@CustomType
public final class PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQuery {
    /**
    ...
    private PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQuery() {}
    /**
     * @return The aggregation methods available for cloud cost queries. Valid values are `avg`, `last`, `max`, `min`, `sum`, `percentile`.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQuery", "dataSource");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQuery", "query");
            }
            this.query = query;
            return this;
        }
        public PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQuery build() {
            final var _resultValue = new PowerpackWidgetQueryValueDefinitionRequestQueryCloudCostQuery();
