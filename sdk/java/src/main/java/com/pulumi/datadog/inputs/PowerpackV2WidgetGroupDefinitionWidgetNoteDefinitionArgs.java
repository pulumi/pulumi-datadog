...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param tickPos When `tick = true`, a string with a percent sign indicating the position of the tick, for example: `tickPos = &#34;50%&#34;` is centered alignment.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionArgs build() {
            if ($.content == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetNoteDefinitionArgs", "content");
            }
            return $;
        }
    }
