...
public final class MonitorVariablesEventQueryGroupBySort {
    ...
    public static Builder builder(MonitorVariablesEventQueryGroupBySort defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String order;
        public Builder() {}
        public Builder(MonitorVariablesEventQueryGroupBySort defaults) {
        ...
        public Builder aggregation(String aggregation) {
            if (aggregation == null) {
              throw new MissingRequiredPropertyException("MonitorVariablesEventQueryGroupBySort", "aggregation");
            }
        ...
        public MonitorVariablesEventQueryGroupBySort build() {
            final var _resultValue = new MonitorVariablesEventQueryGroupBySort();
