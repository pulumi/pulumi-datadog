...
public final class PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs(PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
