...
import com.pulumi.datadog.outputs.ObservabilityPipelineConfigProcessorGroupProcessorGenerateDatadogMetricsMetricValue;
...
@CustomType
public final class ObservabilityPipelineConfigProcessorGroupProcessorGenerateDatadogMetricsMetric {
    /**
    ...
    public static Builder builder(ObservabilityPipelineConfigProcessorGroupProcessorGenerateDatadogMetricsMetric defaults) {
    ...
    public static final class Builder {
        ...
        public Builder include(String include) {
            if (include == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigProcessorGroupProcessorGenerateDatadogMetricsMetric", "include");
            }
        ...
        public Builder metricType(String metricType) {
            if (metricType == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigProcessorGroupProcessorGenerateDatadogMetricsMetric", "metricType");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigProcessorGroupProcessorGenerateDatadogMetricsMetric", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public ObservabilityPipelineConfigProcessorGroupProcessorGenerateDatadogMetricsMetric build() {
            final var _resultValue = new ObservabilityPipelineConfigProcessorGroupProcessorGenerateDatadogMetricsMetric();
