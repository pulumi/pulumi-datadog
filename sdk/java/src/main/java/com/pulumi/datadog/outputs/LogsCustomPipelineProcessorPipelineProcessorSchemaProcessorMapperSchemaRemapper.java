...
@CustomType
public final class LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapper {
    /**
    ...
    public static Builder builder(LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapper defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String targetFormat;
        public Builder() {}
        public Builder(LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapper defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapper", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder sources(List<String> sources) {
            if (sources == null) {
              throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapper", "sources");
            }
        ...
        public Builder target(String target) {
            if (target == null) {
              throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapper", "target");
            }
            this.target = target;
            return this;
        }
        ...
        public LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapper build() {
            final var _resultValue = new LogsCustomPipelineProcessorPipelineProcessorSchemaProcessorMapperSchemaRemapper();
