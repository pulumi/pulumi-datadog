...
public final class DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs Empty = new DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs() {}

    private DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs(DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
