...
import com.pulumi.datadog.inputs.PowerpackV2WidgetCheckStatusDefinitionTimeArgs;
...
public final class PowerpackV2WidgetCheckStatusDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetCheckStatusDefinitionArgs Empty = new PowerpackV2WidgetCheckStatusDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetCheckStatusDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetCheckStatusDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetCheckStatusDefinitionArgs() {}

    private PowerpackV2WidgetCheckStatusDefinitionArgs(PowerpackV2WidgetCheckStatusDefinitionArgs $) {
        this.check = $.check;
    ...
    public static Builder builder(PowerpackV2WidgetCheckStatusDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetCheckStatusDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetCheckStatusDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetCheckStatusDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetCheckStatusDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetCheckStatusDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetCheckStatusDefinitionArgs build() {
            if ($.check == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetCheckStatusDefinitionArgs", "check");
            }
            if ($.grouping == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetCheckStatusDefinitionArgs", "grouping");
            }
            return $;
        }
    }
