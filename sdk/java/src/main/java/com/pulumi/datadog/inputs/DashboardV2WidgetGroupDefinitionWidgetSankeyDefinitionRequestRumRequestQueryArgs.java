...
public final class DashboardV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryArgs();
        }
        ...
        public DashboardV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryArgs", "dataSource");
            }
            if ($.mode == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryArgs", "mode");
            }
            if ($.queryString == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetSankeyDefinitionRequestRumRequestQueryArgs", "queryString");
            }
            return $;
        }
    }
