...
public final class PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs Empty = new PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs() {}

    private PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs(PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
