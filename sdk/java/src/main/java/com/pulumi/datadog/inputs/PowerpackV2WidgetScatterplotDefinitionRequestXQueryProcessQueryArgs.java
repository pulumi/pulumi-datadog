...
public final class PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs(PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
