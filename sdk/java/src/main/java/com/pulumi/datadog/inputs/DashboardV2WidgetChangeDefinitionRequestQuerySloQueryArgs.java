...
public final class DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs Empty = new DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs();
    ...
    private DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs() {}

    private DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs(DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetChangeDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
