...
@CustomType
public final class ObservabilityPipelineConfigDestinationGooglePubsubTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationGooglePubsubTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationGooglePubsubTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationGooglePubsubTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationGooglePubsubTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigDestinationGooglePubsubTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationGooglePubsubTls();
