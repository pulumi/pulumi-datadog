...
@CustomType
public final class PowerpackWidgetTreemapDefinitionRequestQuerySloQuery {
    /**
    ...
    private PowerpackWidgetTreemapDefinitionRequestQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetTreemapDefinitionRequestQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(PowerpackWidgetTreemapDefinitionRequestQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public PowerpackWidgetTreemapDefinitionRequestQuerySloQuery build() {
            final var _resultValue = new PowerpackWidgetTreemapDefinitionRequestQuerySloQuery();
