...
public final class DashboardV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs Empty = new DashboardV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs();
    ...
    private DashboardV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs() {}

    private DashboardV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs(DashboardV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs build() {
            return $;
        }
    }
