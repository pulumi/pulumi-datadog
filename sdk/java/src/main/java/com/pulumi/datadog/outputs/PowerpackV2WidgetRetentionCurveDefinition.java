...
import com.pulumi.datadog.outputs.PowerpackV2WidgetRetentionCurveDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetRetentionCurveDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetRetentionCurveDefinition {
    /**
     ...
     * 
     */
    private List<PowerpackV2WidgetRetentionCurveDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetRetentionCurveDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetRetentionCurveDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetRetentionCurveDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetRetentionCurveDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetRetentionCurveDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetRetentionCurveDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder requests(List<PowerpackV2WidgetRetentionCurveDefinitionRequest> requests) {
            if (requests == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetRetentionCurveDefinition", "requests");
            }
            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetRetentionCurveDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetRetentionCurveDefinitionTime time) {
        ...
        public PowerpackV2WidgetRetentionCurveDefinition build() {
            final var _resultValue = new PowerpackV2WidgetRetentionCurveDefinition();
