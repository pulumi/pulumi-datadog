...
@CustomType
public final class ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String serverName;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTls();
