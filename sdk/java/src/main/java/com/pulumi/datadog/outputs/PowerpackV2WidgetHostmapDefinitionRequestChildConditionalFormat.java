...
@CustomType
public final class PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormat {
    /**
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormat() {}
    /**
     * @return The comparator to use. Valid values are `=`, `&gt;`, `&gt;=`, `&lt;`, `&lt;=`.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormat defaults) {
    ...
    public static final class Builder {
        ...
        private Double value;
        public Builder() {}
        public Builder(PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormat defaults) {
        ...
        public Builder comparator(String comparator) {
            if (comparator == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormat", "comparator");
            }
        ...
        public Builder palette(String palette) {
            if (palette == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormat", "palette");
            }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormat", "value");
            }
            this.value = value;
            return this;
        }
        public PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormat build() {
            final var _resultValue = new PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormat();
