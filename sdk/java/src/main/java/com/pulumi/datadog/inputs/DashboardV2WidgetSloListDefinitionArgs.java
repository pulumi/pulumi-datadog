...
import com.pulumi.datadog.inputs.DashboardV2WidgetSloListDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetSloListDefinitionTimeArgs;
...
public final class DashboardV2WidgetSloListDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetSloListDefinitionArgs Empty = new DashboardV2WidgetSloListDefinitionArgs();
    ...
    private Output<List<DashboardV2WidgetSloListDefinitionRequestArgs>> requests;

    /**
     * @return A nested block describing the request to use when displaying the widget. Exactly one `request` block is allowed.
     * 
     */
    public Output<List<DashboardV2WidgetSloListDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetSloListDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetSloListDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetSloListDefinitionArgs() {}

    private DashboardV2WidgetSloListDefinitionArgs(DashboardV2WidgetSloListDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetSloListDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetSloListDefinitionArgs();
        }

        public Builder(DashboardV2WidgetSloListDefinitionArgs defaults) {
            $ = new DashboardV2WidgetSloListDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<DashboardV2WidgetSloListDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetSloListDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetSloListDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetSloListDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetSloListDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetSloListDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetSloListDefinitionArgs", "requests");
            }
            return $;
        }
    }
