...
@CustomType
public final class PowerpackWidgetSunburstDefinitionRequestFormulaStyle {
    /**
    ...
    private PowerpackWidgetSunburstDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetSunburstDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackWidgetSunburstDefinitionRequestFormulaStyle defaults) {
        ...
        public PowerpackWidgetSunburstDefinitionRequestFormulaStyle build() {
            final var _resultValue = new PowerpackWidgetSunburstDefinitionRequestFormulaStyle();
