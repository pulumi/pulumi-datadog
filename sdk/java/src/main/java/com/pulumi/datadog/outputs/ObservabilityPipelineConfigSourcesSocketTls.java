...
@CustomType
public final class ObservabilityPipelineConfigSourcesSocketTls {
    /**
    ...
    private ObservabilityPipelineConfigSourcesSocketTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesSocketTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesSocketTls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesSocketTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesSocketTls();
