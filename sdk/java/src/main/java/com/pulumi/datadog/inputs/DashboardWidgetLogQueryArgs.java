...
public final class DashboardWidgetLogQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetLogQueryArgs Empty = new DashboardWidgetLogQueryArgs();
    ...
    private @Nullable Output<DashboardWidgetLogQueryComputeQueryArgs> computeQuery;

    /**
     * @return `compute_query` or `multi_compute` is required. The map keys are listed below.
     * 
     */
    public Optional<Output<DashboardWidgetLogQueryComputeQueryArgs>> computeQuery() {
    ...
    private @Nullable Output<List<DashboardWidgetLogQueryMultiComputeArgs>> multiComputes;

    /**
     * @return `compute_query` or `multi_compute` is required. Multiple `multi_compute` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardWidgetLogQueryMultiComputeArgs>>> multiComputes() {
    ...
    private DashboardWidgetLogQueryArgs() {}

    private DashboardWidgetLogQueryArgs(DashboardWidgetLogQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetLogQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetLogQueryArgs();
        }

        public Builder(DashboardWidgetLogQueryArgs defaults) {
            $ = new DashboardWidgetLogQueryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder computeQuery(@Nullable Output<DashboardWidgetLogQueryComputeQueryArgs> computeQuery) {
         ...
         * 
         */
        public Builder computeQuery(DashboardWidgetLogQueryComputeQueryArgs computeQuery) {
         ...
         * 
         */
        public Builder multiComputes(@Nullable Output<List<DashboardWidgetLogQueryMultiComputeArgs>> multiComputes) {
         ...
         * 
         */
        public Builder multiComputes(List<DashboardWidgetLogQueryMultiComputeArgs> multiComputes) {
         ...
         * 
         */
        public Builder multiComputes(DashboardWidgetLogQueryMultiComputeArgs... multiComputes) {
        ...
        public DashboardWidgetLogQueryArgs build() {
            if ($.index == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetLogQueryArgs", "index");
            }
            return $;
        }
    }
