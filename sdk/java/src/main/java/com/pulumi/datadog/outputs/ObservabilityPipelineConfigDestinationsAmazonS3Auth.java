...
@CustomType
public final class ObservabilityPipelineConfigDestinationsAmazonS3Auth {
    /**
    ...
    private ObservabilityPipelineConfigDestinationsAmazonS3Auth() {}
    /**
     * @return The Amazon Resource Name (ARN) of the role to assume.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationsAmazonS3Auth defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionName;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationsAmazonS3Auth defaults) {
        ...
        public ObservabilityPipelineConfigDestinationsAmazonS3Auth build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationsAmazonS3Auth();
