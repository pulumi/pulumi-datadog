...
public final class ObservabilityPipelineConfigSourceSocketTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceSocketTlsArgs Empty = new ObservabilityPipelineConfigSourceSocketTlsArgs();
    ...
    private ObservabilityPipelineConfigSourceSocketTlsArgs() {}

    private ObservabilityPipelineConfigSourceSocketTlsArgs(ObservabilityPipelineConfigSourceSocketTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceSocketTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceSocketTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceSocketTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceSocketTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceSocketTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceSocketTlsArgs", "crtFile");
            }
            return $;
        }
    }
