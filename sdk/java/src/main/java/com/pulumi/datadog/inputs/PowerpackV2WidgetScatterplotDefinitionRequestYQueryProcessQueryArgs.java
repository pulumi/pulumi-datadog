...
public final class PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs(PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
