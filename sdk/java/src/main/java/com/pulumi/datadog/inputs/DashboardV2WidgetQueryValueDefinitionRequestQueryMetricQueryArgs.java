...
public final class DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs Empty = new DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs() {}

    private DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs(DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
