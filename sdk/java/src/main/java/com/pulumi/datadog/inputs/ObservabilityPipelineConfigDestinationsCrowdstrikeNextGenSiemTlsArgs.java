...
public final class ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTlsArgs Empty = new ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTlsArgs() {}

    private ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTlsArgs(ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTlsArgs build() {
            return $;
        }
    }
