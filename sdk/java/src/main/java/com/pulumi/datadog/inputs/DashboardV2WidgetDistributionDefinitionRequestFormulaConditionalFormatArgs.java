...
public final class DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs Empty = new DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs() {}

    private DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs(DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
