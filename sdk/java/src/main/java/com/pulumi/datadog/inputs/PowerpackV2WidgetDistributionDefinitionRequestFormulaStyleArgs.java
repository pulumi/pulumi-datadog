...
public final class PowerpackV2WidgetDistributionDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetDistributionDefinitionRequestFormulaStyleArgs Empty = new PowerpackV2WidgetDistributionDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackV2WidgetDistributionDefinitionRequestFormulaStyleArgs() {}

    private PowerpackV2WidgetDistributionDefinitionRequestFormulaStyleArgs(PowerpackV2WidgetDistributionDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetDistributionDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetDistributionDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetDistributionDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetDistributionDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetDistributionDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
