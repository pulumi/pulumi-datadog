...
public final class PowerpackV2WidgetHeatmapDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHeatmapDefinitionRequestProcessQueryArgs Empty = new PowerpackV2WidgetHeatmapDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackV2WidgetHeatmapDefinitionRequestProcessQueryArgs() {}

    private PowerpackV2WidgetHeatmapDefinitionRequestProcessQueryArgs(PowerpackV2WidgetHeatmapDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHeatmapDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHeatmapDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetHeatmapDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetHeatmapDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHeatmapDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHeatmapDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
