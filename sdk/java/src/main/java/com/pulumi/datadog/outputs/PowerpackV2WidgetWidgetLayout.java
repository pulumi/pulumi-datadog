...
@CustomType
public final class PowerpackV2WidgetWidgetLayout {
    /**
    ...
    private PowerpackV2WidgetWidgetLayout() {}
    /**
     * @return The height of the widget.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetWidgetLayout defaults) {
    ...
    public static final class Builder {
        ...
        private Integer y;
        public Builder() {}
        public Builder(PowerpackV2WidgetWidgetLayout defaults) {
        ...
        public Builder height(Integer height) {
            if (height == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetWidgetLayout", "height");
            }
            this.height = height;
            return this;
        }
        ...
        public Builder width(Integer width) {
            if (width == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetWidgetLayout", "width");
            }
            this.width = width;
            return this;
        }
        ...
        public Builder x(Integer x) {
            if (x == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetWidgetLayout", "x");
            }
            this.x = x;
            return this;
        }
        ...
        public Builder y(Integer y) {
            if (y == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetWidgetLayout", "y");
            }
            this.y = y;
            return this;
        }
        public PowerpackV2WidgetWidgetLayout build() {
            final var _resultValue = new PowerpackV2WidgetWidgetLayout();
