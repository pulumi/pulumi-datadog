...
public final class PowerpackV2WidgetChangeDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetChangeDefinitionRequestProcessQueryArgs Empty = new PowerpackV2WidgetChangeDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackV2WidgetChangeDefinitionRequestProcessQueryArgs() {}

    private PowerpackV2WidgetChangeDefinitionRequestProcessQueryArgs(PowerpackV2WidgetChangeDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetChangeDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetChangeDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetChangeDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetChangeDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetChangeDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetChangeDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
