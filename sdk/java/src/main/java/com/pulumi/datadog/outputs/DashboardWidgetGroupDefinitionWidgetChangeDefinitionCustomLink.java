...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetChangeDefinitionCustomLink {
    /**
    ...
    private DashboardWidgetGroupDefinitionWidgetChangeDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetChangeDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetChangeDefinitionCustomLink defaults) {
        ...
        public DashboardWidgetGroupDefinitionWidgetChangeDefinitionCustomLink build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetChangeDefinitionCustomLink();
