...
@CustomType
public final class DashboardWidgetQueryValueDefinitionRequestSecurityQuery {
    /**
     * @return `compute_query` or `multi_compute` is required. The map keys are listed below.
     * 
     */
    private @Nullable DashboardWidgetQueryValueDefinitionRequestSecurityQueryComputeQuery computeQuery;
    /**
     * @return Multiple `group_by` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardWidgetQueryValueDefinitionRequestSecurityQueryGroupBy> groupBies;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardWidgetQueryValueDefinitionRequestSecurityQueryMultiCompute> multiComputes;
    /**
     ...
     * 
     */
    public Optional<DashboardWidgetQueryValueDefinitionRequestSecurityQueryComputeQuery> computeQuery() {
     ...
     * 
     */
    public List<DashboardWidgetQueryValueDefinitionRequestSecurityQueryGroupBy> groupBies() {
     ...
     * 
     */
    public List<DashboardWidgetQueryValueDefinitionRequestSecurityQueryMultiCompute> multiComputes() {
    ...
    public static Builder builder(DashboardWidgetQueryValueDefinitionRequestSecurityQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchQuery;
        public Builder() {}
        public Builder(DashboardWidgetQueryValueDefinitionRequestSecurityQuery defaults) {
        ...
        public Builder groupBies(DashboardWidgetQueryValueDefinitionRequestSecurityQueryGroupBy... groupBies) {
        ...
        public Builder multiComputes(DashboardWidgetQueryValueDefinitionRequestSecurityQueryMultiCompute... multiComputes) {
        ...
        public DashboardWidgetQueryValueDefinitionRequestSecurityQuery build() {
            final var _resultValue = new DashboardWidgetQueryValueDefinitionRequestSecurityQuery();
