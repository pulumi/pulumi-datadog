...
public final class DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs Empty = new DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs() {}

    private DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs(DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
