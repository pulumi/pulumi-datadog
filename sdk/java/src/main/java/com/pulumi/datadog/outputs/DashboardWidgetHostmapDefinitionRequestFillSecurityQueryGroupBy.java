...
import com.pulumi.datadog.outputs.DashboardWidgetHostmapDefinitionRequestFillSecurityQueryGroupBySortQuery;
...
public final class DashboardWidgetHostmapDefinitionRequestFillSecurityQueryGroupBy {
    ...
    public static Builder builder(DashboardWidgetHostmapDefinitionRequestFillSecurityQueryGroupBy defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable DashboardWidgetHostmapDefinitionRequestFillSecurityQueryGroupBySortQuery sortQuery;
        public Builder() {}
        public Builder(DashboardWidgetHostmapDefinitionRequestFillSecurityQueryGroupBy defaults) {
        ...
        @CustomType.Setter
        public Builder sortQuery(@Nullable DashboardWidgetHostmapDefinitionRequestFillSecurityQueryGroupBySortQuery sortQuery) {

            this.sortQuery = sortQuery;
            return this;
        }
        public DashboardWidgetHostmapDefinitionRequestFillSecurityQueryGroupBy build() {
            final var _resultValue = new DashboardWidgetHostmapDefinitionRequestFillSecurityQueryGroupBy();
