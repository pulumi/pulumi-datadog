...
public final class PowerpackV2WidgetGeomapDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGeomapDefinitionRequestFormulaStyleArgs Empty = new PowerpackV2WidgetGeomapDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackV2WidgetGeomapDefinitionRequestFormulaStyleArgs() {}

    private PowerpackV2WidgetGeomapDefinitionRequestFormulaStyleArgs(PowerpackV2WidgetGeomapDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGeomapDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGeomapDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetGeomapDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetGeomapDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetGeomapDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
