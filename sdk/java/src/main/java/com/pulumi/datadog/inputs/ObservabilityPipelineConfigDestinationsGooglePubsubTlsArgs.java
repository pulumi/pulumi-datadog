...
public final class ObservabilityPipelineConfigDestinationsGooglePubsubTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationsGooglePubsubTlsArgs Empty = new ObservabilityPipelineConfigDestinationsGooglePubsubTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationsGooglePubsubTlsArgs() {}

    private ObservabilityPipelineConfigDestinationsGooglePubsubTlsArgs(ObservabilityPipelineConfigDestinationsGooglePubsubTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationsGooglePubsubTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationsGooglePubsubTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationsGooglePubsubTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationsGooglePubsubTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationsGooglePubsubTlsArgs build() {
            return $;
        }
    }
