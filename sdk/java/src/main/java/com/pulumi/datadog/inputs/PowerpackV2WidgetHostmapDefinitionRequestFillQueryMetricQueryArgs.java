...
public final class PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs Empty = new PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs() {}

    private PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs(PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestFillQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
