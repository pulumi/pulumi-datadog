...
public final class PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs(PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
