...
public final class PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs Empty = new PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs();
    ...
    private PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs() {}

    private PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs(PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs();
        }

        public Builder(PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs defaults) {
            $ = new PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
