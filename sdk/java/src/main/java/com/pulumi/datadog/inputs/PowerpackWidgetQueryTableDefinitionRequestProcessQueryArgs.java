...
public final class PowerpackWidgetQueryTableDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryTableDefinitionRequestProcessQueryArgs Empty = new PowerpackWidgetQueryTableDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackWidgetQueryTableDefinitionRequestProcessQueryArgs() {}

    private PowerpackWidgetQueryTableDefinitionRequestProcessQueryArgs(PowerpackWidgetQueryTableDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryTableDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryTableDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackWidgetQueryTableDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackWidgetQueryTableDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetQueryTableDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
