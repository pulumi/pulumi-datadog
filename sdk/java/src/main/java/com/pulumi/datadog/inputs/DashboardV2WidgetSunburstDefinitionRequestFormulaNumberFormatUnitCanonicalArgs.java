...
public final class DashboardV2WidgetSunburstDefinitionRequestFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetSunburstDefinitionRequestFormulaNumberFormatUnitCanonicalArgs Empty = new DashboardV2WidgetSunburstDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
    ...
    private DashboardV2WidgetSunburstDefinitionRequestFormulaNumberFormatUnitCanonicalArgs() {}

    private DashboardV2WidgetSunburstDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(DashboardV2WidgetSunburstDefinitionRequestFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetSunburstDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetSunburstDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(DashboardV2WidgetSunburstDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new DashboardV2WidgetSunburstDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetSunburstDefinitionRequestFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
