...
public final class DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs Empty = new DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs();
    ...
    private DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs() {}

    private DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs(DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs build() {
            return $;
        }
    }
