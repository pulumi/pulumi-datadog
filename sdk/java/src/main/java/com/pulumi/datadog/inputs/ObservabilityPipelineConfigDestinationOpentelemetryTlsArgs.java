...
public final class ObservabilityPipelineConfigDestinationOpentelemetryTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationOpentelemetryTlsArgs Empty = new ObservabilityPipelineConfigDestinationOpentelemetryTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationOpentelemetryTlsArgs() {}

    private ObservabilityPipelineConfigDestinationOpentelemetryTlsArgs(ObservabilityPipelineConfigDestinationOpentelemetryTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationOpentelemetryTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationOpentelemetryTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationOpentelemetryTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationOpentelemetryTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationOpentelemetryTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationOpentelemetryTlsArgs", "crtFile");
            }
            return $;
        }
    }
