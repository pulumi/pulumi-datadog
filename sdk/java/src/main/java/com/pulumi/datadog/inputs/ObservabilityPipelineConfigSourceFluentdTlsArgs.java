...
public final class ObservabilityPipelineConfigSourceFluentdTlsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceFluentdTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceFluentdTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceFluentdTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceFluentdTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceFluentdTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceFluentdTlsArgs", "crtFile");
            }
            return $;
        }
    }
