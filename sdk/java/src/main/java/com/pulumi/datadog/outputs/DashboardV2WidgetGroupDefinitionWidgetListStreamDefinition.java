...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetListStreamDefinition {
    /**
     ...
     * 
     */
    private List<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequest> requests;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetListStreamDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetListStreamDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetListStreamDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder requests(List<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequest> requests) {
            if (requests == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetListStreamDefinition", "requests");
            }
            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequest... requests) {
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionTime time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetListStreamDefinition build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetListStreamDefinition();
