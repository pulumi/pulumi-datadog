...
public final class DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs Empty = new DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs() {}

    private DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs(DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetChangeDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
