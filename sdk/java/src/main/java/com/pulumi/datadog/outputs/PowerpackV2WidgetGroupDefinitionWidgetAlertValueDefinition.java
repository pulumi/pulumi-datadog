...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinition() {}
    /**
     * @return The ID of the monitor used by the widget.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unit;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinition defaults) {
        ...
        public Builder alertId(String alertId) {
            if (alertId == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinition", "alertId");
            }
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinitionTime time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetAlertValueDefinition();
