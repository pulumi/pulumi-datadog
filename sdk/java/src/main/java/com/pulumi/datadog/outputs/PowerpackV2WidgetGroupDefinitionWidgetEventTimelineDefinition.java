...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinition defaults) {
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinition", "query");
            }
            this.query = query;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTime time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinition();
