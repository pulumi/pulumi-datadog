...
public final class DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs();
    ...
    private DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildConditionalFormatArgs", "value");
            }
            return $;
        }
    }
