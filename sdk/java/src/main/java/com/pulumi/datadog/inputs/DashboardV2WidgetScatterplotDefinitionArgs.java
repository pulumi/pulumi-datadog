...
import com.pulumi.datadog.inputs.DashboardV2WidgetScatterplotDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetScatterplotDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetScatterplotDefinitionTimeArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetScatterplotDefinitionXaxisArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetScatterplotDefinitionYaxisArgs;
...
public final class DashboardV2WidgetScatterplotDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetScatterplotDefinitionArgs Empty = new DashboardV2WidgetScatterplotDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetScatterplotDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetScatterplotDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="request")
    private @Nullable Output<DashboardV2WidgetScatterplotDefinitionRequestArgs> request;
     ...
     * 
     */
    public Optional<Output<DashboardV2WidgetScatterplotDefinitionRequestArgs>> request() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetScatterplotDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetScatterplotDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="xaxis")
    private @Nullable Output<DashboardV2WidgetScatterplotDefinitionXaxisArgs> xaxis;

    /**
     * @return A nested block describing the X-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<DashboardV2WidgetScatterplotDefinitionXaxisArgs>> xaxis() {
     ...
     */
    @Import(name="yaxis")
    private @Nullable Output<DashboardV2WidgetScatterplotDefinitionYaxisArgs> yaxis;

    /**
     * @return A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<DashboardV2WidgetScatterplotDefinitionYaxisArgs>> yaxis() {
        return Optional.ofNullable(this.yaxis);
    }

    private DashboardV2WidgetScatterplotDefinitionArgs() {}

    private DashboardV2WidgetScatterplotDefinitionArgs(DashboardV2WidgetScatterplotDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetScatterplotDefinitionArgs();
        }

        public Builder(DashboardV2WidgetScatterplotDefinitionArgs defaults) {
            $ = new DashboardV2WidgetScatterplotDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetScatterplotDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetScatterplotDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetScatterplotDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder request(@Nullable Output<DashboardV2WidgetScatterplotDefinitionRequestArgs> request) {
            $.request = request;
            return this;
        }
         ...
         * 
         */
        public Builder request(DashboardV2WidgetScatterplotDefinitionRequestArgs request) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetScatterplotDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetScatterplotDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder xaxis(@Nullable Output<DashboardV2WidgetScatterplotDefinitionXaxisArgs> xaxis) {
            $.xaxis = xaxis;
            return this;
        }
         ...
         * 
         */
        public Builder xaxis(DashboardV2WidgetScatterplotDefinitionXaxisArgs xaxis) {
         ...
         * 
         */
        public Builder yaxis(@Nullable Output<DashboardV2WidgetScatterplotDefinitionYaxisArgs> yaxis) {
            $.yaxis = yaxis;
            return this;
        }
         ...
         * 
         */
        public Builder yaxis(DashboardV2WidgetScatterplotDefinitionYaxisArgs yaxis) {
            return yaxis(Output.of(yaxis));
        }

        public DashboardV2WidgetScatterplotDefinitionArgs build() {
            return $;
        }
    }
