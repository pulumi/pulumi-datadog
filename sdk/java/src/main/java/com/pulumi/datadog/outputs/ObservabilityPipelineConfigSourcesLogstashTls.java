...
@CustomType
public final class ObservabilityPipelineConfigSourcesLogstashTls {
    /**
    ...
    private ObservabilityPipelineConfigSourcesLogstashTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesLogstashTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesLogstashTls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesLogstashTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesLogstashTls();
