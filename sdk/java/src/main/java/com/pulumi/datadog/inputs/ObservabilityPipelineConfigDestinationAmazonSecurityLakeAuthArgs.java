...
public final class ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuthArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuthArgs Empty = new ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuthArgs();
    ...
    private ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuthArgs() {}

    private ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuthArgs(ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuthArgs $) {
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuthArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuthArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuthArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuthArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuthArgs build() {
            return $;
        }
    }
