...
public final class PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs Empty = new PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs() {}

    private PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs(PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
