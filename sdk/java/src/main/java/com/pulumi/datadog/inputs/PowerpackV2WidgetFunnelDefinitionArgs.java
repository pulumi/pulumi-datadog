...
import com.pulumi.datadog.inputs.PowerpackV2WidgetFunnelDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetFunnelDefinitionTimeArgs;
...
public final class PowerpackV2WidgetFunnelDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetFunnelDefinitionArgs Empty = new PowerpackV2WidgetFunnelDefinitionArgs();
     ...
     */
    @Import(name="request")
    private @Nullable Output<PowerpackV2WidgetFunnelDefinitionRequestArgs> request;

    /**
     * @return A nested block describing the request to use when displaying the widget. Only one `request` block is allowed.
     * 
     */
    public Optional<Output<PowerpackV2WidgetFunnelDefinitionRequestArgs>> request() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetFunnelDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetFunnelDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetFunnelDefinitionArgs() {}

    private PowerpackV2WidgetFunnelDefinitionArgs(PowerpackV2WidgetFunnelDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetFunnelDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetFunnelDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetFunnelDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetFunnelDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder request(@Nullable Output<PowerpackV2WidgetFunnelDefinitionRequestArgs> request) {
            $.request = request;
            return this;
        }
         ...
         * 
         */
        public Builder request(PowerpackV2WidgetFunnelDefinitionRequestArgs request) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetFunnelDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetFunnelDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetFunnelDefinitionArgs build() {
            return $;
        }
    }
