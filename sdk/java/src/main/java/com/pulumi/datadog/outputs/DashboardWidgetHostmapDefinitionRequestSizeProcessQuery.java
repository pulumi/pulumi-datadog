...
@CustomType
public final class DashboardWidgetHostmapDefinitionRequestSizeProcessQuery {
    /**
    ...
    private DashboardWidgetHostmapDefinitionRequestSizeProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetHostmapDefinitionRequestSizeProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetHostmapDefinitionRequestSizeProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetHostmapDefinitionRequestSizeProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardWidgetHostmapDefinitionRequestSizeProcessQuery build() {
            final var _resultValue = new DashboardWidgetHostmapDefinitionRequestSizeProcessQuery();
