...
public final class PowerpackV2WidgetToplistDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetToplistDefinitionRequestFormulaStyleArgs Empty = new PowerpackV2WidgetToplistDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackV2WidgetToplistDefinitionRequestFormulaStyleArgs() {}

    private PowerpackV2WidgetToplistDefinitionRequestFormulaStyleArgs(PowerpackV2WidgetToplistDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetToplistDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetToplistDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetToplistDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetToplistDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetToplistDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
