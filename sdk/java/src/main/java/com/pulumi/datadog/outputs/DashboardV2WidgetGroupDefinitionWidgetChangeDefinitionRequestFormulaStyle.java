...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetChangeDefinitionRequestFormulaStyle {
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetChangeDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetChangeDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetChangeDefinitionRequestFormulaStyle defaults) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetChangeDefinitionRequestFormulaStyle build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetChangeDefinitionRequestFormulaStyle();
