...
@CustomType
public final class DashboardWidgetQueryTableDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardWidgetQueryTableDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetQueryTableDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetQueryTableDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardWidgetQueryTableDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardWidgetQueryTableDefinitionRequestProcessQuery();
