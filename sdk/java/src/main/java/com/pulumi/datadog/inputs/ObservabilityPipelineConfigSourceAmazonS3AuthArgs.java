...
public final class ObservabilityPipelineConfigSourceAmazonS3AuthArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceAmazonS3AuthArgs Empty = new ObservabilityPipelineConfigSourceAmazonS3AuthArgs();
    ...
    private ObservabilityPipelineConfigSourceAmazonS3AuthArgs() {}

    private ObservabilityPipelineConfigSourceAmazonS3AuthArgs(ObservabilityPipelineConfigSourceAmazonS3AuthArgs $) {
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceAmazonS3AuthArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceAmazonS3AuthArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceAmazonS3AuthArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceAmazonS3AuthArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceAmazonS3AuthArgs build() {
            return $;
        }
    }
