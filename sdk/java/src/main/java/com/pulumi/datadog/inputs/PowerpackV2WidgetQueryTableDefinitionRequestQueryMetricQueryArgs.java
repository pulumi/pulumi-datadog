...
public final class PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs Empty = new PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs() {}

    private PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs(PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
