...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetImageDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetImageDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetImageDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetImageDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetImageDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetImageDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String verticalAlign;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetImageDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetGroupDefinitionWidgetImageDefinitionTime time) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetImageDefinition", "url");
            }
            this.url = url;
            return this;
        }
        ...
        public DashboardV2WidgetGroupDefinitionWidgetImageDefinition build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetImageDefinition();
