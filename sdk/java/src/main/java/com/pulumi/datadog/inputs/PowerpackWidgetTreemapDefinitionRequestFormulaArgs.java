...
public final class PowerpackWidgetTreemapDefinitionRequestFormulaArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetTreemapDefinitionRequestFormulaArgs Empty = new PowerpackWidgetTreemapDefinitionRequestFormulaArgs();
    ...
    private @Nullable Output<List<PowerpackWidgetTreemapDefinitionRequestFormulaConditionalFormatArgs>> conditionalFormats;
     ...
     * 
     */
    public Optional<Output<List<PowerpackWidgetTreemapDefinitionRequestFormulaConditionalFormatArgs>>> conditionalFormats() {
     ...
     */
    @Import(name="limit")
    private @Nullable Output<PowerpackWidgetTreemapDefinitionRequestFormulaLimitArgs> limit;

    /**
     * @return The options for limiting results returned.
     * 
     */
    public Optional<Output<PowerpackWidgetTreemapDefinitionRequestFormulaLimitArgs>> limit() {
     ...
     */
    @Import(name="style")
    private @Nullable Output<PowerpackWidgetTreemapDefinitionRequestFormulaStyleArgs> style;

    /**
     * @return Styling options for widget formulas.
     * 
     */
    public Optional<Output<PowerpackWidgetTreemapDefinitionRequestFormulaStyleArgs>> style() {
        return Optional.ofNullable(this.style);
    }

    private PowerpackWidgetTreemapDefinitionRequestFormulaArgs() {}

    private PowerpackWidgetTreemapDefinitionRequestFormulaArgs(PowerpackWidgetTreemapDefinitionRequestFormulaArgs $) {
        this.alias = $.alias;
    ...
    public static Builder builder(PowerpackWidgetTreemapDefinitionRequestFormulaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetTreemapDefinitionRequestFormulaArgs();
        }

        public Builder(PowerpackWidgetTreemapDefinitionRequestFormulaArgs defaults) {
            $ = new PowerpackWidgetTreemapDefinitionRequestFormulaArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder conditionalFormats(@Nullable Output<List<PowerpackWidgetTreemapDefinitionRequestFormulaConditionalFormatArgs>> conditionalFormats) {
         ...
         * 
         */
        public Builder conditionalFormats(List<PowerpackWidgetTreemapDefinitionRequestFormulaConditionalFormatArgs> conditionalFormats) {
         ...
         * 
         */
        public Builder conditionalFormats(PowerpackWidgetTreemapDefinitionRequestFormulaConditionalFormatArgs... conditionalFormats) {
         ...
         * 
         */
        public Builder limit(@Nullable Output<PowerpackWidgetTreemapDefinitionRequestFormulaLimitArgs> limit) {
            $.limit = limit;
            return this;
        }
         ...
         * 
         */
        public Builder style(@Nullable Output<PowerpackWidgetTreemapDefinitionRequestFormulaStyleArgs> style) {
            $.style = style;
            return this;
        }
         ...
         * 
         */
        public Builder style(PowerpackWidgetTreemapDefinitionRequestFormulaStyleArgs style) {
            return style(Output.of(style));
        }

        public PowerpackWidgetTreemapDefinitionRequestFormulaArgs build() {
            if ($.formulaExpression == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestFormulaArgs", "formulaExpression");
            }
            return $;
        }
    }
