...
@CustomType
public final class PowerpackV2WidgetQueryTableDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackV2WidgetQueryTableDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetQueryTableDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetQueryTableDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetQueryTableDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetQueryTableDefinitionRequestProcessQuery();
