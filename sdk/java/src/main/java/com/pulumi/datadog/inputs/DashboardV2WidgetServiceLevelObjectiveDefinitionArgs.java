...
import com.pulumi.datadog.inputs.DashboardV2WidgetServiceLevelObjectiveDefinitionTimeArgs;
...
public final class DashboardV2WidgetServiceLevelObjectiveDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetServiceLevelObjectiveDefinitionArgs Empty = new DashboardV2WidgetServiceLevelObjectiveDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetServiceLevelObjectiveDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetServiceLevelObjectiveDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetServiceLevelObjectiveDefinitionArgs() {}

    private DashboardV2WidgetServiceLevelObjectiveDefinitionArgs(DashboardV2WidgetServiceLevelObjectiveDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetServiceLevelObjectiveDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetServiceLevelObjectiveDefinitionArgs();
        }

        public Builder(DashboardV2WidgetServiceLevelObjectiveDefinitionArgs defaults) {
            $ = new DashboardV2WidgetServiceLevelObjectiveDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetServiceLevelObjectiveDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetServiceLevelObjectiveDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetServiceLevelObjectiveDefinitionArgs build() {
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetServiceLevelObjectiveDefinitionArgs", "sloId");
            }
            if ($.timeWindows == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetServiceLevelObjectiveDefinitionArgs", "timeWindows");
            }
            if ($.viewMode == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetServiceLevelObjectiveDefinitionArgs", "viewMode");
            }
            if ($.viewType == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetServiceLevelObjectiveDefinitionArgs", "viewType");
            }
            return $;
        }
    }
