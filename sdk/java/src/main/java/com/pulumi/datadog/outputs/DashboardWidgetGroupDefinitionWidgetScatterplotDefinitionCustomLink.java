...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionCustomLink {
    /**
    ...
    private DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionCustomLink defaults) {
        ...
        public DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionCustomLink build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionCustomLink();
