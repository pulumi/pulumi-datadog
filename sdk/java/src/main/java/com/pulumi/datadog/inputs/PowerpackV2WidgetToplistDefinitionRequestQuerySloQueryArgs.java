...
public final class PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs Empty = new PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs(PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
