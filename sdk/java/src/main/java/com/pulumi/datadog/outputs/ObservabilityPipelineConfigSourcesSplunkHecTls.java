...
@CustomType
public final class ObservabilityPipelineConfigSourcesSplunkHecTls {
    /**
    ...
    private ObservabilityPipelineConfigSourcesSplunkHecTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesSplunkHecTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesSplunkHecTls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesSplunkHecTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesSplunkHecTls();
