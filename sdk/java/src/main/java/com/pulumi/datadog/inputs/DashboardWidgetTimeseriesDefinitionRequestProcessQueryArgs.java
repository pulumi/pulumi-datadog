...
public final class DashboardWidgetTimeseriesDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetTimeseriesDefinitionRequestProcessQueryArgs Empty = new DashboardWidgetTimeseriesDefinitionRequestProcessQueryArgs();
    ...
    private DashboardWidgetTimeseriesDefinitionRequestProcessQueryArgs() {}

    private DashboardWidgetTimeseriesDefinitionRequestProcessQueryArgs(DashboardWidgetTimeseriesDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetTimeseriesDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardWidgetTimeseriesDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardWidgetTimeseriesDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetTimeseriesDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
