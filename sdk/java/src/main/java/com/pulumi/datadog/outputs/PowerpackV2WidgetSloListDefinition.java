...
import com.pulumi.datadog.outputs.PowerpackV2WidgetSloListDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetSloListDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetSloListDefinition {
    /**
     ...
     * 
     */
    private List<PowerpackV2WidgetSloListDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetSloListDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetSloListDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetSloListDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetSloListDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetSloListDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetSloListDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder requests(List<PowerpackV2WidgetSloListDefinitionRequest> requests) {
            if (requests == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetSloListDefinition", "requests");
            }
            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetSloListDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetSloListDefinitionTime time) {
        ...
        public PowerpackV2WidgetSloListDefinition build() {
            final var _resultValue = new PowerpackV2WidgetSloListDefinition();
