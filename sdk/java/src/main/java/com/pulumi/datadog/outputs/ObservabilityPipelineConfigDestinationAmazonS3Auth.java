...
@CustomType
public final class ObservabilityPipelineConfigDestinationAmazonS3Auth {
    /**
    ...
    private ObservabilityPipelineConfigDestinationAmazonS3Auth() {}
    /**
     * @return The Amazon Resource Name (ARN) of the role to assume.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationAmazonS3Auth defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionName;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationAmazonS3Auth defaults) {
        ...
        public ObservabilityPipelineConfigDestinationAmazonS3Auth build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationAmazonS3Auth();
