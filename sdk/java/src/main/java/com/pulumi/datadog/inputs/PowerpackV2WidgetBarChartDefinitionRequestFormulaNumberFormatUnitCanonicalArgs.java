...
public final class PowerpackV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs Empty = new PowerpackV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
    ...
    private PowerpackV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs() {}

    private PowerpackV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(PowerpackV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(PowerpackV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
