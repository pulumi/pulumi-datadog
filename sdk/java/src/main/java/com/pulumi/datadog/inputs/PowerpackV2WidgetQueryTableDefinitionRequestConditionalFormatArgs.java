...
public final class PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs Empty = new PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs();
    ...
    private PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs() {}

    private PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs(PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
