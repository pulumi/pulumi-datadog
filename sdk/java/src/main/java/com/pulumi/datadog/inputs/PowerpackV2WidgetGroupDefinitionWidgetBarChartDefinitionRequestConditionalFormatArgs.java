...
public final class PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs();
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs(PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetBarChartDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
