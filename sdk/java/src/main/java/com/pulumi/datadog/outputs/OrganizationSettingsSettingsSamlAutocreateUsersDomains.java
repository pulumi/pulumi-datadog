...
public final class OrganizationSettingsSettingsSamlAutocreateUsersDomains {
    ...
    public static Builder builder(OrganizationSettingsSettingsSamlAutocreateUsersDomains defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean enabled;
        public Builder() {}
        public Builder(OrganizationSettingsSettingsSamlAutocreateUsersDomains defaults) {
