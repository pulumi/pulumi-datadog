...
public final class DashboardV2WidgetApmResourceStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetApmResourceStatsQueryArgs Empty = new DashboardV2WidgetApmResourceStatsQueryArgs();
    ...
    private DashboardV2WidgetApmResourceStatsQueryArgs() {}

    private DashboardV2WidgetApmResourceStatsQueryArgs(DashboardV2WidgetApmResourceStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetApmResourceStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetApmResourceStatsQueryArgs();
        }

        public Builder(DashboardV2WidgetApmResourceStatsQueryArgs defaults) {
            $ = new DashboardV2WidgetApmResourceStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetApmResourceStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetApmResourceStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetApmResourceStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetApmResourceStatsQueryArgs", "name");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetApmResourceStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetApmResourceStatsQueryArgs", "stat");
            }
            return $;
        }
    }
