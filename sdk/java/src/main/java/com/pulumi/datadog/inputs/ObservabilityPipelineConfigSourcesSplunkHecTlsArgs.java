...
public final class ObservabilityPipelineConfigSourcesSplunkHecTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcesSplunkHecTlsArgs Empty = new ObservabilityPipelineConfigSourcesSplunkHecTlsArgs();
    ...
    private ObservabilityPipelineConfigSourcesSplunkHecTlsArgs() {}

    private ObservabilityPipelineConfigSourcesSplunkHecTlsArgs(ObservabilityPipelineConfigSourcesSplunkHecTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesSplunkHecTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcesSplunkHecTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcesSplunkHecTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcesSplunkHecTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcesSplunkHecTlsArgs build() {
            return $;
        }
    }
