...
public final class DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs Empty = new DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs();
    ...
    private DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs() {}

    private DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs(DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs();
        }

        public Builder(DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs build() {
            return $;
        }
    }
