...
public final class PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs Empty = new PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs() {}

    private PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs(PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
