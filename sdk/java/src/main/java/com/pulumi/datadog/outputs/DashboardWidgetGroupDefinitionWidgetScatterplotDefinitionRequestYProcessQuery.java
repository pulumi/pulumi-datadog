...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionRequestYProcessQuery {
    /**
    ...
    private DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionRequestYProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionRequestYProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionRequestYProcessQuery defaults) {
        ...
        public DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionRequestYProcessQuery build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionRequestYProcessQuery();
