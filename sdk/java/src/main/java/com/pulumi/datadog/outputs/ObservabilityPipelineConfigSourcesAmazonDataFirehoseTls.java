...
@CustomType
public final class ObservabilityPipelineConfigSourcesAmazonDataFirehoseTls {
    /**
    ...
    private ObservabilityPipelineConfigSourcesAmazonDataFirehoseTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesAmazonDataFirehoseTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesAmazonDataFirehoseTls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesAmazonDataFirehoseTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesAmazonDataFirehoseTls();
