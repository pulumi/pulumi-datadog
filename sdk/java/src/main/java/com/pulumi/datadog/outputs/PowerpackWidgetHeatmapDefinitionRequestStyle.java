...
@CustomType
public final class PowerpackWidgetHeatmapDefinitionRequestStyle {
    /**
    ...
    private PowerpackWidgetHeatmapDefinitionRequestStyle() {}
    /**
     * @return The color palette to apply. Valid values are `blue`, `custom_bg`, `custom_image`, `custom_text`, `gray_on_white`, `grey`, `green`, `orange`, `red`, `red_on_white`, `white_on_gray`, `white_on_green`, `green_on_white`, `white_on_red`, `white_on_yellow`, `yellow_on_white`, `black_on_light_yellow`, `black_on_light_green`, `black_on_light_red`.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetHeatmapDefinitionRequestStyle defaults) {
    ...
    public static final class Builder {
        private @Nullable String palette;
        public Builder() {}
        public Builder(PowerpackWidgetHeatmapDefinitionRequestStyle defaults) {
        ...
        public PowerpackWidgetHeatmapDefinitionRequestStyle build() {
            final var _resultValue = new PowerpackWidgetHeatmapDefinitionRequestStyle();
