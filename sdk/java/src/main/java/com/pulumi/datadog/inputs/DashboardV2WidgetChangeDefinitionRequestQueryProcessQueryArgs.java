...
public final class DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs Empty = new DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs();
    ...
    private DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs() {}

    private DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs(DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetChangeDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
