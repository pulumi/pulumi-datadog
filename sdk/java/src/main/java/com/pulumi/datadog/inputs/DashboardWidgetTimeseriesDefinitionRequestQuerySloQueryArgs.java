...
public final class DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs Empty = new DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs();
    ...
    private DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs() {}

    private DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs(DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
