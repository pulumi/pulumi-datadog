...
public final class PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs Empty = new PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs() {}

    private PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs(PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
