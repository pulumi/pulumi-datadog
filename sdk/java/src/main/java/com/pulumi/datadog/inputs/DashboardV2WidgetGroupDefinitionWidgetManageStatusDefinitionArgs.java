...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionArgs build() {
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionArgs", "query");
            }
            return $;
        }
    }
