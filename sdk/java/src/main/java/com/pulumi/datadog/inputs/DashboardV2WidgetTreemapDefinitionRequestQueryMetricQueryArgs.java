...
public final class DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs Empty = new DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs() {}

    private DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs(DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTreemapDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
