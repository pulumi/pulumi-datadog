...
public final class DashboardWidgetQueryTableDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetQueryTableDefinitionRequestFormulaStyleArgs Empty = new DashboardWidgetQueryTableDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardWidgetQueryTableDefinitionRequestFormulaStyleArgs() {}

    private DashboardWidgetQueryTableDefinitionRequestFormulaStyleArgs(DashboardWidgetQueryTableDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardWidgetQueryTableDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetQueryTableDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardWidgetQueryTableDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardWidgetQueryTableDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetQueryTableDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
