...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs build() {
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs", "query");
            }
            return $;
        }
    }
