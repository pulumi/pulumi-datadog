...
@CustomType
public final class PowerpackWidgetQueryTableDefinitionRequestQueryMetricQuery {
    /**
    ...
    private PowerpackWidgetQueryTableDefinitionRequestQueryMetricQuery() {}
    /**
     * @return The aggregation methods available for metrics queries. Valid values are `avg`, `min`, `max`, `sum`, `last`, `area`, `l2norm`, `percentile`.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetQueryTableDefinitionRequestQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(PowerpackWidgetQueryTableDefinitionRequestQueryMetricQuery defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
        public PowerpackWidgetQueryTableDefinitionRequestQueryMetricQuery build() {
            final var _resultValue = new PowerpackWidgetQueryTableDefinitionRequestQueryMetricQuery();
