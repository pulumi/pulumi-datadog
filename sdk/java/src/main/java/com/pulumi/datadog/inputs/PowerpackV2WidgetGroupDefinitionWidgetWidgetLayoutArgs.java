...
public final class PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs();
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs(PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs $) {
        this.height = $.height;
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs build() {
            if ($.height == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs", "height");
            }
            if ($.width == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs", "width");
            }
            if ($.x == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs", "x");
            }
            if ($.y == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetWidgetLayoutArgs", "y");
            }
            return $;
        }
    }
