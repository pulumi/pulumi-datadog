 ...
 *             .awsPartition("aws")
 *             .awsRegions(com.pulumi.datadog.aws.inputs.IntegrationAccountAwsRegionsArgs.builder()
 *                 .includeAll(true)
 *                 .build())
 *             .authConfig(com.pulumi.datadog.aws.inputs.IntegrationAccountAuthConfigArgs.builder()
 *                 .awsAuthConfigRole(com.pulumi.datadog.aws.inputs.IntegrationAccountAuthConfigAwsAuthConfigRoleArgs.builder()
 *                     .roleName("DatadogIntegrationRole")
 *                     .build())
 *                 .build())
 *             .logsConfig(com.pulumi.datadog.aws.inputs.IntegrationAccountLogsConfigArgs.builder()
 *                 .lambdaForwarder(com.pulumi.datadog.aws.inputs.IntegrationAccountLogsConfigLambdaForwarderArgs.builder()
 *                     .lambdas("arn:aws:lambda:us-east-1:123456789012:function:my-lambda")
 *                     .sources("s3")
 *                     .logSourceConfig(com.pulumi.datadog.aws.inputs.IntegrationAccountLogsConfigLambdaForwarderLogSourceConfigArgs.builder()
 *                         .tagFilters(com.pulumi.datadog.aws.inputs.IntegrationAccountLogsConfigLambdaForwarderLogSourceConfigTagFilterArgs.builder()
 *                             .source("s3")
 *                             .tags(                            
 *                                 "env:prod",
 *                                 "team:backend")
 ...
 *                     .build())
 *                 .build())
 *             .metricsConfig(com.pulumi.datadog.aws.inputs.IntegrationAccountMetricsConfigArgs.builder()
 *                 .automuteEnabled(true)
 *                 .collectCloudwatchAlarms(true)
 *                 .collectCustomMetrics(true)
 *                 .enabled(true)
 *                 .namespaceFilters(com.pulumi.datadog.aws.inputs.IntegrationAccountMetricsConfigNamespaceFiltersArgs.builder()
 *                     .excludeOnlies(                    
 *                         "AWS/SQS",
 ...
 *                     .build())
 *                 .build())
 *             .resourcesConfig(com.pulumi.datadog.aws.inputs.IntegrationAccountResourcesConfigArgs.builder()
 *                 .cloudSecurityPostureManagementCollection(true)
 *                 .extendedCollection(true)
 *                 .build())
 *             .tracesConfig(com.pulumi.datadog.aws.inputs.IntegrationAccountTracesConfigArgs.builder()
 *                 .xrayServices(com.pulumi.datadog.aws.inputs.IntegrationAccountTracesConfigXrayServicesArgs.builder()
 *                     .includeAll(true)
 *                     .build())
 *                 .build())
 *             .build());
