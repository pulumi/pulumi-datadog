...
public final class DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs Empty = new DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs() {}

    private DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs(DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGeomapDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
