...
import com.pulumi.datadog.inputs.PowerpackWidgetHeatmapDefinitionRequestLogQueryComputeQueryArgs;
import com.pulumi.datadog.inputs.PowerpackWidgetHeatmapDefinitionRequestLogQueryGroupByArgs;
import com.pulumi.datadog.inputs.PowerpackWidgetHeatmapDefinitionRequestLogQueryMultiComputeArgs;
...
public final class PowerpackWidgetHeatmapDefinitionRequestLogQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PowerpackWidgetHeatmapDefinitionRequestLogQueryArgs() {}

    private PowerpackWidgetHeatmapDefinitionRequestLogQueryArgs(PowerpackWidgetHeatmapDefinitionRequestLogQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetHeatmapDefinitionRequestLogQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetHeatmapDefinitionRequestLogQueryArgs();
        }

        public Builder(PowerpackWidgetHeatmapDefinitionRequestLogQueryArgs defaults) {
            $ = new PowerpackWidgetHeatmapDefinitionRequestLogQueryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder computeQuery(@Nullable Output<PowerpackWidgetHeatmapDefinitionRequestLogQueryComputeQueryArgs> computeQuery) {
         ...
         * 
         */
        public Builder computeQuery(PowerpackWidgetHeatmapDefinitionRequestLogQueryComputeQueryArgs computeQuery) {
         ...
         * 
         */
        public Builder groupBies(@Nullable Output<List<PowerpackWidgetHeatmapDefinitionRequestLogQueryGroupByArgs>> groupBies) {
            $.groupBies = groupBies;
            return this;
        }
         ...
         * 
         */
        public Builder groupBies(List<PowerpackWidgetHeatmapDefinitionRequestLogQueryGroupByArgs> groupBies) {
         ...
         * 
         */
        public Builder groupBies(PowerpackWidgetHeatmapDefinitionRequestLogQueryGroupByArgs... groupBies) {
         ...
         * 
         */
        public Builder multiComputes(@Nullable Output<List<PowerpackWidgetHeatmapDefinitionRequestLogQueryMultiComputeArgs>> multiComputes) {
         ...
         * 
         */
        public Builder multiComputes(List<PowerpackWidgetHeatmapDefinitionRequestLogQueryMultiComputeArgs> multiComputes) {
         ...
         * 
         */
        public Builder multiComputes(PowerpackWidgetHeatmapDefinitionRequestLogQueryMultiComputeArgs... multiComputes) {
        ...
        public PowerpackWidgetHeatmapDefinitionRequestLogQueryArgs build() {
            if ($.index == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetHeatmapDefinitionRequestLogQueryArgs", "index");
            }
            return $;
        }
    }
