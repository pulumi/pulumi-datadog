...
@CustomType
public final class ObservabilityPipelineConfigSourceFluentBitTls {
    /**
    ...
    private ObservabilityPipelineConfigSourceFluentBitTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceFluentBitTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceFluentBitTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceFluentBitTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceFluentBitTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceFluentBitTls();
