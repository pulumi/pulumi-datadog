...
public final class RumMetricState extends com.pulumi.resources.ResourceArgs {

    public static final RumMetricState Empty = new RumMetricState();
    ...
    private RumMetricState() {}

    private RumMetricState(RumMetricState $) {
    ...
    public static Builder builder(RumMetricState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RumMetricState defaults) {
            $ = new RumMetricState(Objects.requireNonNull(defaults));
        }
