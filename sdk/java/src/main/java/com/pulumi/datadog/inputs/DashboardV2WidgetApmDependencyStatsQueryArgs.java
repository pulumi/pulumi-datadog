...
public final class DashboardV2WidgetApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetApmDependencyStatsQueryArgs Empty = new DashboardV2WidgetApmDependencyStatsQueryArgs();
    ...
    private DashboardV2WidgetApmDependencyStatsQueryArgs() {}

    private DashboardV2WidgetApmDependencyStatsQueryArgs(DashboardV2WidgetApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetApmDependencyStatsQueryArgs();
        }

        public Builder(DashboardV2WidgetApmDependencyStatsQueryArgs defaults) {
            $ = new DashboardV2WidgetApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
