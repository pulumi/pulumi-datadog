...
import com.pulumi.datadog.inputs.DashboardV2WidgetListStreamDefinitionRequestQueryGroupByArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetListStreamDefinitionRequestQuerySortArgs;
...
public final class DashboardV2WidgetListStreamDefinitionRequestQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetListStreamDefinitionRequestQueryArgs Empty = new DashboardV2WidgetListStreamDefinitionRequestQueryArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetListStreamDefinitionRequestQueryGroupByArgs>> groupBies;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetListStreamDefinitionRequestQueryGroupByArgs>>> groupBies() {
     ...
     */
    @Import(name="sort")
    private @Nullable Output<DashboardV2WidgetListStreamDefinitionRequestQuerySortArgs> sort;

    /**
     * @return The facet and order to sort the data, for example: `{&#34;column&#34;: &#34;time&#34;, &#34;order&#34;: &#34;desc&#34;}`.
     * 
     */
    public Optional<Output<DashboardV2WidgetListStreamDefinitionRequestQuerySortArgs>> sort() {
    ...
    private DashboardV2WidgetListStreamDefinitionRequestQueryArgs() {}

    private DashboardV2WidgetListStreamDefinitionRequestQueryArgs(DashboardV2WidgetListStreamDefinitionRequestQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetListStreamDefinitionRequestQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetListStreamDefinitionRequestQueryArgs();
        }

        public Builder(DashboardV2WidgetListStreamDefinitionRequestQueryArgs defaults) {
            $ = new DashboardV2WidgetListStreamDefinitionRequestQueryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder groupBies(@Nullable Output<List<DashboardV2WidgetListStreamDefinitionRequestQueryGroupByArgs>> groupBies) {
            $.groupBies = groupBies;
            return this;
        }
         ...
         * 
         */
        public Builder groupBies(List<DashboardV2WidgetListStreamDefinitionRequestQueryGroupByArgs> groupBies) {
         ...
         * 
         */
        public Builder groupBies(DashboardV2WidgetListStreamDefinitionRequestQueryGroupByArgs... groupBies) {
         ...
         * 
         */
        public Builder sort(@Nullable Output<DashboardV2WidgetListStreamDefinitionRequestQuerySortArgs> sort) {
            $.sort = sort;
            return this;
        }
         ...
         * 
         */
        public Builder sort(DashboardV2WidgetListStreamDefinitionRequestQuerySortArgs sort) {
        ...
        public DashboardV2WidgetListStreamDefinitionRequestQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetListStreamDefinitionRequestQueryArgs", "dataSource");
            }
            return $;
        }
    }
