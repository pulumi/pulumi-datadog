...
@CustomType
public final class DashboardV2WidgetQueryTableDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardV2WidgetQueryTableDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetQueryTableDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetQueryTableDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetQueryTableDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetQueryTableDefinitionRequestProcessQuery();
