...
public final class DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private String viewType;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition defaults) {
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public Builder timeWindows(List<String> timeWindows) {
            if (timeWindows == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition", "timeWindows");
            }
        ...
        public Builder viewMode(String viewMode) {
            if (viewMode == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition", "viewMode");
            }
        ...
        public Builder viewType(String viewType) {
            if (viewType == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition", "viewType");
            }
