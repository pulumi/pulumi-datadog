...
@CustomType
public final class DashboardWidgetTimeseriesDefinitionRequestQueryMetricQuery {
    /**
    ...
    private DashboardWidgetTimeseriesDefinitionRequestQueryMetricQuery() {}
    /**
     * @return The aggregation methods available for metrics queries. Valid values are `avg`, `min`, `max`, `sum`, `last`, `area`, `l2norm`, `percentile`.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(DashboardWidgetTimeseriesDefinitionRequestQueryMetricQuery defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
        public DashboardWidgetTimeseriesDefinitionRequestQueryMetricQuery build() {
            final var _resultValue = new DashboardWidgetTimeseriesDefinitionRequestQueryMetricQuery();
