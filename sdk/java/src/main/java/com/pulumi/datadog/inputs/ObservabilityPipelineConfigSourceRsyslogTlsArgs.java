...
public final class ObservabilityPipelineConfigSourceRsyslogTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceRsyslogTlsArgs Empty = new ObservabilityPipelineConfigSourceRsyslogTlsArgs();
    ...
    private ObservabilityPipelineConfigSourceRsyslogTlsArgs() {}

    private ObservabilityPipelineConfigSourceRsyslogTlsArgs(ObservabilityPipelineConfigSourceRsyslogTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceRsyslogTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceRsyslogTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceRsyslogTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceRsyslogTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceRsyslogTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceRsyslogTlsArgs", "crtFile");
            }
            return $;
        }
    }
