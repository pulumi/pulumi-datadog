...
import com.pulumi.datadog.inputs.DashboardV2WidgetAlertGraphDefinitionTimeArgs;
...
public final class DashboardV2WidgetAlertGraphDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetAlertGraphDefinitionArgs Empty = new DashboardV2WidgetAlertGraphDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetAlertGraphDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetAlertGraphDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetAlertGraphDefinitionArgs() {}

    private DashboardV2WidgetAlertGraphDefinitionArgs(DashboardV2WidgetAlertGraphDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetAlertGraphDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetAlertGraphDefinitionArgs();
        }

        public Builder(DashboardV2WidgetAlertGraphDefinitionArgs defaults) {
            $ = new DashboardV2WidgetAlertGraphDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetAlertGraphDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetAlertGraphDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetAlertGraphDefinitionArgs build() {
            if ($.alertId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetAlertGraphDefinitionArgs", "alertId");
            }
            if ($.vizType == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetAlertGraphDefinitionArgs", "vizType");
            }
            return $;
        }
    }
