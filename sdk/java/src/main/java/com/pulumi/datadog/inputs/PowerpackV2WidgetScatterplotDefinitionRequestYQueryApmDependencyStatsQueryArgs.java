...
public final class PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs(PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
