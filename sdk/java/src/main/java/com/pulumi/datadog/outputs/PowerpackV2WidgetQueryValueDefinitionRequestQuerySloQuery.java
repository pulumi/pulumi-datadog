...
@CustomType
public final class PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQuery {
    /**
    ...
    private PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQuery build() {
            final var _resultValue = new PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQuery();
