...
import com.pulumi.datadog.outputs.PowerpackV2WidgetAlertValueDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetAlertValueDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetAlertValueDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetAlertValueDefinition() {}
    /**
     * @return The ID of the monitor used by the widget.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetAlertValueDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetAlertValueDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unit;
        public Builder() {}
        public Builder(PowerpackV2WidgetAlertValueDefinition defaults) {
        ...
        public Builder alertId(String alertId) {
            if (alertId == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetAlertValueDefinition", "alertId");
            }
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetAlertValueDefinitionTime time) {
        ...
        public PowerpackV2WidgetAlertValueDefinition build() {
            final var _resultValue = new PowerpackV2WidgetAlertValueDefinition();
