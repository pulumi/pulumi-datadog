...
import com.pulumi.datadog.inputs.DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs;
...
public final class DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs Empty = new DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs>> groupBies;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs>>> groupBies() {
     ...
     */
    @Import(name="sort")
    private @Nullable Output<DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs> sort;

    /**
     * @return The facet and order to sort the data, for example: `{&#34;column&#34;: &#34;time&#34;, &#34;order&#34;: &#34;desc&#34;}`.
     * 
     */
    public Optional<Output<DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs>> sort() {
    ...
    private DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs() {}

    private DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs(DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs();
        }

        public Builder(DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs defaults) {
            $ = new DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder groupBies(@Nullable Output<List<DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs>> groupBies) {
            $.groupBies = groupBies;
            return this;
        }
         ...
         * 
         */
        public Builder groupBies(List<DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs> groupBies) {
         ...
         * 
         */
        public Builder groupBies(DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs... groupBies) {
         ...
         * 
         */
        public Builder sort(@Nullable Output<DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs> sort) {
            $.sort = sort;
            return this;
        }
         ...
         * 
         */
        public Builder sort(DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs sort) {
        ...
        public DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs", "dataSource");
            }
            return $;
        }
    }
