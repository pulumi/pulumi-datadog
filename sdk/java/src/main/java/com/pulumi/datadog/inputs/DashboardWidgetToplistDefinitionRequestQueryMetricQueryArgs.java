...
public final class DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs Empty = new DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs();
    ...
    private DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs() {}

    private DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs(DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
