...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinition() {}
    /**
     * @return The background color of the text widget.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinition defaults) {
        ...
        public Builder text(String text) {
            if (text == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinition", "text");
            }
            this.text = text;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinitionTime time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetFreeTextDefinition();
