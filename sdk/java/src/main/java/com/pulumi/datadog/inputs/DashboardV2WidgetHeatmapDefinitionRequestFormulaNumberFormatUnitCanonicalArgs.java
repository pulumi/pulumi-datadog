...
public final class DashboardV2WidgetHeatmapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHeatmapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs Empty = new DashboardV2WidgetHeatmapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
    ...
    private DashboardV2WidgetHeatmapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs() {}

    private DashboardV2WidgetHeatmapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(DashboardV2WidgetHeatmapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHeatmapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHeatmapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(DashboardV2WidgetHeatmapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new DashboardV2WidgetHeatmapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHeatmapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
