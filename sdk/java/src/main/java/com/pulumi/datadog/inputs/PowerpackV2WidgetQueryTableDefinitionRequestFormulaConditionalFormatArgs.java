...
public final class PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs(PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
