...
public final class DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs Empty = new DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs();
    ...
    private DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs() {}

    private DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs(DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs();
        }

        public Builder(DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs defaults) {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
