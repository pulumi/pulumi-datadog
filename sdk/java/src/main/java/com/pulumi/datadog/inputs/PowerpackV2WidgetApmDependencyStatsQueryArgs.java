...
public final class PowerpackV2WidgetApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetApmDependencyStatsQueryArgs Empty = new PowerpackV2WidgetApmDependencyStatsQueryArgs();
    ...
    private PowerpackV2WidgetApmDependencyStatsQueryArgs() {}

    private PowerpackV2WidgetApmDependencyStatsQueryArgs(PowerpackV2WidgetApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetApmDependencyStatsQueryArgs();
        }

        public Builder(PowerpackV2WidgetApmDependencyStatsQueryArgs defaults) {
            $ = new PowerpackV2WidgetApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
