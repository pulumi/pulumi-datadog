...
@CustomType
public final class ObservabilityPipelineConfigSourcesFluentBitTls {
    /**
    ...
    private ObservabilityPipelineConfigSourcesFluentBitTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesFluentBitTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesFluentBitTls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesFluentBitTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesFluentBitTls();
