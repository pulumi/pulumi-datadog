...
public final class PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs(PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
