...
public final class PowerpackWidgetChangeDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetChangeDefinitionRequestFormulaStyleArgs Empty = new PowerpackWidgetChangeDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackWidgetChangeDefinitionRequestFormulaStyleArgs() {}

    private PowerpackWidgetChangeDefinitionRequestFormulaStyleArgs(PowerpackWidgetChangeDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackWidgetChangeDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetChangeDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackWidgetChangeDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackWidgetChangeDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetChangeDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
