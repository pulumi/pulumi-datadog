...
@CustomType
public final class ObservabilityPipelineConfigSourcesSplunkTcpTls {
    /**
    ...
    private ObservabilityPipelineConfigSourcesSplunkTcpTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server’s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesSplunkTcpTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesSplunkTcpTls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesSplunkTcpTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesSplunkTcpTls();
