...
public final class DashboardWidgetSunburstDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetSunburstDefinitionRequestQueryProcessQueryArgs() {}

    private DashboardWidgetSunburstDefinitionRequestQueryProcessQueryArgs(DashboardWidgetSunburstDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetSunburstDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetSunburstDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(DashboardWidgetSunburstDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new DashboardWidgetSunburstDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetSunburstDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
