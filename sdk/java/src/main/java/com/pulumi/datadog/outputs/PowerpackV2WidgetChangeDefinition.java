...
import com.pulumi.datadog.outputs.PowerpackV2WidgetChangeDefinitionCustomLink;
import com.pulumi.datadog.outputs.PowerpackV2WidgetChangeDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetChangeDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetChangeDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<PowerpackV2WidgetChangeDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetChangeDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetChangeDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetChangeDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<PowerpackV2WidgetChangeDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<PowerpackV2WidgetChangeDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetChangeDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetChangeDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetChangeDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<PowerpackV2WidgetChangeDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(PowerpackV2WidgetChangeDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<PowerpackV2WidgetChangeDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetChangeDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetChangeDefinitionTime time) {
        ...
        public PowerpackV2WidgetChangeDefinition build() {
            final var _resultValue = new PowerpackV2WidgetChangeDefinition();
