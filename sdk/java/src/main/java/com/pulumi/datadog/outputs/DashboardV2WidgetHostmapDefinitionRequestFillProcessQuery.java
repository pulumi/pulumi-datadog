...
@CustomType
public final class DashboardV2WidgetHostmapDefinitionRequestFillProcessQuery {
    /**
    ...
    private DashboardV2WidgetHostmapDefinitionRequestFillProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestFillProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetHostmapDefinitionRequestFillProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestFillProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestFillProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetHostmapDefinitionRequestFillProcessQuery();
