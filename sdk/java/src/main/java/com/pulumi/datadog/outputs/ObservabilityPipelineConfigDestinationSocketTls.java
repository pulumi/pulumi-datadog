...
@CustomType
public final class ObservabilityPipelineConfigDestinationSocketTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationSocketTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationSocketTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationSocketTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationSocketTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigDestinationSocketTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationSocketTls();
