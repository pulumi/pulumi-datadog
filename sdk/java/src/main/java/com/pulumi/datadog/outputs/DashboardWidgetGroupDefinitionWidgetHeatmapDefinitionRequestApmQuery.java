...
public final class DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestApmQuery {
    ...
    public static final class Builder {
        ...
        public Builder index(String index) {
            if (index == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestApmQuery", "index");
            }
            this.index = index;
            return this;
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestApmQuery build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetHeatmapDefinitionRequestApmQuery();
