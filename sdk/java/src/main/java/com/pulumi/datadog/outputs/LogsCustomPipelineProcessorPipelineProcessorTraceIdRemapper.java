...
public final class LogsCustomPipelineProcessorPipelineProcessorTraceIdRemapper {
    ...
    public static Builder builder(LogsCustomPipelineProcessorPipelineProcessorTraceIdRemapper defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> sources;
        public Builder() {}
        public Builder(LogsCustomPipelineProcessorPipelineProcessorTraceIdRemapper defaults) {
        ...
        public Builder sources(List<String> sources) {
            if (sources == null) {
              throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorTraceIdRemapper", "sources");
            }
