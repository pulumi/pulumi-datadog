...
public final class PowerpackWidgetScatterplotDefinitionRequestXProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetScatterplotDefinitionRequestXProcessQueryArgs Empty = new PowerpackWidgetScatterplotDefinitionRequestXProcessQueryArgs();
    ...
    private PowerpackWidgetScatterplotDefinitionRequestXProcessQueryArgs() {}

    private PowerpackWidgetScatterplotDefinitionRequestXProcessQueryArgs(PowerpackWidgetScatterplotDefinitionRequestXProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetScatterplotDefinitionRequestXProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetScatterplotDefinitionRequestXProcessQueryArgs();
        }

        public Builder(PowerpackWidgetScatterplotDefinitionRequestXProcessQueryArgs defaults) {
            $ = new PowerpackWidgetScatterplotDefinitionRequestXProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetScatterplotDefinitionRequestXProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetScatterplotDefinitionRequestXProcessQueryArgs", "metric");
            }
            return $;
        }
    }
