...
public final class ObservabilityPipelineConfigSourceHttpClientTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceHttpClientTlsArgs Empty = new ObservabilityPipelineConfigSourceHttpClientTlsArgs();
    ...
    private ObservabilityPipelineConfigSourceHttpClientTlsArgs() {}

    private ObservabilityPipelineConfigSourceHttpClientTlsArgs(ObservabilityPipelineConfigSourceHttpClientTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceHttpClientTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceHttpClientTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceHttpClientTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceHttpClientTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceHttpClientTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceHttpClientTlsArgs", "crtFile");
            }
            return $;
        }
    }
