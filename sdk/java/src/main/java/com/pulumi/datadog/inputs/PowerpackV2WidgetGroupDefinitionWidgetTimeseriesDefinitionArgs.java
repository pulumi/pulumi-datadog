...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionEventArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionMarkerArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRightYaxisArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionTimeArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="events")
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionEventArgs>> events;

    /**
     * @return The definition of the event to overlay on the graph. Multiple `event` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionEventArgs>>> events() {
     ...
     */
    @Import(name="markers")
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionMarkerArgs>> markers;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionMarkerArgs>>> markers() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestArgs>>> requests() {
    ...
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRightYaxisArgs> rightYaxis;
     ...
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRightYaxisArgs>> rightYaxis() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="yaxis")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisArgs> yaxis;

    /**
     * @return A nested block describing the Y-Axis Controls. The structure of this block is described below.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisArgs>> yaxis() {
        return Optional.ofNullable(this.yaxis);
    }

    private PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder events(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionEventArgs>> events) {
            $.events = events;
            return this;
        }
         ...
         * 
         */
        public Builder events(List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionEventArgs> events) {
         ...
         * 
         */
        public Builder events(PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionEventArgs... events) {
         ...
         * 
         */
        public Builder markers(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionMarkerArgs>> markers) {
            $.markers = markers;
            return this;
        }
         ...
         * 
         */
        public Builder markers(List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionMarkerArgs> markers) {
         ...
         * 
         */
        public Builder markers(PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionMarkerArgs... markers) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder rightYaxis(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRightYaxisArgs> rightYaxis) {
         ...
         * 
         */
        public Builder rightYaxis(PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRightYaxisArgs rightYaxis) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder yaxis(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisArgs> yaxis) {
            $.yaxis = yaxis;
            return this;
        }
         ...
         * 
         */
        public Builder yaxis(PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisArgs yaxis) {
            return yaxis(Output.of(yaxis));
        }

        public PowerpackV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs build() {
            return $;
        }
    }
