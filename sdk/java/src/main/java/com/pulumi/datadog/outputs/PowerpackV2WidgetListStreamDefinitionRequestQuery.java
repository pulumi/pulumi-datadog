...
import com.pulumi.datadog.outputs.PowerpackV2WidgetListStreamDefinitionRequestQueryGroupBy;
import com.pulumi.datadog.outputs.PowerpackV2WidgetListStreamDefinitionRequestQuerySort;
...
@CustomType
public final class PowerpackV2WidgetListStreamDefinitionRequestQuery {
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetListStreamDefinitionRequestQueryGroupBy> groupBies;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetListStreamDefinitionRequestQuerySort sort;
    /**
    ...
    private PowerpackV2WidgetListStreamDefinitionRequestQuery() {}
    /**
     * @return Specifies the field for logs pattern clustering. Can only be used with `logsPatternStream`.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetListStreamDefinitionRequestQueryGroupBy> groupBies() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetListStreamDefinitionRequestQuerySort> sort() {
    ...
    public static Builder builder(PowerpackV2WidgetListStreamDefinitionRequestQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storage;
        public Builder() {}
        public Builder(PowerpackV2WidgetListStreamDefinitionRequestQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetListStreamDefinitionRequestQuery", "dataSource");
            }
        ...
        @CustomType.Setter
        public Builder groupBies(@Nullable List<PowerpackV2WidgetListStreamDefinitionRequestQueryGroupBy> groupBies) {

            this.groupBies = groupBies;
            return this;
        }
        public Builder groupBies(PowerpackV2WidgetListStreamDefinitionRequestQueryGroupBy... groupBies) {
        ...
        @CustomType.Setter
        public Builder sort(@Nullable PowerpackV2WidgetListStreamDefinitionRequestQuerySort sort) {
        ...
        public PowerpackV2WidgetListStreamDefinitionRequestQuery build() {
            final var _resultValue = new PowerpackV2WidgetListStreamDefinitionRequestQuery();
