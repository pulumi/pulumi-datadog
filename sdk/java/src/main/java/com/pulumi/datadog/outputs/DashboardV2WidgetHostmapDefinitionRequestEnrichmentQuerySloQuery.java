...
@CustomType
public final class DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery {
    /**
    ...
    private DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery build() {
            final var _resultValue = new DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQuery();
