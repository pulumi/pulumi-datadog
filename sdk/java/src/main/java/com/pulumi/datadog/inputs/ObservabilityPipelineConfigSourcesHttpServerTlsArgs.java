...
public final class ObservabilityPipelineConfigSourcesHttpServerTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcesHttpServerTlsArgs Empty = new ObservabilityPipelineConfigSourcesHttpServerTlsArgs();
    ...
    private ObservabilityPipelineConfigSourcesHttpServerTlsArgs() {}

    private ObservabilityPipelineConfigSourcesHttpServerTlsArgs(ObservabilityPipelineConfigSourcesHttpServerTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesHttpServerTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcesHttpServerTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcesHttpServerTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcesHttpServerTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcesHttpServerTlsArgs build() {
            return $;
        }
    }
