...
public final class DashboardV2WidgetUserJourneyQueryGroupBySortArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetUserJourneyQueryGroupBySortArgs Empty = new DashboardV2WidgetUserJourneyQueryGroupBySortArgs();
    ...
    private DashboardV2WidgetUserJourneyQueryGroupBySortArgs() {}

    private DashboardV2WidgetUserJourneyQueryGroupBySortArgs(DashboardV2WidgetUserJourneyQueryGroupBySortArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetUserJourneyQueryGroupBySortArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetUserJourneyQueryGroupBySortArgs();
        }

        public Builder(DashboardV2WidgetUserJourneyQueryGroupBySortArgs defaults) {
            $ = new DashboardV2WidgetUserJourneyQueryGroupBySortArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetUserJourneyQueryGroupBySortArgs build() {
            if ($.aggregation == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetUserJourneyQueryGroupBySortArgs", "aggregation");
            }
            return $;
        }
    }
