...
import com.pulumi.datadog.outputs.DashboardV2WidgetListStreamDefinitionRequestQueryGroupBy;
import com.pulumi.datadog.outputs.DashboardV2WidgetListStreamDefinitionRequestQuerySort;
...
@CustomType
public final class DashboardV2WidgetListStreamDefinitionRequestQuery {
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetListStreamDefinitionRequestQueryGroupBy> groupBies;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetListStreamDefinitionRequestQuerySort sort;
    /**
    ...
    private DashboardV2WidgetListStreamDefinitionRequestQuery() {}
    /**
     * @return Specifies the field for logs pattern clustering. Can only be used with `logsPatternStream`.
     * 
     */
     ...
     * 
     */
    public List<DashboardV2WidgetListStreamDefinitionRequestQueryGroupBy> groupBies() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetListStreamDefinitionRequestQuerySort> sort() {
    ...
    public static Builder builder(DashboardV2WidgetListStreamDefinitionRequestQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storage;
        public Builder() {}
        public Builder(DashboardV2WidgetListStreamDefinitionRequestQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetListStreamDefinitionRequestQuery", "dataSource");
            }
        ...
        @CustomType.Setter
        public Builder groupBies(@Nullable List<DashboardV2WidgetListStreamDefinitionRequestQueryGroupBy> groupBies) {

            this.groupBies = groupBies;
            return this;
        }
        public Builder groupBies(DashboardV2WidgetListStreamDefinitionRequestQueryGroupBy... groupBies) {
        ...
        @CustomType.Setter
        public Builder sort(@Nullable DashboardV2WidgetListStreamDefinitionRequestQuerySort sort) {
        ...
        public DashboardV2WidgetListStreamDefinitionRequestQuery build() {
            final var _resultValue = new DashboardV2WidgetListStreamDefinitionRequestQuery();
