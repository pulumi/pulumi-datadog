...
import com.pulumi.datadog.inputs.DashboardV2WidgetChangeDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetChangeDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetChangeDefinitionTimeArgs;
...
public final class DashboardV2WidgetChangeDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetChangeDefinitionArgs Empty = new DashboardV2WidgetChangeDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetChangeDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetChangeDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<DashboardV2WidgetChangeDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetChangeDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetChangeDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetChangeDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetChangeDefinitionArgs() {}

    private DashboardV2WidgetChangeDefinitionArgs(DashboardV2WidgetChangeDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetChangeDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetChangeDefinitionArgs();
        }

        public Builder(DashboardV2WidgetChangeDefinitionArgs defaults) {
            $ = new DashboardV2WidgetChangeDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetChangeDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetChangeDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetChangeDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetChangeDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetChangeDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetChangeDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetChangeDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetChangeDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetChangeDefinitionArgs build() {
            return $;
        }
    }
