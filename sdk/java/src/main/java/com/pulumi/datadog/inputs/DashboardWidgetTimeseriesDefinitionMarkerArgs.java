...
public final class DashboardWidgetTimeseriesDefinitionMarkerArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetTimeseriesDefinitionMarkerArgs Empty = new DashboardWidgetTimeseriesDefinitionMarkerArgs();
    ...
    private DashboardWidgetTimeseriesDefinitionMarkerArgs() {}

    private DashboardWidgetTimeseriesDefinitionMarkerArgs(DashboardWidgetTimeseriesDefinitionMarkerArgs $) {
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionMarkerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetTimeseriesDefinitionMarkerArgs();
        }

        public Builder(DashboardWidgetTimeseriesDefinitionMarkerArgs defaults) {
            $ = new DashboardWidgetTimeseriesDefinitionMarkerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetTimeseriesDefinitionMarkerArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionMarkerArgs", "value");
            }
            return $;
        }
    }
