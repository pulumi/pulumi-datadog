...
public final class PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs Empty = new PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs();
    ...
    private PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs() {}

    private PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs(PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs();
        }

        public Builder(PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs defaults) {
            $ = new PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs", "dataSource");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestQueryCloudCostQueryArgs", "query");
            }
            return $;
        }
    }
