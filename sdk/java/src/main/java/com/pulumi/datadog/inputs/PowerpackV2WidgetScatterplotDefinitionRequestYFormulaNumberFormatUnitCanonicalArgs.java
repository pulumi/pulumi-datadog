...
public final class PowerpackV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs(PowerpackV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
