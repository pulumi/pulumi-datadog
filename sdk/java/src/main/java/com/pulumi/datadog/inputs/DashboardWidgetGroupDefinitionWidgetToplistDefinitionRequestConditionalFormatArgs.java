...
public final class DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs Empty = new DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs();
    ...
    private DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs() {}

    private DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs(DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
