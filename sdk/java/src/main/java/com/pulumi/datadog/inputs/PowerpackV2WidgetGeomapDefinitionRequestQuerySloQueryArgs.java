...
public final class PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs Empty = new PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs(PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGeomapDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
