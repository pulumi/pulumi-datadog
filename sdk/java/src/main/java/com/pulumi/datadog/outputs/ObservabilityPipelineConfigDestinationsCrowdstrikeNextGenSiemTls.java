...
@CustomType
public final class ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTls defaults) {
        ...
        public ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationsCrowdstrikeNextGenSiemTls();
