...
public final class PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs(PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs", "name");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryApmResourceStatsQueryArgs", "stat");
            }
            return $;
        }
    }
