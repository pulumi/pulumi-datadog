...
public final class PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs(PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
