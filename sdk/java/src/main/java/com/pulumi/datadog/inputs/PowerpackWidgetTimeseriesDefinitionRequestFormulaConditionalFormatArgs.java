...
public final class PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs(PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
