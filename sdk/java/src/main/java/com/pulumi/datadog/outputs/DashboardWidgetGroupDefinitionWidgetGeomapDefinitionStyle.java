...
public final class DashboardWidgetGroupDefinitionWidgetGeomapDefinitionStyle {
    ...
    public static final class Builder {
        ...
        public Builder palette(String palette) {
            if (palette == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetGeomapDefinitionStyle", "palette");
            }
        ...
        public Builder paletteFlip(Boolean paletteFlip) {
            if (paletteFlip == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetGeomapDefinitionStyle", "paletteFlip");
            }
