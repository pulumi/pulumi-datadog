...
public final class DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs Empty = new DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs();
    ...
    private DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs() {}

    private DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs(DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs();
        }

        public Builder(DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs defaults) {
            $ = new DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs", "dataSource");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetChangeDefinitionRequestQueryCloudCostQueryArgs", "query");
            }
            return $;
        }
    }
