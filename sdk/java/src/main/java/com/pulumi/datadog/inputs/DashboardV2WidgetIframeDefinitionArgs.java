...
import com.pulumi.datadog.inputs.DashboardV2WidgetIframeDefinitionTimeArgs;
...
public final class DashboardV2WidgetIframeDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetIframeDefinitionArgs Empty = new DashboardV2WidgetIframeDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetIframeDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetIframeDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetIframeDefinitionArgs() {}

    private DashboardV2WidgetIframeDefinitionArgs(DashboardV2WidgetIframeDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetIframeDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetIframeDefinitionArgs();
        }

        public Builder(DashboardV2WidgetIframeDefinitionArgs defaults) {
            $ = new DashboardV2WidgetIframeDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetIframeDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetIframeDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetIframeDefinitionArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetIframeDefinitionArgs", "url");
            }
            return $;
        }
    }
