...
import com.pulumi.datadog.inputs.PowerpackV2WidgetTreemapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetTreemapDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetTreemapDefinitionTimeArgs;
...
public final class PowerpackV2WidgetTreemapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTreemapDefinitionArgs Empty = new PowerpackV2WidgetTreemapDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetTreemapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetTreemapDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetTreemapDefinitionRequestArgs>> requests;

    /**
     * @return Nested block describing the request to use when displaying the widget.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetTreemapDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetTreemapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetTreemapDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetTreemapDefinitionArgs() {}

    private PowerpackV2WidgetTreemapDefinitionArgs(PowerpackV2WidgetTreemapDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTreemapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTreemapDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetTreemapDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetTreemapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetTreemapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetTreemapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetTreemapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetTreemapDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetTreemapDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetTreemapDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetTreemapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetTreemapDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetTreemapDefinitionArgs build() {
            return $;
        }
    }
