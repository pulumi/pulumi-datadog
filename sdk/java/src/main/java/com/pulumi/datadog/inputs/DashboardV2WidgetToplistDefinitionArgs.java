...
import com.pulumi.datadog.inputs.DashboardV2WidgetToplistDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetToplistDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetToplistDefinitionStyleArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetToplistDefinitionTimeArgs;
...
public final class DashboardV2WidgetToplistDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetToplistDefinitionArgs Empty = new DashboardV2WidgetToplistDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetToplistDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetToplistDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<DashboardV2WidgetToplistDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetToplistDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="style")
    private @Nullable Output<DashboardV2WidgetToplistDefinitionStyleArgs> style;

    /**
     * @return The style of the widget
     * 
     */
    public Optional<Output<DashboardV2WidgetToplistDefinitionStyleArgs>> style() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetToplistDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetToplistDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetToplistDefinitionArgs() {}

    private DashboardV2WidgetToplistDefinitionArgs(DashboardV2WidgetToplistDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetToplistDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetToplistDefinitionArgs();
        }

        public Builder(DashboardV2WidgetToplistDefinitionArgs defaults) {
            $ = new DashboardV2WidgetToplistDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetToplistDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetToplistDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetToplistDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetToplistDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetToplistDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetToplistDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder style(@Nullable Output<DashboardV2WidgetToplistDefinitionStyleArgs> style) {
            $.style = style;
            return this;
        }
         ...
         * 
         */
        public Builder style(DashboardV2WidgetToplistDefinitionStyleArgs style) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetToplistDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetToplistDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetToplistDefinitionArgs build() {
            return $;
        }
    }
