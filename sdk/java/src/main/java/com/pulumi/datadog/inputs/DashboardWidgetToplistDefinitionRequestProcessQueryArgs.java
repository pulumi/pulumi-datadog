...
public final class DashboardWidgetToplistDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetToplistDefinitionRequestProcessQueryArgs Empty = new DashboardWidgetToplistDefinitionRequestProcessQueryArgs();
    ...
    private DashboardWidgetToplistDefinitionRequestProcessQueryArgs() {}

    private DashboardWidgetToplistDefinitionRequestProcessQueryArgs(DashboardWidgetToplistDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetToplistDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetToplistDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardWidgetToplistDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardWidgetToplistDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetToplistDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
