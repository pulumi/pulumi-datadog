...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionArgs();
    ...
    private Output<List<PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionRequestArgs>> requests;

    /**
     * @return Cohort retention-grid requests.
     * 
     */
    public Output<List<PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetCohortDefinitionArgs", "requests");
            }
            return $;
        }
    }
