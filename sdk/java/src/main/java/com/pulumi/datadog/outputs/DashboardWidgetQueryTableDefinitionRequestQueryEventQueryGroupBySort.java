...
public final class DashboardWidgetQueryTableDefinitionRequestQueryEventQueryGroupBySort {
    ...
    public static final class Builder {
        ...
        public Builder aggregation(String aggregation) {
            if (aggregation == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQueryEventQueryGroupBySort", "aggregation");
            }
        ...
        public DashboardWidgetQueryTableDefinitionRequestQueryEventQueryGroupBySort build() {
            final var _resultValue = new DashboardWidgetQueryTableDefinitionRequestQueryEventQueryGroupBySort();
