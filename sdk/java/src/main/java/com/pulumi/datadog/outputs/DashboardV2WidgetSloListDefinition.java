...
import com.pulumi.datadog.outputs.DashboardV2WidgetSloListDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetSloListDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetSloListDefinition {
    /**
     ...
     * 
     */
    private List<DashboardV2WidgetSloListDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetSloListDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetSloListDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<DashboardV2WidgetSloListDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetSloListDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetSloListDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetSloListDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder requests(List<DashboardV2WidgetSloListDefinitionRequest> requests) {
            if (requests == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetSloListDefinition", "requests");
            }
            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetSloListDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetSloListDefinitionTime time) {
        ...
        public DashboardV2WidgetSloListDefinition build() {
            final var _resultValue = new DashboardV2WidgetSloListDefinition();
