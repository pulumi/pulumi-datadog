...
public final class DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs Empty = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs();
    ...
    private DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs() {}

    private DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs();
        }

        public Builder(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs defaults) {
            $ = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs", "name");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmResourceStatsQueryArgs", "stat");
            }
            return $;
        }
    }
