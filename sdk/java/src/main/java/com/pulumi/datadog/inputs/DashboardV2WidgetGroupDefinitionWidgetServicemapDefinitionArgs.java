...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs build() {
            if ($.filters == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs", "filters");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetServicemapDefinitionArgs", "service");
            }
            return $;
        }
    }
