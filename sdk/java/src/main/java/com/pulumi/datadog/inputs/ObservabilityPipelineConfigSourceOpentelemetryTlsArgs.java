...
public final class ObservabilityPipelineConfigSourceOpentelemetryTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceOpentelemetryTlsArgs Empty = new ObservabilityPipelineConfigSourceOpentelemetryTlsArgs();
    ...
    private ObservabilityPipelineConfigSourceOpentelemetryTlsArgs() {}

    private ObservabilityPipelineConfigSourceOpentelemetryTlsArgs(ObservabilityPipelineConfigSourceOpentelemetryTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceOpentelemetryTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceOpentelemetryTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceOpentelemetryTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceOpentelemetryTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceOpentelemetryTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceOpentelemetryTlsArgs", "crtFile");
            }
            return $;
        }
    }
