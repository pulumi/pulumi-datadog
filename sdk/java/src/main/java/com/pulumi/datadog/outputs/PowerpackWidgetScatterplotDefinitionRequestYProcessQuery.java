...
@CustomType
public final class PowerpackWidgetScatterplotDefinitionRequestYProcessQuery {
    /**
    ...
    private PowerpackWidgetScatterplotDefinitionRequestYProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetScatterplotDefinitionRequestYProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackWidgetScatterplotDefinitionRequestYProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetScatterplotDefinitionRequestYProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackWidgetScatterplotDefinitionRequestYProcessQuery build() {
            final var _resultValue = new PowerpackWidgetScatterplotDefinitionRequestYProcessQuery();
