...
@CustomType
public final class PowerpackWidgetDistributionDefinitionXaxis {
    /**
    ...
    public static Builder builder(PowerpackWidgetDistributionDefinitionXaxis defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String scale;
        public Builder() {}
        public Builder(PowerpackWidgetDistributionDefinitionXaxis defaults) {
        ...
        public PowerpackWidgetDistributionDefinitionXaxis build() {
            final var _resultValue = new PowerpackWidgetDistributionDefinitionXaxis();
