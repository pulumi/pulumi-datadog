...
public final class DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyleArgs Empty = new DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyleArgs() {}

    private DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyleArgs(DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
