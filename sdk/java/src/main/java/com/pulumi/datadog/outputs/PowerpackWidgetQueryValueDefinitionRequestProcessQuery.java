...
@CustomType
public final class PowerpackWidgetQueryValueDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackWidgetQueryValueDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetQueryValueDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackWidgetQueryValueDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackWidgetQueryValueDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackWidgetQueryValueDefinitionRequestProcessQuery();
