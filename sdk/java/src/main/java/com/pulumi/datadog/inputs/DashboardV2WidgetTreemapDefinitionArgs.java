...
import com.pulumi.datadog.inputs.DashboardV2WidgetTreemapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetTreemapDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetTreemapDefinitionTimeArgs;
...
public final class DashboardV2WidgetTreemapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetTreemapDefinitionArgs Empty = new DashboardV2WidgetTreemapDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetTreemapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetTreemapDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<DashboardV2WidgetTreemapDefinitionRequestArgs>> requests;

    /**
     * @return Nested block describing the request to use when displaying the widget.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetTreemapDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetTreemapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetTreemapDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetTreemapDefinitionArgs() {}

    private DashboardV2WidgetTreemapDefinitionArgs(DashboardV2WidgetTreemapDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetTreemapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetTreemapDefinitionArgs();
        }

        public Builder(DashboardV2WidgetTreemapDefinitionArgs defaults) {
            $ = new DashboardV2WidgetTreemapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetTreemapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetTreemapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetTreemapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetTreemapDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetTreemapDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetTreemapDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetTreemapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetTreemapDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetTreemapDefinitionArgs build() {
            return $;
        }
    }
