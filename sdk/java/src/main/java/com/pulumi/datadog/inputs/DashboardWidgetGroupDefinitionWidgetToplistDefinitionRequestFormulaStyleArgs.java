...
public final class DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleArgs Empty = new DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleArgs() {}

    private DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleArgs(DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
