...
import com.pulumi.datadog.inputs.PowerpackV2WidgetAlertGraphDefinitionTimeArgs;
...
public final class PowerpackV2WidgetAlertGraphDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetAlertGraphDefinitionArgs Empty = new PowerpackV2WidgetAlertGraphDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetAlertGraphDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetAlertGraphDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetAlertGraphDefinitionArgs() {}

    private PowerpackV2WidgetAlertGraphDefinitionArgs(PowerpackV2WidgetAlertGraphDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetAlertGraphDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetAlertGraphDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetAlertGraphDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetAlertGraphDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetAlertGraphDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetAlertGraphDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetAlertGraphDefinitionArgs build() {
            if ($.alertId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetAlertGraphDefinitionArgs", "alertId");
            }
            if ($.vizType == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetAlertGraphDefinitionArgs", "vizType");
            }
            return $;
        }
    }
