...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionArgs build() {
            if ($.content == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetNoteDefinitionArgs", "content");
            }
            return $;
        }
    }
