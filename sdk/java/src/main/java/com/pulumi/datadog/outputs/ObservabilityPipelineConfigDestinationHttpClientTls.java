...
@CustomType
public final class ObservabilityPipelineConfigDestinationHttpClientTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationHttpClientTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationHttpClientTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationHttpClientTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationHttpClientTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigDestinationHttpClientTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationHttpClientTls();
