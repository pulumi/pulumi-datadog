...
public final class PowerpackV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs(PowerpackV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs build() {
            return $;
        }
    }
