...
@CustomType
public final class DashboardWidgetScatterplotDefinitionYaxis {
    /**
    ...
    public static Builder builder(DashboardWidgetScatterplotDefinitionYaxis defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String scale;
        public Builder() {}
        public Builder(DashboardWidgetScatterplotDefinitionYaxis defaults) {
        ...
        public DashboardWidgetScatterplotDefinitionYaxis build() {
            final var _resultValue = new DashboardWidgetScatterplotDefinitionYaxis();
