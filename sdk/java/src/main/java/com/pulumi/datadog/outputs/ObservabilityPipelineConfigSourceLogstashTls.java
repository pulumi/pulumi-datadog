...
@CustomType
public final class ObservabilityPipelineConfigSourceLogstashTls {
    /**
    ...
    private ObservabilityPipelineConfigSourceLogstashTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceLogstashTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceLogstashTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceLogstashTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceLogstashTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceLogstashTls();
