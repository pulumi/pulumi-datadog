...
public final class DashboardWidgetSunburstDefinitionRequestAuditQueryGroupBySortQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetSunburstDefinitionRequestAuditQueryGroupBySortQueryArgs(DashboardWidgetSunburstDefinitionRequestAuditQueryGroupBySortQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetSunburstDefinitionRequestAuditQueryGroupBySortQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetSunburstDefinitionRequestAuditQueryGroupBySortQueryArgs defaults) {
            $ = new DashboardWidgetSunburstDefinitionRequestAuditQueryGroupBySortQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetSunburstDefinitionRequestAuditQueryGroupBySortQueryArgs build() {
            if ($.aggregation == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestAuditQueryGroupBySortQueryArgs", "aggregation");
            }
            if ($.order == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestAuditQueryGroupBySortQueryArgs", "order");
            }
            return $;
        }
    }
