...
public final class DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs Empty = new DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs();
    ...
    private DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs() {}

    private DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs(DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
