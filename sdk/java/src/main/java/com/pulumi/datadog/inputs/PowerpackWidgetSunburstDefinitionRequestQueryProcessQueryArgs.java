...
public final class PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs Empty = new PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs();
    ...
    private PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs() {}

    private PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs(PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
