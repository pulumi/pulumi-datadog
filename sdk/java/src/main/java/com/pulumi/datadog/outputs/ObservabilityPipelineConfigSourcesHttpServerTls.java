...
@CustomType
public final class ObservabilityPipelineConfigSourcesHttpServerTls {
    /**
    ...
    private ObservabilityPipelineConfigSourcesHttpServerTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesHttpServerTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesHttpServerTls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesHttpServerTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesHttpServerTls();
