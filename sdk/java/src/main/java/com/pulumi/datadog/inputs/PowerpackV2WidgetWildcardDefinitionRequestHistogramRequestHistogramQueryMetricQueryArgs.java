...
public final class PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs Empty = new PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs() {}

    private PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs(PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
