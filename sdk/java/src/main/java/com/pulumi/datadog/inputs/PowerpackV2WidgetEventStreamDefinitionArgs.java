...
import com.pulumi.datadog.inputs.PowerpackV2WidgetEventStreamDefinitionTimeArgs;
...
public final class PowerpackV2WidgetEventStreamDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetEventStreamDefinitionArgs Empty = new PowerpackV2WidgetEventStreamDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetEventStreamDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetEventStreamDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetEventStreamDefinitionArgs() {}

    private PowerpackV2WidgetEventStreamDefinitionArgs(PowerpackV2WidgetEventStreamDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetEventStreamDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetEventStreamDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetEventStreamDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetEventStreamDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetEventStreamDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetEventStreamDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetEventStreamDefinitionArgs build() {
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetEventStreamDefinitionArgs", "query");
            }
            return $;
        }
    }
