...
import com.pulumi.datadog.outputs.DashboardV2WidgetAlertGraphDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetAlertGraphDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetAlertGraphDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetAlertGraphDefinition() {}
    /**
     * @return The ID of the monitor used by the widget.
     * 
     */
     ...
     * 
     */
    public Optional<DashboardV2WidgetAlertGraphDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetAlertGraphDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private String vizType;
        public Builder() {}
        public Builder(DashboardV2WidgetAlertGraphDefinition defaults) {
        ...
        public Builder alertId(String alertId) {
            if (alertId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetAlertGraphDefinition", "alertId");
            }
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetAlertGraphDefinitionTime time) {
        ...
        public Builder vizType(String vizType) {
            if (vizType == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetAlertGraphDefinition", "vizType");
            }
            this.vizType = vizType;
            return this;
        }
        public DashboardV2WidgetAlertGraphDefinition build() {
            final var _resultValue = new DashboardV2WidgetAlertGraphDefinition();
