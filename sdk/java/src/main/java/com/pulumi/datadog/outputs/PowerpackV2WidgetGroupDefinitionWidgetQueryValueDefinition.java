...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionCustomLink;
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTime;
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeseriesBackground;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinition {
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequest> requests;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTime time;
    /**
     * @return Set a timeseries on the widget background.
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeseriesBackground timeseriesBackground;
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinition() {}
    /**
     * @return A Boolean indicating whether to automatically scale the tile.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTime> time() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeseriesBackground> timeseriesBackground() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequest... requests) {
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTime time) {

            this.time = time;
            return this;
        }
        @CustomType.Setter
        public Builder timeseriesBackground(@Nullable PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeseriesBackground timeseriesBackground) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinition();
