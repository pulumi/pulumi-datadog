...
public final class PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs(PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
