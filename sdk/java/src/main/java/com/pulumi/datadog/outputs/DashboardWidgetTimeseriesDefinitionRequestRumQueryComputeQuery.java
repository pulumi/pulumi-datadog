...
@CustomType
public final class DashboardWidgetTimeseriesDefinitionRequestRumQueryComputeQuery {
    /**
    ...
    private DashboardWidgetTimeseriesDefinitionRequestRumQueryComputeQuery() {}
    /**
     * @return The aggregation method.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestRumQueryComputeQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer interval;
        public Builder() {}
        public Builder(DashboardWidgetTimeseriesDefinitionRequestRumQueryComputeQuery defaults) {
        ...
        public Builder aggregation(String aggregation) {
            if (aggregation == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestRumQueryComputeQuery", "aggregation");
            }
