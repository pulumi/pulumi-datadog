...
@CustomType
public final class DashboardWidgetScatterplotDefinitionRequestXProcessQuery {
    /**
    ...
    public static Builder builder(DashboardWidgetScatterplotDefinitionRequestXProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetScatterplotDefinitionRequestXProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetScatterplotDefinitionRequestXProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardWidgetScatterplotDefinitionRequestXProcessQuery build() {
            final var _resultValue = new DashboardWidgetScatterplotDefinitionRequestXProcessQuery();
