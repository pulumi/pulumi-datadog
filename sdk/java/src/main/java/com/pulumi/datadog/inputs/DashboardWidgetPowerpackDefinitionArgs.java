...
public final class DashboardWidgetPowerpackDefinitionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<DashboardWidgetPowerpackDefinitionTemplateVariablesArgs> templateVariables;

    /**
     * @return The list of template variables for this powerpack.
     * 
     */
    public Optional<Output<DashboardWidgetPowerpackDefinitionTemplateVariablesArgs>> templateVariables() {
    ...
    private DashboardWidgetPowerpackDefinitionArgs() {}
    ...
    public static Builder builder(DashboardWidgetPowerpackDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetPowerpackDefinitionArgs();
        }

        public Builder(DashboardWidgetPowerpackDefinitionArgs defaults) {
            $ = new DashboardWidgetPowerpackDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder templateVariables(@Nullable Output<DashboardWidgetPowerpackDefinitionTemplateVariablesArgs> templateVariables) {
         ...
         * 
         */
        public Builder templateVariables(DashboardWidgetPowerpackDefinitionTemplateVariablesArgs templateVariables) {
        ...
        public DashboardWidgetPowerpackDefinitionArgs build() {
            if ($.powerpackId == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetPowerpackDefinitionArgs", "powerpackId");
            }
            return $;
        }
    }
