...
public final class GetSecurityMonitoringRulesRuleReferenceTable {
    ...
    private GetSecurityMonitoringRulesRuleReferenceTable() {}
    /**
     * @return Whether to include or exclude logs that match the reference table.
     * 
     */
    ...
    public static Builder builder(GetSecurityMonitoringRulesRuleReferenceTable defaults) {
    ...
    public static final class Builder {
        ...
        private String tableName;
        public Builder() {}
        public Builder(GetSecurityMonitoringRulesRuleReferenceTable defaults) {
        ...
        public Builder checkPresence(Boolean checkPresence) {
            if (checkPresence == null) {
              throw new MissingRequiredPropertyException("GetSecurityMonitoringRulesRuleReferenceTable", "checkPresence");
            }
        ...
        public Builder columnName(String columnName) {
            if (columnName == null) {
              throw new MissingRequiredPropertyException("GetSecurityMonitoringRulesRuleReferenceTable", "columnName");
            }
        ...
        public Builder logFieldPath(String logFieldPath) {
            if (logFieldPath == null) {
              throw new MissingRequiredPropertyException("GetSecurityMonitoringRulesRuleReferenceTable", "logFieldPath");
            }
        ...
        public Builder ruleQueryName(String ruleQueryName) {
            if (ruleQueryName == null) {
              throw new MissingRequiredPropertyException("GetSecurityMonitoringRulesRuleReferenceTable", "ruleQueryName");
            }
        ...
        public Builder tableName(String tableName) {
            if (tableName == null) {
              throw new MissingRequiredPropertyException("GetSecurityMonitoringRulesRuleReferenceTable", "tableName");
            }
            this.tableName = tableName;
            return this;
        }
        public GetSecurityMonitoringRulesRuleReferenceTable build() {
            final var _resultValue = new GetSecurityMonitoringRulesRuleReferenceTable();
