...
public final class DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs Empty = new DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs();
    ...
    private DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs() {}

    private DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs(DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs();
        }

        public Builder(DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
            $ = new DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
