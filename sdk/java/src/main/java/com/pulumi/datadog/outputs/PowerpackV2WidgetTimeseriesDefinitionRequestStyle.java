...
@CustomType
public final class PowerpackV2WidgetTimeseriesDefinitionRequestStyle {
    /**
    ...
    private PowerpackV2WidgetTimeseriesDefinitionRequestStyle() {}
    /**
     * @return Whether to display value labels on the timeseries.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetTimeseriesDefinitionRequestStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String palette;
        public Builder() {}
        public Builder(PowerpackV2WidgetTimeseriesDefinitionRequestStyle defaults) {
        ...
        public PowerpackV2WidgetTimeseriesDefinitionRequestStyle build() {
            final var _resultValue = new PowerpackV2WidgetTimeseriesDefinitionRequestStyle();
