...
@CustomType
public final class DashboardWidgetSunburstDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardWidgetSunburstDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetSunburstDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetSunburstDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardWidgetSunburstDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardWidgetSunburstDefinitionRequestProcessQuery();
