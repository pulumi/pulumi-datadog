...
@CustomType
public final class PowerpackV2WidgetChangeDefinitionRequest {
    /**
     ...
     * 
     */
    public List<PowerpackV2WidgetChangeDefinitionRequestFormula> formulas() {
     ...
     */
    @Deprecated /* Use queries and formulas instead. */
    public Optional<PowerpackV2WidgetChangeDefinitionRequestProcessQuery> processQuery() {
     ...
     * 
     */
    public List<PowerpackV2WidgetChangeDefinitionRequestQuery> queries() {
    ...
    public static Builder builder(PowerpackV2WidgetChangeDefinitionRequest defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder formulas(@Nullable List<PowerpackV2WidgetChangeDefinitionRequestFormula> formulas) {

            this.formulas = formulas;
            return this;
        }
        public Builder formulas(PowerpackV2WidgetChangeDefinitionRequestFormula... formulas) {
        ...
        @CustomType.Setter
        public Builder processQuery(@Nullable PowerpackV2WidgetChangeDefinitionRequestProcessQuery processQuery) {
        ...
        @CustomType.Setter
        public Builder queries(@Nullable List<PowerpackV2WidgetChangeDefinitionRequestQuery> queries) {

            this.queries = queries;
            return this;
        }
        public Builder queries(PowerpackV2WidgetChangeDefinitionRequestQuery... queries) {
        ...
        public PowerpackV2WidgetChangeDefinitionRequest build() {
            final var _resultValue = new PowerpackV2WidgetChangeDefinitionRequest();
