...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs();
     ...
     */
    @Import(name="request")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionRequestArgs> request;

    /**
     * @return A nested block describing the request to use when displaying the widget. Only one `request` block is allowed.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionRequestArgs>> request() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder request(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionRequestArgs> request) {
            $.request = request;
            return this;
        }
         ...
         * 
         */
        public Builder request(PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionRequestArgs request) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs build() {
            return $;
        }
    }
