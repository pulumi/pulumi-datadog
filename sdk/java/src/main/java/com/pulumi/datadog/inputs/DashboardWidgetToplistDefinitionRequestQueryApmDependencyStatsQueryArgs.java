...
public final class DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs Empty = new DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs();
    ...
    private DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs() {}

    private DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs(DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs();
        }

        public Builder(DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
            $ = new DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
