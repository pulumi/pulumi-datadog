...
public final class DashboardWidgetSunburstDefinitionRequestLogQueryMultiComputeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetSunburstDefinitionRequestLogQueryMultiComputeArgs() {}

    private DashboardWidgetSunburstDefinitionRequestLogQueryMultiComputeArgs(DashboardWidgetSunburstDefinitionRequestLogQueryMultiComputeArgs $) {
    ...
    public static Builder builder(DashboardWidgetSunburstDefinitionRequestLogQueryMultiComputeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetSunburstDefinitionRequestLogQueryMultiComputeArgs defaults) {
            $ = new DashboardWidgetSunburstDefinitionRequestLogQueryMultiComputeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetSunburstDefinitionRequestLogQueryMultiComputeArgs build() {
            if ($.aggregation == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestLogQueryMultiComputeArgs", "aggregation");
            }
            return $;
        }
    }
