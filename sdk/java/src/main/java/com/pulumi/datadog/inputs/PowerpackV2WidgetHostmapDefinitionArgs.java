...
import com.pulumi.datadog.inputs.PowerpackV2WidgetHostmapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetHostmapDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetHostmapDefinitionStyleArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetHostmapDefinitionTimeArgs;
...
public final class PowerpackV2WidgetHostmapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionArgs Empty = new PowerpackV2WidgetHostmapDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetHostmapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetHostmapDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="request")
    private @Nullable Output<PowerpackV2WidgetHostmapDefinitionRequestArgs> request;
     ...
     * 
     */
    public Optional<Output<PowerpackV2WidgetHostmapDefinitionRequestArgs>> request() {
     ...
     */
    @Import(name="style")
    private @Nullable Output<PowerpackV2WidgetHostmapDefinitionStyleArgs> style;

    /**
     * @return The style of the widget graph. One nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<PowerpackV2WidgetHostmapDefinitionStyleArgs>> style() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetHostmapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetHostmapDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetHostmapDefinitionArgs() {}

    private PowerpackV2WidgetHostmapDefinitionArgs(PowerpackV2WidgetHostmapDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetHostmapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetHostmapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetHostmapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder request(@Nullable Output<PowerpackV2WidgetHostmapDefinitionRequestArgs> request) {
            $.request = request;
            return this;
        }
         ...
         * 
         */
        public Builder request(PowerpackV2WidgetHostmapDefinitionRequestArgs request) {
         ...
         * 
         */
        public Builder style(@Nullable Output<PowerpackV2WidgetHostmapDefinitionStyleArgs> style) {
            $.style = style;
            return this;
        }
         ...
         * 
         */
        public Builder style(PowerpackV2WidgetHostmapDefinitionStyleArgs style) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetHostmapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetHostmapDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetHostmapDefinitionArgs build() {
            return $;
        }
    }
