...
import com.pulumi.datadog.outputs.PowerpackV2WidgetDistributionDefinitionMarker;
import com.pulumi.datadog.outputs.PowerpackV2WidgetDistributionDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetDistributionDefinitionTime;
import com.pulumi.datadog.outputs.PowerpackV2WidgetDistributionDefinitionXaxis;
import com.pulumi.datadog.outputs.PowerpackV2WidgetDistributionDefinitionYaxis;
...
@CustomType
public final class PowerpackV2WidgetDistributionDefinition {
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetDistributionDefinitionMarker> markers;
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetDistributionDefinitionRequest> requests;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetDistributionDefinitionTime time;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetDistributionDefinitionXaxis xaxis;
    /**
     * @return A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    private @Nullable PowerpackV2WidgetDistributionDefinitionYaxis yaxis;

    private PowerpackV2WidgetDistributionDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetDistributionDefinitionMarker> markers() {
     ...
     * 
     */
    public List<PowerpackV2WidgetDistributionDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetDistributionDefinitionTime> time() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetDistributionDefinitionXaxis> xaxis() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetDistributionDefinitionYaxis> yaxis() {
    ...
    public static Builder builder(PowerpackV2WidgetDistributionDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable PowerpackV2WidgetDistributionDefinitionYaxis yaxis;
        public Builder() {}
        public Builder(PowerpackV2WidgetDistributionDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder markers(@Nullable List<PowerpackV2WidgetDistributionDefinitionMarker> markers) {

            this.markers = markers;
            return this;
        }
        public Builder markers(PowerpackV2WidgetDistributionDefinitionMarker... markers) {
            return markers(List.of(markers));
        }
        @CustomType.Setter
        public Builder requests(@Nullable List<PowerpackV2WidgetDistributionDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetDistributionDefinitionRequest... requests) {
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetDistributionDefinitionTime time) {
        ...
        @CustomType.Setter
        public Builder xaxis(@Nullable PowerpackV2WidgetDistributionDefinitionXaxis xaxis) {

            this.xaxis = xaxis;
            return this;
        }
        @CustomType.Setter
        public Builder yaxis(@Nullable PowerpackV2WidgetDistributionDefinitionYaxis yaxis) {

            this.yaxis = yaxis;
            return this;
        }
        public PowerpackV2WidgetDistributionDefinition build() {
            final var _resultValue = new PowerpackV2WidgetDistributionDefinition();
