...
public final class DashboardV2WidgetTimeseriesDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetTimeseriesDefinitionRequestProcessQueryArgs Empty = new DashboardV2WidgetTimeseriesDefinitionRequestProcessQueryArgs();
    ...
    private DashboardV2WidgetTimeseriesDefinitionRequestProcessQueryArgs() {}

    private DashboardV2WidgetTimeseriesDefinitionRequestProcessQueryArgs(DashboardV2WidgetTimeseriesDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetTimeseriesDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetTimeseriesDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardV2WidgetTimeseriesDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardV2WidgetTimeseriesDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetTimeseriesDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTimeseriesDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
