...
@CustomType
public final class DashboardWidgetDistributionDefinitionXaxis {
    /**
    ...
    public static Builder builder(DashboardWidgetDistributionDefinitionXaxis defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String scale;
        public Builder() {}
        public Builder(DashboardWidgetDistributionDefinitionXaxis defaults) {
        ...
        public DashboardWidgetDistributionDefinitionXaxis build() {
            final var _resultValue = new DashboardWidgetDistributionDefinitionXaxis();
