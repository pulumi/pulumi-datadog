...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs build() {
            if ($.text == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetFreeTextDefinitionArgs", "text");
            }
            return $;
        }
    }
