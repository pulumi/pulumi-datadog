...
import com.pulumi.datadog.inputs.PowerpackWidgetQueryTableDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackWidgetQueryTableDefinitionRequestArgs;
...
public final class PowerpackWidgetQueryTableDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryTableDefinitionArgs Empty = new PowerpackWidgetQueryTableDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackWidgetQueryTableDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackWidgetQueryTableDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<PowerpackWidgetQueryTableDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackWidgetQueryTableDefinitionRequestArgs>>> requests() {
    ...
    private PowerpackWidgetQueryTableDefinitionArgs() {}
    ...
    public static Builder builder(PowerpackWidgetQueryTableDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryTableDefinitionArgs();
        }

        public Builder(PowerpackWidgetQueryTableDefinitionArgs defaults) {
            $ = new PowerpackWidgetQueryTableDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackWidgetQueryTableDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackWidgetQueryTableDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackWidgetQueryTableDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackWidgetQueryTableDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackWidgetQueryTableDefinitionRequestArgs... requests) {
        ...
        public PowerpackWidgetQueryTableDefinitionArgs build() {
            return $;
        }
    }
