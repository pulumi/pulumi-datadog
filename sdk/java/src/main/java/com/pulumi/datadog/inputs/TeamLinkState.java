...
public final class TeamLinkState extends com.pulumi.resources.ResourceArgs {

    public static final TeamLinkState Empty = new TeamLinkState();
    ...
    private TeamLinkState() {}

    private TeamLinkState(TeamLinkState $) {
        this.label = $.label;
    ...
    public static Builder builder(TeamLinkState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(TeamLinkState defaults) {
            $ = new TeamLinkState(Objects.requireNonNull(defaults));
        }
