...
@CustomType
public final class PowerpackV2WidgetToplistDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackV2WidgetToplistDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetToplistDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetToplistDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetToplistDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetToplistDefinitionRequestProcessQuery();
