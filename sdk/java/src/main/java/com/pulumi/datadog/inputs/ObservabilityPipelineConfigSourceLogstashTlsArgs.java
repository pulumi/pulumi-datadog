...
public final class ObservabilityPipelineConfigSourceLogstashTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceLogstashTlsArgs Empty = new ObservabilityPipelineConfigSourceLogstashTlsArgs();
    ...
    private ObservabilityPipelineConfigSourceLogstashTlsArgs() {}

    private ObservabilityPipelineConfigSourceLogstashTlsArgs(ObservabilityPipelineConfigSourceLogstashTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceLogstashTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceLogstashTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceLogstashTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceLogstashTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceLogstashTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceLogstashTlsArgs", "crtFile");
            }
            return $;
        }
    }
