...
public final class PowerpackV2Args extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2Args Empty = new PowerpackV2Args();
    ...
    private PowerpackV2Args() {}

    private PowerpackV2Args(PowerpackV2Args $) {
    ...
    public static Builder builder(PowerpackV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PowerpackV2Args defaults) {
            $ = new PowerpackV2Args(Objects.requireNonNull(defaults));
        }
