...
public final class DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs Empty = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs();
    ...
    private DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs() {}

    private DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
