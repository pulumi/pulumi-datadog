...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionStyle {
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionStyle() {}
    /**
     * @return The max value to use to color the map.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean paletteFlip;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionStyle defaults) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionStyle build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionStyle();
