...
public final class DashboardWidgetTimeseriesDefinitionRequestLogQueryGroupBySortQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetTimeseriesDefinitionRequestLogQueryGroupBySortQueryArgs(DashboardWidgetTimeseriesDefinitionRequestLogQueryGroupBySortQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestLogQueryGroupBySortQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetTimeseriesDefinitionRequestLogQueryGroupBySortQueryArgs defaults) {
            $ = new DashboardWidgetTimeseriesDefinitionRequestLogQueryGroupBySortQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetTimeseriesDefinitionRequestLogQueryGroupBySortQueryArgs build() {
            if ($.aggregation == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestLogQueryGroupBySortQueryArgs", "aggregation");
            }
            if ($.order == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestLogQueryGroupBySortQueryArgs", "order");
            }
            return $;
        }
    }
