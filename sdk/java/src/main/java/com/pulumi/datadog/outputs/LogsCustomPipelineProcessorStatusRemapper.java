...
public final class LogsCustomPipelineProcessorStatusRemapper {
    ...
    public static final class Builder {
        ...
        public Builder sources(List<String> sources) {
            if (sources == null) {
              throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorStatusRemapper", "sources");
            }
        ...
        public LogsCustomPipelineProcessorStatusRemapper build() {
            final var _resultValue = new LogsCustomPipelineProcessorStatusRemapper();
