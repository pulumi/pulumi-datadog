...
public final class DashboardWidgetTimeseriesDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetTimeseriesDefinitionRequestFormulaStyleArgs Empty = new DashboardWidgetTimeseriesDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardWidgetTimeseriesDefinitionRequestFormulaStyleArgs() {}

    private DashboardWidgetTimeseriesDefinitionRequestFormulaStyleArgs(DashboardWidgetTimeseriesDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetTimeseriesDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardWidgetTimeseriesDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardWidgetTimeseriesDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetTimeseriesDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
