...
@CustomType
public final class DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQuery {
    /**
    ...
    private DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQuery() {}
    /**
     * @return The aggregation methods available for metrics queries. Valid values are `avg`, `min`, `max`, `sum`, `last`, `area`, `l2norm`, `percentile`.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String semanticMode;
        public Builder() {}
        public Builder(DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQuery defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
        ...
        public DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQuery build() {
            final var _resultValue = new DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQuery();
