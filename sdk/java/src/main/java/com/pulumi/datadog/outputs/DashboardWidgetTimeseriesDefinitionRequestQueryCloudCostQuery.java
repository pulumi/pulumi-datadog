...
@CustomType
public final class DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQuery {
    /**
    ...
    private DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQuery() {}
    /**
     * @return The aggregation methods available for cloud cost queries. Valid values are `avg`, `last`, `max`, `min`, `sum`, `percentile`.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQuery", "dataSource");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQuery", "query");
            }
            this.query = query;
            return this;
        }
        public DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQuery build() {
            final var _resultValue = new DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQuery();
