...
public final class PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs(PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
