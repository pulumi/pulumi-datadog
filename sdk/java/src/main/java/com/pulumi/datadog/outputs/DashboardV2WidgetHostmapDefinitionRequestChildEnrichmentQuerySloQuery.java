...
@CustomType
public final class DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery {
    /**
    ...
    private DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery build() {
            final var _resultValue = new DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery();
