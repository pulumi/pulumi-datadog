...
public final class DashboardWidgetHostmapDefinitionRequestSizeProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetHostmapDefinitionRequestSizeProcessQueryArgs Empty = new DashboardWidgetHostmapDefinitionRequestSizeProcessQueryArgs();
    ...
    private DashboardWidgetHostmapDefinitionRequestSizeProcessQueryArgs() {}

    private DashboardWidgetHostmapDefinitionRequestSizeProcessQueryArgs(DashboardWidgetHostmapDefinitionRequestSizeProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetHostmapDefinitionRequestSizeProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetHostmapDefinitionRequestSizeProcessQueryArgs();
        }

        public Builder(DashboardWidgetHostmapDefinitionRequestSizeProcessQueryArgs defaults) {
            $ = new DashboardWidgetHostmapDefinitionRequestSizeProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetHostmapDefinitionRequestSizeProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetHostmapDefinitionRequestSizeProcessQueryArgs", "metric");
            }
            return $;
        }
    }
