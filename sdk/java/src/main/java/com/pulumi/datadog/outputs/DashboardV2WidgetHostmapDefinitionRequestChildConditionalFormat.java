...
@CustomType
public final class DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormat {
    /**
    ...
    private DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormat() {}
    /**
     * @return The comparator to use. Valid values are `=`, `&gt;`, `&gt;=`, `&lt;`, `&lt;=`.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormat defaults) {
    ...
    public static final class Builder {
        ...
        private Double value;
        public Builder() {}
        public Builder(DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormat defaults) {
        ...
        public Builder comparator(String comparator) {
            if (comparator == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormat", "comparator");
            }
        ...
        public Builder palette(String palette) {
            if (palette == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormat", "palette");
            }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormat", "value");
            }
            this.value = value;
            return this;
        }
        public DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormat build() {
            final var _resultValue = new DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormat();
