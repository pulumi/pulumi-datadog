...
public final class PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs Empty = new PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs(PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
