...
public final class DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs Empty = new DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs();
    ...
    private DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs() {}

    private DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs(DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs();
        }

        public Builder(DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs defaults) {
            $ = new DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs", "name");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs", "stat");
            }
            return $;
        }
    }
