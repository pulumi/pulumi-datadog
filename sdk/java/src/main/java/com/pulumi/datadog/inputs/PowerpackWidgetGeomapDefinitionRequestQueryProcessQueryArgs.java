...
public final class PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs Empty = new PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs();
    ...
    private PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs() {}

    private PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs(PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
