...
public final class ObservabilityPipelineConfigDestinationAmazonS3GenericAuthArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationAmazonS3GenericAuthArgs Empty = new ObservabilityPipelineConfigDestinationAmazonS3GenericAuthArgs();
    ...
    private ObservabilityPipelineConfigDestinationAmazonS3GenericAuthArgs() {}

    private ObservabilityPipelineConfigDestinationAmazonS3GenericAuthArgs(ObservabilityPipelineConfigDestinationAmazonS3GenericAuthArgs $) {
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationAmazonS3GenericAuthArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationAmazonS3GenericAuthArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationAmazonS3GenericAuthArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationAmazonS3GenericAuthArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationAmazonS3GenericAuthArgs build() {
            return $;
        }
    }
