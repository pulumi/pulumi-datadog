...
@CustomType
public final class DashboardWidgetToplistDefinitionRequestLogQueryMultiCompute {
    /**
    ...
    private DashboardWidgetToplistDefinitionRequestLogQueryMultiCompute() {}
    /**
     * @return The aggregation method.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetToplistDefinitionRequestLogQueryMultiCompute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer interval;
        public Builder() {}
        public Builder(DashboardWidgetToplistDefinitionRequestLogQueryMultiCompute defaults) {
        ...
        public Builder aggregation(String aggregation) {
            if (aggregation == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestLogQueryMultiCompute", "aggregation");
            }
