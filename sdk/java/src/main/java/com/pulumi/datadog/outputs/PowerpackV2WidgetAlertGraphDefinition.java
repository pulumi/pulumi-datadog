...
import com.pulumi.datadog.outputs.PowerpackV2WidgetAlertGraphDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetAlertGraphDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetAlertGraphDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetAlertGraphDefinition() {}
    /**
     * @return The ID of the monitor used by the widget.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetAlertGraphDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetAlertGraphDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private String vizType;
        public Builder() {}
        public Builder(PowerpackV2WidgetAlertGraphDefinition defaults) {
        ...
        public Builder alertId(String alertId) {
            if (alertId == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetAlertGraphDefinition", "alertId");
            }
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetAlertGraphDefinitionTime time) {
        ...
        public Builder vizType(String vizType) {
            if (vizType == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetAlertGraphDefinition", "vizType");
            }
            this.vizType = vizType;
            return this;
        }
        public PowerpackV2WidgetAlertGraphDefinition build() {
            final var _resultValue = new PowerpackV2WidgetAlertGraphDefinition();
