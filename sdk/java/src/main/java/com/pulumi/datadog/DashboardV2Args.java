...
import com.pulumi.datadog.inputs.DashboardV2TabArgs;
import com.pulumi.datadog.inputs.DashboardV2TemplateVariableArgs;
import com.pulumi.datadog.inputs.DashboardV2TemplateVariablePresetArgs;
...
public final class DashboardV2Args extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2Args Empty = new DashboardV2Args();
     ...
     */
    @Import(name="tabs")
    private @Nullable Output<List<DashboardV2TabArgs>> tabs;

    /**
     * @return List of tabs for organizing widgets.
     * 
     */
    public Optional<Output<List<DashboardV2TabArgs>>> tabs() {
    ...
    private @Nullable Output<List<DashboardV2TemplateVariablePresetArgs>> templateVariablePresets;

    /**
     * @return The list of selectable template variable presets for this dashboard.
     * 
     */
    public Optional<Output<List<DashboardV2TemplateVariablePresetArgs>>> templateVariablePresets() {
    ...
    private @Nullable Output<List<DashboardV2TemplateVariableArgs>> templateVariables;

    /**
     * @return The list of template variables for this dashboard.
     * 
     */
    public Optional<Output<List<DashboardV2TemplateVariableArgs>>> templateVariables() {
     ...
     */
    @Import(name="widgets")
    private @Nullable Output<List<DashboardV2WidgetArgs>> widgets;

    /**
     * @return The list of widgets to display on the dashboard.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetArgs>>> widgets() {
        return Optional.ofNullable(this.widgets);
    }

    private DashboardV2Args() {}

    private DashboardV2Args(DashboardV2Args $) {
    ...
    public static Builder builder(DashboardV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardV2Args defaults) {
            $ = new DashboardV2Args(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param isReadOnly Whether this dashboard is read-only. **Deprecated.** This field is deprecated and non-functional. Use `restrictedRoles` instead to define which roles are required to edit the dashboard. Defaults to `false`.
         * 
         * @return builder
         * 
         * @deprecated
        ...
        /**
         * @param restrictedRoles A list of role identifiers. Only the author and users associated with at least one of these roles can edit this dashboard.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tabs List of tabs for organizing widgets.
         * 
         * @return builder
         * 
         */
        public Builder tabs(@Nullable Output<List<DashboardV2TabArgs>> tabs) {
            $.tabs = tabs;
            return this;
        }
         ...
         * 
         */
        public Builder tabs(List<DashboardV2TabArgs> tabs) {
         ...
         * 
         */
        public Builder tabs(DashboardV2TabArgs... tabs) {
         ...
         * 
         */
        public Builder templateVariablePresets(@Nullable Output<List<DashboardV2TemplateVariablePresetArgs>> templateVariablePresets) {
         ...
         * 
         */
        public Builder templateVariablePresets(List<DashboardV2TemplateVariablePresetArgs> templateVariablePresets) {
         ...
         * 
         */
        public Builder templateVariablePresets(DashboardV2TemplateVariablePresetArgs... templateVariablePresets) {
         ...
         * 
         */
        public Builder templateVariables(@Nullable Output<List<DashboardV2TemplateVariableArgs>> templateVariables) {
         ...
         * 
         */
        public Builder templateVariables(List<DashboardV2TemplateVariableArgs> templateVariables) {
         ...
         * 
         */
        public Builder templateVariables(DashboardV2TemplateVariableArgs... templateVariables) {
         ...
         * 
         */
        public Builder widgets(@Nullable Output<List<DashboardV2WidgetArgs>> widgets) {
            $.widgets = widgets;
            return this;
        }
         ...
         * 
         */
        public Builder widgets(List<DashboardV2WidgetArgs> widgets) {
         ...
         * 
         */
        public Builder widgets(DashboardV2WidgetArgs... widgets) {
            return widgets(List.of(widgets));
        }

        public DashboardV2Args build() {
            if ($.layoutType == null) {
                throw new MissingRequiredPropertyException("DashboardV2Args", "layoutType");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("DashboardV2Args", "title");
            }
            return $;
        }
    }
