...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionArgs();
    ...
    private Output<List<PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionRequestArgs>> requests;

    /**
     * @return A nested block describing the request to use when displaying the widget. Exactly one `request` block is allowed.
     * 
     */
    public Output<List<PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetSloListDefinitionArgs", "requests");
            }
            return $;
        }
    }
