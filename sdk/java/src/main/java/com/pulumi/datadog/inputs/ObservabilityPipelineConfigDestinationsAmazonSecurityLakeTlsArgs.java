...
public final class ObservabilityPipelineConfigDestinationsAmazonSecurityLakeTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationsAmazonSecurityLakeTlsArgs Empty = new ObservabilityPipelineConfigDestinationsAmazonSecurityLakeTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationsAmazonSecurityLakeTlsArgs() {}

    private ObservabilityPipelineConfigDestinationsAmazonSecurityLakeTlsArgs(ObservabilityPipelineConfigDestinationsAmazonSecurityLakeTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationsAmazonSecurityLakeTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationsAmazonSecurityLakeTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationsAmazonSecurityLakeTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationsAmazonSecurityLakeTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationsAmazonSecurityLakeTlsArgs build() {
            return $;
        }
    }
