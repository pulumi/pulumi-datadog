...
public final class DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs Empty = new DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs() {}

    private DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs(DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
