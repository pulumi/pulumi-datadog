...
public final class ObservabilityPipelineConfigDestinationAmazonS3AuthArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationAmazonS3AuthArgs Empty = new ObservabilityPipelineConfigDestinationAmazonS3AuthArgs();
    ...
    private ObservabilityPipelineConfigDestinationAmazonS3AuthArgs() {}

    private ObservabilityPipelineConfigDestinationAmazonS3AuthArgs(ObservabilityPipelineConfigDestinationAmazonS3AuthArgs $) {
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationAmazonS3AuthArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationAmazonS3AuthArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationAmazonS3AuthArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationAmazonS3AuthArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationAmazonS3AuthArgs build() {
            return $;
        }
    }
