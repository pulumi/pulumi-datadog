...
public final class DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs Empty = new DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs();
    ...
    private DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs() {}

    private DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs(DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
