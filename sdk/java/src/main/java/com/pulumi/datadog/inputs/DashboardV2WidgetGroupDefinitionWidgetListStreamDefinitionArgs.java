...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs();
    ...
    private Output<List<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Output<List<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionArgs", "requests");
            }
            return $;
        }
    }
