...
import com.pulumi.datadog.inputs.DashboardV2WidgetHostmapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetHostmapDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetHostmapDefinitionStyleArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetHostmapDefinitionTimeArgs;
...
public final class DashboardV2WidgetHostmapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHostmapDefinitionArgs Empty = new DashboardV2WidgetHostmapDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetHostmapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetHostmapDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="request")
    private @Nullable Output<DashboardV2WidgetHostmapDefinitionRequestArgs> request;
     ...
     * 
     */
    public Optional<Output<DashboardV2WidgetHostmapDefinitionRequestArgs>> request() {
     ...
     */
    @Import(name="style")
    private @Nullable Output<DashboardV2WidgetHostmapDefinitionStyleArgs> style;

    /**
     * @return The style of the widget graph. One nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<DashboardV2WidgetHostmapDefinitionStyleArgs>> style() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetHostmapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetHostmapDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetHostmapDefinitionArgs() {}

    private DashboardV2WidgetHostmapDefinitionArgs(DashboardV2WidgetHostmapDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHostmapDefinitionArgs();
        }

        public Builder(DashboardV2WidgetHostmapDefinitionArgs defaults) {
            $ = new DashboardV2WidgetHostmapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetHostmapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetHostmapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetHostmapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder request(@Nullable Output<DashboardV2WidgetHostmapDefinitionRequestArgs> request) {
            $.request = request;
            return this;
        }
         ...
         * 
         */
        public Builder request(DashboardV2WidgetHostmapDefinitionRequestArgs request) {
         ...
         * 
         */
        public Builder style(@Nullable Output<DashboardV2WidgetHostmapDefinitionStyleArgs> style) {
            $.style = style;
            return this;
        }
         ...
         * 
         */
        public Builder style(DashboardV2WidgetHostmapDefinitionStyleArgs style) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetHostmapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetHostmapDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetHostmapDefinitionArgs build() {
            return $;
        }
    }
