...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestQuerySloQuery {
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestQuerySloQuery build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestQuerySloQuery();
