...
@CustomType
public final class ObservabilityPipelineConfigSourceSyslogNgTls {
    /**
    ...
    private ObservabilityPipelineConfigSourceSyslogNgTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceSyslogNgTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceSyslogNgTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceSyslogNgTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceSyslogNgTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceSyslogNgTls();
