...
@CustomType
public final class PowerpackV2WidgetHostmapDefinitionRequestFillProcessQuery {
    /**
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestFillProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestFillProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetHostmapDefinitionRequestFillProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestFillProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestFillProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetHostmapDefinitionRequestFillProcessQuery();
