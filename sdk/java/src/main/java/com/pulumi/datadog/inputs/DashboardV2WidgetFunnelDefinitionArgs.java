...
import com.pulumi.datadog.inputs.DashboardV2WidgetFunnelDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetFunnelDefinitionTimeArgs;
...
public final class DashboardV2WidgetFunnelDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetFunnelDefinitionArgs Empty = new DashboardV2WidgetFunnelDefinitionArgs();
     ...
     */
    @Import(name="request")
    private @Nullable Output<DashboardV2WidgetFunnelDefinitionRequestArgs> request;

    /**
     * @return A nested block describing the request to use when displaying the widget. Only one `request` block is allowed.
     * 
     */
    public Optional<Output<DashboardV2WidgetFunnelDefinitionRequestArgs>> request() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetFunnelDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetFunnelDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetFunnelDefinitionArgs() {}
    ...
    public static Builder builder(DashboardV2WidgetFunnelDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetFunnelDefinitionArgs();
        }

        public Builder(DashboardV2WidgetFunnelDefinitionArgs defaults) {
            $ = new DashboardV2WidgetFunnelDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder request(@Nullable Output<DashboardV2WidgetFunnelDefinitionRequestArgs> request) {
            $.request = request;
            return this;
        }
         ...
         * 
         */
        public Builder request(DashboardV2WidgetFunnelDefinitionRequestArgs request) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetFunnelDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetFunnelDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetFunnelDefinitionArgs build() {
            return $;
        }
    }
