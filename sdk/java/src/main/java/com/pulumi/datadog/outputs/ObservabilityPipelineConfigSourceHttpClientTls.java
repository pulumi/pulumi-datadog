...
@CustomType
public final class ObservabilityPipelineConfigSourceHttpClientTls {
    /**
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceHttpClientTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceHttpClientTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceHttpClientTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceHttpClientTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceHttpClientTls();
