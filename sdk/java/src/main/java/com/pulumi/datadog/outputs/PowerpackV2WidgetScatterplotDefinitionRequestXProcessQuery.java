...
@CustomType
public final class PowerpackV2WidgetScatterplotDefinitionRequestXProcessQuery {
    /**
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestXProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestXProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestXProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestXProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetScatterplotDefinitionRequestXProcessQuery();
