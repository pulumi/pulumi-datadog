...
@CustomType
public final class ObservabilityPipelineConfigSourcesSyslogNgTls {
    /**
    ...
    private ObservabilityPipelineConfigSourcesSyslogNgTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesSyslogNgTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesSyslogNgTls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesSyslogNgTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesSyslogNgTls();
