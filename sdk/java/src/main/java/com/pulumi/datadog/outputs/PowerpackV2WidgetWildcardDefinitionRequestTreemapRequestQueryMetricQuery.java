...
@CustomType
public final class PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestQueryMetricQuery {
    /**
    ...
    private PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestQueryMetricQuery() {}
    /**
     * @return The aggregation methods available for metrics queries. Valid values are `avg`, `min`, `max`, `sum`, `last`, `area`, `l2norm`, `percentile`.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String semanticMode;
        public Builder() {}
        public Builder(PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestQueryMetricQuery defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
        ...
        public PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestQueryMetricQuery build() {
            final var _resultValue = new PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestQueryMetricQuery();
