...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestArgs>> requests;

    /**
     * @return Nested block describing the request to use when displaying the widget.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionArgs build() {
            return $;
        }
    }
