...
public final class DashboardWidgetChangeDefinitionRequestQueryMetricQuery {
    ...
    public static Builder builder(DashboardWidgetChangeDefinitionRequestQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(DashboardWidgetChangeDefinitionRequestQueryMetricQuery defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetChangeDefinitionRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetChangeDefinitionRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
        public DashboardWidgetChangeDefinitionRequestQueryMetricQuery build() {
            final var _resultValue = new DashboardWidgetChangeDefinitionRequestQueryMetricQuery();
