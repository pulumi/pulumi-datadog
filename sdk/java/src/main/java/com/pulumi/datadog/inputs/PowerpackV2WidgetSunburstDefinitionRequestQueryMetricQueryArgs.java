...
public final class PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs Empty = new PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs() {}

    private PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs(PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
