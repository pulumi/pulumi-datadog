...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinition() {}
    /**
     * @return Whether to colorize text or background. Valid values are `background`, `text`.
     * 
     */
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinition defaults) {
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinition", "query");
            }
            this.query = query;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinitionTime time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinition build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetManageStatusDefinition();
