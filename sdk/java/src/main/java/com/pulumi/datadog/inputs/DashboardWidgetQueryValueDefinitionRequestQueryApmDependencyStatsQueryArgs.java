...
public final class DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs Empty = new DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs();
    ...
    private DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs() {}

    private DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs(DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs();
        }

        public Builder(DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
            $ = new DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
