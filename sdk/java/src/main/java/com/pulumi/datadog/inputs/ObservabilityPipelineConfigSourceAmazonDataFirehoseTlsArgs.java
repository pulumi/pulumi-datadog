...
public final class ObservabilityPipelineConfigSourceAmazonDataFirehoseTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceAmazonDataFirehoseTlsArgs Empty = new ObservabilityPipelineConfigSourceAmazonDataFirehoseTlsArgs();
    ...
    private ObservabilityPipelineConfigSourceAmazonDataFirehoseTlsArgs() {}

    private ObservabilityPipelineConfigSourceAmazonDataFirehoseTlsArgs(ObservabilityPipelineConfigSourceAmazonDataFirehoseTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceAmazonDataFirehoseTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceAmazonDataFirehoseTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceAmazonDataFirehoseTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceAmazonDataFirehoseTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceAmazonDataFirehoseTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceAmazonDataFirehoseTlsArgs", "crtFile");
            }
            return $;
        }
    }
