...
import com.pulumi.datadog.outputs.PowerpackV2WidgetHostmapDefinitionCustomLink;
import com.pulumi.datadog.outputs.PowerpackV2WidgetHostmapDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetHostmapDefinitionStyle;
import com.pulumi.datadog.outputs.PowerpackV2WidgetHostmapDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetHostmapDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<PowerpackV2WidgetHostmapDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetHostmapDefinitionRequest request;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetHostmapDefinitionStyle style;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetHostmapDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetHostmapDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<PowerpackV2WidgetHostmapDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetHostmapDefinitionRequest> request() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetHostmapDefinitionStyle> style() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetHostmapDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetHostmapDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<PowerpackV2WidgetHostmapDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(PowerpackV2WidgetHostmapDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder request(@Nullable PowerpackV2WidgetHostmapDefinitionRequest request) {
        ...
        @CustomType.Setter
        public Builder style(@Nullable PowerpackV2WidgetHostmapDefinitionStyle style) {

            this.style = style;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetHostmapDefinitionTime time) {
        ...
        public PowerpackV2WidgetHostmapDefinition build() {
            final var _resultValue = new PowerpackV2WidgetHostmapDefinition();
