...
import com.pulumi.datadog.inputs.PowerpackV2WidgetServiceLevelObjectiveDefinitionTimeArgs;
...
public final class PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs Empty = new PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetServiceLevelObjectiveDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetServiceLevelObjectiveDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs() {}

    private PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs(PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetServiceLevelObjectiveDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetServiceLevelObjectiveDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs build() {
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs", "sloId");
            }
            if ($.timeWindows == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs", "timeWindows");
            }
            if ($.viewMode == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs", "viewMode");
            }
            if ($.viewType == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetServiceLevelObjectiveDefinitionArgs", "viewType");
            }
            return $;
        }
    }
