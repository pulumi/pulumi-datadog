...
@CustomType
public final class ObservabilityPipelineConfigDestinationSyslogNgTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationSyslogNgTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationSyslogNgTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationSyslogNgTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationSyslogNgTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigDestinationSyslogNgTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationSyslogNgTls();
