...
public final class PowerpackV2WidgetTreemapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTreemapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs Empty = new PowerpackV2WidgetTreemapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
    ...
    private PowerpackV2WidgetTreemapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs() {}

    private PowerpackV2WidgetTreemapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(PowerpackV2WidgetTreemapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTreemapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTreemapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(PowerpackV2WidgetTreemapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new PowerpackV2WidgetTreemapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetTreemapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
