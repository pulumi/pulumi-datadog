...
@CustomType
public final class ObservabilityPipelineConfigProcessorGroupProcessorEnrichmentTableFileKey {
    /**
    ...
    public static Builder builder(ObservabilityPipelineConfigProcessorGroupProcessorEnrichmentTableFileKey defaults) {
    ...
    public static final class Builder {
        ...
        public ObservabilityPipelineConfigProcessorGroupProcessorEnrichmentTableFileKey build() {
            final var _resultValue = new ObservabilityPipelineConfigProcessorGroupProcessorEnrichmentTableFileKey();
