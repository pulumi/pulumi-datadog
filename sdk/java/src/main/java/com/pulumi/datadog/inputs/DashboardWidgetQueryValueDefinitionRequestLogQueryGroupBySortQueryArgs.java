...
public final class DashboardWidgetQueryValueDefinitionRequestLogQueryGroupBySortQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetQueryValueDefinitionRequestLogQueryGroupBySortQueryArgs(DashboardWidgetQueryValueDefinitionRequestLogQueryGroupBySortQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetQueryValueDefinitionRequestLogQueryGroupBySortQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetQueryValueDefinitionRequestLogQueryGroupBySortQueryArgs defaults) {
            $ = new DashboardWidgetQueryValueDefinitionRequestLogQueryGroupBySortQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetQueryValueDefinitionRequestLogQueryGroupBySortQueryArgs build() {
            if ($.aggregation == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestLogQueryGroupBySortQueryArgs", "aggregation");
            }
            if ($.order == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestLogQueryGroupBySortQueryArgs", "order");
            }
            return $;
        }
    }
