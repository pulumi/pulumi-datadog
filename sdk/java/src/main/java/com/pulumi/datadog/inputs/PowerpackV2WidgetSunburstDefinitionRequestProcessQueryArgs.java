...
public final class PowerpackV2WidgetSunburstDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetSunburstDefinitionRequestProcessQueryArgs Empty = new PowerpackV2WidgetSunburstDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackV2WidgetSunburstDefinitionRequestProcessQueryArgs() {}

    private PowerpackV2WidgetSunburstDefinitionRequestProcessQueryArgs(PowerpackV2WidgetSunburstDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetSunburstDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetSunburstDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetSunburstDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetSunburstDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetSunburstDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
