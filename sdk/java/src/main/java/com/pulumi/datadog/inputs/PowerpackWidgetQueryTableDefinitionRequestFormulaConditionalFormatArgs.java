...
public final class PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs(PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
