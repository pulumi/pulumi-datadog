...
@CustomType
public final class ObservabilityPipelineConfigDestinationKafkaTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationKafkaTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationKafkaTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationKafkaTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationKafkaTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigDestinationKafkaTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationKafkaTls();
