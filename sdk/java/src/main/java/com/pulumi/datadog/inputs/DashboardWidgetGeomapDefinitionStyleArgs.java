...
public final class DashboardWidgetGeomapDefinitionStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGeomapDefinitionStyleArgs Empty = new DashboardWidgetGeomapDefinitionStyleArgs();
    ...
    private DashboardWidgetGeomapDefinitionStyleArgs() {}

    private DashboardWidgetGeomapDefinitionStyleArgs(DashboardWidgetGeomapDefinitionStyleArgs $) {
    ...
    public static Builder builder(DashboardWidgetGeomapDefinitionStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGeomapDefinitionStyleArgs();
        }

        public Builder(DashboardWidgetGeomapDefinitionStyleArgs defaults) {
            $ = new DashboardWidgetGeomapDefinitionStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGeomapDefinitionStyleArgs build() {
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGeomapDefinitionStyleArgs", "palette");
            }
            if ($.paletteFlip == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGeomapDefinitionStyleArgs", "paletteFlip");
            }
            return $;
        }
    }
