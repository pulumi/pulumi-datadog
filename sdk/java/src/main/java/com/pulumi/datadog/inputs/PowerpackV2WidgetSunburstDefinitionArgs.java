...
import com.pulumi.datadog.inputs.PowerpackV2WidgetSunburstDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetSunburstDefinitionLegendInlineArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetSunburstDefinitionLegendTableArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetSunburstDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetSunburstDefinitionTimeArgs;
...
public final class PowerpackV2WidgetSunburstDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetSunburstDefinitionArgs Empty = new PowerpackV2WidgetSunburstDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetSunburstDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetSunburstDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<PowerpackV2WidgetSunburstDefinitionLegendInlineArgs> legendInline;

    /**
     * @return Used to configure the inline legend. Cannot be used in conjunction with legend*table.
     * 
     */
    public Optional<Output<PowerpackV2WidgetSunburstDefinitionLegendInlineArgs>> legendInline() {
    ...
    private @Nullable Output<PowerpackV2WidgetSunburstDefinitionLegendTableArgs> legendTable;

    /**
     * @return Used to configure the table legend. Cannot be used in conjunction with legend*inline.
     * 
     */
    public Optional<Output<PowerpackV2WidgetSunburstDefinitionLegendTableArgs>> legendTable() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetSunburstDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetSunburstDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetSunburstDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetSunburstDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetSunburstDefinitionArgs() {}

    private PowerpackV2WidgetSunburstDefinitionArgs(PowerpackV2WidgetSunburstDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetSunburstDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetSunburstDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetSunburstDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetSunburstDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetSunburstDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetSunburstDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetSunburstDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder legendInline(@Nullable Output<PowerpackV2WidgetSunburstDefinitionLegendInlineArgs> legendInline) {
         ...
         * 
         */
        public Builder legendInline(PowerpackV2WidgetSunburstDefinitionLegendInlineArgs legendInline) {
         ...
         * 
         */
        public Builder legendTable(@Nullable Output<PowerpackV2WidgetSunburstDefinitionLegendTableArgs> legendTable) {
         ...
         * 
         */
        public Builder legendTable(PowerpackV2WidgetSunburstDefinitionLegendTableArgs legendTable) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetSunburstDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetSunburstDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetSunburstDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetSunburstDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetSunburstDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetSunburstDefinitionArgs build() {
            return $;
        }
    }
