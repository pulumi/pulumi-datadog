...
@CustomType
public final class PowerpackWidgetSunburstDefinitionCustomLink {
    /**
    ...
    private PowerpackWidgetSunburstDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetSunburstDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(PowerpackWidgetSunburstDefinitionCustomLink defaults) {
        ...
        public PowerpackWidgetSunburstDefinitionCustomLink build() {
            final var _resultValue = new PowerpackWidgetSunburstDefinitionCustomLink();
