...
@CustomType
public final class DashboardWidgetToplistDefinitionRequestRumQueryMultiCompute {
    /**
    ...
    private DashboardWidgetToplistDefinitionRequestRumQueryMultiCompute() {}
    /**
     * @return The aggregation method.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetToplistDefinitionRequestRumQueryMultiCompute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer interval;
        public Builder() {}
        public Builder(DashboardWidgetToplistDefinitionRequestRumQueryMultiCompute defaults) {
        ...
        public Builder aggregation(String aggregation) {
            if (aggregation == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestRumQueryMultiCompute", "aggregation");
            }
