...
public final class ObservabilityPipelineConfigSourceSplunkTcpTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceSplunkTcpTlsArgs Empty = new ObservabilityPipelineConfigSourceSplunkTcpTlsArgs();
    ...
    private ObservabilityPipelineConfigSourceSplunkTcpTlsArgs() {}

    private ObservabilityPipelineConfigSourceSplunkTcpTlsArgs(ObservabilityPipelineConfigSourceSplunkTcpTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceSplunkTcpTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceSplunkTcpTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceSplunkTcpTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceSplunkTcpTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceSplunkTcpTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceSplunkTcpTlsArgs", "crtFile");
            }
            return $;
        }
    }
