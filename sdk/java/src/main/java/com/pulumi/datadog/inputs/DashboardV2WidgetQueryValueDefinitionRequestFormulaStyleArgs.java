...
public final class DashboardV2WidgetQueryValueDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetQueryValueDefinitionRequestFormulaStyleArgs Empty = new DashboardV2WidgetQueryValueDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardV2WidgetQueryValueDefinitionRequestFormulaStyleArgs() {}

    private DashboardV2WidgetQueryValueDefinitionRequestFormulaStyleArgs(DashboardV2WidgetQueryValueDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetQueryValueDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetQueryValueDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetQueryValueDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetQueryValueDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetQueryValueDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
