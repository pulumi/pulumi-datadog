...
public final class DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs Empty = new DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs() {}

    private DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs(DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
