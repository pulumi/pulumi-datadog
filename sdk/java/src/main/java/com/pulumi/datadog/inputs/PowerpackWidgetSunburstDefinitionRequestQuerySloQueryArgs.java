...
public final class PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs Empty = new PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs(PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
