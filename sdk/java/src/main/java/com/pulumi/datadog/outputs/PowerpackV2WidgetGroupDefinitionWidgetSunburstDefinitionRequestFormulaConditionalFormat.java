...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormat {
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormat() {}
    /**
     * @return The comparator to use. Valid values are `=`, `&gt;`, `&gt;=`, `&lt;`, `&lt;=`.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormat defaults) {
    ...
    public static final class Builder {
        ...
        private Double value;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormat defaults) {
        ...
        public Builder comparator(String comparator) {
            if (comparator == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormat", "comparator");
            }
        ...
        public Builder palette(String palette) {
            if (palette == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormat", "palette");
            }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormat", "value");
            }
            this.value = value;
            return this;
        }
        public PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormat build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormat();
