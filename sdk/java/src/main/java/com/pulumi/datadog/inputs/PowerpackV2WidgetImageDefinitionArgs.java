...
import com.pulumi.datadog.inputs.PowerpackV2WidgetImageDefinitionTimeArgs;
...
public final class PowerpackV2WidgetImageDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetImageDefinitionArgs Empty = new PowerpackV2WidgetImageDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetImageDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetImageDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetImageDefinitionArgs() {}

    private PowerpackV2WidgetImageDefinitionArgs(PowerpackV2WidgetImageDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetImageDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetImageDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetImageDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetImageDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetImageDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetImageDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetImageDefinitionArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetImageDefinitionArgs", "url");
            }
            return $;
        }
    }
