...
public final class ObservabilityPipelineConfigDestinationsSocketTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationsSocketTlsArgs Empty = new ObservabilityPipelineConfigDestinationsSocketTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationsSocketTlsArgs() {}

    private ObservabilityPipelineConfigDestinationsSocketTlsArgs(ObservabilityPipelineConfigDestinationsSocketTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationsSocketTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationsSocketTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationsSocketTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationsSocketTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationsSocketTlsArgs build() {
            return $;
        }
    }
