...
import com.pulumi.datadog.outputs.DashboardV2WidgetFunnelDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetFunnelDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetFunnelDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetFunnelDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetFunnelDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public Optional<DashboardV2WidgetFunnelDefinitionRequest> request() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetFunnelDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetFunnelDefinition defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder request(@Nullable DashboardV2WidgetFunnelDefinitionRequest request) {

            this.request = request;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetFunnelDefinitionTime time) {
