...
import com.pulumi.datadog.outputs.PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupBy;
import com.pulumi.datadog.outputs.PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuerySort;
...
@CustomType
public final class PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuery {
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupBy> groupBies;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuerySort sort;
    /**
    ...
    private PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuery() {}
    /**
     * @return Specifies the field for logs pattern clustering. Can only be used with `logsPatternStream`.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupBy> groupBies() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuerySort> sort() {
    ...
    public static Builder builder(PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storage;
        public Builder() {}
        public Builder(PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuery", "dataSource");
            }
        ...
        @CustomType.Setter
        public Builder groupBies(@Nullable List<PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupBy> groupBies) {

            this.groupBies = groupBies;
            return this;
        }
        public Builder groupBies(PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupBy... groupBies) {
        ...
        @CustomType.Setter
        public Builder sort(@Nullable PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuerySort sort) {
        ...
        public PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuery build() {
            final var _resultValue = new PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuery();
