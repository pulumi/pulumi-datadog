...
@CustomType
public final class DashboardWidgetHeatmapDefinitionRequestFormulaStyle {
    /**
    ...
    private DashboardWidgetHeatmapDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at [https://docs.datadoghq.com/dashboards/guide/widget_colors](https://docs.datadoghq.com/dashboards/guide/widget_colors).
     * 
     */
    ...
    public static Builder builder(DashboardWidgetHeatmapDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(DashboardWidgetHeatmapDefinitionRequestFormulaStyle defaults) {
        ...
        public DashboardWidgetHeatmapDefinitionRequestFormulaStyle build() {
            final var _resultValue = new DashboardWidgetHeatmapDefinitionRequestFormulaStyle();
