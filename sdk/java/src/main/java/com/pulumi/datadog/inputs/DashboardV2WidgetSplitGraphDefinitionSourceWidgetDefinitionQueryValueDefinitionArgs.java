...
import com.pulumi.datadog.inputs.DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeseriesBackgroundArgs;
...
public final class DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs Empty = new DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeArgs>> time() {
    ...
    private @Nullable Output<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeseriesBackgroundArgs> timeseriesBackground;

    /**
     * @return Set a timeseries on the widget background.
     * 
     */
    public Optional<Output<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeseriesBackgroundArgs>> timeseriesBackground() {
    ...
    private DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs() {}

    private DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs();
        }

        public Builder(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs defaults) {
            $ = new DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder timeseriesBackground(@Nullable Output<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeseriesBackgroundArgs> timeseriesBackground) {
         ...
         * 
         */
        public Builder timeseriesBackground(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionTimeseriesBackgroundArgs timeseriesBackground) {
        ...
        public DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionQueryValueDefinitionArgs build() {
            return $;
        }
    }
