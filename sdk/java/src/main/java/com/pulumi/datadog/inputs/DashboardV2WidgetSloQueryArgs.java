...
public final class DashboardV2WidgetSloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetSloQueryArgs Empty = new DashboardV2WidgetSloQueryArgs();
    ...
    private DashboardV2WidgetSloQueryArgs() {}

    private DashboardV2WidgetSloQueryArgs(DashboardV2WidgetSloQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetSloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetSloQueryArgs();
        }

        public Builder(DashboardV2WidgetSloQueryArgs defaults) {
            $ = new DashboardV2WidgetSloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetSloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetSloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetSloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetSloQueryArgs", "sloId");
            }
            return $;
        }
    }
