...
@CustomType
public final class PowerpackV2WidgetQueryTableDefinitionRequest {
    /**
     ...
     */
    @Deprecated /* Use queries and formulas instead. */
    public Optional<PowerpackV2WidgetQueryTableDefinitionRequestApmStatsQuery> apmStatsQuery() {
     ...
     * 
     */
    public List<PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormat> conditionalFormats() {
     ...
     * 
     */
    public List<PowerpackV2WidgetQueryTableDefinitionRequestFormula> formulas() {
     ...
     */
    @Deprecated /* Use queries and formulas instead. */
    public Optional<PowerpackV2WidgetQueryTableDefinitionRequestProcessQuery> processQuery() {
     ...
     * 
     */
    public List<PowerpackV2WidgetQueryTableDefinitionRequestQuery> queries() {
     ...
     * 
     */
    public List<PowerpackV2WidgetQueryTableDefinitionRequestTextFormat> textFormats() {
    ...
    public static Builder builder(PowerpackV2WidgetQueryTableDefinitionRequest defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder apmStatsQuery(@Nullable PowerpackV2WidgetQueryTableDefinitionRequestApmStatsQuery apmStatsQuery) {
        ...
        @CustomType.Setter
        public Builder conditionalFormats(@Nullable List<PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormat> conditionalFormats) {

            this.conditionalFormats = conditionalFormats;
            return this;
        }
        public Builder conditionalFormats(PowerpackV2WidgetQueryTableDefinitionRequestConditionalFormat... conditionalFormats) {
            return conditionalFormats(List.of(conditionalFormats));
        }
        @CustomType.Setter
        public Builder formulas(@Nullable List<PowerpackV2WidgetQueryTableDefinitionRequestFormula> formulas) {

            this.formulas = formulas;
            return this;
        }
        public Builder formulas(PowerpackV2WidgetQueryTableDefinitionRequestFormula... formulas) {
        ...
        @CustomType.Setter
        public Builder processQuery(@Nullable PowerpackV2WidgetQueryTableDefinitionRequestProcessQuery processQuery) {
        ...
        @CustomType.Setter
        public Builder queries(@Nullable List<PowerpackV2WidgetQueryTableDefinitionRequestQuery> queries) {

            this.queries = queries;
            return this;
        }
        public Builder queries(PowerpackV2WidgetQueryTableDefinitionRequestQuery... queries) {
        ...
        @CustomType.Setter
        public Builder textFormats(@Nullable List<PowerpackV2WidgetQueryTableDefinitionRequestTextFormat> textFormats) {

            this.textFormats = textFormats;
            return this;
        }
        public Builder textFormats(PowerpackV2WidgetQueryTableDefinitionRequestTextFormat... textFormats) {
            return textFormats(List.of(textFormats));
        }
        public PowerpackV2WidgetQueryTableDefinitionRequest build() {
            final var _resultValue = new PowerpackV2WidgetQueryTableDefinitionRequest();
