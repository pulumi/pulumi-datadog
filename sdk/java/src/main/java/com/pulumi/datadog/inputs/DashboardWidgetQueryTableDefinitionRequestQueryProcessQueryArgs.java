...
public final class DashboardWidgetQueryTableDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetQueryTableDefinitionRequestQueryProcessQueryArgs Empty = new DashboardWidgetQueryTableDefinitionRequestQueryProcessQueryArgs();
    ...
    private DashboardWidgetQueryTableDefinitionRequestQueryProcessQueryArgs() {}
    ...
    public static Builder builder(DashboardWidgetQueryTableDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetQueryTableDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(DashboardWidgetQueryTableDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new DashboardWidgetQueryTableDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetQueryTableDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
