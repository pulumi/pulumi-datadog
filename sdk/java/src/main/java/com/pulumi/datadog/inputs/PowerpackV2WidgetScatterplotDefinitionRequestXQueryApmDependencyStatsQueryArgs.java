...
public final class PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs(PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
