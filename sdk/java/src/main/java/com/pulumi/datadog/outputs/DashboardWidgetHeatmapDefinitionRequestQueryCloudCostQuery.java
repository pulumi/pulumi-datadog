...
@CustomType
public final class DashboardWidgetHeatmapDefinitionRequestQueryCloudCostQuery {
    /**
    ...
    private DashboardWidgetHeatmapDefinitionRequestQueryCloudCostQuery() {}
    /**
     * @return The aggregation methods available for cloud cost queries. Valid values are `avg`, `last`, `max`, `min`, `sum`, `percentile`.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetHeatmapDefinitionRequestQueryCloudCostQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(DashboardWidgetHeatmapDefinitionRequestQueryCloudCostQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionRequestQueryCloudCostQuery", "dataSource");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionRequestQueryCloudCostQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionRequestQueryCloudCostQuery", "query");
            }
            this.query = query;
            return this;
        }
        public DashboardWidgetHeatmapDefinitionRequestQueryCloudCostQuery build() {
            final var _resultValue = new DashboardWidgetHeatmapDefinitionRequestQueryCloudCostQuery();
