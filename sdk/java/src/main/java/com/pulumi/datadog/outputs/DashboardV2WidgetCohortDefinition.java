...
import com.pulumi.datadog.outputs.DashboardV2WidgetCohortDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetCohortDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetCohortDefinition {
    /**
     ...
     * 
     */
    private List<DashboardV2WidgetCohortDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetCohortDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetCohortDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<DashboardV2WidgetCohortDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetCohortDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetCohortDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetCohortDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder requests(List<DashboardV2WidgetCohortDefinitionRequest> requests) {
            if (requests == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetCohortDefinition", "requests");
            }
            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetCohortDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetCohortDefinitionTime time) {
        ...
        public DashboardV2WidgetCohortDefinition build() {
            final var _resultValue = new DashboardV2WidgetCohortDefinition();
