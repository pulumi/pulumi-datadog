...
public final class PowerpackV2WidgetUserJourneyQueryGroupBySortArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetUserJourneyQueryGroupBySortArgs Empty = new PowerpackV2WidgetUserJourneyQueryGroupBySortArgs();
    ...
    private PowerpackV2WidgetUserJourneyQueryGroupBySortArgs() {}

    private PowerpackV2WidgetUserJourneyQueryGroupBySortArgs(PowerpackV2WidgetUserJourneyQueryGroupBySortArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetUserJourneyQueryGroupBySortArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetUserJourneyQueryGroupBySortArgs();
        }

        public Builder(PowerpackV2WidgetUserJourneyQueryGroupBySortArgs defaults) {
            $ = new PowerpackV2WidgetUserJourneyQueryGroupBySortArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetUserJourneyQueryGroupBySortArgs build() {
            if ($.aggregation == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetUserJourneyQueryGroupBySortArgs", "aggregation");
            }
            return $;
        }
    }
