...
public final class PowerpackWidgetScatterplotDefinitionRequestYProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetScatterplotDefinitionRequestYProcessQueryArgs Empty = new PowerpackWidgetScatterplotDefinitionRequestYProcessQueryArgs();
    ...
    private PowerpackWidgetScatterplotDefinitionRequestYProcessQueryArgs() {}

    private PowerpackWidgetScatterplotDefinitionRequestYProcessQueryArgs(PowerpackWidgetScatterplotDefinitionRequestYProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetScatterplotDefinitionRequestYProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetScatterplotDefinitionRequestYProcessQueryArgs();
        }

        public Builder(PowerpackWidgetScatterplotDefinitionRequestYProcessQueryArgs defaults) {
            $ = new PowerpackWidgetScatterplotDefinitionRequestYProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetScatterplotDefinitionRequestYProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetScatterplotDefinitionRequestYProcessQueryArgs", "metric");
            }
            return $;
        }
    }
