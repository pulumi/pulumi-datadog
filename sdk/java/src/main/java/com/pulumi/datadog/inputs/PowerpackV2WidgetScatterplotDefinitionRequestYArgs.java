...
public final class PowerpackV2WidgetScatterplotDefinitionRequestYArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestYArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestYArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetScatterplotDefinitionRequestYFormulaArgs>> formulas;

    /**
     * @return A list of formulas to use in the widget.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetScatterplotDefinitionRequestYFormulaArgs>>> formulas() {
    ...
    private @Nullable Output<PowerpackV2WidgetScatterplotDefinitionRequestYProcessQueryArgs> processQuery;
     ...
     */
    @Deprecated /* Use queries and formulas instead. */
    public Optional<Output<PowerpackV2WidgetScatterplotDefinitionRequestYProcessQueryArgs>> processQuery() {
     ...
     */
    @Import(name="queries")
    private @Nullable Output<List<PowerpackV2WidgetScatterplotDefinitionRequestYQueryArgs>> queries;

    /**
     * @return A list of queries to use in the widget.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetScatterplotDefinitionRequestYQueryArgs>>> queries() {
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestYArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestYArgs(PowerpackV2WidgetScatterplotDefinitionRequestYArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestYArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestYArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder formulas(@Nullable Output<List<PowerpackV2WidgetScatterplotDefinitionRequestYFormulaArgs>> formulas) {
            $.formulas = formulas;
            return this;
        }
         ...
         * 
         */
        public Builder formulas(List<PowerpackV2WidgetScatterplotDefinitionRequestYFormulaArgs> formulas) {
         ...
         * 
         */
        public Builder formulas(PowerpackV2WidgetScatterplotDefinitionRequestYFormulaArgs... formulas) {
         ...
         */
        @Deprecated /* Use queries and formulas instead. */
        public Builder processQuery(@Nullable Output<PowerpackV2WidgetScatterplotDefinitionRequestYProcessQueryArgs> processQuery) {
         ...
         */
        @Deprecated /* Use queries and formulas instead. */
        public Builder processQuery(PowerpackV2WidgetScatterplotDefinitionRequestYProcessQueryArgs processQuery) {
         ...
         * 
         */
        public Builder queries(@Nullable Output<List<PowerpackV2WidgetScatterplotDefinitionRequestYQueryArgs>> queries) {
            $.queries = queries;
            return this;
        }
         ...
         * 
         */
        public Builder queries(List<PowerpackV2WidgetScatterplotDefinitionRequestYQueryArgs> queries) {
         ...
         * 
         */
        public Builder queries(PowerpackV2WidgetScatterplotDefinitionRequestYQueryArgs... queries) {
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestYArgs build() {
            return $;
        }
    }
