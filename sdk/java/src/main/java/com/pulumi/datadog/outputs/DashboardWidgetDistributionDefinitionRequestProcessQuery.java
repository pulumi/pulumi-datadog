...
@CustomType
public final class DashboardWidgetDistributionDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardWidgetDistributionDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetDistributionDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetDistributionDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetDistributionDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
