...
import com.pulumi.datadog.outputs.PowerpackV2WidgetCheckStatusDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetCheckStatusDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetCheckStatusDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetCheckStatusDefinition() {}
    /**
     * @return Name of the check to use in the widget.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetCheckStatusDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetCheckStatusDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetCheckStatusDefinition defaults) {
        ...
        public Builder check(String check) {
            if (check == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetCheckStatusDefinition", "check");
            }
            this.check = check;
            return this;
        }
        ...
        public Builder grouping(String grouping) {
            if (grouping == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetCheckStatusDefinition", "grouping");
            }
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetCheckStatusDefinitionTime time) {
        ...
        public PowerpackV2WidgetCheckStatusDefinition build() {
            final var _resultValue = new PowerpackV2WidgetCheckStatusDefinition();
