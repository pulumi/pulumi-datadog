...
public final class DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs Empty = new DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs();
    ...
    private DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs() {}

    private DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs(DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs();
        }

        public Builder(DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs defaults) {
            $ = new DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs", "name");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestQueryApmResourceStatsQueryArgs", "stat");
            }
            return $;
        }
    }
