...
import com.pulumi.datadog.inputs.DashboardV2WidgetCohortDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetCohortDefinitionTimeArgs;
...
public final class DashboardV2WidgetCohortDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetCohortDefinitionArgs Empty = new DashboardV2WidgetCohortDefinitionArgs();
    ...
    private Output<List<DashboardV2WidgetCohortDefinitionRequestArgs>> requests;

    /**
     * @return Cohort retention-grid requests.
     * 
     */
    public Output<List<DashboardV2WidgetCohortDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetCohortDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetCohortDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetCohortDefinitionArgs() {}

    private DashboardV2WidgetCohortDefinitionArgs(DashboardV2WidgetCohortDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetCohortDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetCohortDefinitionArgs();
        }

        public Builder(DashboardV2WidgetCohortDefinitionArgs defaults) {
            $ = new DashboardV2WidgetCohortDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<DashboardV2WidgetCohortDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetCohortDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetCohortDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetCohortDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetCohortDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetCohortDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetCohortDefinitionArgs", "requests");
            }
            return $;
        }
    }
