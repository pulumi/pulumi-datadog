...
public final class DashboardWidgetGeomapDefinitionRequestQueryMetricQuery {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGeomapDefinitionRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGeomapDefinitionRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
