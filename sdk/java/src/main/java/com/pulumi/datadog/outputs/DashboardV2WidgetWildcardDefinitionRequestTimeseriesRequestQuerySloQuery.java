...
@CustomType
public final class DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery {
    /**
    ...
    private DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery build() {
            final var _resultValue = new DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery();
