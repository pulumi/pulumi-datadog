...
@CustomType
public final class PowerpackWidgetSunburstDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackWidgetSunburstDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetSunburstDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackWidgetSunburstDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackWidgetSunburstDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackWidgetSunburstDefinitionRequestProcessQuery();
