...
public final class PowerpackWidgetQueryValueDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryValueDefinitionRequestFormulaStyleArgs Empty = new PowerpackWidgetQueryValueDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackWidgetQueryValueDefinitionRequestFormulaStyleArgs() {}

    private PowerpackWidgetQueryValueDefinitionRequestFormulaStyleArgs(PowerpackWidgetQueryValueDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryValueDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryValueDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackWidgetQueryValueDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackWidgetQueryValueDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetQueryValueDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
