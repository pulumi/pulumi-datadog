...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs build() {
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs", "env");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs", "service");
            }
            if ($.spanName == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs", "spanName");
            }
            return $;
        }
    }
