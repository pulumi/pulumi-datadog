...
import com.pulumi.datadog.inputs.PowerpackV2WidgetToplistDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetToplistDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetToplistDefinitionStyleArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetToplistDefinitionTimeArgs;
...
public final class PowerpackV2WidgetToplistDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetToplistDefinitionArgs Empty = new PowerpackV2WidgetToplistDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetToplistDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetToplistDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetToplistDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetToplistDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="style")
    private @Nullable Output<PowerpackV2WidgetToplistDefinitionStyleArgs> style;

    /**
     * @return The style of the widget
     * 
     */
    public Optional<Output<PowerpackV2WidgetToplistDefinitionStyleArgs>> style() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetToplistDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetToplistDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetToplistDefinitionArgs() {}

    private PowerpackV2WidgetToplistDefinitionArgs(PowerpackV2WidgetToplistDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetToplistDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetToplistDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetToplistDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetToplistDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetToplistDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetToplistDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetToplistDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetToplistDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetToplistDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetToplistDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder style(@Nullable Output<PowerpackV2WidgetToplistDefinitionStyleArgs> style) {
            $.style = style;
            return this;
        }
         ...
         * 
         */
        public Builder style(PowerpackV2WidgetToplistDefinitionStyleArgs style) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetToplistDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetToplistDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetToplistDefinitionArgs build() {
            return $;
        }
    }
