...
public final class ObservabilityPipelineConfigDestinationHttpClientTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationHttpClientTlsArgs Empty = new ObservabilityPipelineConfigDestinationHttpClientTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationHttpClientTlsArgs() {}

    private ObservabilityPipelineConfigDestinationHttpClientTlsArgs(ObservabilityPipelineConfigDestinationHttpClientTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationHttpClientTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationHttpClientTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationHttpClientTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationHttpClientTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationHttpClientTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationHttpClientTlsArgs", "crtFile");
            }
            return $;
        }
    }
