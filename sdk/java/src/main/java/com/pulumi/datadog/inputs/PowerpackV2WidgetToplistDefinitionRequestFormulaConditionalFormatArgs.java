...
public final class PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs(PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
