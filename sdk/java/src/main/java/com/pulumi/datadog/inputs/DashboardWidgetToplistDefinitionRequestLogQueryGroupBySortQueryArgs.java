...
public final class DashboardWidgetToplistDefinitionRequestLogQueryGroupBySortQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetToplistDefinitionRequestLogQueryGroupBySortQueryArgs(DashboardWidgetToplistDefinitionRequestLogQueryGroupBySortQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetToplistDefinitionRequestLogQueryGroupBySortQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetToplistDefinitionRequestLogQueryGroupBySortQueryArgs defaults) {
            $ = new DashboardWidgetToplistDefinitionRequestLogQueryGroupBySortQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetToplistDefinitionRequestLogQueryGroupBySortQueryArgs build() {
            if ($.aggregation == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestLogQueryGroupBySortQueryArgs", "aggregation");
            }
            if ($.order == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestLogQueryGroupBySortQueryArgs", "order");
            }
            return $;
        }
    }
