...
@CustomType
public final class DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormat {
    /**
    ...
    private DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormat() {}
    /**
     * @return The comparator to use. Valid values are `=`, `&gt;`, `&gt;=`, `&lt;`, `&lt;=`.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormat defaults) {
    ...
    public static final class Builder {
        ...
        private Double value;
        public Builder() {}
        public Builder(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormat defaults) {
        ...
        public Builder comparator(String comparator) {
            if (comparator == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormat", "comparator");
            }
        ...
        public Builder palette(String palette) {
            if (palette == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormat", "palette");
            }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormat", "value");
            }
            this.value = value;
            return this;
        }
        public DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormat build() {
            final var _resultValue = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestFormulaConditionalFormat();
