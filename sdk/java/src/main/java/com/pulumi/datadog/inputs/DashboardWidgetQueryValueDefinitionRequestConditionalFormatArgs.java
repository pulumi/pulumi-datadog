...
public final class DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs Empty = new DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs();
    ...
    private DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs() {}

    private DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs(DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs();
        }

        public Builder(DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs defaults) {
            $ = new DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
