...
public final class DashboardWidgetGroupDefinitionWidgetSunburstDefinitionLegendInline {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetSunburstDefinitionLegendInline defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetSunburstDefinitionLegendInline defaults) {
        ...
        public DashboardWidgetGroupDefinitionWidgetSunburstDefinitionLegendInline build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetSunburstDefinitionLegendInline();
