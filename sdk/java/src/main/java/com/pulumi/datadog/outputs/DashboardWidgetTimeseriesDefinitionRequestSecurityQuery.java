...
@CustomType
public final class DashboardWidgetTimeseriesDefinitionRequestSecurityQuery {
    /**
     ...
     * 
     */
    public Optional<DashboardWidgetTimeseriesDefinitionRequestSecurityQueryComputeQuery> computeQuery() {
     ...
     * 
     */
    public List<DashboardWidgetTimeseriesDefinitionRequestSecurityQueryMultiCompute> multiComputes() {
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestSecurityQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchQuery;
        public Builder() {}
        public Builder(DashboardWidgetTimeseriesDefinitionRequestSecurityQuery defaults) {
        ...
        @CustomType.Setter
        public Builder computeQuery(@Nullable DashboardWidgetTimeseriesDefinitionRequestSecurityQueryComputeQuery computeQuery) {
        ...
        public Builder index(String index) {
            if (index == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestSecurityQuery", "index");
            }
            this.index = index;
            return this;
        }
        @CustomType.Setter
        public Builder multiComputes(@Nullable List<DashboardWidgetTimeseriesDefinitionRequestSecurityQueryMultiCompute> multiComputes) {

            this.multiComputes = multiComputes;
            return this;
        }
        public Builder multiComputes(DashboardWidgetTimeseriesDefinitionRequestSecurityQueryMultiCompute... multiComputes) {
        ...
        public DashboardWidgetTimeseriesDefinitionRequestSecurityQuery build() {
            final var _resultValue = new DashboardWidgetTimeseriesDefinitionRequestSecurityQuery();
