...
public final class PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs Empty = new PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs() {}

    private PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs(PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestFillFormulaStyleArgs build() {
            return $;
        }
    }
