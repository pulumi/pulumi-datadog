...
public final class DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs Empty = new DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs() {}

    private DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs(DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestHistogramQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
