...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param displayFormat The number of columns to display. Valid values are `oneColumn`, `twoColumn`, `threeColumn`.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs build() {
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs", "env");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs", "service");
            }
            if ($.spanName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetTraceServiceDefinitionArgs", "spanName");
            }
            return $;
        }
    }
