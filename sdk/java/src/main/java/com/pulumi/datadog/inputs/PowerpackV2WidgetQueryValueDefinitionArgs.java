...
import com.pulumi.datadog.inputs.PowerpackV2WidgetQueryValueDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetQueryValueDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetQueryValueDefinitionTimeArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetQueryValueDefinitionTimeseriesBackgroundArgs;
...
public final class PowerpackV2WidgetQueryValueDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryValueDefinitionArgs Empty = new PowerpackV2WidgetQueryValueDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetQueryValueDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetQueryValueDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetQueryValueDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetQueryValueDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetQueryValueDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetQueryValueDefinitionTimeArgs>> time() {
    ...
    private @Nullable Output<PowerpackV2WidgetQueryValueDefinitionTimeseriesBackgroundArgs> timeseriesBackground;

    /**
     * @return Set a timeseries on the widget background.
     * 
     */
    public Optional<Output<PowerpackV2WidgetQueryValueDefinitionTimeseriesBackgroundArgs>> timeseriesBackground() {
    ...
    private PowerpackV2WidgetQueryValueDefinitionArgs() {}

    private PowerpackV2WidgetQueryValueDefinitionArgs(PowerpackV2WidgetQueryValueDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryValueDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryValueDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetQueryValueDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetQueryValueDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetQueryValueDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetQueryValueDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetQueryValueDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetQueryValueDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetQueryValueDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetQueryValueDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetQueryValueDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetQueryValueDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder timeseriesBackground(@Nullable Output<PowerpackV2WidgetQueryValueDefinitionTimeseriesBackgroundArgs> timeseriesBackground) {
         ...
         * 
         */
        public Builder timeseriesBackground(PowerpackV2WidgetQueryValueDefinitionTimeseriesBackgroundArgs timeseriesBackground) {
        ...
        public PowerpackV2WidgetQueryValueDefinitionArgs build() {
            return $;
        }
    }
