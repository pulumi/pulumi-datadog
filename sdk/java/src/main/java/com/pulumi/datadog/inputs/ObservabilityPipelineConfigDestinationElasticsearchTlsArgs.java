...
public final class ObservabilityPipelineConfigDestinationElasticsearchTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationElasticsearchTlsArgs Empty = new ObservabilityPipelineConfigDestinationElasticsearchTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationElasticsearchTlsArgs() {}

    private ObservabilityPipelineConfigDestinationElasticsearchTlsArgs(ObservabilityPipelineConfigDestinationElasticsearchTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationElasticsearchTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationElasticsearchTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationElasticsearchTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationElasticsearchTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationElasticsearchTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationElasticsearchTlsArgs", "crtFile");
            }
            return $;
        }
    }
