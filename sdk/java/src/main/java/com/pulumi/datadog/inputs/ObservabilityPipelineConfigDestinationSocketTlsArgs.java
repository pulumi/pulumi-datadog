...
public final class ObservabilityPipelineConfigDestinationSocketTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationSocketTlsArgs Empty = new ObservabilityPipelineConfigDestinationSocketTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationSocketTlsArgs() {}

    private ObservabilityPipelineConfigDestinationSocketTlsArgs(ObservabilityPipelineConfigDestinationSocketTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationSocketTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationSocketTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationSocketTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationSocketTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationSocketTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationSocketTlsArgs", "crtFile");
            }
            return $;
        }
    }
