...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestFormulaStyle {
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestFormulaStyle defaults) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestFormulaStyle build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestFormulaStyle();
