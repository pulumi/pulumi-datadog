...
public final class DashboardV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs Empty = new DashboardV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
    ...
    private DashboardV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs() {}

    private DashboardV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(DashboardV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(DashboardV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new DashboardV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetGeomapDefinitionRequestFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
