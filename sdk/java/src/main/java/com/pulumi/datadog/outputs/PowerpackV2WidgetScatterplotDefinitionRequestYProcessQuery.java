...
@CustomType
public final class PowerpackV2WidgetScatterplotDefinitionRequestYProcessQuery {
    /**
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestYProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestYProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestYProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestYProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetScatterplotDefinitionRequestYProcessQuery();
