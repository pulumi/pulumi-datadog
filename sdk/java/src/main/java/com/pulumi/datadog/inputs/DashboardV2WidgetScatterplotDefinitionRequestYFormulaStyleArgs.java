...
public final class DashboardV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs Empty = new DashboardV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs();
    ...
    private DashboardV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs() {}

    private DashboardV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs(DashboardV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs build() {
            return $;
        }
    }
