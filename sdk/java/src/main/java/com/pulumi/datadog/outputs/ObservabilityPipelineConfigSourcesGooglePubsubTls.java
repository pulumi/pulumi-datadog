...
@CustomType
public final class ObservabilityPipelineConfigSourcesGooglePubsubTls {
    /**
    ...
    private ObservabilityPipelineConfigSourcesGooglePubsubTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesGooglePubsubTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesGooglePubsubTls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesGooglePubsubTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesGooglePubsubTls();
