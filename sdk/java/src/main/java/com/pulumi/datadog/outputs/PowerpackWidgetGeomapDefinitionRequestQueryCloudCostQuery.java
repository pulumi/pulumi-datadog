...
@CustomType
public final class PowerpackWidgetGeomapDefinitionRequestQueryCloudCostQuery {
    /**
    ...
    private PowerpackWidgetGeomapDefinitionRequestQueryCloudCostQuery() {}
    /**
     * @return The aggregation methods available for cloud cost queries. Valid values are `avg`, `last`, `max`, `min`, `sum`, `percentile`.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetGeomapDefinitionRequestQueryCloudCostQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(PowerpackWidgetGeomapDefinitionRequestQueryCloudCostQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryCloudCostQuery", "dataSource");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryCloudCostQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryCloudCostQuery", "query");
            }
            this.query = query;
            return this;
        }
        public PowerpackWidgetGeomapDefinitionRequestQueryCloudCostQuery build() {
            final var _resultValue = new PowerpackWidgetGeomapDefinitionRequestQueryCloudCostQuery();
