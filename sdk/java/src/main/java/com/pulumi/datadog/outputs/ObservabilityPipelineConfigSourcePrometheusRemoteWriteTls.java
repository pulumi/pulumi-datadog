...
@CustomType
public final class ObservabilityPipelineConfigSourcePrometheusRemoteWriteTls {
    /**
    ...
    private ObservabilityPipelineConfigSourcePrometheusRemoteWriteTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate connecting clients&#39; TLS certificates.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcePrometheusRemoteWriteTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean verifyCertificate;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcePrometheusRemoteWriteTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourcePrometheusRemoteWriteTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourcePrometheusRemoteWriteTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcePrometheusRemoteWriteTls();
