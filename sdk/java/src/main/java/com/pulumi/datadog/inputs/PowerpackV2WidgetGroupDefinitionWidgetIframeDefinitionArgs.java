...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionArgs", "url");
            }
            return $;
        }
    }
