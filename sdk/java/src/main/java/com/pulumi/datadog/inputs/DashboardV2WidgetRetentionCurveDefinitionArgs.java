...
import com.pulumi.datadog.inputs.DashboardV2WidgetRetentionCurveDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetRetentionCurveDefinitionTimeArgs;
...
public final class DashboardV2WidgetRetentionCurveDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetRetentionCurveDefinitionArgs Empty = new DashboardV2WidgetRetentionCurveDefinitionArgs();
    ...
    private Output<List<DashboardV2WidgetRetentionCurveDefinitionRequestArgs>> requests;

    /**
     * @return Retention curve requests.
     * 
     */
    public Output<List<DashboardV2WidgetRetentionCurveDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetRetentionCurveDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetRetentionCurveDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetRetentionCurveDefinitionArgs() {}

    private DashboardV2WidgetRetentionCurveDefinitionArgs(DashboardV2WidgetRetentionCurveDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetRetentionCurveDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetRetentionCurveDefinitionArgs();
        }

        public Builder(DashboardV2WidgetRetentionCurveDefinitionArgs defaults) {
            $ = new DashboardV2WidgetRetentionCurveDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<DashboardV2WidgetRetentionCurveDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetRetentionCurveDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetRetentionCurveDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetRetentionCurveDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetRetentionCurveDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetRetentionCurveDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetRetentionCurveDefinitionArgs", "requests");
            }
            return $;
        }
    }
