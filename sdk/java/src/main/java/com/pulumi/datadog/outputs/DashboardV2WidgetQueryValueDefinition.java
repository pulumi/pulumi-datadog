...
import com.pulumi.datadog.outputs.DashboardV2WidgetQueryValueDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardV2WidgetQueryValueDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetQueryValueDefinitionTime;
import com.pulumi.datadog.outputs.DashboardV2WidgetQueryValueDefinitionTimeseriesBackground;
...
@CustomType
public final class DashboardV2WidgetQueryValueDefinition {
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetQueryValueDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetQueryValueDefinitionRequest> requests;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetQueryValueDefinitionTime time;
    /**
     * @return Set a timeseries on the widget background.
     * 
     */
    private @Nullable DashboardV2WidgetQueryValueDefinitionTimeseriesBackground timeseriesBackground;
    /**
    ...
    private DashboardV2WidgetQueryValueDefinition() {}
    /**
     * @return A Boolean indicating whether to automatically scale the tile.
     * 
     */
     ...
     * 
     */
    public List<DashboardV2WidgetQueryValueDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<DashboardV2WidgetQueryValueDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetQueryValueDefinitionTime> time() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetQueryValueDefinitionTimeseriesBackground> timeseriesBackground() {
    ...
    public static Builder builder(DashboardV2WidgetQueryValueDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetQueryValueDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardV2WidgetQueryValueDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardV2WidgetQueryValueDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<DashboardV2WidgetQueryValueDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetQueryValueDefinitionRequest... requests) {
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetQueryValueDefinitionTime time) {

            this.time = time;
            return this;
        }
        @CustomType.Setter
        public Builder timeseriesBackground(@Nullable DashboardV2WidgetQueryValueDefinitionTimeseriesBackground timeseriesBackground) {
        ...
        public DashboardV2WidgetQueryValueDefinition build() {
            final var _resultValue = new DashboardV2WidgetQueryValueDefinition();
