...
public final class DashboardV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs Empty = new DashboardV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs() {}

    private DashboardV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs(DashboardV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
