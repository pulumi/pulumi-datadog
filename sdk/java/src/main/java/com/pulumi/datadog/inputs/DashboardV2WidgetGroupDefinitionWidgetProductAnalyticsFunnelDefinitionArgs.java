...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs();
    ...
    private Output<List<DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestArgs>> requests;

    /**
     * @return User journey funnel requests.
     * 
     */
    public Output<List<DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs", "requests");
            }
            return $;
        }
    }
