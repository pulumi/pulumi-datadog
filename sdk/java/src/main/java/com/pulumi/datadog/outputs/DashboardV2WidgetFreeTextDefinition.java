...
import com.pulumi.datadog.outputs.DashboardV2WidgetFreeTextDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetFreeTextDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetFreeTextDefinitionTime time;
    /**
     ...
     * 
     */
    public Optional<DashboardV2WidgetFreeTextDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetFreeTextDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetFreeTextDefinition defaults) {
        ...
        public Builder text(String text) {
            if (text == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetFreeTextDefinition", "text");
            }
            this.text = text;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetFreeTextDefinitionTime time) {
        ...
        public DashboardV2WidgetFreeTextDefinition build() {
            final var _resultValue = new DashboardV2WidgetFreeTextDefinition();
