...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetGeomapDefinitionCustomLink {
    /**
    ...
    private DashboardWidgetGroupDefinitionWidgetGeomapDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetGeomapDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetGeomapDefinitionCustomLink defaults) {
        ...
        public DashboardWidgetGroupDefinitionWidgetGeomapDefinitionCustomLink build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetGeomapDefinitionCustomLink();
