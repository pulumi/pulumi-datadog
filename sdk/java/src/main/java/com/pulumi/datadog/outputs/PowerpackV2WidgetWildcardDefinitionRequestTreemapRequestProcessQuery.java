...
@CustomType
public final class PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery {
    /**
    ...
    private PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetWildcardDefinitionRequestTreemapRequestProcessQuery();
