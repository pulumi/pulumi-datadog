...
public final class PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs Empty = new PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs();
    ...
    private PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs() {}

    private PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs(PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
