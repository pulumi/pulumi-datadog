...
public final class PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs(PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
