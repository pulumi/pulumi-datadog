...
public final class PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs Empty = new PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs() {}

    private PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs(PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
