...
import com.pulumi.datadog.inputs.PowerpackV2WidgetNoteDefinitionTimeArgs;
...
public final class PowerpackV2WidgetNoteDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetNoteDefinitionArgs Empty = new PowerpackV2WidgetNoteDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetNoteDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetNoteDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetNoteDefinitionArgs() {}

    private PowerpackV2WidgetNoteDefinitionArgs(PowerpackV2WidgetNoteDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetNoteDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetNoteDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetNoteDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetNoteDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetNoteDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetNoteDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetNoteDefinitionArgs build() {
            if ($.content == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetNoteDefinitionArgs", "content");
            }
            return $;
        }
    }
