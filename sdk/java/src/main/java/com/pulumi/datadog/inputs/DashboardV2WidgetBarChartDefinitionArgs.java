...
import com.pulumi.datadog.inputs.DashboardV2WidgetBarChartDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetBarChartDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetBarChartDefinitionStyleArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetBarChartDefinitionTimeArgs;
...
public final class DashboardV2WidgetBarChartDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetBarChartDefinitionArgs Empty = new DashboardV2WidgetBarChartDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetBarChartDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetBarChartDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="request")
    private @Nullable Output<DashboardV2WidgetBarChartDefinitionRequestArgs> request;

    /**
     * @return A nested block describing the request to use when displaying the widget.
     * 
     */
    public Optional<Output<DashboardV2WidgetBarChartDefinitionRequestArgs>> request() {
     ...
     */
    @Import(name="style")
    private @Nullable Output<DashboardV2WidgetBarChartDefinitionStyleArgs> style;

    /**
     * @return Style customization for the bar chart widget.
     * 
     */
    public Optional<Output<DashboardV2WidgetBarChartDefinitionStyleArgs>> style() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetBarChartDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetBarChartDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetBarChartDefinitionArgs() {}

    private DashboardV2WidgetBarChartDefinitionArgs(DashboardV2WidgetBarChartDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetBarChartDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetBarChartDefinitionArgs();
        }

        public Builder(DashboardV2WidgetBarChartDefinitionArgs defaults) {
            $ = new DashboardV2WidgetBarChartDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetBarChartDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetBarChartDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetBarChartDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder request(@Nullable Output<DashboardV2WidgetBarChartDefinitionRequestArgs> request) {
            $.request = request;
            return this;
        }
         ...
         * 
         */
        public Builder request(DashboardV2WidgetBarChartDefinitionRequestArgs request) {
         ...
         * 
         */
        public Builder style(@Nullable Output<DashboardV2WidgetBarChartDefinitionStyleArgs> style) {
            $.style = style;
            return this;
        }
         ...
         * 
         */
        public Builder style(DashboardV2WidgetBarChartDefinitionStyleArgs style) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetBarChartDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetBarChartDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetBarChartDefinitionArgs build() {
            return $;
        }
    }
