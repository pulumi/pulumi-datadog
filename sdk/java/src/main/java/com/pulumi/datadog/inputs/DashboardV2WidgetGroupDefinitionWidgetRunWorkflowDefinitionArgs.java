...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionInputArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="inputs")
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionInputArgs>> inputs;

    /**
     * @return Array of workflow inputs to map to dashboard template variables.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionInputArgs>>> inputs() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder inputs(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionInputArgs>> inputs) {
            $.inputs = inputs;
            return this;
        }
         ...
         * 
         */
        public Builder inputs(List<DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionInputArgs> inputs) {
         ...
         * 
         */
        public Builder inputs(DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionInputArgs... inputs) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs build() {
            if ($.workflowId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetRunWorkflowDefinitionArgs", "workflowId");
            }
            return $;
        }
    }
