...
import com.pulumi.datadog.inputs.DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionTimeArgs;
...
public final class DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionArgs Empty = new DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionArgs() {}

    private DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionArgs(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionArgs();
        }

        public Builder(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionArgs defaults) {
            $ = new DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetSplitGraphDefinitionSourceWidgetDefinitionChangeDefinitionArgs build() {
            return $;
        }
    }
