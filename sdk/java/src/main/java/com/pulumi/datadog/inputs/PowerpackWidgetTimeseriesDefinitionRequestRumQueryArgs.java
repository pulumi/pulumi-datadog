...
import com.pulumi.datadog.inputs.PowerpackWidgetTimeseriesDefinitionRequestRumQueryComputeQueryArgs;
import com.pulumi.datadog.inputs.PowerpackWidgetTimeseriesDefinitionRequestRumQueryGroupByArgs;
import com.pulumi.datadog.inputs.PowerpackWidgetTimeseriesDefinitionRequestRumQueryMultiComputeArgs;
...
public final class PowerpackWidgetTimeseriesDefinitionRequestRumQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PowerpackWidgetTimeseriesDefinitionRequestRumQueryArgs() {}

    private PowerpackWidgetTimeseriesDefinitionRequestRumQueryArgs(PowerpackWidgetTimeseriesDefinitionRequestRumQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetTimeseriesDefinitionRequestRumQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetTimeseriesDefinitionRequestRumQueryArgs();
        }

        public Builder(PowerpackWidgetTimeseriesDefinitionRequestRumQueryArgs defaults) {
            $ = new PowerpackWidgetTimeseriesDefinitionRequestRumQueryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder computeQuery(@Nullable Output<PowerpackWidgetTimeseriesDefinitionRequestRumQueryComputeQueryArgs> computeQuery) {
         ...
         * 
         */
        public Builder computeQuery(PowerpackWidgetTimeseriesDefinitionRequestRumQueryComputeQueryArgs computeQuery) {
         ...
         * 
         */
        public Builder groupBies(@Nullable Output<List<PowerpackWidgetTimeseriesDefinitionRequestRumQueryGroupByArgs>> groupBies) {
            $.groupBies = groupBies;
            return this;
        }
         ...
         * 
         */
        public Builder groupBies(List<PowerpackWidgetTimeseriesDefinitionRequestRumQueryGroupByArgs> groupBies) {
         ...
         * 
         */
        public Builder groupBies(PowerpackWidgetTimeseriesDefinitionRequestRumQueryGroupByArgs... groupBies) {
         ...
         * 
         */
        public Builder multiComputes(@Nullable Output<List<PowerpackWidgetTimeseriesDefinitionRequestRumQueryMultiComputeArgs>> multiComputes) {
         ...
         * 
         */
        public Builder multiComputes(List<PowerpackWidgetTimeseriesDefinitionRequestRumQueryMultiComputeArgs> multiComputes) {
         ...
         * 
         */
        public Builder multiComputes(PowerpackWidgetTimeseriesDefinitionRequestRumQueryMultiComputeArgs... multiComputes) {
        ...
        public PowerpackWidgetTimeseriesDefinitionRequestRumQueryArgs build() {
            if ($.index == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestRumQueryArgs", "index");
            }
            return $;
        }
    }
