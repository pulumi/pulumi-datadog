...
public final class DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs Empty = new DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs();
    ...
    private DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs() {}

    private DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs(DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
