...
public final class DashboardV2WidgetGeomapDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGeomapDefinitionRequestFormulaStyleArgs Empty = new DashboardV2WidgetGeomapDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardV2WidgetGeomapDefinitionRequestFormulaStyleArgs() {}

    private DashboardV2WidgetGeomapDefinitionRequestFormulaStyleArgs(DashboardV2WidgetGeomapDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGeomapDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGeomapDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetGeomapDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetGeomapDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetGeomapDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
