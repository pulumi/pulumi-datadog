...
public final class PowerpackV2WidgetSloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetSloQueryArgs Empty = new PowerpackV2WidgetSloQueryArgs();
    ...
    private PowerpackV2WidgetSloQueryArgs() {}

    private PowerpackV2WidgetSloQueryArgs(PowerpackV2WidgetSloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetSloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetSloQueryArgs();
        }

        public Builder(PowerpackV2WidgetSloQueryArgs defaults) {
            $ = new PowerpackV2WidgetSloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetSloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSloQueryArgs", "sloId");
            }
            return $;
        }
    }
