...
public final class ObservabilityPipelineConfigSourcesFluentBitTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcesFluentBitTlsArgs Empty = new ObservabilityPipelineConfigSourcesFluentBitTlsArgs();
    ...
    private ObservabilityPipelineConfigSourcesFluentBitTlsArgs() {}

    private ObservabilityPipelineConfigSourcesFluentBitTlsArgs(ObservabilityPipelineConfigSourcesFluentBitTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesFluentBitTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcesFluentBitTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcesFluentBitTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcesFluentBitTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcesFluentBitTlsArgs build() {
            return $;
        }
    }
