...
public final class RumRetentionFilterState extends com.pulumi.resources.ResourceArgs {

    public static final RumRetentionFilterState Empty = new RumRetentionFilterState();
    ...
    private @Nullable Output<Integer> sampleRate;

    /**
     * @return The sample rate for a RUM retention filter, between 0 and 100.
     * 
     */
    public Optional<Output<Integer>> sampleRate() {
        return Optional.ofNullable(this.sampleRate);
    }

    private RumRetentionFilterState() {}

    private RumRetentionFilterState(RumRetentionFilterState $) {
    ...
    public static Builder builder(RumRetentionFilterState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RumRetentionFilterState();
        }

        public Builder(RumRetentionFilterState defaults) {
            $ = new RumRetentionFilterState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sampleRate(@Nullable Output<Integer> sampleRate) {
        ...
        public RumRetentionFilterState build() {
            return $;
        }
    }
