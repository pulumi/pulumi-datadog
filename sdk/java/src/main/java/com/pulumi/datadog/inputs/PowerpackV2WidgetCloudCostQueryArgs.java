...
public final class PowerpackV2WidgetCloudCostQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetCloudCostQueryArgs Empty = new PowerpackV2WidgetCloudCostQueryArgs();
    ...
    private PowerpackV2WidgetCloudCostQueryArgs() {}

    private PowerpackV2WidgetCloudCostQueryArgs(PowerpackV2WidgetCloudCostQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetCloudCostQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetCloudCostQueryArgs();
        }

        public Builder(PowerpackV2WidgetCloudCostQueryArgs defaults) {
            $ = new PowerpackV2WidgetCloudCostQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetCloudCostQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetCloudCostQueryArgs", "dataSource");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetCloudCostQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetCloudCostQueryArgs", "query");
            }
            return $;
        }
    }
