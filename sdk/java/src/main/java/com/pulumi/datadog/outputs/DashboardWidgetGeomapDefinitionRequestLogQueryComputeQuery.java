...
@CustomType
public final class DashboardWidgetGeomapDefinitionRequestLogQueryComputeQuery {
    /**
    ...
    private DashboardWidgetGeomapDefinitionRequestLogQueryComputeQuery() {}
    /**
     * @return The aggregation method.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGeomapDefinitionRequestLogQueryComputeQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer interval;
        public Builder() {}
        public Builder(DashboardWidgetGeomapDefinitionRequestLogQueryComputeQuery defaults) {
        ...
        public Builder aggregation(String aggregation) {
            if (aggregation == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGeomapDefinitionRequestLogQueryComputeQuery", "aggregation");
            }
