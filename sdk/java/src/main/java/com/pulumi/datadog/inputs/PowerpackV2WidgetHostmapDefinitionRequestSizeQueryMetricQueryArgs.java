...
public final class PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs Empty = new PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs() {}

    private PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs(PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestSizeQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
