...
public final class PowerpackWidgetScatterplotDefinitionRequestScatterplotTableQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetScatterplotDefinitionRequestScatterplotTableQueryMetricQueryArgs Empty = new PowerpackWidgetScatterplotDefinitionRequestScatterplotTableQueryMetricQueryArgs();
    ...
    public static Builder builder(PowerpackWidgetScatterplotDefinitionRequestScatterplotTableQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetScatterplotDefinitionRequestScatterplotTableQueryMetricQueryArgs();
        }

        public Builder(PowerpackWidgetScatterplotDefinitionRequestScatterplotTableQueryMetricQueryArgs defaults) {
            $ = new PowerpackWidgetScatterplotDefinitionRequestScatterplotTableQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetScatterplotDefinitionRequestScatterplotTableQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetScatterplotDefinitionRequestScatterplotTableQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetScatterplotDefinitionRequestScatterplotTableQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
