...
public final class DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs Empty = new DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs();
    ...
    private DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs() {}

    private DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs(DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs", "value");
            }
            return $;
        }
    }
