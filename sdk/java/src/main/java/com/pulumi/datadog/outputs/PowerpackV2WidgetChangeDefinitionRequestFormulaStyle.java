...
@CustomType
public final class PowerpackV2WidgetChangeDefinitionRequestFormulaStyle {
    /**
    ...
    private PowerpackV2WidgetChangeDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetChangeDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackV2WidgetChangeDefinitionRequestFormulaStyle defaults) {
        ...
        public PowerpackV2WidgetChangeDefinitionRequestFormulaStyle build() {
            final var _resultValue = new PowerpackV2WidgetChangeDefinitionRequestFormulaStyle();
