...
@CustomType
public final class ObservabilityPipelineConfigSourcesDatadogAgentTls {
    /**
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesDatadogAgentTls defaults) {
    ...
    public static final class Builder {
        ...
        public ObservabilityPipelineConfigSourcesDatadogAgentTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesDatadogAgentTls();
