...
public final class ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsArgs Empty = new ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsArgs() {}

    private ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsArgs(ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationSplunkHecMetricsTlsArgs", "crtFile");
            }
            return $;
        }
    }
