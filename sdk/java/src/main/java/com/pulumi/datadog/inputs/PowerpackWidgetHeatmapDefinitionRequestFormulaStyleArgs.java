...
public final class PowerpackWidgetHeatmapDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetHeatmapDefinitionRequestFormulaStyleArgs Empty = new PowerpackWidgetHeatmapDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackWidgetHeatmapDefinitionRequestFormulaStyleArgs() {}

    private PowerpackWidgetHeatmapDefinitionRequestFormulaStyleArgs(PowerpackWidgetHeatmapDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackWidgetHeatmapDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetHeatmapDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackWidgetHeatmapDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackWidgetHeatmapDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetHeatmapDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
