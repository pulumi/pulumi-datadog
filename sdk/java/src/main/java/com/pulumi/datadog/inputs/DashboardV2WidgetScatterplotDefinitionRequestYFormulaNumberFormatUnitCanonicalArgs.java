...
public final class DashboardV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs Empty = new DashboardV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs();
    ...
    private DashboardV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs() {}

    private DashboardV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs(DashboardV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(DashboardV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetScatterplotDefinitionRequestYFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
