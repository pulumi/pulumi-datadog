...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionSort;
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionSort sort;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinition() {}
    /**
     * @return Stringified list of columns to use, for example: `[&#34;column1&#34;,&#34;column2&#34;,&#34;column3&#34;]`.
     * 
     */
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionSort> sort() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder sort(@Nullable DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionSort sort) {

            this.sort = sort;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionTime time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinition build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinition();
