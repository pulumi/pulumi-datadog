...
public final class DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs Empty = new DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs() {}

    private DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs(DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
