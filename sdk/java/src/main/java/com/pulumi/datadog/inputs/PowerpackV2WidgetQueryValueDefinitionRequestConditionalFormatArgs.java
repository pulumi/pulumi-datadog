...
public final class PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs Empty = new PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs();
    ...
    private PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs() {}

    private PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs(PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
