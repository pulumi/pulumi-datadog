...
public final class ObservabilityPipelineConfigDestinationsSyslogNgTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationsSyslogNgTlsArgs Empty = new ObservabilityPipelineConfigDestinationsSyslogNgTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationsSyslogNgTlsArgs() {}

    private ObservabilityPipelineConfigDestinationsSyslogNgTlsArgs(ObservabilityPipelineConfigDestinationsSyslogNgTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationsSyslogNgTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationsSyslogNgTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationsSyslogNgTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationsSyslogNgTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationsSyslogNgTlsArgs build() {
            return $;
        }
    }
