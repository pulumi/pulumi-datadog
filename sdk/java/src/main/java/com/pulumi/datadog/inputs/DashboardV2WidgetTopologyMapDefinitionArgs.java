...
import com.pulumi.datadog.inputs.DashboardV2WidgetTopologyMapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetTopologyMapDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetTopologyMapDefinitionTimeArgs;
...
public final class DashboardV2WidgetTopologyMapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetTopologyMapDefinitionArgs Empty = new DashboardV2WidgetTopologyMapDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetTopologyMapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetTopologyMapDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<DashboardV2WidgetTopologyMapDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetTopologyMapDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetTopologyMapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetTopologyMapDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetTopologyMapDefinitionArgs() {}

    private DashboardV2WidgetTopologyMapDefinitionArgs(DashboardV2WidgetTopologyMapDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetTopologyMapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetTopologyMapDefinitionArgs();
        }

        public Builder(DashboardV2WidgetTopologyMapDefinitionArgs defaults) {
            $ = new DashboardV2WidgetTopologyMapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetTopologyMapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetTopologyMapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetTopologyMapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetTopologyMapDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetTopologyMapDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetTopologyMapDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetTopologyMapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetTopologyMapDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetTopologyMapDefinitionArgs build() {
            return $;
        }
    }
