...
public final class DashboardWidgetGeomapDefinitionCustomLink {
    ...
    public static Builder builder(DashboardWidgetGeomapDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(DashboardWidgetGeomapDefinitionCustomLink defaults) {
        ...
        public DashboardWidgetGeomapDefinitionCustomLink build() {
            final var _resultValue = new DashboardWidgetGeomapDefinitionCustomLink();
