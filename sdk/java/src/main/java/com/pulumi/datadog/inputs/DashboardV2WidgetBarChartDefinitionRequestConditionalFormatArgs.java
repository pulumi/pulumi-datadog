...
public final class DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs Empty = new DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs();
    ...
    private DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs() {}

    private DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs(DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetBarChartDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
