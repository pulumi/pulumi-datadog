...
import com.pulumi.datadog.inputs.PowerpackV2WidgetCohortDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetCohortDefinitionTimeArgs;
...
public final class PowerpackV2WidgetCohortDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetCohortDefinitionArgs Empty = new PowerpackV2WidgetCohortDefinitionArgs();
    ...
    private Output<List<PowerpackV2WidgetCohortDefinitionRequestArgs>> requests;

    /**
     * @return Cohort retention-grid requests.
     * 
     */
    public Output<List<PowerpackV2WidgetCohortDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetCohortDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetCohortDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetCohortDefinitionArgs() {}

    private PowerpackV2WidgetCohortDefinitionArgs(PowerpackV2WidgetCohortDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetCohortDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetCohortDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetCohortDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetCohortDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<PowerpackV2WidgetCohortDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetCohortDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetCohortDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetCohortDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetCohortDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetCohortDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetCohortDefinitionArgs", "requests");
            }
            return $;
        }
    }
