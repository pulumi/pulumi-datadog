...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeseriesBackgroundArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeArgs>> time() {
    ...
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeseriesBackgroundArgs> timeseriesBackground;

    /**
     * @return Set a timeseries on the widget background.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeseriesBackgroundArgs>> timeseriesBackground() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder timeseriesBackground(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeseriesBackgroundArgs> timeseriesBackground) {
         ...
         * 
         */
        public Builder timeseriesBackground(PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionTimeseriesBackgroundArgs timeseriesBackground) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetQueryValueDefinitionArgs build() {
            return $;
        }
    }
