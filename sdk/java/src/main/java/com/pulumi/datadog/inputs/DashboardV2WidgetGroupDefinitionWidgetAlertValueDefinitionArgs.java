...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs build() {
            if ($.alertId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetAlertValueDefinitionArgs", "alertId");
            }
            return $;
        }
    }
