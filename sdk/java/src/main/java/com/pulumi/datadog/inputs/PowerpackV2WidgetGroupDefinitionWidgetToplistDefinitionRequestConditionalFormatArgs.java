...
public final class PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs();
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs(PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
