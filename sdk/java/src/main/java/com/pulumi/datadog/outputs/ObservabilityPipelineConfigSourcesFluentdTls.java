...
@CustomType
public final class ObservabilityPipelineConfigSourcesFluentdTls {
    /**
    ...
    private ObservabilityPipelineConfigSourcesFluentdTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server’s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesFluentdTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesFluentdTls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesFluentdTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesFluentdTls();
