...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTime time;
    /**
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private String vizType;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinition defaults) {
        ...
        public Builder alertId(String alertId) {
            if (alertId == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinition", "alertId");
            }
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTime time) {
        ...
        public Builder vizType(String vizType) {
            if (vizType == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinition", "vizType");
            }
            this.vizType = vizType;
            return this;
        }
        public PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinition();
