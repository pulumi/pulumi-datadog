...
public final class PowerpackWidgetSunburstDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetSunburstDefinitionRequestProcessQueryArgs Empty = new PowerpackWidgetSunburstDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackWidgetSunburstDefinitionRequestProcessQueryArgs() {}

    private PowerpackWidgetSunburstDefinitionRequestProcessQueryArgs(PowerpackWidgetSunburstDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetSunburstDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetSunburstDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackWidgetSunburstDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackWidgetSunburstDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetSunburstDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetSunburstDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
