...
@CustomType
public final class ObservabilityPipelineConfigSourcesKafkaTls {
    /**
    ...
    private ObservabilityPipelineConfigSourcesKafkaTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server’s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesKafkaTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesKafkaTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourcesKafkaTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourcesKafkaTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesKafkaTls();
