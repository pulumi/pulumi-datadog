...
@CustomType
public final class PowerpackWidgetHeatmapDefinitionYaxis {
    /**
    ...
    public static Builder builder(PowerpackWidgetHeatmapDefinitionYaxis defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String scale;
        public Builder() {}
        public Builder(PowerpackWidgetHeatmapDefinitionYaxis defaults) {
        ...
        public PowerpackWidgetHeatmapDefinitionYaxis build() {
            final var _resultValue = new PowerpackWidgetHeatmapDefinitionYaxis();
