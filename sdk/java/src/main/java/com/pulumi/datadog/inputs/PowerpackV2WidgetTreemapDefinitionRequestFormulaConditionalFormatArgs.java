...
public final class PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs(PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTreemapDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
