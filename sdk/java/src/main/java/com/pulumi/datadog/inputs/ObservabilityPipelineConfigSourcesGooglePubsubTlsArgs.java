...
public final class ObservabilityPipelineConfigSourcesGooglePubsubTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcesGooglePubsubTlsArgs Empty = new ObservabilityPipelineConfigSourcesGooglePubsubTlsArgs();
    ...
    private ObservabilityPipelineConfigSourcesGooglePubsubTlsArgs() {}

    private ObservabilityPipelineConfigSourcesGooglePubsubTlsArgs(ObservabilityPipelineConfigSourcesGooglePubsubTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesGooglePubsubTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcesGooglePubsubTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcesGooglePubsubTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcesGooglePubsubTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcesGooglePubsubTlsArgs build() {
            return $;
        }
    }
