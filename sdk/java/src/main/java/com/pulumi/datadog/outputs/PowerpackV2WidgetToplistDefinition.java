...
import com.pulumi.datadog.outputs.PowerpackV2WidgetToplistDefinitionCustomLink;
import com.pulumi.datadog.outputs.PowerpackV2WidgetToplistDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetToplistDefinitionStyle;
import com.pulumi.datadog.outputs.PowerpackV2WidgetToplistDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetToplistDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<PowerpackV2WidgetToplistDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetToplistDefinitionRequest> requests;
    /**
     * @return The style of the widget
     * 
     */
    private @Nullable PowerpackV2WidgetToplistDefinitionStyle style;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetToplistDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetToplistDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<PowerpackV2WidgetToplistDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<PowerpackV2WidgetToplistDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetToplistDefinitionStyle> style() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetToplistDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetToplistDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetToplistDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<PowerpackV2WidgetToplistDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(PowerpackV2WidgetToplistDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<PowerpackV2WidgetToplistDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetToplistDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder style(@Nullable PowerpackV2WidgetToplistDefinitionStyle style) {

            this.style = style;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetToplistDefinitionTime time) {
        ...
        public PowerpackV2WidgetToplistDefinition build() {
            final var _resultValue = new PowerpackV2WidgetToplistDefinition();
