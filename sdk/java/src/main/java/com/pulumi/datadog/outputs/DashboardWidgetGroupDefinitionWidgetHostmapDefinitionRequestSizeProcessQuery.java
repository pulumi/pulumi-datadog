...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeProcessQuery {
    /**
    ...
    private DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeProcessQuery build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeProcessQuery();
