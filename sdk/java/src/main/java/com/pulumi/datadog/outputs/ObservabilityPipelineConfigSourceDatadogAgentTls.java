...
@CustomType
public final class ObservabilityPipelineConfigSourceDatadogAgentTls {
    /**
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceDatadogAgentTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceDatadogAgentTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceDatadogAgentTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceDatadogAgentTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceDatadogAgentTls();
