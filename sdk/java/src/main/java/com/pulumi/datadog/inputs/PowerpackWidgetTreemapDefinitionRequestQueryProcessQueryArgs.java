...
public final class PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs Empty = new PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs();
    ...
    private PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs() {}

    private PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs(PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
