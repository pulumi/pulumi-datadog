...
public final class PowerpackV2WidgetHostmapDefinitionStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionStyleArgs Empty = new PowerpackV2WidgetHostmapDefinitionStyleArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionStyleArgs() {}

    private PowerpackV2WidgetHostmapDefinitionStyleArgs(PowerpackV2WidgetHostmapDefinitionStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionStyleArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionStyleArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionStyleArgs build() {
            return $;
        }
    }
