...
@CustomType
public final class ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuth {
    /**
    ...
    private ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuth() {}
    /**
     * @return The Amazon Resource Name (ARN) of the role to assume.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuth defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionName;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuth defaults) {
        ...
        public ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuth build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationAmazonSecurityLakeAuth();
