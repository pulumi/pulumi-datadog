...
@CustomType
public final class DashboardV2WidgetHostmapDefinitionRequestSizeProcessQuery {
    /**
    ...
    private DashboardV2WidgetHostmapDefinitionRequestSizeProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestSizeProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetHostmapDefinitionRequestSizeProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestSizeProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestSizeProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetHostmapDefinitionRequestSizeProcessQuery();
