...
public final class AppsecWafExclusionFilterState extends com.pulumi.resources.ResourceArgs {

    public static final AppsecWafExclusionFilterState Empty = new AppsecWafExclusionFilterState();
    ...
    private AppsecWafExclusionFilterState() {}

    private AppsecWafExclusionFilterState(AppsecWafExclusionFilterState $) {
    ...
    public static Builder builder(AppsecWafExclusionFilterState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppsecWafExclusionFilterState();
        }

        public Builder(AppsecWafExclusionFilterState defaults) {
            $ = new AppsecWafExclusionFilterState(Objects.requireNonNull(defaults));
        }
        ...
        public AppsecWafExclusionFilterState build() {
            return $;
        }
    }
