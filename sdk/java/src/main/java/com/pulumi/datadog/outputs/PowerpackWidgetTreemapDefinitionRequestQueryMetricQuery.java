...
@CustomType
public final class PowerpackWidgetTreemapDefinitionRequestQueryMetricQuery {
    /**
    ...
    private PowerpackWidgetTreemapDefinitionRequestQueryMetricQuery() {}
    /**
     * @return The aggregation methods available for metrics queries. Valid values are `avg`, `min`, `max`, `sum`, `last`, `area`, `l2norm`, `percentile`.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetTreemapDefinitionRequestQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(PowerpackWidgetTreemapDefinitionRequestQueryMetricQuery defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetTreemapDefinitionRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
        public PowerpackWidgetTreemapDefinitionRequestQueryMetricQuery build() {
            final var _resultValue = new PowerpackWidgetTreemapDefinitionRequestQueryMetricQuery();
