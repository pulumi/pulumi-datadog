...
public final class PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs Empty = new PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs(PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
