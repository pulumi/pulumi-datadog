...
public final class PowerpackV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs Empty = new PowerpackV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs() {}

    private PowerpackV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs(PowerpackV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestFillFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
