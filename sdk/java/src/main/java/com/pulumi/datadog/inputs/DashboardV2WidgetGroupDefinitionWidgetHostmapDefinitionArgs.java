...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionStyleArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLinkArgs>>> customLinks() {
    ...
    /**
     * @return Notes/description text for the host map widget.
     * 
     */
     ...
     */
    @Import(name="request")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestArgs> request;
     ...
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestArgs>> request() {
     ...
     */
    @Import(name="style")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionStyleArgs> style;

    /**
     * @return The style of the widget graph. One nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionStyleArgs>> style() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionCustomLinkArgs... customLinks) {
        ...
        /**
         * @param groups The list of tag prefixes to group by.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param noGroupHosts A Boolean indicating whether to show the hosts that don&#39;t fit in a group.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param notes Notes/description text for the host map widget.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder request(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestArgs> request) {
            $.request = request;
            return this;
        }
         ...
         * 
         */
        public Builder request(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestArgs request) {
            return request(Output.of(request));
        }

        /**
         * @param scopes The list of tags used to filter the map.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder style(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionStyleArgs> style) {
            $.style = style;
            return this;
        }
         ...
         * 
         */
        public Builder style(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionStyleArgs style) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionArgs build() {
            return $;
        }
    }
