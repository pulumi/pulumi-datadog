...
import com.pulumi.datadog.inputs.DashboardWidgetQueryTableDefinitionRequestApmQueryGroupBySortQueryArgs;
...
public final class DashboardWidgetQueryTableDefinitionRequestApmQueryGroupByArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetQueryTableDefinitionRequestApmQueryGroupByArgs(DashboardWidgetQueryTableDefinitionRequestApmQueryGroupByArgs $) {
        this.facet = $.facet;
        this.limit = $.limit;
    ...
    public static Builder builder(DashboardWidgetQueryTableDefinitionRequestApmQueryGroupByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetQueryTableDefinitionRequestApmQueryGroupByArgs();
        }

        public Builder(DashboardWidgetQueryTableDefinitionRequestApmQueryGroupByArgs defaults) {
        ...
        public DashboardWidgetQueryTableDefinitionRequestApmQueryGroupByArgs build() {
            return $;
        }
    }
