...
@CustomType
public final class DashboardV2WidgetHeatmapDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardV2WidgetHeatmapDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHeatmapDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetHeatmapDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHeatmapDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetHeatmapDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetHeatmapDefinitionRequestProcessQuery();
