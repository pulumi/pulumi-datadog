...
public final class ObservabilityPipelineConfigSourcesRsyslogTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcesRsyslogTlsArgs Empty = new ObservabilityPipelineConfigSourcesRsyslogTlsArgs();
    ...
    private ObservabilityPipelineConfigSourcesRsyslogTlsArgs() {}

    private ObservabilityPipelineConfigSourcesRsyslogTlsArgs(ObservabilityPipelineConfigSourcesRsyslogTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesRsyslogTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcesRsyslogTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcesRsyslogTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcesRsyslogTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcesRsyslogTlsArgs build() {
            return $;
        }
    }
