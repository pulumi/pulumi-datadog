...
@CustomType
public final class PowerpackWidgetScatterplotDefinitionRequestXProcessQuery {
    /**
    ...
    private PowerpackWidgetScatterplotDefinitionRequestXProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetScatterplotDefinitionRequestXProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackWidgetScatterplotDefinitionRequestXProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetScatterplotDefinitionRequestXProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackWidgetScatterplotDefinitionRequestXProcessQuery build() {
            final var _resultValue = new PowerpackWidgetScatterplotDefinitionRequestXProcessQuery();
