...
public final class DashboardWidgetGroupDefinitionWidgetListStreamDefinitionRequestColumnArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DashboardWidgetGroupDefinitionWidgetListStreamDefinitionRequestColumnArgs build() {
            if ($.field == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetListStreamDefinitionRequestColumnArgs", "field");
            }
            if ($.width == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetListStreamDefinitionRequestColumnArgs", "width");
            }
            return $;
        }
    }
