...
import com.pulumi.datadog.inputs.PowerpackV2WidgetFreeTextDefinitionTimeArgs;
...
public final class PowerpackV2WidgetFreeTextDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetFreeTextDefinitionArgs Empty = new PowerpackV2WidgetFreeTextDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetFreeTextDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetFreeTextDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetFreeTextDefinitionArgs() {}

    private PowerpackV2WidgetFreeTextDefinitionArgs(PowerpackV2WidgetFreeTextDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetFreeTextDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetFreeTextDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetFreeTextDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetFreeTextDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetFreeTextDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetFreeTextDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetFreeTextDefinitionArgs build() {
            if ($.text == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetFreeTextDefinitionArgs", "text");
            }
            return $;
        }
    }
