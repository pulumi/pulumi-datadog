...
@CustomType
public final class DashboardV2WidgetScatterplotDefinitionRequestXQuerySloQuery {
    /**
    ...
    private DashboardV2WidgetScatterplotDefinitionRequestXQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinitionRequestXQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(DashboardV2WidgetScatterplotDefinitionRequestXQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public DashboardV2WidgetScatterplotDefinitionRequestXQuerySloQuery build() {
            final var _resultValue = new DashboardV2WidgetScatterplotDefinitionRequestXQuerySloQuery();
