...
public final class DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs Empty = new DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs();
    ...
    private DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs() {}

    private DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs(DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
