...
import com.pulumi.datadog.outputs.PowerpackV2WidgetListStreamDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetListStreamDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetListStreamDefinition {
    /**
     ...
     * 
     */
    private List<PowerpackV2WidgetListStreamDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetListStreamDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetListStreamDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetListStreamDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetListStreamDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetListStreamDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetListStreamDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder requests(List<PowerpackV2WidgetListStreamDefinitionRequest> requests) {
            if (requests == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetListStreamDefinition", "requests");
            }
            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetListStreamDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetListStreamDefinitionTime time) {
        ...
        public PowerpackV2WidgetListStreamDefinition build() {
            final var _resultValue = new PowerpackV2WidgetListStreamDefinition();
