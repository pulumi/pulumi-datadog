...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionArgs();
    ...
    /**
     * Cohort retention-grid requests.
     * 
     */
    @Import(name="requests", required=true)
    private Output<List<DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestArgs>> requests;

    /**
     * @return Cohort retention-grid requests.
     * 
     */
    public Output<List<DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param requests Cohort retention-grid requests.
         * 
         * @return builder
         * 
         */
        public Builder requests(Output<List<DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetCohortDefinitionArgs", "requests");
            }
            return $;
        }
    }
