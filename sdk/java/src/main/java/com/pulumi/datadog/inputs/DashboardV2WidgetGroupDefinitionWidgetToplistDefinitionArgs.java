...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionStyleArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="style")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionStyleArgs> style;

    /**
     * @return The style of the widget
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionStyleArgs>> style() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder style(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionStyleArgs> style) {
            $.style = style;
            return this;
        }
         ...
         * 
         */
        public Builder style(DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionStyleArgs style) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionArgs build() {
            return $;
        }
    }
