...
import com.pulumi.datadog.inputs.DashboardV2WidgetTraceServiceDefinitionTimeArgs;
...
public final class DashboardV2WidgetTraceServiceDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetTraceServiceDefinitionArgs Empty = new DashboardV2WidgetTraceServiceDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetTraceServiceDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetTraceServiceDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetTraceServiceDefinitionArgs() {}

    private DashboardV2WidgetTraceServiceDefinitionArgs(DashboardV2WidgetTraceServiceDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetTraceServiceDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetTraceServiceDefinitionArgs();
        }

        public Builder(DashboardV2WidgetTraceServiceDefinitionArgs defaults) {
            $ = new DashboardV2WidgetTraceServiceDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetTraceServiceDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetTraceServiceDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetTraceServiceDefinitionArgs build() {
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTraceServiceDefinitionArgs", "env");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTraceServiceDefinitionArgs", "service");
            }
            if ($.spanName == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTraceServiceDefinitionArgs", "spanName");
            }
            return $;
        }
    }
