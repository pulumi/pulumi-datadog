...
public final class PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs Empty = new PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs(PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
