...
public final class DashboardWidgetGroupDefinitionWidgetDistributionDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetGroupDefinitionWidgetDistributionDefinitionRequestProcessQueryArgs() {}

    private DashboardWidgetGroupDefinitionWidgetDistributionDefinitionRequestProcessQueryArgs(DashboardWidgetGroupDefinitionWidgetDistributionDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetDistributionDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetGroupDefinitionWidgetDistributionDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetDistributionDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetDistributionDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetDistributionDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
