...
public final class PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs Empty = new PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs() {}

    private PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs(PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestChildConditionalFormatArgs", "value");
            }
            return $;
        }
    }
