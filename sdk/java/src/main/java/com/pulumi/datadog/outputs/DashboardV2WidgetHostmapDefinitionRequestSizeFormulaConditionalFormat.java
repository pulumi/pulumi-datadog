...
@CustomType
public final class DashboardV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormat {
    /**
    ...
    private DashboardV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormat() {}
    /**
     * @return The comparator to use. Valid values are `=`, `&gt;`, `&gt;=`, `&lt;`, `&lt;=`.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormat defaults) {
    ...
    public static final class Builder {
        ...
        private Double value;
        public Builder() {}
        public Builder(DashboardV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormat defaults) {
        ...
        public Builder comparator(String comparator) {
            if (comparator == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormat", "comparator");
            }
        ...
        public Builder palette(String palette) {
            if (palette == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormat", "palette");
            }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormat", "value");
            }
            this.value = value;
            return this;
        }
        public DashboardV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormat build() {
            final var _resultValue = new DashboardV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormat();
