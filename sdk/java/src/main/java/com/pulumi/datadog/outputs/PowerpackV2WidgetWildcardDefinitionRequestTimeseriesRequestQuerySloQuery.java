...
@CustomType
public final class PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery {
    /**
    ...
    private PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery build() {
            final var _resultValue = new PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQuerySloQuery();
