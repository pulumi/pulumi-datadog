...
public final class PowerpackV2WidgetWidgetLayoutArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetWidgetLayoutArgs Empty = new PowerpackV2WidgetWidgetLayoutArgs();
    ...
    private PowerpackV2WidgetWidgetLayoutArgs() {}

    private PowerpackV2WidgetWidgetLayoutArgs(PowerpackV2WidgetWidgetLayoutArgs $) {
        this.height = $.height;
    ...
    public static Builder builder(PowerpackV2WidgetWidgetLayoutArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetWidgetLayoutArgs();
        }

        public Builder(PowerpackV2WidgetWidgetLayoutArgs defaults) {
            $ = new PowerpackV2WidgetWidgetLayoutArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetWidgetLayoutArgs build() {
            if ($.height == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWidgetLayoutArgs", "height");
            }
            if ($.width == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWidgetLayoutArgs", "width");
            }
            if ($.x == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWidgetLayoutArgs", "x");
            }
            if ($.y == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWidgetLayoutArgs", "y");
            }
            return $;
        }
    }
