...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyle {
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyle defaults) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyle build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetGeomapDefinitionRequestFormulaStyle();
