...
public final class DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs Empty = new DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs();
    ...
    private DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs() {}

    private DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs(DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
