...
@CustomType
public final class PowerpackWidgetHeatmapDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackWidgetHeatmapDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetHeatmapDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackWidgetHeatmapDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetHeatmapDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackWidgetHeatmapDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackWidgetHeatmapDefinitionRequestProcessQuery();
