...
public final class DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs Empty = new DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs();
    ...
    private DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs() {}

    private DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs(DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs();
        }

        public Builder(DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs build() {
            return $;
        }
    }
