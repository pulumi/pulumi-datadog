...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionCustomLink {
    /**
    ...
    private DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionCustomLink defaults) {
        ...
        public DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionCustomLink build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionCustomLink();
