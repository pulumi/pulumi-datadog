...
@CustomType
public final class DashboardWidgetQueryValueDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardWidgetQueryValueDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetQueryValueDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetQueryValueDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetQueryValueDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardWidgetQueryValueDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardWidgetQueryValueDefinitionRequestProcessQuery();
