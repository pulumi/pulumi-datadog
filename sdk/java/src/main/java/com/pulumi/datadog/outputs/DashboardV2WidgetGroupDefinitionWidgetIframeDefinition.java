...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetIframeDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetIframeDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetIframeDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetIframeDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetGroupDefinitionWidgetIframeDefinitionTime time) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetIframeDefinition", "url");
            }
            this.url = url;
            return this;
        }
        public DashboardV2WidgetGroupDefinitionWidgetIframeDefinition build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetIframeDefinition();
