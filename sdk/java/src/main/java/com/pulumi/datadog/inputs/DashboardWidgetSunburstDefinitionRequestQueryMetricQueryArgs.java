...
public final class DashboardWidgetSunburstDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetSunburstDefinitionRequestQueryMetricQueryArgs() {}
    ...
    public static Builder builder(DashboardWidgetSunburstDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetSunburstDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardWidgetSunburstDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardWidgetSunburstDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetSunburstDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
