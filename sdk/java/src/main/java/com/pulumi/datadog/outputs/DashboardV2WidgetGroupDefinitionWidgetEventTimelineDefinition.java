...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinition defaults) {
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinition", "query");
            }
            this.query = query;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTime time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinition build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinition();
