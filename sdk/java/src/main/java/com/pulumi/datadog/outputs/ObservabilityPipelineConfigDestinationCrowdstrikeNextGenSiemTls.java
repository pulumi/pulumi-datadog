...
@CustomType
public final class ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationCrowdstrikeNextGenSiemTls();
