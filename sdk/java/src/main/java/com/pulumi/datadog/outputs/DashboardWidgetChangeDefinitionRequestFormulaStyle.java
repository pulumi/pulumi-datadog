...
@CustomType
public final class DashboardWidgetChangeDefinitionRequestFormulaStyle {
    /**
    ...
    private DashboardWidgetChangeDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetChangeDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(DashboardWidgetChangeDefinitionRequestFormulaStyle defaults) {
