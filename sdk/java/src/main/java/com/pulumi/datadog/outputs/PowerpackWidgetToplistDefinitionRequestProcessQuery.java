...
@CustomType
public final class PowerpackWidgetToplistDefinitionRequestProcessQuery {
    /**
    ...
    public static Builder builder(PowerpackWidgetToplistDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackWidgetToplistDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetToplistDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackWidgetToplistDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackWidgetToplistDefinitionRequestProcessQuery();
