...
public final class PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs Empty = new PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs(PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
