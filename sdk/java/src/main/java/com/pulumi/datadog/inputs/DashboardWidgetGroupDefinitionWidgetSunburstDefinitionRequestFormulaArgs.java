...
public final class DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaArgs Empty = new DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaArgs();
    ...
    private @Nullable Output<List<DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs>> conditionalFormats;
     ...
     * 
     */
    public Optional<Output<List<DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs>>> conditionalFormats() {
     ...
     */
    @Import(name="limit")
    private @Nullable Output<DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaLimitArgs> limit;

    /**
     * @return The maximum number of items in the group.
     * 
     */
    public Optional<Output<DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaLimitArgs>> limit() {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder conditionalFormats(@Nullable Output<List<DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs>> conditionalFormats) {
         ...
         * 
         */
        public Builder conditionalFormats(List<DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs> conditionalFormats) {
         ...
         * 
         */
        public Builder conditionalFormats(DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaConditionalFormatArgs... conditionalFormats) {
         ...
         * 
         */
        public Builder limit(@Nullable Output<DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaLimitArgs> limit) {
            $.limit = limit;
            return this;
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaArgs build() {
            if ($.formulaExpression == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestFormulaArgs", "formulaExpression");
            }
            return $;
        }
    }
