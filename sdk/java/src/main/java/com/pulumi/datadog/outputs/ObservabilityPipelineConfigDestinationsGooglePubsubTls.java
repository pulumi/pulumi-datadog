...
@CustomType
public final class ObservabilityPipelineConfigDestinationsGooglePubsubTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationsGooglePubsubTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationsGooglePubsubTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationsGooglePubsubTls defaults) {
        ...
        public ObservabilityPipelineConfigDestinationsGooglePubsubTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationsGooglePubsubTls();
