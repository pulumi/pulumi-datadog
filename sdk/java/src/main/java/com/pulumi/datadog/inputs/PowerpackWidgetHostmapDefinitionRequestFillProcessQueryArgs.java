...
public final class PowerpackWidgetHostmapDefinitionRequestFillProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetHostmapDefinitionRequestFillProcessQueryArgs Empty = new PowerpackWidgetHostmapDefinitionRequestFillProcessQueryArgs();
    ...
    private PowerpackWidgetHostmapDefinitionRequestFillProcessQueryArgs() {}

    private PowerpackWidgetHostmapDefinitionRequestFillProcessQueryArgs(PowerpackWidgetHostmapDefinitionRequestFillProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetHostmapDefinitionRequestFillProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetHostmapDefinitionRequestFillProcessQueryArgs();
        }

        public Builder(PowerpackWidgetHostmapDefinitionRequestFillProcessQueryArgs defaults) {
            $ = new PowerpackWidgetHostmapDefinitionRequestFillProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetHostmapDefinitionRequestFillProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetHostmapDefinitionRequestFillProcessQueryArgs", "metric");
            }
            return $;
        }
    }
