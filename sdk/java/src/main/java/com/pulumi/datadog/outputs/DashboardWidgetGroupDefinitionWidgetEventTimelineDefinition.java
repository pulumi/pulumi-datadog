...
public final class DashboardWidgetGroupDefinitionWidgetEventTimelineDefinition {
    ...
    public static final class Builder {
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetEventTimelineDefinition", "query");
            }
            this.query = query;
            return this;
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetEventTimelineDefinition build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetEventTimelineDefinition();
