...
public final class PowerpackWidgetTimeseriesDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetTimeseriesDefinitionRequestFormulaStyleArgs Empty = new PowerpackWidgetTimeseriesDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackWidgetTimeseriesDefinitionRequestFormulaStyleArgs() {}

    private PowerpackWidgetTimeseriesDefinitionRequestFormulaStyleArgs(PowerpackWidgetTimeseriesDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackWidgetTimeseriesDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetTimeseriesDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackWidgetTimeseriesDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackWidgetTimeseriesDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetTimeseriesDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
