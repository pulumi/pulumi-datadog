...
public final class DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs Empty = new DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs();
    ...
    private DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs() {}

    private DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs(DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
