...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestStyle {
    /**
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestStyle defaults) {
    ...
    public static final class Builder {
        private @Nullable String palette;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestStyle defaults) {
        ...
        public DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestStyle build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestStyle();
