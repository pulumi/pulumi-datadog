...
public final class MonitorVariablesEventQueryComputeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(MonitorVariablesEventQueryComputeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MonitorVariablesEventQueryComputeArgs();
        }

        public Builder(MonitorVariablesEventQueryComputeArgs defaults) {
        ...
        public MonitorVariablesEventQueryComputeArgs build() {
            if ($.aggregation == null) {
                throw new MissingRequiredPropertyException("MonitorVariablesEventQueryComputeArgs", "aggregation");
            }
            return $;
        }
    }
