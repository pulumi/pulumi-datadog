...
public final class DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs Empty = new DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs();
    ...
    private DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs() {}

    private DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs(DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs();
        }

        public Builder(DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs defaults) {
            $ = new DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs", "dataSource");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQueryCloudCostQueryArgs", "query");
            }
            return $;
        }
    }
