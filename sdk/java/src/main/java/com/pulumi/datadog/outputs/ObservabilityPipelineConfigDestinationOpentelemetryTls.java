...
@CustomType
public final class ObservabilityPipelineConfigDestinationOpentelemetryTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationOpentelemetryTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationOpentelemetryTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyPassKey;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationOpentelemetryTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationOpentelemetryTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigDestinationOpentelemetryTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationOpentelemetryTls();
