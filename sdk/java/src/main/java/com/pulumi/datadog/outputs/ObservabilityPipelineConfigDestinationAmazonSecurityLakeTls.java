...
@CustomType
public final class ObservabilityPipelineConfigDestinationAmazonSecurityLakeTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationAmazonSecurityLakeTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationAmazonSecurityLakeTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationAmazonSecurityLakeTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationAmazonSecurityLakeTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigDestinationAmazonSecurityLakeTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationAmazonSecurityLakeTls();
