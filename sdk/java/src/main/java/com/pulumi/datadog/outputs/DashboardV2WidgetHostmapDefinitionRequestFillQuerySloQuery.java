...
@CustomType
public final class DashboardV2WidgetHostmapDefinitionRequestFillQuerySloQuery {
    /**
    ...
    private DashboardV2WidgetHostmapDefinitionRequestFillQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestFillQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(DashboardV2WidgetHostmapDefinitionRequestFillQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestFillQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestFillQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestFillQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestFillQuerySloQuery build() {
            final var _resultValue = new DashboardV2WidgetHostmapDefinitionRequestFillQuerySloQuery();
