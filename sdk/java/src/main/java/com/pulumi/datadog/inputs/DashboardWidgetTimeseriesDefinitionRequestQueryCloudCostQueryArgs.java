...
public final class DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs Empty = new DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs();
    ...
    private DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs() {}

    private DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs(DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs();
        }

        public Builder(DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs defaults) {
            $ = new DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs", "dataSource");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs", "query");
            }
            return $;
        }
    }
