...
public final class PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs Empty = new PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs() {}

    private PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs(PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaStyleArgs build() {
            return $;
        }
    }
