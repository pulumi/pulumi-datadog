...
public final class PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs Empty = new PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs() {}

    private PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs(PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
