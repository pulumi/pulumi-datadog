...
public final class DashboardWidgetAlertGraphDefinitionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetAlertGraphDefinitionArgs() {}

    private DashboardWidgetAlertGraphDefinitionArgs(DashboardWidgetAlertGraphDefinitionArgs $) {
    ...
    public static Builder builder(DashboardWidgetAlertGraphDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetAlertGraphDefinitionArgs();
        }

        public Builder(DashboardWidgetAlertGraphDefinitionArgs defaults) {
        ...
        public DashboardWidgetAlertGraphDefinitionArgs build() {
            if ($.alertId == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetAlertGraphDefinitionArgs", "alertId");
            }
            if ($.vizType == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetAlertGraphDefinitionArgs", "vizType");
            }
            return $;
        }
    }
