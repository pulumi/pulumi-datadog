...
@CustomType
public final class ObservabilityPipelineConfigDestinationsSyslogNgTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationsSyslogNgTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationsSyslogNgTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationsSyslogNgTls defaults) {
        ...
        public ObservabilityPipelineConfigDestinationsSyslogNgTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationsSyslogNgTls();
