...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetSunburstDefinitionCustomLink {
    /**
    ...
    private DashboardWidgetGroupDefinitionWidgetSunburstDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetSunburstDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetSunburstDefinitionCustomLink defaults) {
        ...
        public DashboardWidgetGroupDefinitionWidgetSunburstDefinitionCustomLink build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetSunburstDefinitionCustomLink();
