...
@CustomType
public final class PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQuery {
    /**
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQuery build() {
            final var _resultValue = new PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQuerySloQuery();
