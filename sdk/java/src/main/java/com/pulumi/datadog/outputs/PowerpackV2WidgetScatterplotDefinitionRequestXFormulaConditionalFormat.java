...
@CustomType
public final class PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormat {
    /**
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormat() {}
    /**
     * @return The comparator to use. Valid values are `=`, `&gt;`, `&gt;=`, `&lt;`, `&lt;=`.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormat defaults) {
    ...
    public static final class Builder {
        ...
        private Double value;
        public Builder() {}
        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormat defaults) {
        ...
        public Builder comparator(String comparator) {
            if (comparator == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormat", "comparator");
            }
        ...
        public Builder palette(String palette) {
            if (palette == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormat", "palette");
            }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormat", "value");
            }
            this.value = value;
            return this;
        }
        public PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormat build() {
            final var _resultValue = new PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormat();
