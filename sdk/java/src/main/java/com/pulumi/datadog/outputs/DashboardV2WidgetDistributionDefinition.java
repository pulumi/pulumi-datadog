...
import com.pulumi.datadog.outputs.DashboardV2WidgetDistributionDefinitionMarker;
import com.pulumi.datadog.outputs.DashboardV2WidgetDistributionDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetDistributionDefinitionTime;
import com.pulumi.datadog.outputs.DashboardV2WidgetDistributionDefinitionXaxis;
import com.pulumi.datadog.outputs.DashboardV2WidgetDistributionDefinitionYaxis;
...
@CustomType
public final class DashboardV2WidgetDistributionDefinition {
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetDistributionDefinitionMarker> markers;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetDistributionDefinitionRequest> requests;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetDistributionDefinitionTime time;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetDistributionDefinitionXaxis xaxis;
    /**
     * @return A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    private @Nullable DashboardV2WidgetDistributionDefinitionYaxis yaxis;
     ...
     * 
     */
    public List<DashboardV2WidgetDistributionDefinitionMarker> markers() {
     ...
     * 
     */
    public List<DashboardV2WidgetDistributionDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetDistributionDefinitionTime> time() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetDistributionDefinitionXaxis> xaxis() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetDistributionDefinitionYaxis> yaxis() {
    ...
    public static Builder builder(DashboardV2WidgetDistributionDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable DashboardV2WidgetDistributionDefinitionYaxis yaxis;
        public Builder() {}
        public Builder(DashboardV2WidgetDistributionDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder markers(@Nullable List<DashboardV2WidgetDistributionDefinitionMarker> markers) {

            this.markers = markers;
            return this;
        }
        public Builder markers(DashboardV2WidgetDistributionDefinitionMarker... markers) {
            return markers(List.of(markers));
        }
        @CustomType.Setter
        public Builder requests(@Nullable List<DashboardV2WidgetDistributionDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetDistributionDefinitionRequest... requests) {
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetDistributionDefinitionTime time) {
        ...
        @CustomType.Setter
        public Builder xaxis(@Nullable DashboardV2WidgetDistributionDefinitionXaxis xaxis) {

            this.xaxis = xaxis;
            return this;
        }
        @CustomType.Setter
        public Builder yaxis(@Nullable DashboardV2WidgetDistributionDefinitionYaxis yaxis) {

            this.yaxis = yaxis;
            return this;
        }
        public DashboardV2WidgetDistributionDefinition build() {
            final var _resultValue = new DashboardV2WidgetDistributionDefinition();
