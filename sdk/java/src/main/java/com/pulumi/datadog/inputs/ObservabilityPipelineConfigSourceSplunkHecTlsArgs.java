...
public final class ObservabilityPipelineConfigSourceSplunkHecTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceSplunkHecTlsArgs Empty = new ObservabilityPipelineConfigSourceSplunkHecTlsArgs();
    ...
    private ObservabilityPipelineConfigSourceSplunkHecTlsArgs() {}

    private ObservabilityPipelineConfigSourceSplunkHecTlsArgs(ObservabilityPipelineConfigSourceSplunkHecTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceSplunkHecTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceSplunkHecTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceSplunkHecTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceSplunkHecTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceSplunkHecTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceSplunkHecTlsArgs", "crtFile");
            }
            return $;
        }
    }
