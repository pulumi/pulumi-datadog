...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupByArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySortArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupByArgs>> groupBies;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupByArgs>>> groupBies() {
     ...
     */
    @Import(name="sort")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySortArgs> sort;

    /**
     * @return The facet and order to sort the data, for example: `{&#34;column&#34;: &#34;time&#34;, &#34;order&#34;: &#34;desc&#34;}`.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySortArgs>> sort() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryArgs(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder groupBies(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupByArgs>> groupBies) {
            $.groupBies = groupBies;
            return this;
        }
         ...
         * 
         */
        public Builder groupBies(List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupByArgs> groupBies) {
         ...
         * 
         */
        public Builder groupBies(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupByArgs... groupBies) {
         ...
         * 
         */
        public Builder sort(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySortArgs> sort) {
            $.sort = sort;
            return this;
        }
         ...
         * 
         */
        public Builder sort(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySortArgs sort) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryArgs", "dataSource");
            }
            return $;
        }
    }
