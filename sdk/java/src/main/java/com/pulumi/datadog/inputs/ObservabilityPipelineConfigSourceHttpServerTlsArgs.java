...
public final class ObservabilityPipelineConfigSourceHttpServerTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceHttpServerTlsArgs Empty = new ObservabilityPipelineConfigSourceHttpServerTlsArgs();
    ...
    private ObservabilityPipelineConfigSourceHttpServerTlsArgs() {}

    private ObservabilityPipelineConfigSourceHttpServerTlsArgs(ObservabilityPipelineConfigSourceHttpServerTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceHttpServerTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceHttpServerTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceHttpServerTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceHttpServerTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceHttpServerTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceHttpServerTlsArgs", "crtFile");
            }
            return $;
        }
    }
