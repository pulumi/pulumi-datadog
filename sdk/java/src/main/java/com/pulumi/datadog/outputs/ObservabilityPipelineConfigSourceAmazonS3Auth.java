...
@CustomType
public final class ObservabilityPipelineConfigSourceAmazonS3Auth {
    /**
    ...
    private ObservabilityPipelineConfigSourceAmazonS3Auth() {}
    /**
     * @return The Amazon Resource Name (ARN) of the role to assume.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceAmazonS3Auth defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionName;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceAmazonS3Auth defaults) {
        ...
        public ObservabilityPipelineConfigSourceAmazonS3Auth build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceAmazonS3Auth();
