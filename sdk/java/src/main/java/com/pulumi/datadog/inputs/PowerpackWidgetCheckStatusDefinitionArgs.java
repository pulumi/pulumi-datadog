...
public final class PowerpackWidgetCheckStatusDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetCheckStatusDefinitionArgs Empty = new PowerpackWidgetCheckStatusDefinitionArgs();
    ...
    private PowerpackWidgetCheckStatusDefinitionArgs() {}

    private PowerpackWidgetCheckStatusDefinitionArgs(PowerpackWidgetCheckStatusDefinitionArgs $) {
        this.check = $.check;
        this.group = $.group;
    ...
    public static Builder builder(PowerpackWidgetCheckStatusDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetCheckStatusDefinitionArgs();
        }

        public Builder(PowerpackWidgetCheckStatusDefinitionArgs defaults) {
            $ = new PowerpackWidgetCheckStatusDefinitionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetCheckStatusDefinitionArgs build() {
            if ($.check == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetCheckStatusDefinitionArgs", "check");
            }
            if ($.grouping == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetCheckStatusDefinitionArgs", "grouping");
            }
            return $;
        }
    }
