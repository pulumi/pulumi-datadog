...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs build() {
            if ($.alertId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs", "alertId");
            }
            if ($.vizType == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetAlertGraphDefinitionArgs", "vizType");
            }
            return $;
        }
    }
