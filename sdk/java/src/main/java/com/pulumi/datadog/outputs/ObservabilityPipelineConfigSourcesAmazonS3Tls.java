...
@CustomType
public final class ObservabilityPipelineConfigSourcesAmazonS3Tls {
    /**
    ...
    private ObservabilityPipelineConfigSourcesAmazonS3Tls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server’s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesAmazonS3Tls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesAmazonS3Tls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesAmazonS3Tls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesAmazonS3Tls();
