...
public final class DashboardWidgetHostmapDefinitionRequestFillProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetHostmapDefinitionRequestFillProcessQueryArgs Empty = new DashboardWidgetHostmapDefinitionRequestFillProcessQueryArgs();
    ...
    private DashboardWidgetHostmapDefinitionRequestFillProcessQueryArgs() {}

    private DashboardWidgetHostmapDefinitionRequestFillProcessQueryArgs(DashboardWidgetHostmapDefinitionRequestFillProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetHostmapDefinitionRequestFillProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetHostmapDefinitionRequestFillProcessQueryArgs();
        }

        public Builder(DashboardWidgetHostmapDefinitionRequestFillProcessQueryArgs defaults) {
            $ = new DashboardWidgetHostmapDefinitionRequestFillProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetHostmapDefinitionRequestFillProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetHostmapDefinitionRequestFillProcessQueryArgs", "metric");
            }
            return $;
        }
    }
