...
import com.pulumi.datadog.outputs.PowerpackV2WidgetLogStreamDefinitionSort;
import com.pulumi.datadog.outputs.PowerpackV2WidgetLogStreamDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetLogStreamDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetLogStreamDefinitionSort sort;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetLogStreamDefinitionTime time;
    /**
     ...
     * 
     */
    public Optional<PowerpackV2WidgetLogStreamDefinitionSort> sort() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetLogStreamDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetLogStreamDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetLogStreamDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder sort(@Nullable PowerpackV2WidgetLogStreamDefinitionSort sort) {

            this.sort = sort;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetLogStreamDefinitionTime time) {
        ...
        public PowerpackV2WidgetLogStreamDefinition build() {
            final var _resultValue = new PowerpackV2WidgetLogStreamDefinition();
