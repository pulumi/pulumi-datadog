...
public final class DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs Empty = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs();
    ...
    private DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs() {}

    private DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs();
        }

        public Builder(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs defaults) {
            $ = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
