...
@CustomType
public final class PowerpackV2WidgetHostmapDefinitionStyle {
    /**
    ...
    private PowerpackV2WidgetHostmapDefinitionStyle() {}
    /**
     * @return The max value to use to color the map.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean paletteFlip;
        public Builder() {}
        public Builder(PowerpackV2WidgetHostmapDefinitionStyle defaults) {
        ...
        public PowerpackV2WidgetHostmapDefinitionStyle build() {
            final var _resultValue = new PowerpackV2WidgetHostmapDefinitionStyle();
