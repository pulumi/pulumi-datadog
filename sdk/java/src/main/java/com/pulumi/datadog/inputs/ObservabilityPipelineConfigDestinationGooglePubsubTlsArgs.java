...
public final class ObservabilityPipelineConfigDestinationGooglePubsubTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationGooglePubsubTlsArgs Empty = new ObservabilityPipelineConfigDestinationGooglePubsubTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationGooglePubsubTlsArgs() {}

    private ObservabilityPipelineConfigDestinationGooglePubsubTlsArgs(ObservabilityPipelineConfigDestinationGooglePubsubTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationGooglePubsubTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationGooglePubsubTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationGooglePubsubTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationGooglePubsubTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationGooglePubsubTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationGooglePubsubTlsArgs", "crtFile");
            }
            return $;
        }
    }
