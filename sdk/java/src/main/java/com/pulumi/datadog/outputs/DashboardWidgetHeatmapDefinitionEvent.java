...
public final class DashboardWidgetHeatmapDefinitionEvent {
    ...
    public static Builder builder(DashboardWidgetHeatmapDefinitionEvent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tagsExecution;
        public Builder() {}
        public Builder(DashboardWidgetHeatmapDefinitionEvent defaults) {
        ...
        public Builder q(String q) {
            if (q == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionEvent", "q");
            }
            this.q = q;
            return this;
        }
