...
@CustomType
public final class PowerpackV2WidgetQueryValueDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackV2WidgetQueryValueDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetQueryValueDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetQueryValueDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetQueryValueDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetQueryValueDefinitionRequestProcessQuery();
