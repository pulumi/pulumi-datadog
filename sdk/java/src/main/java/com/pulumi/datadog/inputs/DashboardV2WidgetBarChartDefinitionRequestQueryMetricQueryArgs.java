...
public final class DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs Empty = new DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs() {}

    private DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs(DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetBarChartDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
