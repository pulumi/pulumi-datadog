...
public final class PowerpackWidgetEventTimelineDefinition {
    ...
    public static Builder builder(PowerpackWidgetEventTimelineDefinition defaults) {
    ...
    public static final class Builder {
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetEventTimelineDefinition", "query");
            }
            this.query = query;
            return this;
        }
