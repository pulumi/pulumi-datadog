...
import com.pulumi.datadog.inputs.PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs;
...
public final class PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs Empty = new PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs>> groupBies;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs>>> groupBies() {
     ...
     */
    @Import(name="sort")
    private @Nullable Output<PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs> sort;

    /**
     * @return The facet and order to sort the data, for example: `{&#34;column&#34;: &#34;time&#34;, &#34;order&#34;: &#34;desc&#34;}`.
     * 
     */
    public Optional<Output<PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs>> sort() {
    ...
    private PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs() {}

    private PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs(PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs();
        }

        public Builder(PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs defaults) {
            $ = new PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder groupBies(@Nullable Output<List<PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs>> groupBies) {
            $.groupBies = groupBies;
            return this;
        }
         ...
         * 
         */
        public Builder groupBies(List<PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs> groupBies) {
         ...
         * 
         */
        public Builder groupBies(PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryGroupByArgs... groupBies) {
         ...
         * 
         */
        public Builder sort(@Nullable Output<PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs> sort) {
            $.sort = sort;
            return this;
        }
         ...
         * 
         */
        public Builder sort(PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQuerySortArgs sort) {
        ...
        public PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestListstreamRequestQueryArgs", "dataSource");
            }
            return $;
        }
    }
