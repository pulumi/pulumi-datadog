...
public final class DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs Empty = new DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs();
    ...
    private DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs() {}

    private DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs(DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
