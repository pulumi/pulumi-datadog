...
public final class DashboardV2WidgetSunburstDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetSunburstDefinitionRequestProcessQueryArgs Empty = new DashboardV2WidgetSunburstDefinitionRequestProcessQueryArgs();
    ...
    private DashboardV2WidgetSunburstDefinitionRequestProcessQueryArgs() {}

    private DashboardV2WidgetSunburstDefinitionRequestProcessQueryArgs(DashboardV2WidgetSunburstDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetSunburstDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetSunburstDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardV2WidgetSunburstDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardV2WidgetSunburstDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetSunburstDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetSunburstDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
