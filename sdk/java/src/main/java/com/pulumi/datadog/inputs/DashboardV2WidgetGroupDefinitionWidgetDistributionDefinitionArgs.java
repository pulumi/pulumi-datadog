...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionMarkerArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionTimeArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionXaxisArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionYaxisArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs();
     ...
     */
    @Import(name="markers")
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionMarkerArgs>> markers;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionMarkerArgs>>> markers() {
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="xaxis")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionXaxisArgs> xaxis;

    /**
     * @return A nested block describing the X-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionXaxisArgs>> xaxis() {
     ...
     */
    @Import(name="yaxis")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionYaxisArgs> yaxis;

    /**
     * @return A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionYaxisArgs>> yaxis() {
        return Optional.ofNullable(this.yaxis);
    }

    private DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder markers(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionMarkerArgs>> markers) {
            $.markers = markers;
            return this;
        }
         ...
         * 
         */
        public Builder markers(List<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionMarkerArgs> markers) {
         ...
         * 
         */
        public Builder markers(DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionMarkerArgs... markers) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder xaxis(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionXaxisArgs> xaxis) {
            $.xaxis = xaxis;
            return this;
        }
         ...
         * 
         */
        public Builder xaxis(DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionXaxisArgs xaxis) {
         ...
         * 
         */
        public Builder yaxis(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionYaxisArgs> yaxis) {
            $.yaxis = yaxis;
            return this;
        }
         ...
         * 
         */
        public Builder yaxis(DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionYaxisArgs yaxis) {
            return yaxis(Output.of(yaxis));
        }

        public DashboardV2WidgetGroupDefinitionWidgetDistributionDefinitionArgs build() {
            return $;
        }
    }
