...
public final class DashboardV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs Empty = new DashboardV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs();
    ...
    private DashboardV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs() {}

    private DashboardV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs(DashboardV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetScatterplotDefinitionRequestXFormulaStyleArgs build() {
            return $;
        }
    }
