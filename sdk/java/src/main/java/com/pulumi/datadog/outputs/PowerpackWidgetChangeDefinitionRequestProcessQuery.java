...
@CustomType
public final class PowerpackWidgetChangeDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackWidgetChangeDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetChangeDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackWidgetChangeDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackWidgetChangeDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackWidgetChangeDefinitionRequestProcessQuery();
