...
public final class PowerpackWidgetChangeDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetChangeDefinitionRequestProcessQueryArgs Empty = new PowerpackWidgetChangeDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackWidgetChangeDefinitionRequestProcessQueryArgs() {}

    private PowerpackWidgetChangeDefinitionRequestProcessQueryArgs(PowerpackWidgetChangeDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetChangeDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetChangeDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackWidgetChangeDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackWidgetChangeDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetChangeDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
