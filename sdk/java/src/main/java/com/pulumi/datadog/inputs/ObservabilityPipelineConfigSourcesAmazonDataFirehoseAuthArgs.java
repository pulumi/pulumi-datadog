...
public final class ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuthArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuthArgs Empty = new ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuthArgs();
    ...
    private ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuthArgs() {}

    private ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuthArgs(ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuthArgs $) {
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuthArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuthArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuthArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuthArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuthArgs build() {
            return $;
        }
    }
