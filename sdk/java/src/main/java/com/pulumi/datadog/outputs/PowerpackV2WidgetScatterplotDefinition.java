...
import com.pulumi.datadog.outputs.PowerpackV2WidgetScatterplotDefinitionCustomLink;
import com.pulumi.datadog.outputs.PowerpackV2WidgetScatterplotDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetScatterplotDefinitionTime;
import com.pulumi.datadog.outputs.PowerpackV2WidgetScatterplotDefinitionXaxis;
import com.pulumi.datadog.outputs.PowerpackV2WidgetScatterplotDefinitionYaxis;
...
@CustomType
public final class PowerpackV2WidgetScatterplotDefinition {
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetScatterplotDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetScatterplotDefinitionRequest request;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetScatterplotDefinitionTime time;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetScatterplotDefinitionXaxis xaxis;
    /**
     * @return A nested block describing the Y-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    private @Nullable PowerpackV2WidgetScatterplotDefinitionYaxis yaxis;

    private PowerpackV2WidgetScatterplotDefinition() {}
    /**
     * @return List of groups used for colors.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetScatterplotDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetScatterplotDefinitionRequest> request() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetScatterplotDefinitionTime> time() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetScatterplotDefinitionXaxis> xaxis() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetScatterplotDefinitionYaxis> yaxis() {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable PowerpackV2WidgetScatterplotDefinitionYaxis yaxis;
        public Builder() {}
        public Builder(PowerpackV2WidgetScatterplotDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<PowerpackV2WidgetScatterplotDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(PowerpackV2WidgetScatterplotDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder request(@Nullable PowerpackV2WidgetScatterplotDefinitionRequest request) {

            this.request = request;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetScatterplotDefinitionTime time) {
        ...
        @CustomType.Setter
        public Builder xaxis(@Nullable PowerpackV2WidgetScatterplotDefinitionXaxis xaxis) {

            this.xaxis = xaxis;
            return this;
        }
        @CustomType.Setter
        public Builder yaxis(@Nullable PowerpackV2WidgetScatterplotDefinitionYaxis yaxis) {

            this.yaxis = yaxis;
            return this;
        }
        public PowerpackV2WidgetScatterplotDefinition build() {
            final var _resultValue = new PowerpackV2WidgetScatterplotDefinition();
