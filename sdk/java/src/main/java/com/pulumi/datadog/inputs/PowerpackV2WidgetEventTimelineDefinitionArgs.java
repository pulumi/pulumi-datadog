...
import com.pulumi.datadog.inputs.PowerpackV2WidgetEventTimelineDefinitionTimeArgs;
...
public final class PowerpackV2WidgetEventTimelineDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetEventTimelineDefinitionArgs Empty = new PowerpackV2WidgetEventTimelineDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetEventTimelineDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetEventTimelineDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetEventTimelineDefinitionArgs() {}

    private PowerpackV2WidgetEventTimelineDefinitionArgs(PowerpackV2WidgetEventTimelineDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetEventTimelineDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetEventTimelineDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetEventTimelineDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetEventTimelineDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetEventTimelineDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetEventTimelineDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetEventTimelineDefinitionArgs build() {
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetEventTimelineDefinitionArgs", "query");
            }
            return $;
        }
    }
