...
import com.pulumi.datadog.outputs.DashboardWidgetToplistDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardWidgetToplistDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardWidgetToplistDefinitionStyle;
...
@CustomType
public final class DashboardWidgetToplistDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `custom_link` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardWidgetToplistDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardWidgetToplistDefinitionRequest> requests;
    /**
     * @return The style of the widget
     * 
     */
    private @Nullable List<DashboardWidgetToplistDefinitionStyle> styles;
    /**
     ...
     * 
     */
    public List<DashboardWidgetToplistDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<DashboardWidgetToplistDefinitionRequest> requests() {
     ...
     * 
     */
    public List<DashboardWidgetToplistDefinitionStyle> styles() {
    ...
    public static Builder builder(DashboardWidgetToplistDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardWidgetToplistDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardWidgetToplistDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardWidgetToplistDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<DashboardWidgetToplistDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardWidgetToplistDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder styles(@Nullable List<DashboardWidgetToplistDefinitionStyle> styles) {

            this.styles = styles;
            return this;
        }
        public Builder styles(DashboardWidgetToplistDefinitionStyle... styles) {
        ...
        public DashboardWidgetToplistDefinition build() {
            final var _resultValue = new DashboardWidgetToplistDefinition();
