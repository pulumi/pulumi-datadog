...
public final class DashboardWidgetApmQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetApmQueryArgs Empty = new DashboardWidgetApmQueryArgs();
    ...
    private @Nullable Output<DashboardWidgetApmQueryComputeQueryArgs> computeQuery;

    /**
     * @return `computeQuery` or `multiCompute` is required. The map keys are listed below.
     * 
     */
    public Optional<Output<DashboardWidgetApmQueryComputeQueryArgs>> computeQuery() {
    ...
    private @Nullable Output<List<DashboardWidgetApmQueryMultiComputeArgs>> multiComputes;

    /**
     * @return `computeQuery` or `multiCompute` is required. Multiple `multiCompute` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardWidgetApmQueryMultiComputeArgs>>> multiComputes() {
    ...
    private DashboardWidgetApmQueryArgs() {}

    private DashboardWidgetApmQueryArgs(DashboardWidgetApmQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetApmQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetApmQueryArgs();
        }

        public Builder(DashboardWidgetApmQueryArgs defaults) {
            $ = new DashboardWidgetApmQueryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder computeQuery(@Nullable Output<DashboardWidgetApmQueryComputeQueryArgs> computeQuery) {
         ...
         * 
         */
        public Builder computeQuery(DashboardWidgetApmQueryComputeQueryArgs computeQuery) {
         ...
         * 
         */
        public Builder multiComputes(@Nullable Output<List<DashboardWidgetApmQueryMultiComputeArgs>> multiComputes) {
         ...
         * 
         */
        public Builder multiComputes(List<DashboardWidgetApmQueryMultiComputeArgs> multiComputes) {
         ...
         * 
         */
        public Builder multiComputes(DashboardWidgetApmQueryMultiComputeArgs... multiComputes) {
        ...
        public DashboardWidgetApmQueryArgs build() {
            if ($.index == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetApmQueryArgs", "index");
            }
            return $;
        }
    }
