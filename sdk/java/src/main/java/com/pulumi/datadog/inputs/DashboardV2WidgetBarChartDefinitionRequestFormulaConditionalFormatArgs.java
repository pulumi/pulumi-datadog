...
public final class DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs Empty = new DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs() {}

    private DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs(DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetBarChartDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
