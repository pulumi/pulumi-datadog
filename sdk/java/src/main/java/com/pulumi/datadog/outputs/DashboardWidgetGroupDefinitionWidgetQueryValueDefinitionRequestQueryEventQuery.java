...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQueryEventQuery {
    /**
     * @return The compute options.
     * 
     */
    private List<DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQueryEventQueryCompute> computes;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQueryEventQueryGroupBy> groupBies;
    /**
     ...
     * 
     */
    private @Nullable DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQueryEventQuerySearch search;
    /**
     ...
     * 
     */
    public List<DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQueryEventQueryCompute> computes() {
     ...
     * 
     */
    public List<DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQueryEventQueryGroupBy> groupBies() {
     ...
     * 
     */
    public Optional<DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQueryEventQuerySearch> search() {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQueryEventQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storage;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQueryEventQuery defaults) {
        ...
        public Builder groupBies(DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQueryEventQueryGroupBy... groupBies) {
        ...
        public DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQueryEventQuery build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestQueryEventQuery();
