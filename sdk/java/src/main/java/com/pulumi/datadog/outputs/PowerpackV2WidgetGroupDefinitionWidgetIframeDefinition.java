...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetIframeDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetIframeDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetIframeDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetIframeDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionWidgetIframeDefinitionTime time) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetIframeDefinition", "url");
            }
            this.url = url;
            return this;
        }
        public PowerpackV2WidgetGroupDefinitionWidgetIframeDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetIframeDefinition();
