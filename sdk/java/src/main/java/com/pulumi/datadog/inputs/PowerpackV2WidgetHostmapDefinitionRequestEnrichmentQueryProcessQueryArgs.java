...
public final class PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs Empty = new PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs() {}

    private PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs(PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestEnrichmentQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
