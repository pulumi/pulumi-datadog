...
@CustomType
public final class ObservabilityPipelineConfigSourceSplunkTcpTls {
    /**
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceSplunkTcpTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceSplunkTcpTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceSplunkTcpTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceSplunkTcpTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceSplunkTcpTls();
