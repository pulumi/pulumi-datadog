...
public final class ObservabilityPipelineConfigDestinationRsyslogTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationRsyslogTlsArgs Empty = new ObservabilityPipelineConfigDestinationRsyslogTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationRsyslogTlsArgs() {}

    private ObservabilityPipelineConfigDestinationRsyslogTlsArgs(ObservabilityPipelineConfigDestinationRsyslogTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationRsyslogTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationRsyslogTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationRsyslogTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationRsyslogTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationRsyslogTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationRsyslogTlsArgs", "crtFile");
            }
            return $;
        }
    }
