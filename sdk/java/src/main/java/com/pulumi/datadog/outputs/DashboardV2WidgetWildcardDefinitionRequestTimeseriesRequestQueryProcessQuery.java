...
@CustomType
public final class DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQuery {
    /**
    ...
    private DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQuery() {}
    /**
     * @return The aggregation methods available for metrics queries. Valid values are `avg`, `min`, `max`, `sum`, `last`, `area`, `l2norm`, `percentile`.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String textFilter;
        public Builder() {}
        public Builder(DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQuery", "dataSource");
            }
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQuery();
