...
@CustomType
public final class DashboardWidgetTreemapDefinitionRequestQueryMetricQuery {
    /**
    ...
    public static Builder builder(DashboardWidgetTreemapDefinitionRequestQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(DashboardWidgetTreemapDefinitionRequestQueryMetricQuery defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
        public DashboardWidgetTreemapDefinitionRequestQueryMetricQuery build() {
            final var _resultValue = new DashboardWidgetTreemapDefinitionRequestQueryMetricQuery();
