...
public final class DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs Empty = new DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs() {}

    private DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs(DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
