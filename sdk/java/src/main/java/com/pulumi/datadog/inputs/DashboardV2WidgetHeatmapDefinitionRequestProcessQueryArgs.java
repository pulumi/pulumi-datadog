...
public final class DashboardV2WidgetHeatmapDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHeatmapDefinitionRequestProcessQueryArgs Empty = new DashboardV2WidgetHeatmapDefinitionRequestProcessQueryArgs();
    ...
    private DashboardV2WidgetHeatmapDefinitionRequestProcessQueryArgs() {}

    private DashboardV2WidgetHeatmapDefinitionRequestProcessQueryArgs(DashboardV2WidgetHeatmapDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHeatmapDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHeatmapDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardV2WidgetHeatmapDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardV2WidgetHeatmapDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHeatmapDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHeatmapDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
