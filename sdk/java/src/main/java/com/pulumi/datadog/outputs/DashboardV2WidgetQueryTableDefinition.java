...
import com.pulumi.datadog.outputs.DashboardV2WidgetQueryTableDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardV2WidgetQueryTableDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetQueryTableDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetQueryTableDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardV2WidgetQueryTableDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetQueryTableDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetQueryTableDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetQueryTableDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<DashboardV2WidgetQueryTableDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<DashboardV2WidgetQueryTableDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetQueryTableDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetQueryTableDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetQueryTableDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardV2WidgetQueryTableDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardV2WidgetQueryTableDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<DashboardV2WidgetQueryTableDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetQueryTableDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetQueryTableDefinitionTime time) {
        ...
        public DashboardV2WidgetQueryTableDefinition build() {
            final var _resultValue = new DashboardV2WidgetQueryTableDefinition();
