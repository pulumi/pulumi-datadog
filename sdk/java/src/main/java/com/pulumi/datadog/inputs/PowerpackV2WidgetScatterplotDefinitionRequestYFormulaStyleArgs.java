...
public final class PowerpackV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs(PowerpackV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestYFormulaStyleArgs build() {
            return $;
        }
    }
