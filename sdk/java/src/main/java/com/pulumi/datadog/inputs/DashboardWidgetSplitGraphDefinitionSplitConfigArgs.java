...
public final class DashboardWidgetSplitGraphDefinitionSplitConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DashboardWidgetSplitGraphDefinitionSplitConfigArgs build() {
            $.sort = Objects.requireNonNull($.sort, "expected parameter 'sort' to be non-null");
            $.splitDimensions = Objects.requireNonNull($.splitDimensions, "expected parameter 'splitDimensions' to be non-null");
            return $;
        }
    }
