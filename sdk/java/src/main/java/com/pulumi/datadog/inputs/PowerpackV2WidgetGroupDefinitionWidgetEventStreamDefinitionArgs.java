...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionArgs build() {
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionArgs", "query");
            }
            return $;
        }
    }
