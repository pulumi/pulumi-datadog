...
public final class DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequestQueryMetricQuery {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequestQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequestQueryMetricQuery defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
        public DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequestQueryMetricQuery build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequestQueryMetricQuery();
