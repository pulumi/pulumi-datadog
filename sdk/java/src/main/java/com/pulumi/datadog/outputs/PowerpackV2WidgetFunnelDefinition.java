...
import com.pulumi.datadog.outputs.PowerpackV2WidgetFunnelDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetFunnelDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetFunnelDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetFunnelDefinitionRequest request;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetFunnelDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetFunnelDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetFunnelDefinitionRequest> request() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetFunnelDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetFunnelDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetFunnelDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder request(@Nullable PowerpackV2WidgetFunnelDefinitionRequest request) {

            this.request = request;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetFunnelDefinitionTime time) {
        ...
        public PowerpackV2WidgetFunnelDefinition build() {
            final var _resultValue = new PowerpackV2WidgetFunnelDefinition();
