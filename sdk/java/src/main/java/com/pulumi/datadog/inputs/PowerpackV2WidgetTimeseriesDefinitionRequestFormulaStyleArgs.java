...
public final class PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs Empty = new PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs() {}

    private PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs(PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
