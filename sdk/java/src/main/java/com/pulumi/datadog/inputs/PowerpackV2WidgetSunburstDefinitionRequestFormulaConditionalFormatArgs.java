...
public final class PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs(PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
