...
public final class PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs(PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
