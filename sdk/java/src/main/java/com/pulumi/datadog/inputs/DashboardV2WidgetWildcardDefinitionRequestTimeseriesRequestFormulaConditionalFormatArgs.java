...
public final class DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs Empty = new DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs();
    ...
    private DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs() {}

    private DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs(DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTimeseriesRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
