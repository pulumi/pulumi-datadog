...
public final class ObservabilityPipelineConfigSourceOpentelemetryTls {
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceOpentelemetryTls defaults) {
    ...
    public static final class Builder {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceOpentelemetryTls", "crtFile");
            }
