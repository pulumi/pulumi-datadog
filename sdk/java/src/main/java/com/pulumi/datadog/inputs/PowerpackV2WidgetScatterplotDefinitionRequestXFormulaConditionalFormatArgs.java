...
public final class PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs(PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestXFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
