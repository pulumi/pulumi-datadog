...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetImageDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetImageDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetImageDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetImageDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetImageDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetImageDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String verticalAlign;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetImageDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionWidgetImageDefinitionTime time) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetImageDefinition", "url");
            }
            this.url = url;
            return this;
        }
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetImageDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetImageDefinition();
