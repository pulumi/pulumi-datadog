...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupBy;
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySort;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery {
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupBy> groupBies;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySort sort;
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery() {}
    /**
     * @return Specifies the field for logs pattern clustering. Can only be used with `logsPatternStream`.
     * 
     */
     ...
     * 
     */
    public List<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupBy> groupBies() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySort> sort() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storage;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery", "dataSource");
            }
        ...
        @CustomType.Setter
        public Builder groupBies(@Nullable List<DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupBy> groupBies) {

            this.groupBies = groupBies;
            return this;
        }
        public Builder groupBies(DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQueryGroupBy... groupBies) {
        ...
        @CustomType.Setter
        public Builder sort(@Nullable DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuerySort sort) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetListStreamDefinitionRequestQuery();
