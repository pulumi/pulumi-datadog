...
import com.pulumi.datadog.outputs.DashboardV2WidgetSunburstDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardV2WidgetSunburstDefinitionLegendInline;
import com.pulumi.datadog.outputs.DashboardV2WidgetSunburstDefinitionLegendTable;
import com.pulumi.datadog.outputs.DashboardV2WidgetSunburstDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetSunburstDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetSunburstDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardV2WidgetSunburstDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetSunburstDefinitionLegendInline legendInline;
    /**
     * @return Used to configure the table legend. Cannot be used in conjunction with legend*inline.
     * 
     */
    private @Nullable DashboardV2WidgetSunburstDefinitionLegendTable legendTable;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetSunburstDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetSunburstDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetSunburstDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<DashboardV2WidgetSunburstDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetSunburstDefinitionLegendInline> legendInline() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetSunburstDefinitionLegendTable> legendTable() {
     ...
     * 
     */
    public List<DashboardV2WidgetSunburstDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetSunburstDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetSunburstDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetSunburstDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardV2WidgetSunburstDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardV2WidgetSunburstDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder legendInline(@Nullable DashboardV2WidgetSunburstDefinitionLegendInline legendInline) {

            this.legendInline = legendInline;
            return this;
        }
        @CustomType.Setter
        public Builder legendTable(@Nullable DashboardV2WidgetSunburstDefinitionLegendTable legendTable) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<DashboardV2WidgetSunburstDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetSunburstDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetSunburstDefinitionTime time) {
        ...
        public DashboardV2WidgetSunburstDefinition build() {
            final var _resultValue = new DashboardV2WidgetSunburstDefinition();
