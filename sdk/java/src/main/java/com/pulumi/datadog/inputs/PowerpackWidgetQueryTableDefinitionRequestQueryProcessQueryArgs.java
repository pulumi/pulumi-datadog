...
public final class PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs Empty = new PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs();
    ...
    private PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs() {}

    private PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs(PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryTableDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
