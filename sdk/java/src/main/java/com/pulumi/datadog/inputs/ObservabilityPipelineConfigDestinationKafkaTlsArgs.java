...
public final class ObservabilityPipelineConfigDestinationKafkaTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationKafkaTlsArgs Empty = new ObservabilityPipelineConfigDestinationKafkaTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationKafkaTlsArgs() {}

    private ObservabilityPipelineConfigDestinationKafkaTlsArgs(ObservabilityPipelineConfigDestinationKafkaTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationKafkaTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationKafkaTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationKafkaTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationKafkaTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationKafkaTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationKafkaTlsArgs", "crtFile");
            }
            return $;
        }
    }
