...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLink {
    /**
    ...
    private DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLink defaults) {
        ...
        public DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLink build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetServicemapDefinitionCustomLink();
