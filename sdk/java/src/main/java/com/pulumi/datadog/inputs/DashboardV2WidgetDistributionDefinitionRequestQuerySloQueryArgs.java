...
public final class DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs Empty = new DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs();
    ...
    private DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs() {}

    private DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs(DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetDistributionDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
