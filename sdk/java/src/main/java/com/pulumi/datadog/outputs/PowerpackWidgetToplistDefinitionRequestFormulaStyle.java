...
@CustomType
public final class PowerpackWidgetToplistDefinitionRequestFormulaStyle {
    /**
    ...
    public static Builder builder(PowerpackWidgetToplistDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackWidgetToplistDefinitionRequestFormulaStyle defaults) {
        ...
        public PowerpackWidgetToplistDefinitionRequestFormulaStyle build() {
            final var _resultValue = new PowerpackWidgetToplistDefinitionRequestFormulaStyle();
