...
@CustomType
public final class ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuth {
    /**
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuth defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionName;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuth defaults) {
        ...
        public ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuth build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesAmazonDataFirehoseAuth();
