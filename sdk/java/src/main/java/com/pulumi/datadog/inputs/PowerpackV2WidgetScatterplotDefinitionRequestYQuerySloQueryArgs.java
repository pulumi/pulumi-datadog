...
public final class PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs(PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
