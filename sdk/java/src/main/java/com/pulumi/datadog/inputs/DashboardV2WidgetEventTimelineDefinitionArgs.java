...
import com.pulumi.datadog.inputs.DashboardV2WidgetEventTimelineDefinitionTimeArgs;
...
public final class DashboardV2WidgetEventTimelineDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetEventTimelineDefinitionArgs Empty = new DashboardV2WidgetEventTimelineDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetEventTimelineDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetEventTimelineDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetEventTimelineDefinitionArgs() {}

    private DashboardV2WidgetEventTimelineDefinitionArgs(DashboardV2WidgetEventTimelineDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetEventTimelineDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetEventTimelineDefinitionArgs();
        }

        public Builder(DashboardV2WidgetEventTimelineDefinitionArgs defaults) {
            $ = new DashboardV2WidgetEventTimelineDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetEventTimelineDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetEventTimelineDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetEventTimelineDefinitionArgs build() {
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetEventTimelineDefinitionArgs", "query");
            }
            return $;
        }
    }
