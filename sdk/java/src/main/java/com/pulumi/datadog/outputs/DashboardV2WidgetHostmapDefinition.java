...
import com.pulumi.datadog.outputs.DashboardV2WidgetHostmapDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardV2WidgetHostmapDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetHostmapDefinitionStyle;
import com.pulumi.datadog.outputs.DashboardV2WidgetHostmapDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetHostmapDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardV2WidgetHostmapDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetHostmapDefinitionStyle style;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetHostmapDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetHostmapDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<DashboardV2WidgetHostmapDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetHostmapDefinitionStyle> style() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetHostmapDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetHostmapDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardV2WidgetHostmapDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardV2WidgetHostmapDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder request(@Nullable DashboardV2WidgetHostmapDefinitionRequest request) {
        ...
        @CustomType.Setter
        public Builder style(@Nullable DashboardV2WidgetHostmapDefinitionStyle style) {

            this.style = style;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetHostmapDefinitionTime time) {
        ...
        public DashboardV2WidgetHostmapDefinition build() {
            final var _resultValue = new DashboardV2WidgetHostmapDefinition();
