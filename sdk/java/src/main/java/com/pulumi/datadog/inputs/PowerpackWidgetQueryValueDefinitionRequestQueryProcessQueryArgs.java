...
public final class PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs Empty = new PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs();
    ...
    private PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs() {}

    private PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs(PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetQueryValueDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
