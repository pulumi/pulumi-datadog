...
import com.pulumi.datadog.outputs.DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionLegendInline;
import com.pulumi.datadog.outputs.DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionLegendTable;
import com.pulumi.datadog.outputs.DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionRequest;
...
public final class DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinition {
     ...
     * 
     */
    private @Nullable DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionLegendInline legendInline;
    /**
     * @return Used to configure the table legend. Cannot be used in conjunction with legend*inline.
     * 
     */
    private @Nullable DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionLegendTable legendTable;
    /**
     ...
     * 
     */
    public Optional<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionLegendInline> legendInline() {
     ...
     * 
     */
    public Optional<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionLegendTable> legendTable() {
    ...
    public static Builder builder(DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder legendInline(@Nullable DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionLegendInline legendInline) {

            this.legendInline = legendInline;
            return this;
        }
        @CustomType.Setter
        public Builder legendTable(@Nullable DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionLegendTable legendTable) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinitionRequest... requests) {
        ...
        public DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinition build() {
            final var _resultValue = new DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinition();
