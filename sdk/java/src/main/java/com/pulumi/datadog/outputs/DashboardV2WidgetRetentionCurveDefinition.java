...
import com.pulumi.datadog.outputs.DashboardV2WidgetRetentionCurveDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetRetentionCurveDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetRetentionCurveDefinition {
    /**
     ...
     * 
     */
    private List<DashboardV2WidgetRetentionCurveDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetRetentionCurveDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetRetentionCurveDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<DashboardV2WidgetRetentionCurveDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetRetentionCurveDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetRetentionCurveDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetRetentionCurveDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder requests(List<DashboardV2WidgetRetentionCurveDefinitionRequest> requests) {
            if (requests == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetRetentionCurveDefinition", "requests");
            }
            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetRetentionCurveDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetRetentionCurveDefinitionTime time) {
        ...
        public DashboardV2WidgetRetentionCurveDefinition build() {
            final var _resultValue = new DashboardV2WidgetRetentionCurveDefinition();
