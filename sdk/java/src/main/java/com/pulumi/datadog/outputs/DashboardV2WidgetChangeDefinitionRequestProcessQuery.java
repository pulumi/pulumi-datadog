...
@CustomType
public final class DashboardV2WidgetChangeDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardV2WidgetChangeDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetChangeDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetChangeDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetChangeDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetChangeDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetChangeDefinitionRequestProcessQuery();
