...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionEventArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionMarkerArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRightYaxisArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionTimeArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="events")
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionEventArgs>> events;

    /**
     * @return The definition of the event to overlay on the graph. Multiple `event` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionEventArgs>>> events() {
     ...
     */
    @Import(name="markers")
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionMarkerArgs>> markers;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionMarkerArgs>>> markers() {
    ...
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestArgs>>> requests() {
    ...
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRightYaxisArgs> rightYaxis;
     ...
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRightYaxisArgs>> rightYaxis() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="yaxis")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisArgs> yaxis;

    /**
     * @return A nested block describing the Y-Axis Controls. The structure of this block is described below.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisArgs>> yaxis() {
        return Optional.ofNullable(this.yaxis);
    }

    private DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder events(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionEventArgs>> events) {
            $.events = events;
            return this;
        }
         ...
         * 
         */
        public Builder events(List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionEventArgs> events) {
         ...
         * 
         */
        public Builder events(DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionEventArgs... events) {
         ...
         * 
         */
        public Builder markers(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionMarkerArgs>> markers) {
            $.markers = markers;
            return this;
        }
         ...
         * 
         */
        public Builder markers(List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionMarkerArgs> markers) {
         ...
         * 
         */
        public Builder markers(DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionMarkerArgs... markers) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder rightYaxis(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRightYaxisArgs> rightYaxis) {
         ...
         * 
         */
        public Builder rightYaxis(DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionRightYaxisArgs rightYaxis) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder yaxis(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisArgs> yaxis) {
            $.yaxis = yaxis;
            return this;
        }
         ...
         * 
         */
        public Builder yaxis(DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisArgs yaxis) {
            return yaxis(Output.of(yaxis));
        }

        public DashboardV2WidgetGroupDefinitionWidgetTimeseriesDefinitionArgs build() {
            return $;
        }
    }
