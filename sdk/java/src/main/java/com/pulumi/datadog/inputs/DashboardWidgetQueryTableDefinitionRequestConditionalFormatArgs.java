...
public final class DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs Empty = new DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs();
    ...
    private DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs() {}

    private DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs(DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs();
        }

        public Builder(DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs defaults) {
            $ = new DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
