...
import com.pulumi.datadog.inputs.DashboardV2WidgetImageDefinitionTimeArgs;
...
public final class DashboardV2WidgetImageDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetImageDefinitionArgs Empty = new DashboardV2WidgetImageDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetImageDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetImageDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetImageDefinitionArgs() {}

    private DashboardV2WidgetImageDefinitionArgs(DashboardV2WidgetImageDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetImageDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetImageDefinitionArgs();
        }

        public Builder(DashboardV2WidgetImageDefinitionArgs defaults) {
            $ = new DashboardV2WidgetImageDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetImageDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetImageDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetImageDefinitionArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetImageDefinitionArgs", "url");
            }
            return $;
        }
    }
