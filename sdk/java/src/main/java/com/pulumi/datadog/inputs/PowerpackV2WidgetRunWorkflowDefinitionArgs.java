...
import com.pulumi.datadog.inputs.PowerpackV2WidgetRunWorkflowDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetRunWorkflowDefinitionInputArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetRunWorkflowDefinitionTimeArgs;
...
public final class PowerpackV2WidgetRunWorkflowDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetRunWorkflowDefinitionArgs Empty = new PowerpackV2WidgetRunWorkflowDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetRunWorkflowDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetRunWorkflowDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="inputs")
    private @Nullable Output<List<PowerpackV2WidgetRunWorkflowDefinitionInputArgs>> inputs;

    /**
     * @return Array of workflow inputs to map to dashboard template variables.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetRunWorkflowDefinitionInputArgs>>> inputs() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetRunWorkflowDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetRunWorkflowDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetRunWorkflowDefinitionArgs() {}

    private PowerpackV2WidgetRunWorkflowDefinitionArgs(PowerpackV2WidgetRunWorkflowDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetRunWorkflowDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetRunWorkflowDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetRunWorkflowDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetRunWorkflowDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetRunWorkflowDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetRunWorkflowDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetRunWorkflowDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder inputs(@Nullable Output<List<PowerpackV2WidgetRunWorkflowDefinitionInputArgs>> inputs) {
            $.inputs = inputs;
            return this;
        }
         ...
         * 
         */
        public Builder inputs(List<PowerpackV2WidgetRunWorkflowDefinitionInputArgs> inputs) {
         ...
         * 
         */
        public Builder inputs(PowerpackV2WidgetRunWorkflowDefinitionInputArgs... inputs) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetRunWorkflowDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetRunWorkflowDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetRunWorkflowDefinitionArgs build() {
            if ($.workflowId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetRunWorkflowDefinitionArgs", "workflowId");
            }
            return $;
        }
    }
