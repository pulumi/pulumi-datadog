...
@CustomType
public final class DashboardWidgetTreemapDefinitionRequestQueryCloudCostQuery {
    /**
    ...
    public static Builder builder(DashboardWidgetTreemapDefinitionRequestQueryCloudCostQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(DashboardWidgetTreemapDefinitionRequestQueryCloudCostQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQueryCloudCostQuery", "dataSource");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQueryCloudCostQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQueryCloudCostQuery", "query");
            }
            this.query = query;
            return this;
        }
        public DashboardWidgetTreemapDefinitionRequestQueryCloudCostQuery build() {
            final var _resultValue = new DashboardWidgetTreemapDefinitionRequestQueryCloudCostQuery();
