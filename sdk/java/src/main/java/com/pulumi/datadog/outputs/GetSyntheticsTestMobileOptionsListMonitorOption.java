...
@CustomType
public final class GetSyntheticsTestMobileOptionsListMonitorOption {
    /**
    ...
    private GetSyntheticsTestMobileOptionsListMonitorOption() {}
    /**
     * @return A message to include with a re-notification.
     * 
     */
    ...
    public static Builder builder(GetSyntheticsTestMobileOptionsListMonitorOption defaults) {
    ...
    public static final class Builder {
        ...
        private Integer renotifyOccurrences;
        public Builder() {}
        public Builder(GetSyntheticsTestMobileOptionsListMonitorOption defaults) {
        ...
        public Builder escalationMessage(String escalationMessage) {
            if (escalationMessage == null) {
              throw new MissingRequiredPropertyException("GetSyntheticsTestMobileOptionsListMonitorOption", "escalationMessage");
            }
        ...
        public Builder notificationPresetName(String notificationPresetName) {
            if (notificationPresetName == null) {
              throw new MissingRequiredPropertyException("GetSyntheticsTestMobileOptionsListMonitorOption", "notificationPresetName");
            }
        ...
        public Builder renotifyInterval(Integer renotifyInterval) {
            if (renotifyInterval == null) {
              throw new MissingRequiredPropertyException("GetSyntheticsTestMobileOptionsListMonitorOption", "renotifyInterval");
            }
        ...
        public Builder renotifyOccurrences(Integer renotifyOccurrences) {
            if (renotifyOccurrences == null) {
              throw new MissingRequiredPropertyException("GetSyntheticsTestMobileOptionsListMonitorOption", "renotifyOccurrences");
            }
            this.renotifyOccurrences = renotifyOccurrences;
            return this;
        }
        public GetSyntheticsTestMobileOptionsListMonitorOption build() {
            final var _resultValue = new GetSyntheticsTestMobileOptionsListMonitorOption();
