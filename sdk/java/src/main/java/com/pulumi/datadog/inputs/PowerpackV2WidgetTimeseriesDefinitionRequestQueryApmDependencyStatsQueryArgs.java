...
public final class PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs Empty = new PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs();
    ...
    private PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs() {}

    private PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs(PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs();
        }

        public Builder(PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
