...
@CustomType
public final class DashboardV2WidgetHostmapDefinitionStyle {
    /**
    ...
    private DashboardV2WidgetHostmapDefinitionStyle() {}
    /**
     * @return The max value to use to color the map.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean paletteFlip;
        public Builder() {}
        public Builder(DashboardV2WidgetHostmapDefinitionStyle defaults) {
        ...
        public DashboardV2WidgetHostmapDefinitionStyle build() {
            final var _resultValue = new DashboardV2WidgetHostmapDefinitionStyle();
