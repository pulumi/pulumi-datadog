...
public final class DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs Empty = new DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs();
    ...
    private DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs() {}

    private DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs(DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetTreemapDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
