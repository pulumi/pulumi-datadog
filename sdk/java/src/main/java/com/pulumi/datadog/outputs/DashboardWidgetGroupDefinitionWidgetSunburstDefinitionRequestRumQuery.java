...
public final class DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestRumQuery {
    ...
    public static final class Builder {
        ...
        public Builder index(String index) {
            if (index == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestRumQuery", "index");
            }
            this.index = index;
            return this;
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestRumQuery build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestRumQuery();
