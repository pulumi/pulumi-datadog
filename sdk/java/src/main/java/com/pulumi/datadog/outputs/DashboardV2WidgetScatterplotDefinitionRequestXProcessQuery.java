...
@CustomType
public final class DashboardV2WidgetScatterplotDefinitionRequestXProcessQuery {
    /**
    ...
    private DashboardV2WidgetScatterplotDefinitionRequestXProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinitionRequestXProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardV2WidgetScatterplotDefinitionRequestXProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardV2WidgetScatterplotDefinitionRequestXProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetScatterplotDefinitionRequestXProcessQuery();
