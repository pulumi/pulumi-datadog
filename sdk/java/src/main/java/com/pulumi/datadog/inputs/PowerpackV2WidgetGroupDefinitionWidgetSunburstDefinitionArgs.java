...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendInlineArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendTableArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendInlineArgs> legendInline;

    /**
     * @return Used to configure the inline legend. Cannot be used in conjunction with legend*table.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendInlineArgs>> legendInline() {
    ...
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendTableArgs> legendTable;

    /**
     * @return Used to configure the table legend. Cannot be used in conjunction with legend*inline.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendTableArgs>> legendTable() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder legendInline(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendInlineArgs> legendInline) {
         ...
         * 
         */
        public Builder legendInline(PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendInlineArgs legendInline) {
         ...
         * 
         */
        public Builder legendTable(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendTableArgs> legendTable) {
         ...
         * 
         */
        public Builder legendTable(PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionLegendTableArgs legendTable) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetSunburstDefinitionArgs build() {
            return $;
        }
    }
