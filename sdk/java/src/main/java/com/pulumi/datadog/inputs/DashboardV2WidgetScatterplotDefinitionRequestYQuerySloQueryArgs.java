...
public final class DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs Empty = new DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs();
    ...
    private DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs() {}

    private DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs(DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs();
        }

        public Builder(DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs defaults) {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestYQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
