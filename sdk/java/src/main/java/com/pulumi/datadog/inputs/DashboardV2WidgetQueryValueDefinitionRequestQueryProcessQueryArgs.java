...
public final class DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs Empty = new DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs();
    ...
    private DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs() {}

    private DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs(DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryValueDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
