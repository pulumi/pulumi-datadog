...
import com.pulumi.datadog.outputs.DashboardV2WidgetTreemapDefinitionRequestQueryApmMetricsQuery;
...
import com.pulumi.datadog.outputs.DashboardV2WidgetTreemapDefinitionRequestQueryProductAnalyticsExtendedQuery;
import com.pulumi.datadog.outputs.DashboardV2WidgetTreemapDefinitionRequestQueryRetentionQuery;
import com.pulumi.datadog.outputs.DashboardV2WidgetTreemapDefinitionRequestQuerySloQuery;
import com.pulumi.datadog.outputs.DashboardV2WidgetTreemapDefinitionRequestQueryUserJourneyQuery;
...
public final class DashboardV2WidgetTreemapDefinitionRequestQuery {
     ...
     * 
     */
    private @Nullable DashboardV2WidgetTreemapDefinitionRequestQueryApmMetricsQuery apmMetricsQuery;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetTreemapDefinitionRequestQueryProductAnalyticsExtendedQuery productAnalyticsExtendedQuery;
    /**
     * @return The retention query using formulas and functions.
     * 
     */
    private @Nullable DashboardV2WidgetTreemapDefinitionRequestQueryRetentionQuery retentionQuery;
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetTreemapDefinitionRequestQueryUserJourneyQuery userJourneyQuery;
     ...
     * 
     */
    public Optional<DashboardV2WidgetTreemapDefinitionRequestQueryApmMetricsQuery> apmMetricsQuery() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetTreemapDefinitionRequestQueryProductAnalyticsExtendedQuery> productAnalyticsExtendedQuery() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetTreemapDefinitionRequestQueryRetentionQuery> retentionQuery() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetTreemapDefinitionRequestQueryUserJourneyQuery> userJourneyQuery() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder apmMetricsQuery(@Nullable DashboardV2WidgetTreemapDefinitionRequestQueryApmMetricsQuery apmMetricsQuery) {
        ...
        @CustomType.Setter
        public Builder productAnalyticsExtendedQuery(@Nullable DashboardV2WidgetTreemapDefinitionRequestQueryProductAnalyticsExtendedQuery productAnalyticsExtendedQuery) {

            this.productAnalyticsExtendedQuery = productAnalyticsExtendedQuery;
            return this;
        }
        @CustomType.Setter
        public Builder retentionQuery(@Nullable DashboardV2WidgetTreemapDefinitionRequestQueryRetentionQuery retentionQuery) {
        ...
        @CustomType.Setter
        public Builder userJourneyQuery(@Nullable DashboardV2WidgetTreemapDefinitionRequestQueryUserJourneyQuery userJourneyQuery) {
