...
public final class DashboardV2WidgetToplistDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetToplistDefinitionRequestProcessQueryArgs Empty = new DashboardV2WidgetToplistDefinitionRequestProcessQueryArgs();
    ...
    private DashboardV2WidgetToplistDefinitionRequestProcessQueryArgs() {}

    private DashboardV2WidgetToplistDefinitionRequestProcessQueryArgs(DashboardV2WidgetToplistDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetToplistDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetToplistDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardV2WidgetToplistDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardV2WidgetToplistDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetToplistDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
