...
public final class PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs Empty = new PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs();
    ...
    private PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs() {}

    private PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs(PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs();
        }

        public Builder(PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs defaults) {
            $ = new PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs", "name");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetDistributionDefinitionRequestHistogramQueryApmResourceStatsQueryArgs", "stat");
            }
            return $;
        }
    }
