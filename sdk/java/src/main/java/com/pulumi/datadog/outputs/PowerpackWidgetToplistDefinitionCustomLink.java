...
@CustomType
public final class PowerpackWidgetToplistDefinitionCustomLink {
    /**
    ...
    private PowerpackWidgetToplistDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetToplistDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(PowerpackWidgetToplistDefinitionCustomLink defaults) {
        ...
        public PowerpackWidgetToplistDefinitionCustomLink build() {
            final var _resultValue = new PowerpackWidgetToplistDefinitionCustomLink();
