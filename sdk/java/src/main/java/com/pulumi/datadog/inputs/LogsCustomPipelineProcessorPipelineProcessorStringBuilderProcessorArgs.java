...
public final class LogsCustomPipelineProcessorPipelineProcessorStringBuilderProcessorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private LogsCustomPipelineProcessorPipelineProcessorStringBuilderProcessorArgs() {}

    private LogsCustomPipelineProcessorPipelineProcessorStringBuilderProcessorArgs(LogsCustomPipelineProcessorPipelineProcessorStringBuilderProcessorArgs $) {
    ...
    public static Builder builder(LogsCustomPipelineProcessorPipelineProcessorStringBuilderProcessorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LogsCustomPipelineProcessorPipelineProcessorStringBuilderProcessorArgs();
        }

        public Builder(LogsCustomPipelineProcessorPipelineProcessorStringBuilderProcessorArgs defaults) {
        ...
        public LogsCustomPipelineProcessorPipelineProcessorStringBuilderProcessorArgs build() {
            if ($.target == null) {
                throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorStringBuilderProcessorArgs", "target");
            }
            if ($.template == null) {
                throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorStringBuilderProcessorArgs", "template");
            }
            return $;
        }
    }
