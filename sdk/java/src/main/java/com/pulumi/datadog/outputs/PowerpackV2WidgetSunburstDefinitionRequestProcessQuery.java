...
@CustomType
public final class PowerpackV2WidgetSunburstDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackV2WidgetSunburstDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetSunburstDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetSunburstDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetSunburstDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetSunburstDefinitionRequestProcessQuery();
