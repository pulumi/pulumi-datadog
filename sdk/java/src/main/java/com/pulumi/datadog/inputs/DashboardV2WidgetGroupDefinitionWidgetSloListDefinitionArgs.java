...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionArgs();
    ...
    private Output<List<DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionRequestArgs>> requests;

    /**
     * @return A nested block describing the request to use when displaying the widget. Exactly one `request` block is allowed.
     * 
     */
    public Output<List<DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param requests A nested block describing the request to use when displaying the widget. Exactly one `request` block is allowed.
         * 
         * @return builder
         * 
         */
        public Builder requests(Output<List<DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetSloListDefinitionArgs", "requests");
            }
            return $;
        }
    }
