...
import com.pulumi.datadog.inputs.PowerpackV2WidgetTopologyMapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetTopologyMapDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetTopologyMapDefinitionTimeArgs;
...
public final class PowerpackV2WidgetTopologyMapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTopologyMapDefinitionArgs Empty = new PowerpackV2WidgetTopologyMapDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetTopologyMapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetTopologyMapDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetTopologyMapDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetTopologyMapDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetTopologyMapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetTopologyMapDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetTopologyMapDefinitionArgs() {}

    private PowerpackV2WidgetTopologyMapDefinitionArgs(PowerpackV2WidgetTopologyMapDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTopologyMapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTopologyMapDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetTopologyMapDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetTopologyMapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetTopologyMapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetTopologyMapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetTopologyMapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetTopologyMapDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetTopologyMapDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetTopologyMapDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetTopologyMapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetTopologyMapDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetTopologyMapDefinitionArgs build() {
            return $;
        }
    }
