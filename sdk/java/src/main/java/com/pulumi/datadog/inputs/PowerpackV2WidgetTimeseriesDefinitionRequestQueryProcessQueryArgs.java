...
public final class PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs Empty = new PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs();
    ...
    private PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs() {}

    private PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs(PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTimeseriesDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
