...
public final class ObservabilityPipelineConfigSourcesFluentdTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcesFluentdTlsArgs Empty = new ObservabilityPipelineConfigSourcesFluentdTlsArgs();
    ...
    private ObservabilityPipelineConfigSourcesFluentdTlsArgs() {}

    private ObservabilityPipelineConfigSourcesFluentdTlsArgs(ObservabilityPipelineConfigSourcesFluentdTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesFluentdTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcesFluentdTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcesFluentdTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcesFluentdTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcesFluentdTlsArgs build() {
            return $;
        }
    }
