...
public final class PowerpackWidgetDistributionDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetDistributionDefinitionRequestProcessQueryArgs Empty = new PowerpackWidgetDistributionDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackWidgetDistributionDefinitionRequestProcessQueryArgs() {}

    private PowerpackWidgetDistributionDefinitionRequestProcessQueryArgs(PowerpackWidgetDistributionDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetDistributionDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetDistributionDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackWidgetDistributionDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackWidgetDistributionDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetDistributionDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetDistributionDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
