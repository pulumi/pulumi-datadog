...
public final class DashboardWidgetGeomapDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGeomapDefinitionRequestFormulaStyleArgs Empty = new DashboardWidgetGeomapDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardWidgetGeomapDefinitionRequestFormulaStyleArgs() {}

    private DashboardWidgetGeomapDefinitionRequestFormulaStyleArgs(DashboardWidgetGeomapDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardWidgetGeomapDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGeomapDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardWidgetGeomapDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardWidgetGeomapDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGeomapDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
