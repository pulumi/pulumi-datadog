...
public final class PowerpackV2WidgetQueryTableDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryTableDefinitionRequestFormulaStyleArgs Empty = new PowerpackV2WidgetQueryTableDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackV2WidgetQueryTableDefinitionRequestFormulaStyleArgs() {}

    private PowerpackV2WidgetQueryTableDefinitionRequestFormulaStyleArgs(PowerpackV2WidgetQueryTableDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryTableDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetQueryTableDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryTableDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
