...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetImageDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetImageDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetImageDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetImageDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetImageDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetImageDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetImageDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetImageDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetImageDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetImageDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetImageDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetImageDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetImageDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetImageDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetImageDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetImageDefinitionArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetImageDefinitionArgs", "url");
            }
            return $;
        }
    }
