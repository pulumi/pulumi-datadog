...
public final class PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs Empty = new PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs(PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTreemapDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
