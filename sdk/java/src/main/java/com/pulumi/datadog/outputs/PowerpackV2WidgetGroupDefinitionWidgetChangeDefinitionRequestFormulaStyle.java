...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestFormulaStyle {
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestFormulaStyle defaults) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestFormulaStyle build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetChangeDefinitionRequestFormulaStyle();
