...
@CustomType
public final class PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormat {
    /**
    ...
    private PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormat() {}
    /**
     * @return The comparator to use. Valid values are `=`, `&gt;`, `&gt;=`, `&lt;`, `&lt;=`.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormat defaults) {
    ...
    public static final class Builder {
        ...
        private Double value;
        public Builder() {}
        public Builder(PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormat defaults) {
        ...
        public Builder comparator(String comparator) {
            if (comparator == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormat", "comparator");
            }
        ...
        public Builder palette(String palette) {
            if (palette == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormat", "palette");
            }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormat", "value");
            }
            this.value = value;
            return this;
        }
        public PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormat build() {
            final var _resultValue = new PowerpackV2WidgetQueryValueDefinitionRequestConditionalFormat();
