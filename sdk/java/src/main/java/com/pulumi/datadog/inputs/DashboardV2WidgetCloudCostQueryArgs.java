...
public final class DashboardV2WidgetCloudCostQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetCloudCostQueryArgs Empty = new DashboardV2WidgetCloudCostQueryArgs();
    ...
    private DashboardV2WidgetCloudCostQueryArgs() {}

    private DashboardV2WidgetCloudCostQueryArgs(DashboardV2WidgetCloudCostQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetCloudCostQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetCloudCostQueryArgs();
        }

        public Builder(DashboardV2WidgetCloudCostQueryArgs defaults) {
            $ = new DashboardV2WidgetCloudCostQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetCloudCostQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetCloudCostQueryArgs", "dataSource");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetCloudCostQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetCloudCostQueryArgs", "query");
            }
            return $;
        }
    }
