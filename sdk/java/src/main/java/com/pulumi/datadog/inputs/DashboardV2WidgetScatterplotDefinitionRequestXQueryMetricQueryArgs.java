...
public final class DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs Empty = new DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs() {}

    private DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs(DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestXQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
