...
public final class PowerpackWidgetGeomapDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetGeomapDefinitionRequestFormulaStyleArgs Empty = new PowerpackWidgetGeomapDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackWidgetGeomapDefinitionRequestFormulaStyleArgs() {}

    private PowerpackWidgetGeomapDefinitionRequestFormulaStyleArgs(PowerpackWidgetGeomapDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackWidgetGeomapDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetGeomapDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackWidgetGeomapDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackWidgetGeomapDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetGeomapDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
