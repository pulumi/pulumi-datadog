...
import com.pulumi.datadog.inputs.DashboardV2WidgetQueryValueDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetQueryValueDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetQueryValueDefinitionTimeArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetQueryValueDefinitionTimeseriesBackgroundArgs;
...
public final class DashboardV2WidgetQueryValueDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetQueryValueDefinitionArgs Empty = new DashboardV2WidgetQueryValueDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetQueryValueDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetQueryValueDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<DashboardV2WidgetQueryValueDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetQueryValueDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetQueryValueDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetQueryValueDefinitionTimeArgs>> time() {
    ...
    private @Nullable Output<DashboardV2WidgetQueryValueDefinitionTimeseriesBackgroundArgs> timeseriesBackground;

    /**
     * @return Set a timeseries on the widget background.
     * 
     */
    public Optional<Output<DashboardV2WidgetQueryValueDefinitionTimeseriesBackgroundArgs>> timeseriesBackground() {
    ...
    private DashboardV2WidgetQueryValueDefinitionArgs() {}

    private DashboardV2WidgetQueryValueDefinitionArgs(DashboardV2WidgetQueryValueDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetQueryValueDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetQueryValueDefinitionArgs();
        }

        public Builder(DashboardV2WidgetQueryValueDefinitionArgs defaults) {
            $ = new DashboardV2WidgetQueryValueDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetQueryValueDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetQueryValueDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetQueryValueDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetQueryValueDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetQueryValueDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetQueryValueDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetQueryValueDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetQueryValueDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder timeseriesBackground(@Nullable Output<DashboardV2WidgetQueryValueDefinitionTimeseriesBackgroundArgs> timeseriesBackground) {
         ...
         * 
         */
        public Builder timeseriesBackground(DashboardV2WidgetQueryValueDefinitionTimeseriesBackgroundArgs timeseriesBackground) {
        ...
        public DashboardV2WidgetQueryValueDefinitionArgs build() {
            return $;
        }
    }
