...
public final class AppBuilderAppState extends com.pulumi.resources.ResourceArgs {

    public static final AppBuilderAppState Empty = new AppBuilderAppState();
     ...
     */
    @Import(name="appJson")
    private @Nullable Output<String> appJson;

    /**
     * @return The JSON representation of the App. String length must be at least 1.
     * 
     */
    public Optional<Output<String>> appJson() {
        return Optional.ofNullable(this.appJson);
    }
    ...
    private AppBuilderAppState() {}

    private AppBuilderAppState(AppBuilderAppState $) {
    ...
    public static Builder builder(AppBuilderAppState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppBuilderAppState();
        }

        public Builder(AppBuilderAppState defaults) {
            $ = new AppBuilderAppState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder appJson(@Nullable Output<String> appJson) {
            $.appJson = appJson;
            return this;
        }
        ...
        public AppBuilderAppState build() {
            return $;
        }
    }
