...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinition() {}
    /**
     * @return Name of the check to use in the widget.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinition defaults) {
        ...
        public Builder check(String check) {
            if (check == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinition", "check");
            }
            this.check = check;
            return this;
        }
        ...
        public Builder grouping(String grouping) {
            if (grouping == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinition", "grouping");
            }
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinitionTime time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetCheckStatusDefinition();
