...
import com.pulumi.datadog.inputs.PowerpackV2WidgetIframeDefinitionTimeArgs;
...
public final class PowerpackV2WidgetIframeDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetIframeDefinitionArgs Empty = new PowerpackV2WidgetIframeDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetIframeDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetIframeDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetIframeDefinitionArgs() {}

    private PowerpackV2WidgetIframeDefinitionArgs(PowerpackV2WidgetIframeDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetIframeDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetIframeDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetIframeDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetIframeDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetIframeDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetIframeDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetIframeDefinitionArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetIframeDefinitionArgs", "url");
            }
            return $;
        }
    }
