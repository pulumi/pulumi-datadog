...
public final class PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs Empty = new PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs();
    ...
    private PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs() {}

    private PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs(PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs();
        }

        public Builder(PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
            $ = new PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetSunburstDefinitionRequestQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
