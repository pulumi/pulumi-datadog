...
@CustomType
public final class DashboardWidgetHeatmapDefinitionRequestProcessQuery {
    /**
    ...
    private DashboardWidgetHeatmapDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetHeatmapDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetHeatmapDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardWidgetHeatmapDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardWidgetHeatmapDefinitionRequestProcessQuery();
