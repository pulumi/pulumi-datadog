...
@CustomType
public final class PowerpackWidgetWidgetLayout {
    /**
    ...
    public static Builder builder(PowerpackWidgetWidgetLayout defaults) {
    ...
    public static final class Builder {
        ...
        private Integer y;
        public Builder() {}
        public Builder(PowerpackWidgetWidgetLayout defaults) {
        ...
        public Builder height(Integer height) {
            if (height == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetWidgetLayout", "height");
            }
            this.height = height;
            return this;
        }
        ...
        public Builder width(Integer width) {
            if (width == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetWidgetLayout", "width");
            }
            this.width = width;
            return this;
        }
        ...
        public Builder x(Integer x) {
            if (x == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetWidgetLayout", "x");
            }
            this.x = x;
            return this;
        }
        ...
        public Builder y(Integer y) {
            if (y == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetWidgetLayout", "y");
            }
            this.y = y;
            return this;
        }
        public PowerpackWidgetWidgetLayout build() {
            final var _resultValue = new PowerpackWidgetWidgetLayout();
