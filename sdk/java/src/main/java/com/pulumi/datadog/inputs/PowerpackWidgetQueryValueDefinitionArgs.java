...
import com.pulumi.datadog.inputs.PowerpackWidgetQueryValueDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackWidgetQueryValueDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackWidgetQueryValueDefinitionTimeseriesBackgroundArgs;
...
public final class PowerpackWidgetQueryValueDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetQueryValueDefinitionArgs Empty = new PowerpackWidgetQueryValueDefinitionArgs();
    ...
    private @Nullable Output<PowerpackWidgetQueryValueDefinitionTimeseriesBackgroundArgs> timeseriesBackground;

    /**
     * @return Set a timeseries on the widget background.
     * 
     */
    public Optional<Output<PowerpackWidgetQueryValueDefinitionTimeseriesBackgroundArgs>> timeseriesBackground() {
    ...
    private PowerpackWidgetQueryValueDefinitionArgs() {}

    private PowerpackWidgetQueryValueDefinitionArgs(PowerpackWidgetQueryValueDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackWidgetQueryValueDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetQueryValueDefinitionArgs();
        }

        public Builder(PowerpackWidgetQueryValueDefinitionArgs defaults) {
            $ = new PowerpackWidgetQueryValueDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackWidgetQueryValueDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackWidgetQueryValueDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackWidgetQueryValueDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackWidgetQueryValueDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackWidgetQueryValueDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackWidgetQueryValueDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder timeseriesBackground(@Nullable Output<PowerpackWidgetQueryValueDefinitionTimeseriesBackgroundArgs> timeseriesBackground) {
         ...
         * 
         */
        public Builder timeseriesBackground(PowerpackWidgetQueryValueDefinitionTimeseriesBackgroundArgs timeseriesBackground) {
        ...
        public PowerpackWidgetQueryValueDefinitionArgs build() {
            return $;
        }
    }
