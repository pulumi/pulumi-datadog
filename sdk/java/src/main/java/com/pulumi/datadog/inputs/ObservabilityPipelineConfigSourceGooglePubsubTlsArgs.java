...
public final class ObservabilityPipelineConfigSourceGooglePubsubTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceGooglePubsubTlsArgs Empty = new ObservabilityPipelineConfigSourceGooglePubsubTlsArgs();
    ...
    private ObservabilityPipelineConfigSourceGooglePubsubTlsArgs() {}

    private ObservabilityPipelineConfigSourceGooglePubsubTlsArgs(ObservabilityPipelineConfigSourceGooglePubsubTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceGooglePubsubTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceGooglePubsubTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceGooglePubsubTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceGooglePubsubTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceGooglePubsubTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceGooglePubsubTlsArgs", "crtFile");
            }
            return $;
        }
    }
