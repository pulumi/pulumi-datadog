...
@CustomType
public final class DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormat {
    /**
    ...
    private DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormat() {}
    /**
     * @return The comparator to use. Valid values are `=`, `&gt;`, `&gt;=`, `&lt;`, `&lt;=`.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormat defaults) {
    ...
    public static final class Builder {
        ...
        private Double value;
        public Builder() {}
        public Builder(DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormat defaults) {
        ...
        public Builder comparator(String comparator) {
            if (comparator == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormat", "comparator");
            }
        ...
        public Builder palette(String palette) {
            if (palette == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormat", "palette");
            }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormat", "value");
            }
            this.value = value;
            return this;
        }
        public DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormat build() {
            final var _resultValue = new DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormat();
