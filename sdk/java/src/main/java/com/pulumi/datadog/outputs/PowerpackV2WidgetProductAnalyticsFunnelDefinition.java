...
import com.pulumi.datadog.outputs.PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetProductAnalyticsFunnelDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetProductAnalyticsFunnelDefinition {
    /**
     ...
     * 
     */
    private List<PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequest> requests;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable PowerpackV2WidgetProductAnalyticsFunnelDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetProductAnalyticsFunnelDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetProductAnalyticsFunnelDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetProductAnalyticsFunnelDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetProductAnalyticsFunnelDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder requests(List<PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequest> requests) {
            if (requests == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetProductAnalyticsFunnelDefinition", "requests");
            }
            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetProductAnalyticsFunnelDefinitionTime time) {
        ...
        public PowerpackV2WidgetProductAnalyticsFunnelDefinition build() {
            final var _resultValue = new PowerpackV2WidgetProductAnalyticsFunnelDefinition();
