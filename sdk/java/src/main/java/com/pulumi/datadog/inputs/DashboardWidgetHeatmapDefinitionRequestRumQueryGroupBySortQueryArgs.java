...
public final class DashboardWidgetHeatmapDefinitionRequestRumQueryGroupBySortQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetHeatmapDefinitionRequestRumQueryGroupBySortQueryArgs(DashboardWidgetHeatmapDefinitionRequestRumQueryGroupBySortQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetHeatmapDefinitionRequestRumQueryGroupBySortQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetHeatmapDefinitionRequestRumQueryGroupBySortQueryArgs defaults) {
            $ = new DashboardWidgetHeatmapDefinitionRequestRumQueryGroupBySortQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetHeatmapDefinitionRequestRumQueryGroupBySortQueryArgs build() {
            if ($.aggregation == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionRequestRumQueryGroupBySortQueryArgs", "aggregation");
            }
            if ($.order == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetHeatmapDefinitionRequestRumQueryGroupBySortQueryArgs", "order");
            }
            return $;
        }
    }
