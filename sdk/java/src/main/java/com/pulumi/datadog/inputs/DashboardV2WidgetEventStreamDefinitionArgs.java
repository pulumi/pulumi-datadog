...
import com.pulumi.datadog.inputs.DashboardV2WidgetEventStreamDefinitionTimeArgs;
...
public final class DashboardV2WidgetEventStreamDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetEventStreamDefinitionArgs Empty = new DashboardV2WidgetEventStreamDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetEventStreamDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetEventStreamDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetEventStreamDefinitionArgs() {}

    private DashboardV2WidgetEventStreamDefinitionArgs(DashboardV2WidgetEventStreamDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetEventStreamDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetEventStreamDefinitionArgs();
        }

        public Builder(DashboardV2WidgetEventStreamDefinitionArgs defaults) {
            $ = new DashboardV2WidgetEventStreamDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetEventStreamDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetEventStreamDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetEventStreamDefinitionArgs build() {
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetEventStreamDefinitionArgs", "query");
            }
            return $;
        }
    }
