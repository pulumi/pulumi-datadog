...
public final class SyntheticsTestApiStepArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The subtype of the Synthetic multistep API test step. Valid values are `http`, `grpc`, `ssl`, `dns`, `tcp`, `udp`, `icmp`, `websocket`, `mcp`, `wait`, `playSubTest`. Defaults to `&#34;http&#34;`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param subtype The subtype of the Synthetic multistep API test step. Valid values are `http`, `grpc`, `ssl`, `dns`, `tcp`, `udp`, `icmp`, `websocket`, `mcp`, `wait`, `playSubTest`. Defaults to `&#34;http&#34;`.
         * 
         * @return builder
         * 
         */
