...
public final class PowerpackV2WidgetBarChartDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetBarChartDefinitionRequestFormulaStyleArgs Empty = new PowerpackV2WidgetBarChartDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackV2WidgetBarChartDefinitionRequestFormulaStyleArgs() {}

    private PowerpackV2WidgetBarChartDefinitionRequestFormulaStyleArgs(PowerpackV2WidgetBarChartDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetBarChartDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetBarChartDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetBarChartDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
