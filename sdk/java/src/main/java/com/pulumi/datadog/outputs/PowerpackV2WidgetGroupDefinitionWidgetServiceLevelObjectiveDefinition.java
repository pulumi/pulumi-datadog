...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTime time;
    /**
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private String viewType;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition defaults) {
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionTime time) {
        ...
        public Builder timeWindows(List<String> timeWindows) {
            if (timeWindows == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition", "timeWindows");
            }
        ...
        public Builder viewMode(String viewMode) {
            if (viewMode == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition", "viewMode");
            }
        ...
        public Builder viewType(String viewType) {
            if (viewType == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition", "viewType");
            }
            this.viewType = viewType;
            return this;
        }
        public PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetServiceLevelObjectiveDefinition();
