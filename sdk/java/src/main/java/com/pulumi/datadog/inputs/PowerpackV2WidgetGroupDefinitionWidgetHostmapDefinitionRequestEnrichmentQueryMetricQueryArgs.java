...
public final class PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs(PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestEnrichmentQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
