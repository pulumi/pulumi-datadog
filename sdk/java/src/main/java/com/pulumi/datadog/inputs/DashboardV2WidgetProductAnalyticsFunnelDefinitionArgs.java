...
import com.pulumi.datadog.inputs.DashboardV2WidgetProductAnalyticsFunnelDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetProductAnalyticsFunnelDefinitionTimeArgs;
...
public final class DashboardV2WidgetProductAnalyticsFunnelDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetProductAnalyticsFunnelDefinitionArgs Empty = new DashboardV2WidgetProductAnalyticsFunnelDefinitionArgs();
    ...
    private Output<List<DashboardV2WidgetProductAnalyticsFunnelDefinitionRequestArgs>> requests;

    /**
     * @return User journey funnel requests.
     * 
     */
    public Output<List<DashboardV2WidgetProductAnalyticsFunnelDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetProductAnalyticsFunnelDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetProductAnalyticsFunnelDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetProductAnalyticsFunnelDefinitionArgs() {}

    private DashboardV2WidgetProductAnalyticsFunnelDefinitionArgs(DashboardV2WidgetProductAnalyticsFunnelDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetProductAnalyticsFunnelDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetProductAnalyticsFunnelDefinitionArgs();
        }

        public Builder(DashboardV2WidgetProductAnalyticsFunnelDefinitionArgs defaults) {
            $ = new DashboardV2WidgetProductAnalyticsFunnelDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<DashboardV2WidgetProductAnalyticsFunnelDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetProductAnalyticsFunnelDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetProductAnalyticsFunnelDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetProductAnalyticsFunnelDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetProductAnalyticsFunnelDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetProductAnalyticsFunnelDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetProductAnalyticsFunnelDefinitionArgs", "requests");
            }
            return $;
        }
    }
