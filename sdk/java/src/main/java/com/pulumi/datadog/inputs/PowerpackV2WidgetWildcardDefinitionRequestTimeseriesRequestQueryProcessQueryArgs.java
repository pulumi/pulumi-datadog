...
public final class PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs Empty = new PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs();
    ...
    private PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs() {}

    private PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs(PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetWildcardDefinitionRequestTimeseriesRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
