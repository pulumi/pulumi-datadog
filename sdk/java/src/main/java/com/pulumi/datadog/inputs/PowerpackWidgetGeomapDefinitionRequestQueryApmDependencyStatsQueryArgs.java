...
public final class PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs Empty = new PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs();
    ...
    private PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs() {}

    private PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs(PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs();
        }

        public Builder(PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
            $ = new PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
