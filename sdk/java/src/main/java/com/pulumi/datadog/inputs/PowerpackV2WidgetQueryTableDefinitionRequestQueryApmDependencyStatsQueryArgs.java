...
public final class PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs Empty = new PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs();
    ...
    private PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs() {}

    private PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs(PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs();
        }

        public Builder(PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs defaults) {
            $ = new PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryTableDefinitionRequestQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
