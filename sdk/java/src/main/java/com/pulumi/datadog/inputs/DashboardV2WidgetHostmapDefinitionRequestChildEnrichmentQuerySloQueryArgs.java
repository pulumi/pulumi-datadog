...
public final class DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs Empty = new DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs();
    ...
    private DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs() {}

    private DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs(DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs();
        }

        public Builder(DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs defaults) {
            $ = new DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestChildEnrichmentQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
