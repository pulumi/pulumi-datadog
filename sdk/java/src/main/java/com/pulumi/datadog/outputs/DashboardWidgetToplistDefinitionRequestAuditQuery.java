...
public final class DashboardWidgetToplistDefinitionRequestAuditQuery {
    ...
    public static final class Builder {
        ...
        public Builder index(String index) {
            if (index == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestAuditQuery", "index");
            }
            this.index = index;
            return this;
        }
        ...
        public DashboardWidgetToplistDefinitionRequestAuditQuery build() {
            final var _resultValue = new DashboardWidgetToplistDefinitionRequestAuditQuery();
