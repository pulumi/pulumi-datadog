...
import com.pulumi.datadog.inputs.PowerpackWidgetListStreamDefinitionRequestQueryGroupByArgs;
...
public final class PowerpackWidgetListStreamDefinitionRequestQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder groupBies(@Nullable Output<List<PowerpackWidgetListStreamDefinitionRequestQueryGroupByArgs>> groupBies) {
            $.groupBies = groupBies;
            return this;
        }
         ...
         * 
         */
        public Builder groupBies(List<PowerpackWidgetListStreamDefinitionRequestQueryGroupByArgs> groupBies) {
         ...
         * 
         */
        public Builder groupBies(PowerpackWidgetListStreamDefinitionRequestQueryGroupByArgs... groupBies) {
