...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinition defaults) {
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinition", "query");
            }
            this.query = query;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinitionTime time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinition build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetEventStreamDefinition();
