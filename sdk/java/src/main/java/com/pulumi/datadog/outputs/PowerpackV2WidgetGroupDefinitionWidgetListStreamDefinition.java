...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinition {
    /**
     ...
     * 
     */
    private List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequest> requests;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder requests(List<PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequest> requests) {
            if (requests == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinition", "requests");
            }
            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionRequest... requests) {
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinitionTime time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetListStreamDefinition();
