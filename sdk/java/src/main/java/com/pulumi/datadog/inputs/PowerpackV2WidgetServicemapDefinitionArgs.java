...
import com.pulumi.datadog.inputs.PowerpackV2WidgetServicemapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetServicemapDefinitionTimeArgs;
...
public final class PowerpackV2WidgetServicemapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetServicemapDefinitionArgs Empty = new PowerpackV2WidgetServicemapDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetServicemapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetServicemapDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetServicemapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetServicemapDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetServicemapDefinitionArgs() {}

    private PowerpackV2WidgetServicemapDefinitionArgs(PowerpackV2WidgetServicemapDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetServicemapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetServicemapDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetServicemapDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetServicemapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetServicemapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetServicemapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetServicemapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetServicemapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetServicemapDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetServicemapDefinitionArgs build() {
            if ($.filters == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetServicemapDefinitionArgs", "filters");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetServicemapDefinitionArgs", "service");
            }
            return $;
        }
    }
