...
@CustomType
public final class ObservabilityPipelineConfigSourceAmazonDataFirehoseTls {
    /**
    ...
    private ObservabilityPipelineConfigSourceAmazonDataFirehoseTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceAmazonDataFirehoseTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceAmazonDataFirehoseTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceAmazonDataFirehoseTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceAmazonDataFirehoseTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceAmazonDataFirehoseTls();
