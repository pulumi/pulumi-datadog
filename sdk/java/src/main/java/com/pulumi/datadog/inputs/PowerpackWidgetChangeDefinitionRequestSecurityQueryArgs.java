...
import com.pulumi.datadog.inputs.PowerpackWidgetChangeDefinitionRequestSecurityQueryComputeQueryArgs;
import com.pulumi.datadog.inputs.PowerpackWidgetChangeDefinitionRequestSecurityQueryGroupByArgs;
import com.pulumi.datadog.inputs.PowerpackWidgetChangeDefinitionRequestSecurityQueryMultiComputeArgs;
...
public final class PowerpackWidgetChangeDefinitionRequestSecurityQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PowerpackWidgetChangeDefinitionRequestSecurityQueryArgs() {}

    private PowerpackWidgetChangeDefinitionRequestSecurityQueryArgs(PowerpackWidgetChangeDefinitionRequestSecurityQueryArgs $) {
    ...
    public static Builder builder(PowerpackWidgetChangeDefinitionRequestSecurityQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetChangeDefinitionRequestSecurityQueryArgs();
        }

        public Builder(PowerpackWidgetChangeDefinitionRequestSecurityQueryArgs defaults) {
            $ = new PowerpackWidgetChangeDefinitionRequestSecurityQueryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder computeQuery(@Nullable Output<PowerpackWidgetChangeDefinitionRequestSecurityQueryComputeQueryArgs> computeQuery) {
         ...
         * 
         */
        public Builder computeQuery(PowerpackWidgetChangeDefinitionRequestSecurityQueryComputeQueryArgs computeQuery) {
         ...
         * 
         */
        public Builder groupBies(@Nullable Output<List<PowerpackWidgetChangeDefinitionRequestSecurityQueryGroupByArgs>> groupBies) {
            $.groupBies = groupBies;
            return this;
        }
         ...
         * 
         */
        public Builder groupBies(List<PowerpackWidgetChangeDefinitionRequestSecurityQueryGroupByArgs> groupBies) {
         ...
         * 
         */
        public Builder groupBies(PowerpackWidgetChangeDefinitionRequestSecurityQueryGroupByArgs... groupBies) {
         ...
         * 
         */
        public Builder multiComputes(@Nullable Output<List<PowerpackWidgetChangeDefinitionRequestSecurityQueryMultiComputeArgs>> multiComputes) {
         ...
         * 
         */
        public Builder multiComputes(List<PowerpackWidgetChangeDefinitionRequestSecurityQueryMultiComputeArgs> multiComputes) {
         ...
         * 
         */
        public Builder multiComputes(PowerpackWidgetChangeDefinitionRequestSecurityQueryMultiComputeArgs... multiComputes) {
        ...
        public PowerpackWidgetChangeDefinitionRequestSecurityQueryArgs build() {
            if ($.index == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetChangeDefinitionRequestSecurityQueryArgs", "index");
            }
            return $;
        }
    }
