...
public final class DashboardWidgetTimeseriesDefinitionRequestQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs> cloudCostQuery;

    /**
     * @return The Cloud Cost query using formulas and functions.
     * 
     */
    public Optional<Output<DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs>> cloudCostQuery() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder cloudCostQuery(@Nullable Output<DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs> cloudCostQuery) {
         ...
         * 
         */
        public Builder cloudCostQuery(DashboardWidgetTimeseriesDefinitionRequestQueryCloudCostQueryArgs cloudCostQuery) {
