...
public final class PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs(PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestYQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
