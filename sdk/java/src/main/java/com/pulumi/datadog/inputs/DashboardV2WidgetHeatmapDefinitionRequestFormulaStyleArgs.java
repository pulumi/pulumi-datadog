...
public final class DashboardV2WidgetHeatmapDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHeatmapDefinitionRequestFormulaStyleArgs Empty = new DashboardV2WidgetHeatmapDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardV2WidgetHeatmapDefinitionRequestFormulaStyleArgs() {}

    private DashboardV2WidgetHeatmapDefinitionRequestFormulaStyleArgs(DashboardV2WidgetHeatmapDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHeatmapDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHeatmapDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetHeatmapDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetHeatmapDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHeatmapDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
