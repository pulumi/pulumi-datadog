...
public final class DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs Empty = new DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs();
    ...
    private DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs() {}

    private DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs(DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestFillFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
