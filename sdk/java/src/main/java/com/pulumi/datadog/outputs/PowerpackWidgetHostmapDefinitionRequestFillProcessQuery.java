...
@CustomType
public final class PowerpackWidgetHostmapDefinitionRequestFillProcessQuery {
    /**
    ...
    private PowerpackWidgetHostmapDefinitionRequestFillProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetHostmapDefinitionRequestFillProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackWidgetHostmapDefinitionRequestFillProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetHostmapDefinitionRequestFillProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackWidgetHostmapDefinitionRequestFillProcessQuery build() {
            final var _resultValue = new PowerpackWidgetHostmapDefinitionRequestFillProcessQuery();
