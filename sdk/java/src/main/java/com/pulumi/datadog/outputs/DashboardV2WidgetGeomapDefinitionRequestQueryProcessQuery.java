...
@CustomType
public final class DashboardV2WidgetGeomapDefinitionRequestQueryProcessQuery {
    /**
    ...
    private DashboardV2WidgetGeomapDefinitionRequestQueryProcessQuery() {}
    /**
     * @return The aggregation methods available for metrics queries. Valid values are `avg`, `min`, `max`, `sum`, `last`, `area`, `l2norm`, `percentile`.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetGeomapDefinitionRequestQueryProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String textFilter;
        public Builder() {}
        public Builder(DashboardV2WidgetGeomapDefinitionRequestQueryProcessQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGeomapDefinitionRequestQueryProcessQuery", "dataSource");
            }
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGeomapDefinitionRequestQueryProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGeomapDefinitionRequestQueryProcessQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public DashboardV2WidgetGeomapDefinitionRequestQueryProcessQuery build() {
            final var _resultValue = new DashboardV2WidgetGeomapDefinitionRequestQueryProcessQuery();
