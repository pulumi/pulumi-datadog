...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyle {
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyle defaults) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyle build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyle();
