...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionSortArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs();
     ...
     */
    @Import(name="sort")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionSortArgs> sort;

    /**
     * @return The facet and order to sort the data, for example: `{&#34;column&#34;: &#34;time&#34;, &#34;order&#34;: &#34;desc&#34;}`.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionSortArgs>> sort() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sort(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionSortArgs> sort) {
            $.sort = sort;
            return this;
        }
         ...
         * 
         */
        public Builder sort(DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionSortArgs sort) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetLogStreamDefinitionArgs build() {
            return $;
        }
    }
