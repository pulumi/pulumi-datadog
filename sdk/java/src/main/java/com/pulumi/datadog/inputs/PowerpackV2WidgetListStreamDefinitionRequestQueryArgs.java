...
import com.pulumi.datadog.inputs.PowerpackV2WidgetListStreamDefinitionRequestQueryGroupByArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetListStreamDefinitionRequestQuerySortArgs;
...
public final class PowerpackV2WidgetListStreamDefinitionRequestQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetListStreamDefinitionRequestQueryArgs Empty = new PowerpackV2WidgetListStreamDefinitionRequestQueryArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetListStreamDefinitionRequestQueryGroupByArgs>> groupBies;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetListStreamDefinitionRequestQueryGroupByArgs>>> groupBies() {
     ...
     */
    @Import(name="sort")
    private @Nullable Output<PowerpackV2WidgetListStreamDefinitionRequestQuerySortArgs> sort;

    /**
     * @return The facet and order to sort the data, for example: `{&#34;column&#34;: &#34;time&#34;, &#34;order&#34;: &#34;desc&#34;}`.
     * 
     */
    public Optional<Output<PowerpackV2WidgetListStreamDefinitionRequestQuerySortArgs>> sort() {
    ...
    private PowerpackV2WidgetListStreamDefinitionRequestQueryArgs() {}

    private PowerpackV2WidgetListStreamDefinitionRequestQueryArgs(PowerpackV2WidgetListStreamDefinitionRequestQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetListStreamDefinitionRequestQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetListStreamDefinitionRequestQueryArgs();
        }

        public Builder(PowerpackV2WidgetListStreamDefinitionRequestQueryArgs defaults) {
            $ = new PowerpackV2WidgetListStreamDefinitionRequestQueryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder groupBies(@Nullable Output<List<PowerpackV2WidgetListStreamDefinitionRequestQueryGroupByArgs>> groupBies) {
            $.groupBies = groupBies;
            return this;
        }
         ...
         * 
         */
        public Builder groupBies(List<PowerpackV2WidgetListStreamDefinitionRequestQueryGroupByArgs> groupBies) {
         ...
         * 
         */
        public Builder groupBies(PowerpackV2WidgetListStreamDefinitionRequestQueryGroupByArgs... groupBies) {
         ...
         * 
         */
        public Builder sort(@Nullable Output<PowerpackV2WidgetListStreamDefinitionRequestQuerySortArgs> sort) {
            $.sort = sort;
            return this;
        }
         ...
         * 
         */
        public Builder sort(PowerpackV2WidgetListStreamDefinitionRequestQuerySortArgs sort) {
        ...
        public PowerpackV2WidgetListStreamDefinitionRequestQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetListStreamDefinitionRequestQueryArgs", "dataSource");
            }
            return $;
        }
    }
