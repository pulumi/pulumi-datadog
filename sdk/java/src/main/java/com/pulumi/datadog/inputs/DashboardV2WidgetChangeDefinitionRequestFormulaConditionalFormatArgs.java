...
public final class DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs Empty = new DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs() {}

    private DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs(DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetChangeDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
