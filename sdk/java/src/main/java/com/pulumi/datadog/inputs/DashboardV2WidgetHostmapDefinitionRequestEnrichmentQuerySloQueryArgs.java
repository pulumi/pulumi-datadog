...
public final class DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs Empty = new DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs();
    ...
    private DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs() {}

    private DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs(DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs();
        }

        public Builder(DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs defaults) {
            $ = new DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestEnrichmentQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
