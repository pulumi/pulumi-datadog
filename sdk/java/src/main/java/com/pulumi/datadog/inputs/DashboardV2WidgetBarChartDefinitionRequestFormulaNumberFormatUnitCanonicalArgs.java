...
public final class DashboardV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs Empty = new DashboardV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
    ...
    private DashboardV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs() {}

    private DashboardV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(DashboardV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(DashboardV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new DashboardV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetBarChartDefinitionRequestFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
