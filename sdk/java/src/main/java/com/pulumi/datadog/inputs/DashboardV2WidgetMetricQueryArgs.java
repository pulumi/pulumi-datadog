...
public final class DashboardV2WidgetMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetMetricQueryArgs Empty = new DashboardV2WidgetMetricQueryArgs();
    ...
    private DashboardV2WidgetMetricQueryArgs() {}

    private DashboardV2WidgetMetricQueryArgs(DashboardV2WidgetMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetMetricQueryArgs", "query");
            }
            return $;
        }
    }
