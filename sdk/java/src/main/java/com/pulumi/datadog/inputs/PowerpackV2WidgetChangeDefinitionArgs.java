...
import com.pulumi.datadog.inputs.PowerpackV2WidgetChangeDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetChangeDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetChangeDefinitionTimeArgs;
...
public final class PowerpackV2WidgetChangeDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetChangeDefinitionArgs Empty = new PowerpackV2WidgetChangeDefinitionArgs();
    ...
    private @Nullable Output<List<PowerpackV2WidgetChangeDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetChangeDefinitionCustomLinkArgs>>> customLinks() {
    ...
    private @Nullable Output<List<PowerpackV2WidgetChangeDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<PowerpackV2WidgetChangeDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetChangeDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetChangeDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetChangeDefinitionArgs() {}

    private PowerpackV2WidgetChangeDefinitionArgs(PowerpackV2WidgetChangeDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetChangeDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetChangeDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetChangeDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetChangeDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<PowerpackV2WidgetChangeDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<PowerpackV2WidgetChangeDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(PowerpackV2WidgetChangeDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<PowerpackV2WidgetChangeDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetChangeDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetChangeDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetChangeDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetChangeDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetChangeDefinitionArgs build() {
            return $;
        }
    }
