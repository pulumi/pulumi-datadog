...
import com.pulumi.datadog.outputs.PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinition {
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinition() {}
    /**
     * @return The description of the widget.
     * 
     */
     ...
     * 
     */
    public Optional<PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinition defaults) {
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinition", "query");
            }
            this.query = query;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinitionTime time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinition build() {
            final var _resultValue = new PowerpackV2WidgetGroupDefinitionWidgetEventStreamDefinition();
