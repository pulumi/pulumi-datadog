...
@CustomType
public final class DashboardWidgetQueryTableDefinitionCustomLink {
    /**
    ...
    private DashboardWidgetQueryTableDefinitionCustomLink() {}
    /**
     * @return The flag for toggling context menu link visibility.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetQueryTableDefinitionCustomLink defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String overrideLabel;
        public Builder() {}
        public Builder(DashboardWidgetQueryTableDefinitionCustomLink defaults) {
        ...
        public DashboardWidgetQueryTableDefinitionCustomLink build() {
            final var _resultValue = new DashboardWidgetQueryTableDefinitionCustomLink();
