...
@CustomType
public final class PowerpackV2WidgetBarChartDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackV2WidgetBarChartDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetBarChartDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackV2WidgetBarChartDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackV2WidgetBarChartDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackV2WidgetBarChartDefinitionRequestProcessQuery();
