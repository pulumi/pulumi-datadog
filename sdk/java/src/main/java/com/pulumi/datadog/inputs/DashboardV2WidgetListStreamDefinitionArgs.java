...
import com.pulumi.datadog.inputs.DashboardV2WidgetListStreamDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetListStreamDefinitionTimeArgs;
...
public final class DashboardV2WidgetListStreamDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetListStreamDefinitionArgs Empty = new DashboardV2WidgetListStreamDefinitionArgs();
    ...
    private Output<List<DashboardV2WidgetListStreamDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Output<List<DashboardV2WidgetListStreamDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetListStreamDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetListStreamDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetListStreamDefinitionArgs() {}

    private DashboardV2WidgetListStreamDefinitionArgs(DashboardV2WidgetListStreamDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetListStreamDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetListStreamDefinitionArgs();
        }

        public Builder(DashboardV2WidgetListStreamDefinitionArgs defaults) {
            $ = new DashboardV2WidgetListStreamDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<DashboardV2WidgetListStreamDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetListStreamDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetListStreamDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetListStreamDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetListStreamDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetListStreamDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetListStreamDefinitionArgs", "requests");
            }
            return $;
        }
    }
