...
@CustomType
public final class OnCallTeamRoutingRulesRuleActionEscalationPolicySupportHoursRestriction {
    /**
    ...
    private OnCallTeamRoutingRulesRuleActionEscalationPolicySupportHoursRestriction() {}
    /**
     * @return The weekday when the restriction period ends. Valid values are `monday`, `tuesday`, `wednesday`, `thursday`, `friday`, `saturday`, `sunday`.
     * 
     */
    ...
    public static Builder builder(OnCallTeamRoutingRulesRuleActionEscalationPolicySupportHoursRestriction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String startTime;
        public Builder() {}
        public Builder(OnCallTeamRoutingRulesRuleActionEscalationPolicySupportHoursRestriction defaults) {
        ...
        public OnCallTeamRoutingRulesRuleActionEscalationPolicySupportHoursRestriction build() {
            final var _resultValue = new OnCallTeamRoutingRulesRuleActionEscalationPolicySupportHoursRestriction();
