...
public final class DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs() {}

    private DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs(DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs();
        }

        public Builder(DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs build() {
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs", "sloId");
            }
            if ($.timeWindows == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs", "timeWindows");
            }
            if ($.viewMode == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs", "viewMode");
            }
            if ($.viewType == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetServiceLevelObjectiveDefinitionArgs", "viewType");
            }
            return $;
        }
    }
