...
@CustomType
public final class PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQuery {
    /**
    ...
    public static Builder builder(PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQuery defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
        public PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQuery build() {
            final var _resultValue = new PowerpackWidgetTimeseriesDefinitionRequestQueryMetricQuery();
