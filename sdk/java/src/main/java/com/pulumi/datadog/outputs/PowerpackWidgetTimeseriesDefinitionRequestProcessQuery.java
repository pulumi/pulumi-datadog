...
@CustomType
public final class PowerpackWidgetTimeseriesDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackWidgetTimeseriesDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetTimeseriesDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackWidgetTimeseriesDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetTimeseriesDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackWidgetTimeseriesDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackWidgetTimeseriesDefinitionRequestProcessQuery();
