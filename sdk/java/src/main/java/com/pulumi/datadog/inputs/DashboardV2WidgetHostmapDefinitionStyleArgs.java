...
public final class DashboardV2WidgetHostmapDefinitionStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHostmapDefinitionStyleArgs Empty = new DashboardV2WidgetHostmapDefinitionStyleArgs();
    ...
    private DashboardV2WidgetHostmapDefinitionStyleArgs() {}

    private DashboardV2WidgetHostmapDefinitionStyleArgs(DashboardV2WidgetHostmapDefinitionStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHostmapDefinitionStyleArgs();
        }

        public Builder(DashboardV2WidgetHostmapDefinitionStyleArgs defaults) {
            $ = new DashboardV2WidgetHostmapDefinitionStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHostmapDefinitionStyleArgs build() {
            return $;
        }
    }
