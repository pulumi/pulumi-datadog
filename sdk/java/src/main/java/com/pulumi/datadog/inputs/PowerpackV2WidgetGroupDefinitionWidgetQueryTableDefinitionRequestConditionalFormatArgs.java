...
public final class PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs();
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs(PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetQueryTableDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
