...
public final class ObservabilityPipelineConfigSourceDatadogAgentTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourceDatadogAgentTlsArgs Empty = new ObservabilityPipelineConfigSourceDatadogAgentTlsArgs();
    ...
    private ObservabilityPipelineConfigSourceDatadogAgentTlsArgs() {}

    private ObservabilityPipelineConfigSourceDatadogAgentTlsArgs(ObservabilityPipelineConfigSourceDatadogAgentTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceDatadogAgentTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourceDatadogAgentTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourceDatadogAgentTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourceDatadogAgentTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourceDatadogAgentTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceDatadogAgentTlsArgs", "crtFile");
            }
            return $;
        }
    }
