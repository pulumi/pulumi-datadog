...
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionTimeArgs;
...
public final class PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs();
    ...
    private Output<List<PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestArgs>> requests;

    /**
     * @return User journey funnel requests.
     * 
     */
    public Output<List<PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs(PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param requests User journey funnel requests.
         * 
         * @return builder
         * 
         */
        public Builder requests(Output<List<PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetProductAnalyticsFunnelDefinitionArgs", "requests");
            }
            return $;
        }
    }
