...
import com.pulumi.datadog.inputs.SyntheticsTestApiStepAssertionTargetMcpCapabilitiesArgs;
...
public final class SyntheticsTestApiStepAssertionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<SyntheticsTestApiStepAssertionTargetMcpCapabilitiesArgs> targetMcpCapabilities;
     ...
     * 
     */
    public Optional<Output<SyntheticsTestApiStepAssertionTargetMcpCapabilitiesArgs>> targetMcpCapabilities() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder targetMcpCapabilities(@Nullable Output<SyntheticsTestApiStepAssertionTargetMcpCapabilitiesArgs> targetMcpCapabilities) {
         ...
         * 
         */
        public Builder targetMcpCapabilities(SyntheticsTestApiStepAssertionTargetMcpCapabilitiesArgs targetMcpCapabilities) {
