...
public final class ObservabilityPipelineConfigSourcesAmazonS3TlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcesAmazonS3TlsArgs Empty = new ObservabilityPipelineConfigSourcesAmazonS3TlsArgs();
    ...
    private ObservabilityPipelineConfigSourcesAmazonS3TlsArgs() {}

    private ObservabilityPipelineConfigSourcesAmazonS3TlsArgs(ObservabilityPipelineConfigSourcesAmazonS3TlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesAmazonS3TlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcesAmazonS3TlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcesAmazonS3TlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcesAmazonS3TlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcesAmazonS3TlsArgs build() {
            return $;
        }
    }
