...
public final class PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs Empty = new PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs() {}

    private PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs(PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
