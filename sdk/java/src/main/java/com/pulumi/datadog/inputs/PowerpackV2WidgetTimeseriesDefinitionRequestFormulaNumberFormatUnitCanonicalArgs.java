...
public final class PowerpackV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs Empty = new PowerpackV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
    ...
    private PowerpackV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs() {}

    private PowerpackV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(PowerpackV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(PowerpackV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new PowerpackV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
