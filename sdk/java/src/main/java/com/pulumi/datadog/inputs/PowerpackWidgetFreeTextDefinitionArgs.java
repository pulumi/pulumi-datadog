...
public final class PowerpackWidgetFreeTextDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetFreeTextDefinitionArgs Empty = new PowerpackWidgetFreeTextDefinitionArgs();
    ...
    private PowerpackWidgetFreeTextDefinitionArgs() {}

    private PowerpackWidgetFreeTextDefinitionArgs(PowerpackWidgetFreeTextDefinitionArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(PowerpackWidgetFreeTextDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetFreeTextDefinitionArgs();
        }

        public Builder(PowerpackWidgetFreeTextDefinitionArgs defaults) {
            $ = new PowerpackWidgetFreeTextDefinitionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetFreeTextDefinitionArgs build() {
            if ($.text == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetFreeTextDefinitionArgs", "text");
            }
            return $;
        }
    }
