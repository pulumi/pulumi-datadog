...
public final class ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs Empty = new ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs();
    ...
    private ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs() {}

    private ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs(ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourcePrometheusRemoteWriteTlsArgs", "crtFile");
            }
            return $;
        }
    }
