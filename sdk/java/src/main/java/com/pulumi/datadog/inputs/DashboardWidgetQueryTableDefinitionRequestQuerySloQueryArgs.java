...
public final class DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs Empty = new DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs();
    ...
    private DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs() {}

    private DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs(DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
