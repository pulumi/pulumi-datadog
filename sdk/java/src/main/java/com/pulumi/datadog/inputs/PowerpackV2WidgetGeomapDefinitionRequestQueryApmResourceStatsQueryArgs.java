...
public final class PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs Empty = new PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs();
    ...
    private PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs() {}

    private PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs(PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs();
        }

        public Builder(PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs defaults) {
            $ = new PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs", "name");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGeomapDefinitionRequestQueryApmResourceStatsQueryArgs", "stat");
            }
            return $;
        }
    }
