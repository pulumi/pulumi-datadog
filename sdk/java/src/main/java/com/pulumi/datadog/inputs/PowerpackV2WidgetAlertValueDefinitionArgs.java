...
import com.pulumi.datadog.inputs.PowerpackV2WidgetAlertValueDefinitionTimeArgs;
...
public final class PowerpackV2WidgetAlertValueDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetAlertValueDefinitionArgs Empty = new PowerpackV2WidgetAlertValueDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetAlertValueDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetAlertValueDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetAlertValueDefinitionArgs() {}

    private PowerpackV2WidgetAlertValueDefinitionArgs(PowerpackV2WidgetAlertValueDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetAlertValueDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetAlertValueDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetAlertValueDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetAlertValueDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetAlertValueDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetAlertValueDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetAlertValueDefinitionArgs build() {
            if ($.alertId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetAlertValueDefinitionArgs", "alertId");
            }
            return $;
        }
    }
