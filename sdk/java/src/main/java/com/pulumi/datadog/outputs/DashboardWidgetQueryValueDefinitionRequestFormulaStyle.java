...
@CustomType
public final class DashboardWidgetQueryValueDefinitionRequestFormulaStyle {
    /**
    ...
    public static Builder builder(DashboardWidgetQueryValueDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(DashboardWidgetQueryValueDefinitionRequestFormulaStyle defaults) {
        ...
        public DashboardWidgetQueryValueDefinitionRequestFormulaStyle build() {
            final var _resultValue = new DashboardWidgetQueryValueDefinitionRequestFormulaStyle();
