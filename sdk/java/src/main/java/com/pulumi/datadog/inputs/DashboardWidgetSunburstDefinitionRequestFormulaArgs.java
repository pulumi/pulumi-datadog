...
import com.pulumi.datadog.inputs.DashboardWidgetSunburstDefinitionRequestFormulaNumberFormatArgs;
import com.pulumi.datadog.inputs.DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs;
...
public final class DashboardWidgetSunburstDefinitionRequestFormulaArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<DashboardWidgetSunburstDefinitionRequestFormulaNumberFormatArgs> numberFormat;

    /**
     * @return Number formatting options for the formula.
     * 
     */
    public Optional<Output<DashboardWidgetSunburstDefinitionRequestFormulaNumberFormatArgs>> numberFormat() {
     ...
     */
    @Import(name="style")
    private @Nullable Output<DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs> style;

    /**
     * @return Styling options for widget formulas.
     * 
     */
    public Optional<Output<DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs>> style() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder numberFormat(@Nullable Output<DashboardWidgetSunburstDefinitionRequestFormulaNumberFormatArgs> numberFormat) {
         ...
         * 
         */
        public Builder numberFormat(DashboardWidgetSunburstDefinitionRequestFormulaNumberFormatArgs numberFormat) {
         ...
         * 
         */
        public Builder style(@Nullable Output<DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs> style) {
            $.style = style;
            return this;
        }
         ...
         * 
         */
        public Builder style(DashboardWidgetSunburstDefinitionRequestFormulaStyleArgs style) {
            return style(Output.of(style));
        }

        public DashboardWidgetSunburstDefinitionRequestFormulaArgs build() {
            if ($.formulaExpression == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestFormulaArgs", "formulaExpression");
            }
            return $;
        }
    }
