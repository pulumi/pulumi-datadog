...
import com.pulumi.datadog.outputs.DashboardV2WidgetToplistDefinitionCustomLink;
import com.pulumi.datadog.outputs.DashboardV2WidgetToplistDefinitionRequest;
import com.pulumi.datadog.outputs.DashboardV2WidgetToplistDefinitionStyle;
import com.pulumi.datadog.outputs.DashboardV2WidgetToplistDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetToplistDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<DashboardV2WidgetToplistDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<DashboardV2WidgetToplistDefinitionRequest> requests;
    /**
     * @return The style of the widget
     * 
     */
    private @Nullable DashboardV2WidgetToplistDefinitionStyle style;
    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    private @Nullable DashboardV2WidgetToplistDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetToplistDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<DashboardV2WidgetToplistDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<DashboardV2WidgetToplistDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetToplistDefinitionStyle> style() {
     ...
     * 
     */
    public Optional<DashboardV2WidgetToplistDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetToplistDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(DashboardV2WidgetToplistDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<DashboardV2WidgetToplistDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(DashboardV2WidgetToplistDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder requests(@Nullable List<DashboardV2WidgetToplistDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(DashboardV2WidgetToplistDefinitionRequest... requests) {
            return requests(List.of(requests));
        }
        @CustomType.Setter
        public Builder style(@Nullable DashboardV2WidgetToplistDefinitionStyle style) {

            this.style = style;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetToplistDefinitionTime time) {
        ...
        public DashboardV2WidgetToplistDefinition build() {
            final var _resultValue = new DashboardV2WidgetToplistDefinition();
