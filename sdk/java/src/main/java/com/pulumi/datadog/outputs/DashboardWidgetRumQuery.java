...
import com.pulumi.datadog.outputs.DashboardWidgetRumQueryComputeQuery;
import com.pulumi.datadog.outputs.DashboardWidgetRumQueryGroupBy;
import com.pulumi.datadog.outputs.DashboardWidgetRumQueryMultiCompute;
...
public final class DashboardWidgetRumQuery {
    ...
    public static Builder builder(DashboardWidgetRumQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchQuery;
        public Builder() {}
        public Builder(DashboardWidgetRumQuery defaults) {
        ...
        @CustomType.Setter
        public Builder computeQuery(@Nullable DashboardWidgetRumQueryComputeQuery computeQuery) {

            this.computeQuery = computeQuery;
            return this;
        }
        @CustomType.Setter
        public Builder groupBies(@Nullable List<DashboardWidgetRumQueryGroupBy> groupBies) {

            this.groupBies = groupBies;
            return this;
        }
        public Builder groupBies(DashboardWidgetRumQueryGroupBy... groupBies) {
            return groupBies(List.of(groupBies));
        }
        @CustomType.Setter
        public Builder index(String index) {
            if (index == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetRumQuery", "index");
            }
            this.index = index;
            return this;
        }
        @CustomType.Setter
        public Builder multiComputes(@Nullable List<DashboardWidgetRumQueryMultiCompute> multiComputes) {

            this.multiComputes = multiComputes;
            return this;
        }
        public Builder multiComputes(DashboardWidgetRumQueryMultiCompute... multiComputes) {
        ...
        public DashboardWidgetRumQuery build() {
            final var _resultValue = new DashboardWidgetRumQuery();
