...
public final class LogsCustomPipelineProcessorPipelineProcessorAttributeRemapperArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public LogsCustomPipelineProcessorPipelineProcessorAttributeRemapperArgs build() {
            if ($.sourceType == null) {
                throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorAttributeRemapperArgs", "sourceType");
            }
            if ($.sources == null) {
                throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorAttributeRemapperArgs", "sources");
            }
            if ($.target == null) {
                throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorAttributeRemapperArgs", "target");
            }
            if ($.targetType == null) {
                throw new MissingRequiredPropertyException("LogsCustomPipelineProcessorPipelineProcessorAttributeRemapperArgs", "targetType");
            }
            return $;
        }
    }
