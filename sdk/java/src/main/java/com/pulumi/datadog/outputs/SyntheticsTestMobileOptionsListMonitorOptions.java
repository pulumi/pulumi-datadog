...
public final class SyntheticsTestMobileOptionsListMonitorOptions {
    ...
    public static Builder builder(SyntheticsTestMobileOptionsListMonitorOptions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer renotifyOccurrences;
        public Builder() {}
        public Builder(SyntheticsTestMobileOptionsListMonitorOptions defaults) {
        ...
        public SyntheticsTestMobileOptionsListMonitorOptions build() {
            final var _resultValue = new SyntheticsTestMobileOptionsListMonitorOptions();
