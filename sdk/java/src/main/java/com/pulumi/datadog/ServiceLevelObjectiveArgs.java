...
public final class ServiceLevelObjectiveArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<List<ServiceLevelObjectiveThresholdArgs>> thresholds;
    ...
    /**
     * @return The type of the service level objective. The mapping from these types to the types found in the Datadog Web UI can be found in the Datadog API [documentation page](https://docs.datadoghq.com/api/v1/service-level-objectives/#create-a-slo-object). Valid values are `metric`, `monitor`, `timeSlice`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param forceDelete A boolean indicating whether this monitor can be deleted even if it&#39;s referenced by other resources (for example, dashboards).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param targetThreshold The objective&#39;s target in `(0,100)`. This must match the corresponding thresholds of the primary time frame.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder thresholds(Output<List<ServiceLevelObjectiveThresholdArgs>> thresholds) {
        ...
        /**
         * @param type The type of the service level objective. The mapping from these types to the types found in the Datadog Web UI can be found in the Datadog API [documentation page](https://docs.datadoghq.com/api/v1/service-level-objectives/#create-a-slo-object). Valid values are `metric`, `monitor`, `timeSlice`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param warningThreshold The objective&#39;s warning value in `(0,100)`. This must be greater than the target value and match the corresponding thresholds of the primary time frame.
         * 
         * @return builder
         * 
         */
