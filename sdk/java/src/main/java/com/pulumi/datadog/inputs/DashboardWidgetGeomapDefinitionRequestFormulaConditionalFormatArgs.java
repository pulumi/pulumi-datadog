...
public final class DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs Empty = new DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs() {}

    private DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs(DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGeomapDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
