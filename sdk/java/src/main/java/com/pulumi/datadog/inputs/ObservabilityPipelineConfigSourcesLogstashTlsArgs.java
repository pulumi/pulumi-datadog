...
public final class ObservabilityPipelineConfigSourcesLogstashTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcesLogstashTlsArgs Empty = new ObservabilityPipelineConfigSourcesLogstashTlsArgs();
    ...
    private ObservabilityPipelineConfigSourcesLogstashTlsArgs() {}

    private ObservabilityPipelineConfigSourcesLogstashTlsArgs(ObservabilityPipelineConfigSourcesLogstashTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesLogstashTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcesLogstashTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcesLogstashTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcesLogstashTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcesLogstashTlsArgs build() {
            return $;
        }
    }
