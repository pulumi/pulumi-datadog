...
public final class DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs Empty = new DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs() {}

    private DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs(DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetSunburstDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
