...
import com.pulumi.datadog.inputs.PowerpackV2WidgetTraceServiceDefinitionTimeArgs;
...
public final class PowerpackV2WidgetTraceServiceDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTraceServiceDefinitionArgs Empty = new PowerpackV2WidgetTraceServiceDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetTraceServiceDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetTraceServiceDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetTraceServiceDefinitionArgs() {}

    private PowerpackV2WidgetTraceServiceDefinitionArgs(PowerpackV2WidgetTraceServiceDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTraceServiceDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTraceServiceDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetTraceServiceDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetTraceServiceDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetTraceServiceDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetTraceServiceDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetTraceServiceDefinitionArgs build() {
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTraceServiceDefinitionArgs", "env");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTraceServiceDefinitionArgs", "service");
            }
            if ($.spanName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetTraceServiceDefinitionArgs", "spanName");
            }
            return $;
        }
    }
