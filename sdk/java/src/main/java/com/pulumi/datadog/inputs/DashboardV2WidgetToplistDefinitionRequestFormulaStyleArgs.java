...
public final class DashboardV2WidgetToplistDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetToplistDefinitionRequestFormulaStyleArgs Empty = new DashboardV2WidgetToplistDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardV2WidgetToplistDefinitionRequestFormulaStyleArgs() {}

    private DashboardV2WidgetToplistDefinitionRequestFormulaStyleArgs(DashboardV2WidgetToplistDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetToplistDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetToplistDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetToplistDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetToplistDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetToplistDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
