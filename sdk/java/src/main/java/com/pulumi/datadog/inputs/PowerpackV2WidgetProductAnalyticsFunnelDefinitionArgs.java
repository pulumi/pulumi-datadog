...
import com.pulumi.datadog.inputs.PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestArgs;
import com.pulumi.datadog.inputs.PowerpackV2WidgetProductAnalyticsFunnelDefinitionTimeArgs;
...
public final class PowerpackV2WidgetProductAnalyticsFunnelDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetProductAnalyticsFunnelDefinitionArgs Empty = new PowerpackV2WidgetProductAnalyticsFunnelDefinitionArgs();
    ...
    private Output<List<PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestArgs>> requests;

    /**
     * @return User journey funnel requests.
     * 
     */
    public Output<List<PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestArgs>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<PowerpackV2WidgetProductAnalyticsFunnelDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<PowerpackV2WidgetProductAnalyticsFunnelDefinitionTimeArgs>> time() {
    ...
    private PowerpackV2WidgetProductAnalyticsFunnelDefinitionArgs() {}

    private PowerpackV2WidgetProductAnalyticsFunnelDefinitionArgs(PowerpackV2WidgetProductAnalyticsFunnelDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetProductAnalyticsFunnelDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetProductAnalyticsFunnelDefinitionArgs();
        }

        public Builder(PowerpackV2WidgetProductAnalyticsFunnelDefinitionArgs defaults) {
            $ = new PowerpackV2WidgetProductAnalyticsFunnelDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackV2WidgetProductAnalyticsFunnelDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<PowerpackV2WidgetProductAnalyticsFunnelDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(PowerpackV2WidgetProductAnalyticsFunnelDefinitionTimeArgs time) {
        ...
        public PowerpackV2WidgetProductAnalyticsFunnelDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetProductAnalyticsFunnelDefinitionArgs", "requests");
            }
            return $;
        }
    }
