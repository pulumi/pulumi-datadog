...
public final class DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs Empty = new DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs();
    ...
    private DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs() {}

    private DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs(DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
