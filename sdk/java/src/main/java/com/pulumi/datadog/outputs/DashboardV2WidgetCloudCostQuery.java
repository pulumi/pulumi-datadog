...
@CustomType
public final class DashboardV2WidgetCloudCostQuery {
    /**
    ...
    private DashboardV2WidgetCloudCostQuery() {}
    /**
     * @return The aggregation methods available for cloud cost queries. Valid values are `avg`, `min`, `max`, `sum`, `last`, `area`, `l2norm`, `percentile`.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetCloudCostQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(DashboardV2WidgetCloudCostQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetCloudCostQuery", "dataSource");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetCloudCostQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetCloudCostQuery", "query");
            }
            this.query = query;
            return this;
        }
        public DashboardV2WidgetCloudCostQuery build() {
            final var _resultValue = new DashboardV2WidgetCloudCostQuery();
