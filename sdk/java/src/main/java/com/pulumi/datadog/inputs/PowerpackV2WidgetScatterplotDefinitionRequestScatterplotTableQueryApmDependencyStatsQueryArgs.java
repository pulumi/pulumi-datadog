...
public final class PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs Empty = new PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs();
    ...
    private PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs() {}

    private PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs(PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs();
        }

        public Builder(PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs defaults) {
            $ = new PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetScatterplotDefinitionRequestScatterplotTableQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
