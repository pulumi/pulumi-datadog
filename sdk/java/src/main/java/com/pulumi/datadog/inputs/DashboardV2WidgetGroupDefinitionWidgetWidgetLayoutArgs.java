...
public final class DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs();
    ...
    private DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs(DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs $) {
        this.height = $.height;
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs build() {
            if ($.height == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs", "height");
            }
            if ($.width == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs", "width");
            }
            if ($.x == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs", "x");
            }
            if ($.y == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetWidgetLayoutArgs", "y");
            }
            return $;
        }
    }
