...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery {
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery() {}
    /**
     * @return Additional filters applied to the SLO query.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sloQueryType;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery", "dataSource");
            }
        ...
        public Builder measure(String measure) {
            if (measure == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery", "measure");
            }
        ...
        public Builder sloId(String sloId) {
            if (sloId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery", "sloId");
            }
            this.sloId = sloId;
            return this;
        }
        ...
        public DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestChildEnrichmentQuerySloQuery();
