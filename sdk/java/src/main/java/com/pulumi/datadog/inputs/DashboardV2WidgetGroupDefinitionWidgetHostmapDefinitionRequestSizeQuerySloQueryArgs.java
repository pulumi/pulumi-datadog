...
public final class DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs();
    ...
    private DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
