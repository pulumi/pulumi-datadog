...
public final class PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs(PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHeatmapDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
