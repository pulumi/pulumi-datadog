...
public final class DashboardWidgetToplistDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetToplistDefinitionRequestConditionalFormatArgs Empty = new DashboardWidgetToplistDefinitionRequestConditionalFormatArgs();
    ...
    private DashboardWidgetToplistDefinitionRequestConditionalFormatArgs() {}

    private DashboardWidgetToplistDefinitionRequestConditionalFormatArgs(DashboardWidgetToplistDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardWidgetToplistDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetToplistDefinitionRequestConditionalFormatArgs();
        }

        public Builder(DashboardWidgetToplistDefinitionRequestConditionalFormatArgs defaults) {
            $ = new DashboardWidgetToplistDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetToplistDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetToplistDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
