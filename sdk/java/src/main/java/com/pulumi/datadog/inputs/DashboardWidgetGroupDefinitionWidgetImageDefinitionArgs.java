...
public final class DashboardWidgetGroupDefinitionWidgetImageDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetGroupDefinitionWidgetImageDefinitionArgs Empty = new DashboardWidgetGroupDefinitionWidgetImageDefinitionArgs();
    ...
    private DashboardWidgetGroupDefinitionWidgetImageDefinitionArgs() {}

    private DashboardWidgetGroupDefinitionWidgetImageDefinitionArgs(DashboardWidgetGroupDefinitionWidgetImageDefinitionArgs $) {
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetImageDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetGroupDefinitionWidgetImageDefinitionArgs();
        }

        public Builder(DashboardWidgetGroupDefinitionWidgetImageDefinitionArgs defaults) {
            $ = new DashboardWidgetGroupDefinitionWidgetImageDefinitionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetGroupDefinitionWidgetImageDefinitionArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetImageDefinitionArgs", "url");
            }
            return $;
        }
    }
