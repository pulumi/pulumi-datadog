...
public final class DashboardV2WidgetQueryTableDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetQueryTableDefinitionRequestProcessQueryArgs Empty = new DashboardV2WidgetQueryTableDefinitionRequestProcessQueryArgs();
    ...
    private DashboardV2WidgetQueryTableDefinitionRequestProcessQueryArgs() {}

    private DashboardV2WidgetQueryTableDefinitionRequestProcessQueryArgs(DashboardV2WidgetQueryTableDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetQueryTableDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetQueryTableDefinitionRequestProcessQueryArgs();
        }

        public Builder(DashboardV2WidgetQueryTableDefinitionRequestProcessQueryArgs defaults) {
            $ = new DashboardV2WidgetQueryTableDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetQueryTableDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetQueryTableDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
