...
@CustomType
public final class ObservabilityPipelineConfigDestinationsSocketTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationsSocketTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationsSocketTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationsSocketTls defaults) {
        ...
        public ObservabilityPipelineConfigDestinationsSocketTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationsSocketTls();
