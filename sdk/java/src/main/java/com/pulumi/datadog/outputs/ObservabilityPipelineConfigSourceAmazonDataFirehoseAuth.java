...
@CustomType
public final class ObservabilityPipelineConfigSourceAmazonDataFirehoseAuth {
    /**
    ...
    private ObservabilityPipelineConfigSourceAmazonDataFirehoseAuth() {}
    /**
     * @return The Amazon Resource Name (ARN) of the role to assume.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceAmazonDataFirehoseAuth defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sessionName;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceAmazonDataFirehoseAuth defaults) {
        ...
        public ObservabilityPipelineConfigSourceAmazonDataFirehoseAuth build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceAmazonDataFirehoseAuth();
