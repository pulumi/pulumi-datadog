...
public final class PowerpackV2WidgetMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetMetricQueryArgs Empty = new PowerpackV2WidgetMetricQueryArgs();
    ...
    private PowerpackV2WidgetMetricQueryArgs() {}

    private PowerpackV2WidgetMetricQueryArgs(PowerpackV2WidgetMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetMetricQueryArgs", "query");
            }
            return $;
        }
    }
