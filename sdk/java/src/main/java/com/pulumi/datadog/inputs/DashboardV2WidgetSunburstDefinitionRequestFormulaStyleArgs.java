...
public final class DashboardV2WidgetSunburstDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetSunburstDefinitionRequestFormulaStyleArgs Empty = new DashboardV2WidgetSunburstDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardV2WidgetSunburstDefinitionRequestFormulaStyleArgs() {}

    private DashboardV2WidgetSunburstDefinitionRequestFormulaStyleArgs(DashboardV2WidgetSunburstDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetSunburstDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetSunburstDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetSunburstDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetSunburstDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetSunburstDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
