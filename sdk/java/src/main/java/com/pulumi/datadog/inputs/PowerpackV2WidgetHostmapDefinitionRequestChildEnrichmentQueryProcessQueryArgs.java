...
public final class PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs Empty = new PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs() {}

    private PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs(PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestChildEnrichmentQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
