...
import com.pulumi.datadog.outputs.PowerpackV2WidgetHeatmapDefinitionCustomLink;
import com.pulumi.datadog.outputs.PowerpackV2WidgetHeatmapDefinitionEvent;
import com.pulumi.datadog.outputs.PowerpackV2WidgetHeatmapDefinitionMarker;
import com.pulumi.datadog.outputs.PowerpackV2WidgetHeatmapDefinitionRequest;
import com.pulumi.datadog.outputs.PowerpackV2WidgetHeatmapDefinitionTime;
import com.pulumi.datadog.outputs.PowerpackV2WidgetHeatmapDefinitionXaxis;
import com.pulumi.datadog.outputs.PowerpackV2WidgetHeatmapDefinitionYaxis;
...
@CustomType
public final class PowerpackV2WidgetHeatmapDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<PowerpackV2WidgetHeatmapDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetHeatmapDefinitionEvent> events;
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetHeatmapDefinitionMarker> markers;
    /**
     ...
     * 
     */
    private @Nullable List<PowerpackV2WidgetHeatmapDefinitionRequest> requests;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetHeatmapDefinitionTime time;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetHeatmapDefinitionXaxis xaxis;
    /**
     * @return A nested block describing the Y-Axis Controls. The structure of this block is described below.
     * 
     */
    private @Nullable PowerpackV2WidgetHeatmapDefinitionYaxis yaxis;
     ...
     * 
     */
    public List<PowerpackV2WidgetHeatmapDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public List<PowerpackV2WidgetHeatmapDefinitionEvent> events() {
     ...
     * 
     */
    public List<PowerpackV2WidgetHeatmapDefinitionMarker> markers() {
     ...
     * 
     */
    public List<PowerpackV2WidgetHeatmapDefinitionRequest> requests() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetHeatmapDefinitionTime> time() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetHeatmapDefinitionXaxis> xaxis() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetHeatmapDefinitionYaxis> yaxis() {
    ...
    public static Builder builder(PowerpackV2WidgetHeatmapDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable PowerpackV2WidgetHeatmapDefinitionYaxis yaxis;
        public Builder() {}
        public Builder(PowerpackV2WidgetHeatmapDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<PowerpackV2WidgetHeatmapDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(PowerpackV2WidgetHeatmapDefinitionCustomLink... customLinks) {
        ...
        @CustomType.Setter
        public Builder events(@Nullable List<PowerpackV2WidgetHeatmapDefinitionEvent> events) {

            this.events = events;
            return this;
        }
        public Builder events(PowerpackV2WidgetHeatmapDefinitionEvent... events) {
        ...
        @CustomType.Setter
        public Builder markers(@Nullable List<PowerpackV2WidgetHeatmapDefinitionMarker> markers) {

            this.markers = markers;
            return this;
        }
        public Builder markers(PowerpackV2WidgetHeatmapDefinitionMarker... markers) {
            return markers(List.of(markers));
        }
        @CustomType.Setter
        public Builder requests(@Nullable List<PowerpackV2WidgetHeatmapDefinitionRequest> requests) {

            this.requests = requests;
            return this;
        }
        public Builder requests(PowerpackV2WidgetHeatmapDefinitionRequest... requests) {
        ...
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetHeatmapDefinitionTime time) {
        ...
        @CustomType.Setter
        public Builder xaxis(@Nullable PowerpackV2WidgetHeatmapDefinitionXaxis xaxis) {

            this.xaxis = xaxis;
            return this;
        }
        @CustomType.Setter
        public Builder yaxis(@Nullable PowerpackV2WidgetHeatmapDefinitionYaxis yaxis) {

            this.yaxis = yaxis;
            return this;
        }
        public PowerpackV2WidgetHeatmapDefinition build() {
            final var _resultValue = new PowerpackV2WidgetHeatmapDefinition();
