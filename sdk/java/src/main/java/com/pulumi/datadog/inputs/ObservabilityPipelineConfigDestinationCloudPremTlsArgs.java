...
public final class ObservabilityPipelineConfigDestinationCloudPremTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationCloudPremTlsArgs Empty = new ObservabilityPipelineConfigDestinationCloudPremTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationCloudPremTlsArgs() {}

    private ObservabilityPipelineConfigDestinationCloudPremTlsArgs(ObservabilityPipelineConfigDestinationCloudPremTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationCloudPremTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationCloudPremTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationCloudPremTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationCloudPremTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationCloudPremTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationCloudPremTlsArgs", "crtFile");
            }
            return $;
        }
    }
