...
public final class PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs Empty = new PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs();
    ...
    private PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs() {}

    private PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs(PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHostmapDefinitionRequestSizeFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
