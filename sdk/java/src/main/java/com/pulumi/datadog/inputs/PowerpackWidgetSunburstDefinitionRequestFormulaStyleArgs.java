...
public final class PowerpackWidgetSunburstDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetSunburstDefinitionRequestFormulaStyleArgs Empty = new PowerpackWidgetSunburstDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackWidgetSunburstDefinitionRequestFormulaStyleArgs() {}

    private PowerpackWidgetSunburstDefinitionRequestFormulaStyleArgs(PowerpackWidgetSunburstDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackWidgetSunburstDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetSunburstDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackWidgetSunburstDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackWidgetSunburstDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackWidgetSunburstDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
