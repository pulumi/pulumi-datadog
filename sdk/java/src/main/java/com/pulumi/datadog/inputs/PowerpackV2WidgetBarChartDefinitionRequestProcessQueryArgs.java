...
public final class PowerpackV2WidgetBarChartDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetBarChartDefinitionRequestProcessQueryArgs Empty = new PowerpackV2WidgetBarChartDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackV2WidgetBarChartDefinitionRequestProcessQueryArgs() {}

    private PowerpackV2WidgetBarChartDefinitionRequestProcessQueryArgs(PowerpackV2WidgetBarChartDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetBarChartDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetBarChartDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetBarChartDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetBarChartDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetBarChartDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
