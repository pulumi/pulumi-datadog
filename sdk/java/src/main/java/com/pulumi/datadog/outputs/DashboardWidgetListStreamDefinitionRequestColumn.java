...
public final class DashboardWidgetListStreamDefinitionRequestColumn {
    ...
    public static final class Builder {
        ...
        public Builder field(String field) {
            if (field == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetListStreamDefinitionRequestColumn", "field");
            }
            this.field = field;
            return this;
        }
        ...
        public Builder width(String width) {
            if (width == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetListStreamDefinitionRequestColumn", "width");
            }
            this.width = width;
            return this;
        }
        public DashboardWidgetListStreamDefinitionRequestColumn build() {
            final var _resultValue = new DashboardWidgetListStreamDefinitionRequestColumn();
