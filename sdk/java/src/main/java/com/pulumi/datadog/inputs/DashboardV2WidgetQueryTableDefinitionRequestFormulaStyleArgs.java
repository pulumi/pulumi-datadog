...
public final class DashboardV2WidgetQueryTableDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetQueryTableDefinitionRequestFormulaStyleArgs Empty = new DashboardV2WidgetQueryTableDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardV2WidgetQueryTableDefinitionRequestFormulaStyleArgs() {}

    private DashboardV2WidgetQueryTableDefinitionRequestFormulaStyleArgs(DashboardV2WidgetQueryTableDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetQueryTableDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetQueryTableDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetQueryTableDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetQueryTableDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetQueryTableDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
