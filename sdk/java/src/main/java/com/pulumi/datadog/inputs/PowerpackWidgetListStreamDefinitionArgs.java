...
import com.pulumi.datadog.inputs.PowerpackWidgetListStreamDefinitionRequestArgs;
...
public final class PowerpackWidgetListStreamDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackWidgetListStreamDefinitionArgs Empty = new PowerpackWidgetListStreamDefinitionArgs();
    ...
    private Output<List<PowerpackWidgetListStreamDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Output<List<PowerpackWidgetListStreamDefinitionRequestArgs>> requests() {
    ...
    private PowerpackWidgetListStreamDefinitionArgs() {}

    private PowerpackWidgetListStreamDefinitionArgs(PowerpackWidgetListStreamDefinitionArgs $) {
    ...
    public static Builder builder(PowerpackWidgetListStreamDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackWidgetListStreamDefinitionArgs();
        }

        public Builder(PowerpackWidgetListStreamDefinitionArgs defaults) {
            $ = new PowerpackWidgetListStreamDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requests(Output<List<PowerpackWidgetListStreamDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<PowerpackWidgetListStreamDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(PowerpackWidgetListStreamDefinitionRequestArgs... requests) {
        ...
        public PowerpackWidgetListStreamDefinitionArgs build() {
            if ($.requests == null) {
                throw new MissingRequiredPropertyException("PowerpackWidgetListStreamDefinitionArgs", "requests");
            }
            return $;
        }
    }
