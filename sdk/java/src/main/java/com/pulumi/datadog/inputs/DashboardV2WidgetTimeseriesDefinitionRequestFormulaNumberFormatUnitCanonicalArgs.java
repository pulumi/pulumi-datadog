...
public final class DashboardV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs Empty = new DashboardV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
    ...
    private DashboardV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs() {}

    private DashboardV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(DashboardV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs();
        }

        public Builder(DashboardV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs defaults) {
            $ = new DashboardV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetTimeseriesDefinitionRequestFormulaNumberFormatUnitCanonicalArgs build() {
            return $;
        }
    }
