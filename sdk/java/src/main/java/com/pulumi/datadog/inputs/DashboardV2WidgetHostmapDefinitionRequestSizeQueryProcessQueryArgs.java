...
public final class DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs Empty = new DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs();
    ...
    private DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs() {}

    private DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs(DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs();
        }

        public Builder(DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs defaults) {
            $ = new DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHostmapDefinitionRequestSizeQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
