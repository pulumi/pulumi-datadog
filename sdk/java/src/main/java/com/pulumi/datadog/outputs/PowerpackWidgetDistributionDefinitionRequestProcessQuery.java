...
@CustomType
public final class PowerpackWidgetDistributionDefinitionRequestProcessQuery {
    /**
    ...
    private PowerpackWidgetDistributionDefinitionRequestProcessQuery() {}
    /**
     * @return A list of processes.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetDistributionDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(PowerpackWidgetDistributionDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetDistributionDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public PowerpackWidgetDistributionDefinitionRequestProcessQuery build() {
            final var _resultValue = new PowerpackWidgetDistributionDefinitionRequestProcessQuery();
