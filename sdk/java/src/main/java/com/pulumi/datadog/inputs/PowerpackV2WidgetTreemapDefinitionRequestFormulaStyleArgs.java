...
public final class PowerpackV2WidgetTreemapDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetTreemapDefinitionRequestFormulaStyleArgs Empty = new PowerpackV2WidgetTreemapDefinitionRequestFormulaStyleArgs();
    ...
    private PowerpackV2WidgetTreemapDefinitionRequestFormulaStyleArgs() {}

    private PowerpackV2WidgetTreemapDefinitionRequestFormulaStyleArgs(PowerpackV2WidgetTreemapDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetTreemapDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetTreemapDefinitionRequestFormulaStyleArgs();
        }

        public Builder(PowerpackV2WidgetTreemapDefinitionRequestFormulaStyleArgs defaults) {
            $ = new PowerpackV2WidgetTreemapDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetTreemapDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
