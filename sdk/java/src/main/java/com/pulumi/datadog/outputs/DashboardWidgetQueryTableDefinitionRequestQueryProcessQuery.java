...
@CustomType
public final class DashboardWidgetQueryTableDefinitionRequestQueryProcessQuery {
    /**
    ...
    private DashboardWidgetQueryTableDefinitionRequestQueryProcessQuery() {}
    /**
     * @return The aggregation methods available for cloud cost queries. Valid values are `avg`, `last`, `max`, `min`, `sum`, `percentile`.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetQueryTableDefinitionRequestQueryProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String textFilter;
        public Builder() {}
        public Builder(DashboardWidgetQueryTableDefinitionRequestQueryProcessQuery defaults) {
        ...
        public Builder dataSource(String dataSource) {
            if (dataSource == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQueryProcessQuery", "dataSource");
            }
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQueryProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestQueryProcessQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public DashboardWidgetQueryTableDefinitionRequestQueryProcessQuery build() {
            final var _resultValue = new DashboardWidgetQueryTableDefinitionRequestQueryProcessQuery();
