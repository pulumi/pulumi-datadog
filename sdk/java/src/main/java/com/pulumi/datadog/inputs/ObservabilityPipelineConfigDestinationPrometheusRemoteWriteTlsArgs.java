...
public final class ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTlsArgs Empty = new ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTlsArgs();
    ...
    private ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTlsArgs() {}

    private ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTlsArgs(ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTlsArgs build() {
            if ($.crtFile == null) {
                throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationPrometheusRemoteWriteTlsArgs", "crtFile");
            }
            return $;
        }
    }
