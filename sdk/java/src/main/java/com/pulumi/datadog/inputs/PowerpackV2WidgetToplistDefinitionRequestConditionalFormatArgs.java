...
public final class PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs Empty = new PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs();
    ...
    private PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs() {}

    private PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs(PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs();
        }

        public Builder(PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs defaults) {
            $ = new PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestConditionalFormatArgs", "value");
            }
            return $;
        }
    }
