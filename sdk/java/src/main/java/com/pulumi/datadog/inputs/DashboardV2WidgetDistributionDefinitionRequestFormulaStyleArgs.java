...
public final class DashboardV2WidgetDistributionDefinitionRequestFormulaStyleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetDistributionDefinitionRequestFormulaStyleArgs Empty = new DashboardV2WidgetDistributionDefinitionRequestFormulaStyleArgs();
    ...
    private DashboardV2WidgetDistributionDefinitionRequestFormulaStyleArgs() {}

    private DashboardV2WidgetDistributionDefinitionRequestFormulaStyleArgs(DashboardV2WidgetDistributionDefinitionRequestFormulaStyleArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetDistributionDefinitionRequestFormulaStyleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetDistributionDefinitionRequestFormulaStyleArgs();
        }

        public Builder(DashboardV2WidgetDistributionDefinitionRequestFormulaStyleArgs defaults) {
            $ = new DashboardV2WidgetDistributionDefinitionRequestFormulaStyleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetDistributionDefinitionRequestFormulaStyleArgs build() {
            return $;
        }
    }
