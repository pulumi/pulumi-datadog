...
import com.pulumi.datadog.outputs.DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTime;
...
@CustomType
public final class DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinition {
    /**
     ...
     * 
     */
    private @Nullable DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTime time;
    /**
    ...
    private DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinition() {}
    /**
     * @return The ID of the monitor used by the widget.
     * 
     */
     ...
     * 
     */
    public Optional<DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTime> time() {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private String vizType;
        public Builder() {}
        public Builder(DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinition defaults) {
        ...
        public Builder alertId(String alertId) {
            if (alertId == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinition", "alertId");
            }
        ...
        @CustomType.Setter
        public Builder time(@Nullable DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinitionTime time) {
        ...
        public Builder vizType(String vizType) {
            if (vizType == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinition", "vizType");
            }
            this.vizType = vizType;
            return this;
        }
        public DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinition build() {
            final var _resultValue = new DashboardV2WidgetGroupDefinitionWidgetAlertGraphDefinition();
