...
public final class DashboardWidgetTimeseriesDefinitionRequestLogQueryMultiComputeArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetTimeseriesDefinitionRequestLogQueryMultiComputeArgs Empty = new DashboardWidgetTimeseriesDefinitionRequestLogQueryMultiComputeArgs();
    ...
    private DashboardWidgetTimeseriesDefinitionRequestLogQueryMultiComputeArgs() {}

    private DashboardWidgetTimeseriesDefinitionRequestLogQueryMultiComputeArgs(DashboardWidgetTimeseriesDefinitionRequestLogQueryMultiComputeArgs $) {
    ...
    public static Builder builder(DashboardWidgetTimeseriesDefinitionRequestLogQueryMultiComputeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetTimeseriesDefinitionRequestLogQueryMultiComputeArgs defaults) {
            $ = new DashboardWidgetTimeseriesDefinitionRequestLogQueryMultiComputeArgs(Objects.requireNonNull(defaults));
        }
