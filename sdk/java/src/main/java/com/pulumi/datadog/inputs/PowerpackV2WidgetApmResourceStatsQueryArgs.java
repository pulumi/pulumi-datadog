...
public final class PowerpackV2WidgetApmResourceStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetApmResourceStatsQueryArgs Empty = new PowerpackV2WidgetApmResourceStatsQueryArgs();
    ...
    private PowerpackV2WidgetApmResourceStatsQueryArgs() {}

    private PowerpackV2WidgetApmResourceStatsQueryArgs(PowerpackV2WidgetApmResourceStatsQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetApmResourceStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetApmResourceStatsQueryArgs();
        }

        public Builder(PowerpackV2WidgetApmResourceStatsQueryArgs defaults) {
            $ = new PowerpackV2WidgetApmResourceStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetApmResourceStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetApmResourceStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetApmResourceStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetApmResourceStatsQueryArgs", "name");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetApmResourceStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetApmResourceStatsQueryArgs", "stat");
            }
            return $;
        }
    }
