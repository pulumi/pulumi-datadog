...
public final class DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs Empty = new DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs();
    ...
    private DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs() {}

    private DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs(DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetTreemapDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
