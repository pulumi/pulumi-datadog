...
public final class DashboardWidgetScatterplotDefinitionRequestXLogQuery {
    ...
    public static final class Builder {
        ...
        public Builder index(String index) {
            if (index == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetScatterplotDefinitionRequestXLogQuery", "index");
            }
            this.index = index;
            return this;
        }
        ...
        public DashboardWidgetScatterplotDefinitionRequestXLogQuery build() {
            final var _resultValue = new DashboardWidgetScatterplotDefinitionRequestXLogQuery();
