...
import com.pulumi.datadog.outputs.PowerpackV2WidgetServicemapDefinitionCustomLink;
import com.pulumi.datadog.outputs.PowerpackV2WidgetServicemapDefinitionTime;
...
@CustomType
public final class PowerpackV2WidgetServicemapDefinition {
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    private @Nullable List<PowerpackV2WidgetServicemapDefinitionCustomLink> customLinks;
    /**
     ...
     * 
     */
    private @Nullable PowerpackV2WidgetServicemapDefinitionTime time;
    /**
    ...
    private PowerpackV2WidgetServicemapDefinition() {}
    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public List<PowerpackV2WidgetServicemapDefinitionCustomLink> customLinks() {
     ...
     * 
     */
    public Optional<PowerpackV2WidgetServicemapDefinitionTime> time() {
    ...
    public static Builder builder(PowerpackV2WidgetServicemapDefinition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String titleSize;
        public Builder() {}
        public Builder(PowerpackV2WidgetServicemapDefinition defaults) {
        ...
        @CustomType.Setter
        public Builder customLinks(@Nullable List<PowerpackV2WidgetServicemapDefinitionCustomLink> customLinks) {

            this.customLinks = customLinks;
            return this;
        }
        public Builder customLinks(PowerpackV2WidgetServicemapDefinitionCustomLink... customLinks) {
        ...
        public Builder filters(List<String> filters) {
            if (filters == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetServicemapDefinition", "filters");
            }
        ...
        public Builder service(String service) {
            if (service == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetServicemapDefinition", "service");
            }
            this.service = service;
            return this;
        }
        @CustomType.Setter
        public Builder time(@Nullable PowerpackV2WidgetServicemapDefinitionTime time) {
        ...
        public PowerpackV2WidgetServicemapDefinition build() {
            final var _resultValue = new PowerpackV2WidgetServicemapDefinition();
