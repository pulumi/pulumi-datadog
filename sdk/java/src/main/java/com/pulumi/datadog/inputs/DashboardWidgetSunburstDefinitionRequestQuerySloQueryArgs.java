...
public final class DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs Empty = new DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs();
    ...
    private DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs() {}

    private DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs(DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
