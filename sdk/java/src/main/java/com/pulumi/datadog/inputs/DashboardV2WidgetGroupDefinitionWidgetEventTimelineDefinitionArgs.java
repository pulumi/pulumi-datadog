...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs();
    ...
    /**
     * @return Query to filter the event timeline with.
     * 
     */
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs build() {
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionWidgetEventTimelineDefinitionArgs", "query");
            }
            return $;
        }
    }
