...
import com.pulumi.datadog.inputs.DashboardV2WidgetTimeseriesDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetTimeseriesDefinitionEventArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetTimeseriesDefinitionMarkerArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetTimeseriesDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetTimeseriesDefinitionRightYaxisArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetTimeseriesDefinitionTimeArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetTimeseriesDefinitionYaxisArgs;
...
public final class DashboardV2WidgetTimeseriesDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetTimeseriesDefinitionArgs Empty = new DashboardV2WidgetTimeseriesDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetTimeseriesDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetTimeseriesDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="events")
    private @Nullable Output<List<DashboardV2WidgetTimeseriesDefinitionEventArgs>> events;

    /**
     * @return The definition of the event to overlay on the graph. Multiple `event` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetTimeseriesDefinitionEventArgs>>> events() {
     ...
     */
    @Import(name="markers")
    private @Nullable Output<List<DashboardV2WidgetTimeseriesDefinitionMarkerArgs>> markers;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetTimeseriesDefinitionMarkerArgs>>> markers() {
    ...
    private @Nullable Output<List<DashboardV2WidgetTimeseriesDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetTimeseriesDefinitionRequestArgs>>> requests() {
    ...
    private @Nullable Output<DashboardV2WidgetTimeseriesDefinitionRightYaxisArgs> rightYaxis;
     ...
     * 
     */
    public Optional<Output<DashboardV2WidgetTimeseriesDefinitionRightYaxisArgs>> rightYaxis() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetTimeseriesDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetTimeseriesDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="yaxis")
    private @Nullable Output<DashboardV2WidgetTimeseriesDefinitionYaxisArgs> yaxis;

    /**
     * @return A nested block describing the Y-Axis Controls. The structure of this block is described below.
     * 
     */
    public Optional<Output<DashboardV2WidgetTimeseriesDefinitionYaxisArgs>> yaxis() {
        return Optional.ofNullable(this.yaxis);
    }

    private DashboardV2WidgetTimeseriesDefinitionArgs() {}

    private DashboardV2WidgetTimeseriesDefinitionArgs(DashboardV2WidgetTimeseriesDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetTimeseriesDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetTimeseriesDefinitionArgs();
        }

        public Builder(DashboardV2WidgetTimeseriesDefinitionArgs defaults) {
            $ = new DashboardV2WidgetTimeseriesDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetTimeseriesDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetTimeseriesDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetTimeseriesDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder events(@Nullable Output<List<DashboardV2WidgetTimeseriesDefinitionEventArgs>> events) {
            $.events = events;
            return this;
        }
         ...
         * 
         */
        public Builder events(List<DashboardV2WidgetTimeseriesDefinitionEventArgs> events) {
         ...
         * 
         */
        public Builder events(DashboardV2WidgetTimeseriesDefinitionEventArgs... events) {
         ...
         * 
         */
        public Builder markers(@Nullable Output<List<DashboardV2WidgetTimeseriesDefinitionMarkerArgs>> markers) {
            $.markers = markers;
            return this;
        }
         ...
         * 
         */
        public Builder markers(List<DashboardV2WidgetTimeseriesDefinitionMarkerArgs> markers) {
         ...
         * 
         */
        public Builder markers(DashboardV2WidgetTimeseriesDefinitionMarkerArgs... markers) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetTimeseriesDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetTimeseriesDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetTimeseriesDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder rightYaxis(@Nullable Output<DashboardV2WidgetTimeseriesDefinitionRightYaxisArgs> rightYaxis) {
         ...
         * 
         */
        public Builder rightYaxis(DashboardV2WidgetTimeseriesDefinitionRightYaxisArgs rightYaxis) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetTimeseriesDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetTimeseriesDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder yaxis(@Nullable Output<DashboardV2WidgetTimeseriesDefinitionYaxisArgs> yaxis) {
            $.yaxis = yaxis;
            return this;
        }
         ...
         * 
         */
        public Builder yaxis(DashboardV2WidgetTimeseriesDefinitionYaxisArgs yaxis) {
            return yaxis(Output.of(yaxis));
        }

        public DashboardV2WidgetTimeseriesDefinitionArgs build() {
            return $;
        }
    }
