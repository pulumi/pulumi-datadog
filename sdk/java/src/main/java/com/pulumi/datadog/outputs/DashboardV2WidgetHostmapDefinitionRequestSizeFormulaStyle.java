...
@CustomType
public final class DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyle {
    /**
    ...
    private DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyle defaults) {
        ...
        public DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyle build() {
            final var _resultValue = new DashboardV2WidgetHostmapDefinitionRequestSizeFormulaStyle();
