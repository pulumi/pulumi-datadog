...
import com.pulumi.datadog.inputs.DashboardV2WidgetRunWorkflowDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetRunWorkflowDefinitionInputArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetRunWorkflowDefinitionTimeArgs;
...
public final class DashboardV2WidgetRunWorkflowDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetRunWorkflowDefinitionArgs Empty = new DashboardV2WidgetRunWorkflowDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetRunWorkflowDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetRunWorkflowDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="inputs")
    private @Nullable Output<List<DashboardV2WidgetRunWorkflowDefinitionInputArgs>> inputs;

    /**
     * @return Array of workflow inputs to map to dashboard template variables.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetRunWorkflowDefinitionInputArgs>>> inputs() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetRunWorkflowDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetRunWorkflowDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetRunWorkflowDefinitionArgs() {}

    private DashboardV2WidgetRunWorkflowDefinitionArgs(DashboardV2WidgetRunWorkflowDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetRunWorkflowDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetRunWorkflowDefinitionArgs();
        }

        public Builder(DashboardV2WidgetRunWorkflowDefinitionArgs defaults) {
            $ = new DashboardV2WidgetRunWorkflowDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetRunWorkflowDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetRunWorkflowDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetRunWorkflowDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder inputs(@Nullable Output<List<DashboardV2WidgetRunWorkflowDefinitionInputArgs>> inputs) {
            $.inputs = inputs;
            return this;
        }
         ...
         * 
         */
        public Builder inputs(List<DashboardV2WidgetRunWorkflowDefinitionInputArgs> inputs) {
         ...
         * 
         */
        public Builder inputs(DashboardV2WidgetRunWorkflowDefinitionInputArgs... inputs) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetRunWorkflowDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetRunWorkflowDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetRunWorkflowDefinitionArgs build() {
            if ($.workflowId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetRunWorkflowDefinitionArgs", "workflowId");
            }
            return $;
        }
    }
