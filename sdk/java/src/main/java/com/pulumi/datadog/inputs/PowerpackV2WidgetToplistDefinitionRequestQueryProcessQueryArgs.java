...
public final class PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs Empty = new PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs();
    ...
    private PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs() {}

    private PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs(PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetToplistDefinitionRequestQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
