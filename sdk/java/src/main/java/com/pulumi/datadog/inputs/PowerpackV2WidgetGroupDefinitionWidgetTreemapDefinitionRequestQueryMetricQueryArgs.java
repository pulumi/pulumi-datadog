...
public final class PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs Empty = new PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs();
    ...
    private PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs() {}

    private PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs(PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs();
        }

        public Builder(PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs defaults) {
            $ = new PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
