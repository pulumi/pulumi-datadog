...
public final class ObservabilityPipelineConfigSourcesSyslogNgTlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ObservabilityPipelineConfigSourcesSyslogNgTlsArgs Empty = new ObservabilityPipelineConfigSourcesSyslogNgTlsArgs();
    ...
    private ObservabilityPipelineConfigSourcesSyslogNgTlsArgs() {}

    private ObservabilityPipelineConfigSourcesSyslogNgTlsArgs(ObservabilityPipelineConfigSourcesSyslogNgTlsArgs $) {
        this.caFile = $.caFile;
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesSyslogNgTlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ObservabilityPipelineConfigSourcesSyslogNgTlsArgs();
        }

        public Builder(ObservabilityPipelineConfigSourcesSyslogNgTlsArgs defaults) {
            $ = new ObservabilityPipelineConfigSourcesSyslogNgTlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ObservabilityPipelineConfigSourcesSyslogNgTlsArgs build() {
            return $;
        }
    }
