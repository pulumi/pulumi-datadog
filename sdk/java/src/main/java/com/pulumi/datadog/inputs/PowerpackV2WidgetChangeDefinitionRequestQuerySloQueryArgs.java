...
public final class PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs Empty = new PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs(PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetChangeDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
