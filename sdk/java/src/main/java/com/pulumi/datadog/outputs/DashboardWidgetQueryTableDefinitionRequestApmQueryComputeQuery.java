...
@CustomType
public final class DashboardWidgetQueryTableDefinitionRequestApmQueryComputeQuery {
    /**
    ...
    private DashboardWidgetQueryTableDefinitionRequestApmQueryComputeQuery() {}
    /**
     * @return The aggregation method.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetQueryTableDefinitionRequestApmQueryComputeQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer interval;
        public Builder() {}
        public Builder(DashboardWidgetQueryTableDefinitionRequestApmQueryComputeQuery defaults) {
        ...
        public Builder aggregation(String aggregation) {
            if (aggregation == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetQueryTableDefinitionRequestApmQueryComputeQuery", "aggregation");
            }
