...
@CustomType
public final class DashboardV2WidgetTimeseriesDefinitionRequestStyle {
    /**
    ...
    private DashboardV2WidgetTimeseriesDefinitionRequestStyle() {}
    /**
     * @return Whether to display value labels on the timeseries.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetTimeseriesDefinitionRequestStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String palette;
        public Builder() {}
        public Builder(DashboardV2WidgetTimeseriesDefinitionRequestStyle defaults) {
        ...
        public DashboardV2WidgetTimeseriesDefinitionRequestStyle build() {
            final var _resultValue = new DashboardV2WidgetTimeseriesDefinitionRequestStyle();
