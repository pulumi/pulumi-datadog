...
public final class DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs Empty = new DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs();
    ...
    private DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs() {}

    private DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs(DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs();
        }

        public Builder(DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs defaults) {
            $ = new DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs", "name");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetHeatmapDefinitionRequestHistogramRequestHistogramQueryMetricQueryArgs", "query");
            }
            return $;
        }
    }
