...
@CustomType
public final class ObservabilityPipelineConfigSourcesRsyslogTls {
    /**
    ...
    public static Builder builder(ObservabilityPipelineConfigSourcesRsyslogTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourcesRsyslogTls defaults) {
        ...
        public ObservabilityPipelineConfigSourcesRsyslogTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourcesRsyslogTls();
