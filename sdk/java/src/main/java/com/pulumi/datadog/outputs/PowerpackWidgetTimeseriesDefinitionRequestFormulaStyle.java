...
@CustomType
public final class PowerpackWidgetTimeseriesDefinitionRequestFormulaStyle {
    /**
    ...
    private PowerpackWidgetTimeseriesDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetTimeseriesDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackWidgetTimeseriesDefinitionRequestFormulaStyle defaults) {
        ...
        public PowerpackWidgetTimeseriesDefinitionRequestFormulaStyle build() {
            final var _resultValue = new PowerpackWidgetTimeseriesDefinitionRequestFormulaStyle();
