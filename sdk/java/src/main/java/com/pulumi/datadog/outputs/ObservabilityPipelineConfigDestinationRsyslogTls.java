...
@CustomType
public final class ObservabilityPipelineConfigDestinationRsyslogTls {
    /**
    ...
    private ObservabilityPipelineConfigDestinationRsyslogTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigDestinationRsyslogTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigDestinationRsyslogTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigDestinationRsyslogTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigDestinationRsyslogTls build() {
            final var _resultValue = new ObservabilityPipelineConfigDestinationRsyslogTls();
