...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs();
     ...
     */
    @Import(name="request")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionRequestArgs> request;

    /**
     * @return A nested block describing the request to use when displaying the widget. Only one `request` block is allowed.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionRequestArgs>> request() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs(DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param request A nested block describing the request to use when displaying the widget. Only one `request` block is allowed.
         * 
         * @return builder
         * 
         */
        public Builder request(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionRequestArgs> request) {
            $.request = request;
            return this;
        }
         ...
         * 
         */
        public Builder request(DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionRequestArgs request) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetGroupDefinitionWidgetFunnelDefinitionArgs build() {
            return $;
        }
    }
