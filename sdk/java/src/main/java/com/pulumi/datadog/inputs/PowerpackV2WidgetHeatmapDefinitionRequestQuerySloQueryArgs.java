...
public final class PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs Empty = new PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs();
    ...
    private PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs() {}

    private PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs(PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetHeatmapDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
