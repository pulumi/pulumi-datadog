...
import com.pulumi.datadog.inputs.DashboardV2WidgetHeatmapDefinitionCustomLinkArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetHeatmapDefinitionEventArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetHeatmapDefinitionMarkerArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetHeatmapDefinitionRequestArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetHeatmapDefinitionTimeArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetHeatmapDefinitionXaxisArgs;
import com.pulumi.datadog.inputs.DashboardV2WidgetHeatmapDefinitionYaxisArgs;
...
public final class DashboardV2WidgetHeatmapDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetHeatmapDefinitionArgs Empty = new DashboardV2WidgetHeatmapDefinitionArgs();
    ...
    private @Nullable Output<List<DashboardV2WidgetHeatmapDefinitionCustomLinkArgs>> customLinks;

    /**
     * @return A nested block describing a custom link. Multiple `customLink` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetHeatmapDefinitionCustomLinkArgs>>> customLinks() {
     ...
     */
    @Import(name="events")
    private @Nullable Output<List<DashboardV2WidgetHeatmapDefinitionEventArgs>> events;

    /**
     * @return The definition of the event to overlay on the graph. Multiple `event` blocks are allowed using the structure below.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetHeatmapDefinitionEventArgs>>> events() {
     ...
     */
    @Import(name="markers")
    private @Nullable Output<List<DashboardV2WidgetHeatmapDefinitionMarkerArgs>> markers;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetHeatmapDefinitionMarkerArgs>>> markers() {
    ...
    private @Nullable Output<List<DashboardV2WidgetHeatmapDefinitionRequestArgs>> requests;
     ...
     * 
     */
    public Optional<Output<List<DashboardV2WidgetHeatmapDefinitionRequestArgs>>> requests() {
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetHeatmapDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetHeatmapDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="xaxis")
    private @Nullable Output<DashboardV2WidgetHeatmapDefinitionXaxisArgs> xaxis;

    /**
     * @return A nested block describing the X-Axis Controls. Exactly one nested block is allowed using the structure below.
     * 
     */
    public Optional<Output<DashboardV2WidgetHeatmapDefinitionXaxisArgs>> xaxis() {
     ...
     */
    @Import(name="yaxis")
    private @Nullable Output<DashboardV2WidgetHeatmapDefinitionYaxisArgs> yaxis;

    /**
     * @return A nested block describing the Y-Axis Controls. The structure of this block is described below.
     * 
     */
    public Optional<Output<DashboardV2WidgetHeatmapDefinitionYaxisArgs>> yaxis() {
        return Optional.ofNullable(this.yaxis);
    }

    private DashboardV2WidgetHeatmapDefinitionArgs() {}

    private DashboardV2WidgetHeatmapDefinitionArgs(DashboardV2WidgetHeatmapDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetHeatmapDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetHeatmapDefinitionArgs();
        }

        public Builder(DashboardV2WidgetHeatmapDefinitionArgs defaults) {
            $ = new DashboardV2WidgetHeatmapDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customLinks(@Nullable Output<List<DashboardV2WidgetHeatmapDefinitionCustomLinkArgs>> customLinks) {
         ...
         * 
         */
        public Builder customLinks(List<DashboardV2WidgetHeatmapDefinitionCustomLinkArgs> customLinks) {
         ...
         * 
         */
        public Builder customLinks(DashboardV2WidgetHeatmapDefinitionCustomLinkArgs... customLinks) {
         ...
         * 
         */
        public Builder events(@Nullable Output<List<DashboardV2WidgetHeatmapDefinitionEventArgs>> events) {
            $.events = events;
            return this;
        }
         ...
         * 
         */
        public Builder events(List<DashboardV2WidgetHeatmapDefinitionEventArgs> events) {
         ...
         * 
         */
        public Builder events(DashboardV2WidgetHeatmapDefinitionEventArgs... events) {
         ...
         * 
         */
        public Builder markers(@Nullable Output<List<DashboardV2WidgetHeatmapDefinitionMarkerArgs>> markers) {
            $.markers = markers;
            return this;
        }
         ...
         * 
         */
        public Builder markers(List<DashboardV2WidgetHeatmapDefinitionMarkerArgs> markers) {
         ...
         * 
         */
        public Builder markers(DashboardV2WidgetHeatmapDefinitionMarkerArgs... markers) {
         ...
         * 
         */
        public Builder requests(@Nullable Output<List<DashboardV2WidgetHeatmapDefinitionRequestArgs>> requests) {
            $.requests = requests;
            return this;
        }
         ...
         * 
         */
        public Builder requests(List<DashboardV2WidgetHeatmapDefinitionRequestArgs> requests) {
         ...
         * 
         */
        public Builder requests(DashboardV2WidgetHeatmapDefinitionRequestArgs... requests) {
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetHeatmapDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetHeatmapDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder xaxis(@Nullable Output<DashboardV2WidgetHeatmapDefinitionXaxisArgs> xaxis) {
            $.xaxis = xaxis;
            return this;
        }
         ...
         * 
         */
        public Builder xaxis(DashboardV2WidgetHeatmapDefinitionXaxisArgs xaxis) {
         ...
         * 
         */
        public Builder yaxis(@Nullable Output<DashboardV2WidgetHeatmapDefinitionYaxisArgs> yaxis) {
            $.yaxis = yaxis;
            return this;
        }
         ...
         * 
         */
        public Builder yaxis(DashboardV2WidgetHeatmapDefinitionYaxisArgs yaxis) {
            return yaxis(Output.of(yaxis));
        }

        public DashboardV2WidgetHeatmapDefinitionArgs build() {
            return $;
        }
    }
