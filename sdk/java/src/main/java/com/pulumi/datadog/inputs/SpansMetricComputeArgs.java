...
public final class SpansMetricComputeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param includePercentiles Toggle to include or exclude percentile aggregations for distribution metrics. Only present when the `aggregationType` is `distribution`.
         * 
         * @return builder
         * 
         */
        ...
        public SpansMetricComputeArgs build() {
            if ($.aggregationType == null) {
                throw new MissingRequiredPropertyException("SpansMetricComputeArgs", "aggregationType");
            }
            return $;
        }
    }
