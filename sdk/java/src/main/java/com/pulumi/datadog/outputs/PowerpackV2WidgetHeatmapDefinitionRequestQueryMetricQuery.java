...
@CustomType
public final class PowerpackV2WidgetHeatmapDefinitionRequestQueryMetricQuery {
    /**
    ...
    private PowerpackV2WidgetHeatmapDefinitionRequestQueryMetricQuery() {}
    /**
     * @return The aggregation methods available for metrics queries. Valid values are `avg`, `min`, `max`, `sum`, `last`, `area`, `l2norm`, `percentile`.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetHeatmapDefinitionRequestQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String semanticMode;
        public Builder() {}
        public Builder(PowerpackV2WidgetHeatmapDefinitionRequestQueryMetricQuery defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetHeatmapDefinitionRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("PowerpackV2WidgetHeatmapDefinitionRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
        ...
        public PowerpackV2WidgetHeatmapDefinitionRequestQueryMetricQuery build() {
            final var _resultValue = new PowerpackV2WidgetHeatmapDefinitionRequestQueryMetricQuery();
