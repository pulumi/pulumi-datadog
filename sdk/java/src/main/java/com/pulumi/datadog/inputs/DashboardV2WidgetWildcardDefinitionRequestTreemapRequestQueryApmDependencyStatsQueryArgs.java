...
public final class DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs Empty = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs();
    ...
    private DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs() {}

    private DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs();
        }

        public Builder(DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs defaults) {
            $ = new DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs", "dataSource");
            }
            if ($.env == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs", "env");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs", "name");
            }
            if ($.operationName == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs", "operationName");
            }
            if ($.resourceName == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs", "resourceName");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs", "service");
            }
            if ($.stat == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetWildcardDefinitionRequestTreemapRequestQueryApmDependencyStatsQueryArgs", "stat");
            }
            return $;
        }
    }
