...
import com.pulumi.datadog.outputs.DashboardWidgetSunburstDefinitionRequestFormulaNumberFormat;
...
@CustomType
public final class DashboardWidgetSunburstDefinitionRequestFormula {
    /**
     ...
     * 
     */
    private @Nullable DashboardWidgetSunburstDefinitionRequestFormulaNumberFormat numberFormat;
    /**
     ...
     * 
     */
    public List<DashboardWidgetSunburstDefinitionRequestFormulaConditionalFormat> conditionalFormats() {
     ...
     * 
     */
    public Optional<DashboardWidgetSunburstDefinitionRequestFormulaNumberFormat> numberFormat() {
    ...
    public static Builder builder(DashboardWidgetSunburstDefinitionRequestFormula defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder conditionalFormats(@Nullable List<DashboardWidgetSunburstDefinitionRequestFormulaConditionalFormat> conditionalFormats) {

            this.conditionalFormats = conditionalFormats;
            return this;
        }
        public Builder conditionalFormats(DashboardWidgetSunburstDefinitionRequestFormulaConditionalFormat... conditionalFormats) {
            return conditionalFormats(List.of(conditionalFormats));
        }
        @CustomType.Setter
        public Builder formulaExpression(String formulaExpression) {
            if (formulaExpression == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetSunburstDefinitionRequestFormula", "formulaExpression");
            }
            this.formulaExpression = formulaExpression;
            return this;
        }
        @CustomType.Setter
        public Builder limit(@Nullable DashboardWidgetSunburstDefinitionRequestFormulaLimit limit) {

            this.limit = limit;
            return this;
        }
        @CustomType.Setter
        public Builder numberFormat(@Nullable DashboardWidgetSunburstDefinitionRequestFormulaNumberFormat numberFormat) {
        ...
        public DashboardWidgetSunburstDefinitionRequestFormula build() {
            final var _resultValue = new DashboardWidgetSunburstDefinitionRequestFormula();
