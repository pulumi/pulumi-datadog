...
public final class SyntheticsTestApiStepRequestDefinitionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(SyntheticsTestApiStepRequestDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SyntheticsTestApiStepRequestDefinitionArgs();
        }
        ...
        public SyntheticsTestApiStepRequestDefinitionArgs build() {
            return $;
        }
    }
