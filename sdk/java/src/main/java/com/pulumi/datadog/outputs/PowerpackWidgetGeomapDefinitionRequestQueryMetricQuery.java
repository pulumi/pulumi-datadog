...
@CustomType
public final class PowerpackWidgetGeomapDefinitionRequestQueryMetricQuery {
    /**
    ...
    private PowerpackWidgetGeomapDefinitionRequestQueryMetricQuery() {}
    /**
     * @return The aggregation methods available for metrics queries. Valid values are `avg`, `min`, `max`, `sum`, `last`, `area`, `l2norm`, `percentile`.
     * 
     */
    ...
    public static Builder builder(PowerpackWidgetGeomapDefinitionRequestQueryMetricQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(PowerpackWidgetGeomapDefinitionRequestQueryMetricQuery defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryMetricQuery", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("PowerpackWidgetGeomapDefinitionRequestQueryMetricQuery", "query");
            }
            this.query = query;
            return this;
        }
        public PowerpackWidgetGeomapDefinitionRequestQueryMetricQuery build() {
            final var _resultValue = new PowerpackWidgetGeomapDefinitionRequestQueryMetricQuery();
