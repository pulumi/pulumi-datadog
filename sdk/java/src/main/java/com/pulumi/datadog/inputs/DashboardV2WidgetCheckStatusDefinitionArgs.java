...
import com.pulumi.datadog.inputs.DashboardV2WidgetCheckStatusDefinitionTimeArgs;
...
public final class DashboardV2WidgetCheckStatusDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetCheckStatusDefinitionArgs Empty = new DashboardV2WidgetCheckStatusDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetCheckStatusDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetCheckStatusDefinitionTimeArgs>> time() {
    ...
    private DashboardV2WidgetCheckStatusDefinitionArgs() {}

    private DashboardV2WidgetCheckStatusDefinitionArgs(DashboardV2WidgetCheckStatusDefinitionArgs $) {
        this.check = $.check;
    ...
    public static Builder builder(DashboardV2WidgetCheckStatusDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetCheckStatusDefinitionArgs();
        }

        public Builder(DashboardV2WidgetCheckStatusDefinitionArgs defaults) {
            $ = new DashboardV2WidgetCheckStatusDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetCheckStatusDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetCheckStatusDefinitionTimeArgs time) {
        ...
        public DashboardV2WidgetCheckStatusDefinitionArgs build() {
            if ($.check == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetCheckStatusDefinitionArgs", "check");
            }
            if ($.grouping == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetCheckStatusDefinitionArgs", "grouping");
            }
            return $;
        }
    }
