...
public final class DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs Empty = new DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs();
    ...
    private DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs() {}

    private DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs(DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs();
        }

        public Builder(DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs defaults) {
            $ = new DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs build() {
            if ($.comparator == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs", "comparator");
            }
            if ($.palette == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs", "palette");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestFormulaConditionalFormatArgs", "value");
            }
            return $;
        }
    }
