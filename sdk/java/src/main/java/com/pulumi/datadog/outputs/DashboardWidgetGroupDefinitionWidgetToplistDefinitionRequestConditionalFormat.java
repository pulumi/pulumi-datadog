...
@CustomType
public final class DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormat {
    /**
    ...
    private DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormat() {}
    /**
     * @return The comparator to use. Valid values are `=`, `&gt;`, `&gt;=`, `&lt;`, `&lt;=`.
     * 
     */
    ...
    public static Builder builder(DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormat defaults) {
    ...
    public static final class Builder {
        ...
        private Double value;
        public Builder() {}
        public Builder(DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormat defaults) {
        ...
        public Builder comparator(String comparator) {
            if (comparator == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormat", "comparator");
            }
        ...
        public Builder palette(String palette) {
            if (palette == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormat", "palette");
            }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormat", "value");
            }
            this.value = value;
            return this;
        }
        public DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormat build() {
            final var _resultValue = new DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestConditionalFormat();
