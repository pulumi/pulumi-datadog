...
import com.pulumi.datadog.inputs.DashboardV2WidgetGroupDefinitionTimeArgs;
...
public final class DashboardV2WidgetGroupDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetGroupDefinitionArgs Empty = new DashboardV2WidgetGroupDefinitionArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<DashboardV2WidgetGroupDefinitionTimeArgs> time;

    /**
     * @return A nested block used to specify a time span for the widget. Use this or `liveSpan`, not both.
     * 
     */
    public Optional<Output<DashboardV2WidgetGroupDefinitionTimeArgs>> time() {
     ...
     */
    @Import(name="widgets")
    private @Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetArgs>> widgets;

    /**
     * @return The list of widgets in this group.
     * 
     */
    public Optional<Output<List<DashboardV2WidgetGroupDefinitionWidgetArgs>>> widgets() {
        return Optional.ofNullable(this.widgets);
    }

    private DashboardV2WidgetGroupDefinitionArgs() {}

    private DashboardV2WidgetGroupDefinitionArgs(DashboardV2WidgetGroupDefinitionArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetGroupDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetGroupDefinitionArgs();
        }

        public Builder(DashboardV2WidgetGroupDefinitionArgs defaults) {
            $ = new DashboardV2WidgetGroupDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<DashboardV2WidgetGroupDefinitionTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(DashboardV2WidgetGroupDefinitionTimeArgs time) {
         ...
         * 
         */
        public Builder widgets(@Nullable Output<List<DashboardV2WidgetGroupDefinitionWidgetArgs>> widgets) {
            $.widgets = widgets;
            return this;
        }
         ...
         * 
         */
        public Builder widgets(List<DashboardV2WidgetGroupDefinitionWidgetArgs> widgets) {
         ...
         * 
         */
        public Builder widgets(DashboardV2WidgetGroupDefinitionWidgetArgs... widgets) {
            return widgets(List.of(widgets));
        }

        public DashboardV2WidgetGroupDefinitionArgs build() {
            if ($.layoutType == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetGroupDefinitionArgs", "layoutType");
            }
            return $;
        }
    }
