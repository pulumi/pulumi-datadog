...
@CustomType
public final class PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyle {
    /**
    ...
    private PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyle() {}
    /**
     * @return The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.datadoghq.com/dashboards/guide/widget_colors.
     * 
     */
    ...
    public static Builder builder(PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer paletteIndex;
        public Builder() {}
        public Builder(PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyle defaults) {
        ...
        public PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyle build() {
            final var _resultValue = new PowerpackV2WidgetTimeseriesDefinitionRequestFormulaStyle();
