...
@CustomType
public final class ObservabilityPipelineConfigSourceSplunkHecTls {
    /**
    ...
    private ObservabilityPipelineConfigSourceSplunkHecTls() {}
    /**
     * @return Path to the Certificate Authority (CA) file used to validate the server&#39;s TLS certificate.
     * 
     */
    ...
    public static Builder builder(ObservabilityPipelineConfigSourceSplunkHecTls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyFile;
        public Builder() {}
        public Builder(ObservabilityPipelineConfigSourceSplunkHecTls defaults) {
        ...
        public Builder crtFile(String crtFile) {
            if (crtFile == null) {
              throw new MissingRequiredPropertyException("ObservabilityPipelineConfigSourceSplunkHecTls", "crtFile");
            }
        ...
        public ObservabilityPipelineConfigSourceSplunkHecTls build() {
            final var _resultValue = new ObservabilityPipelineConfigSourceSplunkHecTls();
