...
public final class DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs Empty = new DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs();
    ...
    private DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs() {}

    private DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs(DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs();
        }

        public Builder(DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs defaults) {
            $ = new DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs", "dataSource");
            }
            if ($.measure == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs", "measure");
            }
            if ($.sloId == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestQuerySloQueryArgs", "sloId");
            }
            return $;
        }
    }
