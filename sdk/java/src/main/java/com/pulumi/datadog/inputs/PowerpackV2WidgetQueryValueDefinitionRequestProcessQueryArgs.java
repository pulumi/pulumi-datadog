...
public final class PowerpackV2WidgetQueryValueDefinitionRequestProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PowerpackV2WidgetQueryValueDefinitionRequestProcessQueryArgs Empty = new PowerpackV2WidgetQueryValueDefinitionRequestProcessQueryArgs();
    ...
    private PowerpackV2WidgetQueryValueDefinitionRequestProcessQueryArgs() {}

    private PowerpackV2WidgetQueryValueDefinitionRequestProcessQueryArgs(PowerpackV2WidgetQueryValueDefinitionRequestProcessQueryArgs $) {
    ...
    public static Builder builder(PowerpackV2WidgetQueryValueDefinitionRequestProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PowerpackV2WidgetQueryValueDefinitionRequestProcessQueryArgs();
        }

        public Builder(PowerpackV2WidgetQueryValueDefinitionRequestProcessQueryArgs defaults) {
            $ = new PowerpackV2WidgetQueryValueDefinitionRequestProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PowerpackV2WidgetQueryValueDefinitionRequestProcessQueryArgs build() {
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("PowerpackV2WidgetQueryValueDefinitionRequestProcessQueryArgs", "metric");
            }
            return $;
        }
    }
