...
@CustomType
public final class DashboardV2WidgetToplistDefinitionRequestConditionalFormat {
    /**
    ...
    private DashboardV2WidgetToplistDefinitionRequestConditionalFormat() {}
    /**
     * @return The comparator to use. Valid values are `=`, `&gt;`, `&gt;=`, `&lt;`, `&lt;=`.
     * 
     */
    ...
    public static Builder builder(DashboardV2WidgetToplistDefinitionRequestConditionalFormat defaults) {
    ...
    public static final class Builder {
        ...
        private Double value;
        public Builder() {}
        public Builder(DashboardV2WidgetToplistDefinitionRequestConditionalFormat defaults) {
        ...
        public Builder comparator(String comparator) {
            if (comparator == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestConditionalFormat", "comparator");
            }
        ...
        public Builder palette(String palette) {
            if (palette == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestConditionalFormat", "palette");
            }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DashboardV2WidgetToplistDefinitionRequestConditionalFormat", "value");
            }
            this.value = value;
            return this;
        }
        public DashboardV2WidgetToplistDefinitionRequestConditionalFormat build() {
            final var _resultValue = new DashboardV2WidgetToplistDefinitionRequestConditionalFormat();
