...
public final class DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs Empty = new DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs();
    ...
    private DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs() {}

    private DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs(DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs $) {
    ...
    public static Builder builder(DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs();
        }

        public Builder(DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs defaults) {
            $ = new DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs build() {
            if ($.dataSource == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs", "dataSource");
            }
            if ($.metric == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs", "metric");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DashboardV2WidgetScatterplotDefinitionRequestScatterplotTableQueryProcessQueryArgs", "name");
            }
            return $;
        }
    }
