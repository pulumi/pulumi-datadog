...
@CustomType
public final class DashboardWidgetChangeDefinitionRequestProcessQuery {
    /**
    ...
    public static Builder builder(DashboardWidgetChangeDefinitionRequestProcessQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String searchBy;
        public Builder() {}
        public Builder(DashboardWidgetChangeDefinitionRequestProcessQuery defaults) {
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("DashboardWidgetChangeDefinitionRequestProcessQuery", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public DashboardWidgetChangeDefinitionRequestProcessQuery build() {
            final var _resultValue = new DashboardWidgetChangeDefinitionRequestProcessQuery();
